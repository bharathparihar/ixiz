...
class Vcard extends Model implements HasMedia
{
    ...
    public function getFaviconUrlAttribute(): string
    {
        ...
        return asset('web/media/logos/favicon.png');
    }
    ...
    public function whatsappStores()
    {
        return $this->belongsToMany(WhatsappStore::class,'vcard_whatsapp_stores')->withTimestamps();
    }

    public function paymentLinks(): HasMany
    {
        return $this->hasMany(VcardPaymentLink::class, 'vcard_id');
    }
