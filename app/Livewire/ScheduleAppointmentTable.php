...
class ScheduleAppointmentTable extends LivewireTableComponent
{
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make(__('Service Name'), 'service.name')
                ->view('appointment.columns.service'),
    ...
    public function builder(): Builder
    {
        ...
        $scheduleAppointments = ScheduleAppointment::with('vcard','appointmentTransaction')->whereIn('schedule_appointments.vcard_id', $vcardIds)->select('schedule_appointments.*');
