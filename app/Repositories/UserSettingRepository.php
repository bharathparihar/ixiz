...
class UserSettingRepository extends BaseRepository
{
    ...
    public function paymentMethodUpdate($input, $id)
    {
        ...
        // $inputArr['sslcommerz_enable'] = isset($inputArr['sslcommerz_enable']) ? $inputArr['sslcommerz_enable'] : '0';
        $inputArr['iyzico_enable'] = isset($inputArr['iyzico_enable']) ? $inputArr['iyzico_enable'] : '0';
        $inputArr['cashfree_enable'] = isset($inputArr['cashfree_enable']) ? $inputArr['cashfree_enable'] : '0';
        $inputArr['mercado_pago_enable'] = isset($inputArr['mercado_pago_enable']) ? $inputArr['mercado_pago_enable'] : '0';
