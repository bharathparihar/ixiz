      ...
      <div class="main-content mx-auto w-100 overflow-hidden bg-green">
        <div class="banner-section position-relative">
          <div class="banner-img">
            <img src="{{ asset('assets/img/vcard22/banner-img.png') }}" class="object-fit-cover w-100 h-100" loading="lazy"/>
          </div>
          ...
          >
            ...
            <div class="card-body text-sm-start text-center">
              <div class="profile-name">
                <h2 class="text-primary mb-0 fs-30">Pallavi Hegde</h2>
                <p class="fs-18 text-white mb-0">UI / UX Designer</p>
              </div>
            </div>
          </div>
          <p
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <div class="service-card h-100">
                  ...
                  <div class="card-body text-center p-0">
                    <h3 class="card-title fs-18 text-white mb-10">UI/UX</h3>
                    <p class="mb-0 fs-14 text-gray-100 text-center">
                      It is a long established fact that a reader will be
                      distracted by the readable content of a page when looking
                      at its layout.
        ...
        <div class="appointment-section mb-5 px-30">
          <div class="section-heading mb-5">
            <h2 class="mb-0">Make an Appointment</h2>
          </div>
          <div class="appointment">
            <div class="mb-30">
              <label for="date" class="appoint-date text-white fs-18 mb-1"
                >Date:</label
              >
              <div class="row">
                <div class="col-12">
            ...
            <div class="">
              <label class="text-white fs-18 mb-10">Hours :</label>
              <div class="row mb-3">
        ...
        <div class="gallery-section mb-5">
          <div class="section-heading mb-5 px-30">
        ...
        <div class="product-section mb-5 px-3">
          <div class="section-heading mb-5 px-3">
        ...
        <div class="testimonial-section mb-5 px-3">
          <div class="section-heading mb-5 px-3">
        ...
        <div class="blog-section mb-5 px-3">
          <div class="section-heading mb-5 px-3">
          ...
          <div class="blog-slider">
            <div class="">
              <div class="blog-card card">
                ...
                <div class="card-body p-0">
                  <h2 class="fs-18 text-white">colour Panel</h2>
            ...
            <div class="">
              <div class="blog-card card">
                ...
                <div class="card-body p-0">
                  <h2 class="fs-18 text-white">UI Research</h2>
                  <p class="text-gray-100 blog-desc fs-14">
                    Lorem Ipsum is simply dummy text of the printing and type
                    setting industry.
                  </p>
        ...
        <div class="business-hour-section mb-5 px-30">
          <div class="section-heading mb-5">
        ...
        <div class="create-vcard-section mb-5 mb-5">
          <div class="section-heading mb-5 px-30">
        ...
        <div class="add-to-contact-section mb-5">
          <div class="text-center">
            <button class="add-contact-btn rounded-2 btn btn-primary"><i
