<div id="mySidebar" class="sidebar vcard-sidebar-submenu d-lg-block d-xl-block">
        ...
        <ul class="nav nav-tabs-1 flex-nowrap text-nowrap flex-sm-column d-sm-flex d-block">
            <div class="d-sm-flex flex-sm-column overflow-auto">
                <li class="nav-item nav-item-1 position-relative">
                    <a class="nav-link-1 nav-link p-3 gap-2  {{ isset($partName) && ($partName == 'basics' || $partName == 'basics2' || $partName == 'basics3') ? 'active' : '' }}"
                ...
                @if (checkFeature('dynamic_vcard'))
                    <li class="nav-item nav-item-1 position-relative">
                        <a class="nav-link-1 nav-link p-3 gap-2 {{ isset($partName) && $partName == 'dynamic_vcard' ? 'active' : '' }}"
                            href="{{ route('vcards.edit', $vcard->id) . '?part=dynamic_vcard' }}" data-turbo="false">
                            <i
                                class="fa-solid fa-swatchbook p-1 icon-color-bs-green"></i>{{ __('messages.vcard.dynamic_vcard') }}
                        </a>
                    </li>
                @endif
                <li class="nav-item nav-item-1 position-relative">
                    <a class="nav-link-1 nav-link p-3 gap-2 {{ isset($partName) && $partName == 'business-hours' ? 'active' : '' }}"
                        href="{{ route('vcards.edit', $vcard->id) . '?part=business-hours' }}">
                        <i class="fa-solid fa-clock p-1 icon-color-bs-yellow"></i>
                        {{ __('messages.business.business_hours') }}
                    </a>
                </li>
                @if (checkFeature('qrcode-customize'))
                    <li class="nav-item nav-item-1 position-relative">
                        <a class="nav-link-1 nav-link p-3 gap-2 {{ isset($partName) && $partName == 'qrcode-customize' ? 'active' : '' }}"
                            href="{{ route('vcards.edit', $vcard->id) . '?part=qrcode-customize' }}">
                            <i
                                class="fa-solid fa-qrcode p-1 icon-color-bs-purple"></i>{{ __('messages.vcard.qrcode_customize') }}
                        </a>
                    </li>
                @endif
                <li class="nav-item nav-item-1 position-relative">
                    <a class="nav-link-1 nav-link p-3 gap-2  {{ isset($partName) && $partName == 'payment-links' ? 'active' : '' }}"
                        href="{{ route('vcards.edit', $vcard->id) . '?part=payment-links' }}">
                        <i class="fa-solid fa-link p-1 icon-color-bs-blue"></i>{{ __('messages.vcard.payment_links') }}
                    </a>
                </li>
                @if (checkFeature('services'))
                    <li class="nav-item nav-item-1 position-relative">
                        <a class="nav-link-1 nav-link p-3 gap-2 {{ isset($partName) && $partName == 'services' ? 'active' : '' }}"
                            href="{{ route('vcards.edit', $vcard->id) . '?part=services' }}">
                            <i
                                class="fa-solid fa-wrench p-1 icon-color-bs-darkyellow"></i>{{ __('messages.vcard.services') }}
                        </a>
                    </li>
                @endif
                @if (checkFeature('products'))
                    <li class="nav-item nav-item-1 position-relative">
                        <a class="nav-link-1 nav-link p-3 gap-2 {{ isset($partName) && $partName == 'products' ? 'active' : '' }}"
                            href="{{ route('vcards.edit', $vcard->id) . '?part=products' }}">
                            <i
                                class="fa-brands fa-product-hunt p-1 icon-color-bs-teal"></i>{{ __('messages.vcard.products') }}
                        </a>
                    </li>
                @endif
                @if (getPlanFeature(getCurrentSubscription()->plan)['whatsapp_store'])
                    <li class="nav-item nav-item-1 position-relative">
                        <a class="nav-link-1 nav-link p-3 gap-2 {{ isset($partName) && $partName == 'whatsapp-store' ? 'active' : '' }}"
                            href="{{ route('vcards.edit', $vcard->id) . '?part=whatsapp-store' }}">
                            <i
                                class="fab fa-whatsapp p-1 icon-color-bs-green"></i>{{ __('messages.feature.whatsapp_store') }}
                        </a>
                    </li>
                @endif
                @if (checkFeature('insta_embed'))
                    <li class="nav-item nav-item-1 position-relative">
                        <a class="nav-link-1 nav-link p-3 gap-2  {{ isset($partName) && $partName == 'instagram-embed' ? 'active' : '' }}"
                            href="{{ route('vcards.edit', $vcard->id) . '?part=instagram-embed' }}">
                            <i
                                class="fa-solid fa-clipboard-list p-1 icon-color-bs-lightred"></i>{{ __('messages.vcard.instagramembed') }}
                        </a>
                    </li>
                @endif
                @if (checkFeature('linkedin_embed'))
                    <li class="nav-item nav-item-1 position-relative">
                        <a class="nav-link-1 nav-link p-3 gap-2 {{ isset($partName) && $partName == 'linkedin-embed' ? 'active' : '' }}"
                            href="{{ route('vcards.edit', $vcard->id) . '?part=linkedin-embed' }}">
                            <i
                                class="fa-brands fa-linkedin p-1 icon-color-bs-blue"></i>{{ __('messages.vcard.linkedinembed') }}
                        </a>
                    </li>
                @endif
                @if (checkFeature('gallery'))
                    <li class="nav-item nav-item-1 position-relative">
                        <a class="nav-link-1 nav-link p-3 gap-2  {{ isset($partName) && $partName == 'galleries' ? 'active' : '' }}"
                            href="{{ route('vcards.edit', $vcard->id) . '?part=galleries' }}">
                            <i class="fa-solid fa-images p-1 icon-color-bs-green"></i>
                ...
                @if (checkFeature('blog'))
                    <li class="nav-item nav-item-1 position-relative">
                        <a class="nav-link-1 nav-link p-3 gap-2  {{ isset($partName) && $partName == 'blogs' ? 'active' : '' }}"
                            href="{{ route('vcards.edit', $vcard->id) . '?part=blogs' }}">
                ...
                @if (checkFeature('testimonials'))
                    <li class="nav-item nav-item-1 position-relative">
                        <a class="nav-link-1 nav-link p-3 gap-2 {{ isset($partName) && $partName == 'testimonials' ? 'active' : '' }}"
                            href="{{ route('vcards.edit', $vcard->id) . '?part=testimonials' }}">
                            <i
                                class="fa-solid fa-comment p-1 icon-color-bs-red"></i>{{ __('messages.vcard.testimonials') }}
                        </a>
                    </li>
                @endif
                @if (checkFeature('iframes'))
                    <li class="nav-item nav-item-1 position-relative">
                        <a class="nav-link-1 nav-link p-3 gap-2 {{ isset($partName) && $partName == 'iframes' ? 'active' : '' }}"
                            href="{{ route('vcards.edit', $vcard->id) . '?part=iframes' }}">
                            <i class="fa-solid fa-crop-simple p-1 icon-color-bs-pink"></i>
                ...
                @if (checkFeature('appointments'))
                    <li class="nav-item nav-item-1 position-relative">
                        <a class="nav-link-1 nav-link p-3 gap-2 {{ isset($partName) && $partName == 'appointments' ? 'active' : '' }}"
                            href="{{ route('vcards.edit', $vcard->id) . '?part=appointments' }}">
                            <i class="fa-solid fa-calendar-check p-1 icon-color-bs-teal"></i>
                ...
                @if (checkFeature('social_links'))
                    <li class="nav-item nav-item-1 position-relative">
                        <a class="nav-link-1 nav-link p-3 gap-2 {{ isset($partName) && $partName == 'social-links' ? 'active' : '' }}"
                            href="{{ route('vcards.edit', $vcard->id) . '?part=social-links' }}">
                            <i class="fa-solid fa-globe p-1 icon-color-bs-blue"></i>
                ...
                @if (checkFeature('custom-links'))
                    <li class="nav-item nav-item-1 position-relative">
                        <a class="nav-link-1 nav-link p-3 gap-2 {{ isset($partName) && $partName == 'custom-links' ? 'active' : '' }}"
                            href="{{ route('vcards.edit', $vcard->id) . '?part=custom-links' }}">
                            <i class="fa-solid fa-link p-1 icon-color-bs-teal"></i>
                            {{ __('messages.custom_links.custom_links') }}
                        </a>
                    </li>
                @endif
                <li class="nav-item nav-item-1 position-relative">
                    <a class="nav-link-1 nav-link p-3 gap-2 {{ isset($partName) && $partName == 'banners' ? 'active' : '' }}"
                        href="{{ route('vcards.edit', $vcard->id) . '?part=banners' }}">
                        <i class="fa-regular fa-hard-drive p-1 icon-color-bs-lightred"></i>
                        {{ __('messages.front_cms.banner_title') }}
                    </a>
                </li>
                @if (checkFeature('advanced'))
                    <li class="nav-item nav-item-1 position-relative">
                        <a class="nav-link-1 nav-link p-3 gap-2  {{ isset($partName) && $partName == 'advanced' ? 'active' : '' }}"
                ...
                @if (checkFeature('custom-fonts'))
                    <li class="nav-item nav-item-1 position-relative">
                        <a class="nav-link-1 nav-link p-3 gap-2  {{ isset($partName) && $partName == 'custom-fonts' ? 'active' : '' }}"
                ...
                @if (checkFeature('seo'))
                    <li class="nav-item nav-item-1 position-relative">
                        <a class="nav-link-1 nav-link p-3 gap-2  {{ isset($partName) && $partName == 'seo' ? 'active' : '' }}"
                            href="{{ route('vcards.edit', $vcard->id) . '?part=seo' }}">
                ...
                @endif
                <li class="nav-item nav-item-1 position-relative">
                    <a class="nav-link-1 nav-link p-3 gap-2  {{ isset($partName) && $partName == 'privacy-policy' ? 'active' : '' }}"
                        href="{{ route('vcards.edit', $vcard->id) . '?part=privacy-policy' }}">
                        <i class="fa-solid fa-lock p-1 icon-color-bs-darkyellow"></i>
                        {{ __('messages.vcard.privacy_policy') }}
                    </a>
                </li>
            @if (checkFeature('gallery'))
                <li class="nav-item nav-item-1 position-relative">
                    <a class="nav-link-1 nav-link p-3 gap-2  {{ isset($partName) && $partName == 'term-condition' ? 'active' : '' }}"
                ...
                <li class="nav-item nav-item-1 position-relative mb-3">
                    <a class="nav-link-1 nav-link p-3 gap-2  {{ isset($partName) && $partName == 'manage-section' ? 'active' : '' }}"
