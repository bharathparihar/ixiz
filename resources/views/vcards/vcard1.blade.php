    ...
    <div class="vcard-one main-content w-100 mx-auto">
        ...
        <div class="vcard-one__profile position-relative">
            <div class="avatar position-absolute top-0 start-50 translate-middle">
                <img src="{{asset('assets/img/vcard1/vcard1-profile.png')}}" alt="profile-img" class="rounded-circle" loading="lazy"/>
            </div>
        </div>
        {{--profile details--}}
            ...
            <div class="container">
                <div class="row g-3">
                    <div class="col-sm-6 col-12">
                        <div class="card event-card p-3 h-100 border-0">
                                 <span class="event-icon d-flex justify-content-center">
                                    <img src="{{asset('assets/img/vcard1/vcard1-email.png')}}" alt="email" loading="lazy"/>
                                 </span>
                    ...
                    <div class="col-sm-6 col-12">
                        <div class="card event-card p-3 h-100 border-0">
                                 <span class="event-icon d-flex justify-content-center">
                                    <img src="{{asset('assets/img/vcard1/vcard1-birthday.png')}}" alt="email" loading="lazy"/>
                                 </span>
                    ...
                    <div class="col-sm-6 col-12">
                        <div class="card event-card p-3 h-100 border-0">
                                 <span class="event-icon d-flex justify-content-center">
                                    <img src="{{asset('assets/img/vcard1/vcard1-phone.png')}}" alt="email" loading="lazy"/>
                                 </span>
                    ...
                    <div class="col-sm-6 col-12">
                        <div class="card event-card p-3 h-100 border-0">
                                 <span class="event-icon d-flex justify-content-center">
                                    <img src="{{asset('assets/img/vcard1/vcard1-location.png')}}" alt="email" loading="lazy"/>
                                 </span>
            ...
            <div class="container">
                <div class="row g-3">
                    <div class="col-sm-6 col-12">
                        <div class="card service-card d-flex align-items-center flex-row p-2 border-0 h-100">
                            <div class="service-image d-flex justify-content-center align-items-center rounded-circle">
                                <img src="{{asset('assets/img/vcard1/service1.png')}}" alt="Ui/Ux" loading="lazy"/>
                            </div>
                    ...
                    <div class="col-sm-6 col-12">
                        <div class="card service-card d-flex align-items-center flex-row p-2 border-0 h-100">
                            <div class="service-image d-flex justify-content-center align-items-center rounded-circle">
                                <img src="{{asset('assets/img/vcard1/service2.png')}}" alt="Icons" loading="lazy"/>
                            </div>
                            <div class="service-details ms-3">
                    ...
                    <div class="col-sm-6 col-12">
                        <div class="card service-card d-flex align-items-center flex-row p-2 border-0 h-100">
                            <div class="service-image d-flex justify-content-center align-items-center rounded-circle">
                                <img src="{{asset('assets/img/vcard1/service3.png')}}" alt="Branding" loading="lazy"/>
                            </div>
                            <div class="service-details ms-3">
                    ...
                    <div class="col-sm-6 col-12">
                        <div class="card service-card d-flex align-items-center flex-row p-2 border-0 h-100">
                            <div class="service-image d-flex justify-content-center align-items-center rounded-circle">
                                <img src="{{asset('assets/img/vcard1/service4.png')}}" alt="App Design" loading="lazy"/>
                            </div>
                            <div class="service-details ms-3">
                    ...
                    <div class="col-sm-6 col-12">
                        <div class="card service-card d-flex align-items-center flex-row p-2 border-0 h-100">
                            <div class="service-image d-flex justify-content-center align-items-center rounded-circle">
                                <img src="{{asset('assets/img/vcard1/service5.png')}}" alt="Motion" loading="lazy"/>
                            </div>
                            <div class="service-details ms-3">
                    ...
                    <div class="col-sm-6 col-12">
                        <div class="card service-card d-flex align-items-center flex-row p-2 border-0 h-100">
                            <div class="service-image d-flex justify-content-center align-items-center rounded-circle">
                                <img src="{{asset('assets/img/vcard1/service6.png')}}" alt="Development" loading="lazy"/>
                            </div>
                            <div class="service-details ms-3">
                    ...
                    <div class="col-6 mb-2 gallery-vcard-position">
                        <div class="card gallery-card product-card p-2 border-0 w-100 h-100">
                            <div class="gallery-profile">
                                <img src="{{asset('assets/img/vcard1/v1.jpg')}}" alt="profile" class="w-100" loading="lazy"/>
                            </div>
                        </div>
                    </div>
                    <div class="col-6 mb-2 gallery-vcard-position">
            ...
            <div class="container">
                <div class="row g-4 product-slider overflow-hidden">
                    ...
                    <div class="col-6 mb-2">
                        <div class="card product-card p-2 border-0 w-100 h-100 product-template-block">
                            <div class="product-profile">
                                <img src="{{asset('assets/img/vcard1/v2.jpg')}}" alt="profile" class="w-100" loading="lazy"/>
                            </div>
                            <div class="product-details mt-3">
                                <h4>Laptop</h4>
                                <p class="mb-2">
            ...
            <div class="container">
                <div class="row g-4 pt-5 testimonial-slider overflow-hidden">
                    ...
                    <div class="col-6">
                        <div class="card testimonial-card position-relative p-2 border-0 w-100">
                            <div class="testimonial-profile position-absolute top-0 start-50 translate-middle">
                                <img src="{{asset('assets/img/vcard1/vcard1-profile.png')}}" alt="profile" class="rounded-circle m-auto" loading="lazy"/>
                            </div>
                            <div class="testimonial-details mt-5">
                                <h4 class="text-center">Melten Lopher</h4>
                                <span class="text-center d-block mb-2">CEO at Codexr</span>
        ...
        <div class="vcard-one__qr-code my-3 py-5 px-3">
            ...
            <div class="qr-code p-3 card d-block mx-auto border-0">
                ...
                <div class="qr-code-image mt-4 d-flex justify-content-center">
                    <img src="{{asset('assets/img/vcard1/vcard-qr.png')}}" alt="qr code" loading="lazy"/>
                </div>
            </div>
        ...
        <div class="vcard-one__contact py-5">
            <h4 class="vcard-one-heading text-center pb-4">Inquiries</h4>
