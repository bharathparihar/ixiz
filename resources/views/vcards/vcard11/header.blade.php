            ...
            <div class="dropdown">
                ...
                <div id="myDropdown" class="dropdown-content text-start">
                    <a href="javascript:void(0)" class="nav-link d-flex align-items-center ">
                        <img class="me-2 country-flag" src="/assets/img/iraq.svg"> Arabic</a>
                    <a href="javascript:void(0)" class="nav-link d-flex align-items-center">
                        <img class="me-2 country-flag" src="/assets/img/china.svg">
                        Chinese</a>
                    <a href="javascript:void(0)" class="nav-link d-flex align-items-center">
                        <img class="me-2 country-flag" src="/assets/img/united-states.svg">
                        English</a>
                    <a href="javascript:void(0)" class="nav-link d-flex align-items-center">
                        <img class="me-2 country-flag" src="/assets/img/france.svg">
                        French</a>
                    <a href="javascript:void(0)" class="nav-link d-flex align-items-center">
                        <img class="me-2 country-flag" src="/assets/img/germany.svg">
                        German</a>
                    <a href="javascript:void(0)" class="nav-link d-flex align-items-center">
                        <img class="me-2 country-flag" src="/assets/img/portugal.svg">
                        Portuguese</a>
                    <a href="javascript:void(0)" class="nav-link d-flex align-items-center">
                        <img class="me-2 country-flag" src="/assets/img/russia.svg">
                        Russian</a>
                    <a href="javascript:void(0)" class="nav-link d-flex align-items-center">
                        <img class="me-2 country-flag" src="/assets/img/spain.svg">
                        Spanish</a>
                    <a href="javascript:void(0)" class="nav-link d-flex align-items-center">
                        <img class="me-2 country-flag" src="/assets/img/turkey.svg">
                        Turkish</a>
                </div>
            </div>
