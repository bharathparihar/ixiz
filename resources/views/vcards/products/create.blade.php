        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row mb-5">
                    ...
                    <div class="mb-5 col-lg-6">
                        {{ Form::label('sort', __('messages.common.sort').':', ['class' => 'form-label fs-6  text-gray-700 mb-3']) }}
                        {{ Form::number('sort', null, ['class' => 'form-control', 'placeholder' => __('messages.common.sort')]) }}
                    </div>
                    <div class="mb-5 col-lg-6">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="d-block image-picker-wrapper">
                                    <div class="image-picker">
                                        ...
                                        <span class="picker-edit rounded-circle text-gray-500 fs-small"
                                            ...
                                            data-bs-original-title="{{ __('messages.tooltip.change_product_icon') }}">
                                            <label>
                                                <i class="fa-solid fa-pen" id="profileImageIcon"></i>
                                                <input type="file" id="productIcon" name="product_icon[]"
                                                    class="image-upload file-validation d-none crop-image-input" accept="image/*" data-preview-id="createProductPreview"
                                                    multiple />
                                            </label>
                                        </span>
                                    </div>
