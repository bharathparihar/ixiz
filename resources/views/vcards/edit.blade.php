    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-body d-sm-flex position-relative px-2">
                ...
                <div class="ps-sm-3 pt-lg-auto pt-0 w-100 overflow-auto px-1 overflow-hidden" id="main">
                    <button type="button"
                    ...
                    @if (
                        ...
                        $partName != 'custom-links' &&
                            ...
                            $partName != 'payment-links' &&
                            $partName != 'products' &&
                            $partName != 'galleries' &&
                            $partName != 'instagram-embed' &&
                            $partName != 'linkedin-embed' &&
                            $partName != 'banners' &&
                            $partName != 'iframes')
                        {!! Form::open([
                    ...
                    @else
                        ...
                        @elseif($partName === 'linkedin-embed')
                            @include('vcards.linkedin-embed.index')
                        @elseif($partName === 'iframes')
                            @include('vcards.iframes.index')
                        @elseif($partName === 'custom-links')
                            @include('vcards.custom-link.index')
                        @elseif ($partName === 'payment-links')
                            @include('vcards.payment-link.index')
                        @else
