@role(App\Models\Role::ROLE_SUPER_ADMIN)
    <li class="nav-item {{ Request::is('sadmin/dashboard*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-3 gap-3" aria-current="page" href="{{ route('sadmin.dashboard') }}">
    ...
    <!-- <li class="nav-item {{ Request::is('sadmin/admins*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-3 gap-3" aria-current="page" href="{{ route('admins.index') }}">
    ...
    <li class="nav-item {{ Request::is('sadmin/users*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-3 gap-3" aria-current="page" href="{{ route('users.index') }}">
    ...
    <li class="nav-item {{ Request::is('sadmin/plans*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-3 gap-3" aria-current="page" href="{{ route('plans.index') }}">
    ...
    <!-- <li class="nav-item {{ Request::is('sadmin/blogs*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-3 gap-3" aria-current="page" href="{{ route('blogs.index') }}">
    ...
    <!-- <li class="nav-item {{ Request::is('sadmin/currencies*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-3 gap-3" aria-current="page" href="{{ route('currencies.index') }}">
    ...
    <!-- <li class="nav-item {{ Request::is('sadmin/countries*', 'sadmin/states*', 'sadmin/cities*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-3 gap-3" aria-current="page" href="{{ route('countries.index') }}">
    ...
    <!-- <li class="nav-item {{ Request::is('sadmin/send*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-3 gap-3" aria-current="page" href="{{ route('send.mail.index') }}">
    ...
    <!-- <li class="nav-item {{ Request::is('sadmin/email*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-3" aria-current="page" href="{{ route('email.templates.index') }}">
    ...
    <!-- <li class="nav-item {{ Request::is('sadmin/settings*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-3 gap-3" aria-current="page" href="{{ route('setting.index') }}">
...
@role(App\Models\Role::ROLE_ADMIN)
    ...
    <li class="vcard-option nav-item {{ Request::is('admin/vcard*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-3 gap-3" aria-current="page" href="{{ route('vcards.index') }}">
   ...
   <!--  @if (getPlanFeature(getCurrentSubscription()->plan)['whatsapp_store'])
    ...
    <li class="nav-item {{ Request::is('admin/appointments*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-3 gap-3" aria-current="page" href="{{ route('appointments.index') }}">
    ...
    <li class="nav-item {{ Request::is('admin/user-setting*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-3 gap-3" aria-current="page" href="{{ route('user.setting.index') }}">
