                        ...
                        <div class="row row-gap-24px">
                            <div class="col-xl-6">
                                <div class="row">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <label class="form-check form-switch form-switch-sm cursor-pointer">
                                                <input type="checkbox" name="user_verified_email" class="form-check-input"
                                                    value="1"
                                                    {{ $setting['user_verified_email'] == '1' ? 'checked' : '' }}
                                    ...
                                    <div class="col-sm-6 col-12">
                                        <div class="form-group mb-3">
                                            {{ Form::label('phoneNumberRequired', __('messages.common.phone_number_required') . ':', ['class' => 'form-label mb-3']) }}
                                            <label class="form-check form-switch form-switch-sm cursor-pointer">
                                                <input type="checkbox" name="phone_number_required" class="form-check-input"
                                                    value="1" {{ $setting['phone_number_required'] == '1' ? 'checked' : '' }}
                                                    id="">
                                                <span class="form-check-label text-gray-600"
                                                    for="">{{ __('messages.common.phone_number_required') }}</span>&nbsp;&nbsp;
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-12">
                                        <div class="form-group mb-3">
                                            {{ Form::label('referralCode', __('messages.setting.show_referral_code') . ':', ['class' => 'form-label mb-3']) }}
                                            <label class="form-check form-switch form-switch-sm cursor-pointer">
                                                <input type="checkbox" name="show_referral_code" class="form-check-input"
                                                    value="1" {{ $setting['show_referral_code'] == '1' ? 'checked' : '' }}
                                                    id="">
                                                <span class="form-check-label text-gray-600"
                                                    for="">{{ __('messages.setting.show_referral_code') }}</span>&nbsp;&nbsp;
                                            </label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-6">
                                <div class="row">
                                                    ...
                                                    <span class="picker-edit rounded-circle text-gray-500 fs-small"
                                                        ...
                                                        <label>
                                                            ...
                                                            <input type="file" id="appLogo" name="app_logo"
                                                                class="image-upload d-none crop-image-input" accept="image/*" data-crop-width="100" data-crop-height="100" data-preview-id="appLogoPreview"/>
                                                        </label>
                                                    </span>
                                                </div>
                                            </div>
                                                    ...
                                                    <span class="picker-edit rounded-circle text-gray-500 fs-small"
                                                        ...
                                                        <label>
                                                            ...
                                                            <input type="file" id="favicon" name="favicon"
                                                                class="image-upload d-none crop-image-input" accept="image/*" data-crop-width="16" data-crop-height="16" data-preview-id="appFaviconPreview"/>
                                                        </label>
                                                    </span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col mb-3">
                                        <div class="mb-3 form-group" io-image-input="true">
                                            <label for="reigisterPreview" class="form-label required">
                                                {{ __('messages.setting.register_image') . ':' }}</label>
                                            <span data-bs-toggle="tooltip" data-placement="top"
                                                data-bs-original-title="{{ __('messages.tooltip.register_img') }}">
                                                <i class="fas fa-question-circle ml-1 mt-1 general-question-mark"></i>
                                            </span>
                                            <div class="d-block">
                                                <div class="image-picker">
                                                    ...
                                                    <span class="picker-edit rounded-circle text-gray-500 fs-small"
                                                        data-bs-toggle="tooltip" data-placement="top"
                                                        data-bs-original-title="{{ __('messages.tooltip.change_register_image') }}">
                                                        <label>
                                                            <i class="fa-solid fa-pen" id="profileImageIcon"></i>
                                                            <input type="file" id="registerImage"
                                                                name="register_image" class="image-upload d-none crop-image-input"
                                                                accept="image/*" data-crop-width="970" data-crop-height="841" data-preview-id="appRegisterImagePreview"/>
                                                        </label>
                                                    </span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-block">
                                                <div class="image-picker">
                                                    ...
                                                    <span class="picker-edit rounded-circle text-gray-500 fs-small"
                                                        ...
                                                        <label>
                                                            <i class="fa-solid fa-pen" id="profileImageIcon"></i>
                                                            <input type="file" id="dashboardLogo"
                                                                name="dashboard_logo" class="image-upload d-none crop-image-input"
                                                                accept="image/*" data-crop-width="60" data-crop-height="60" data-preview-id="appDashboardLogoPreview"/>
                                                        </label>
                                                    </span>
                                                </div>
                                            </div>
