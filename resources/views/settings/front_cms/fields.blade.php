            ...
            <div class="d-block">
                <div class="image-picker">
                    ...
                    <label>
                        ...
                        <input type="file"  name="home_page_banner" class="image-upload file-validation d-none crop-image-input" accept=".png, .jpg, .jpeg" data-crop-width="636" data-crop-height="562" data-preview-id="frontCmsBannerImagePreview"/>
                    </label>
                </span>
                </div>
            </div>
