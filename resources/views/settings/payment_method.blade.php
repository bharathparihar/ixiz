                                    ...
                                    <div
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 mb-3">
                                                ...
                                                <div class="position-relative">
                                                    {{ Form::input(isset($setting['phonepe_env']) ?? null ? 'password' : 'text', 'phonepe_env', $setting['phonepe_env'] ?? null, ['class' => 'form-control form-control-sm phonepe_env ' . (getLogInUser()->language == 'ar' || getLogInUser()->language == 'fa' ? 'payment-input-left' : 'payment-input-right'), 'placeholder' => __('messages.setting.phonepe_env'), 'data-toggle' => 'password']) }}
                                                    <span
                                                        class="position-absolute d-flex align-items-center top-0 bottom-0 payment-eye-icon @if (getLogInUser()->language == 'ar' || getLogInUser()->language == 'fa') start-0 pe-2 @else end-0 pe-2 ps-2 @endif input-icon input-password-hide cursor-pointer text-gray-600">
                                                        <i class="bi bi-eye-slash-fill fs-7"></i>
                                                    </span>
                                ...
                                <div class="card-body p-3 p-md-4">
                                    ...
                                    <div
                                        ...
                                        <div class="mb-0">
                                            ...
                                            {{ Form::select('paypal_mode', $paypalMode, $setting['paypal_mode'] ?? null, ['class' => 'form-control form-control-sm paypal-secret', 'data-control' => 'select2', 'data-minimum-results-for-search' => 'Infinity']) }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card h-100 border-0 shadow-sm">
                                <div class="card-body p-3 p-md-4">
                                    <div class="d-flex flex-column flex-sm-row align-items-start align-items-sm-center justify-content-between mb-3">
                                        ...
                                        <label class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" value="{{ \App\Models\Plan::CASHFREE }}"
                                                name="payment_gateway[{{ \App\Models\Plan::CASHFREE }}]"
                                                {{ isset($selectedPaymentGateways['Cashfree']) ? 'checked' : '' }} id="cashfree_payment">
                                        </label>
                                    </div>
                                    <div class="cashfree-cred {{ !isset($selectedPaymentGateways['Cashfree']) ? 'd-none' : '' }}">
                                        <div class="mb-3">
                                            {{ Form::label('cashfree_key', __('messages.setting.cashfree_app_id') . ':', ['class' => 'form-label mb-2 required fs-7']) }}
                                            <div class="position-relative">
                                                {{ Form::input(isset($setting['cashfree_key']) ?? null ? 'password' : 'text', 'cashfree_key', $setting['cashfree_key'] ?? null, ['class' => 'form-control form-control-sm cashfree-key ' . (getLogInUser()->language == 'ar' || getLogInUser()->language == 'fa' ? 'payment-input-left' : 'payment-input-right'), 'placeholder' => __('messages.setting.cashfree_app_id'), 'data-toggle' => 'password']) }}
                                                <span class="position-absolute d-flex align-items-center top-0 bottom-0 payment-eye-icon @if (getLogInUser()->language == 'ar' || getLogInUser()->language == 'fa') start-0 pe-2 @else end-0 pe-2 ps-2 @endif input-icon input-password-hide cursor-pointer text-gray-600">
                                                    <i class="bi bi-eye-slash-fill fs-7"></i>
                                                </span>
                                            </div>
                                        </div>
                                        <div class="mb-3">
                                            {{ Form::label('cashfree_secret', __('messages.setting.cashfree_secret') . ':', ['class' => 'form-label cashfree-secret-label mb-2 required fs-7']) }}
                                            <div class="position-relative">
                                                {{ Form::input(isset($setting['cashfree_secret']) ?? null ? 'password' : 'text', 'cashfree_secret', $setting['cashfree_secret'] ?? null, ['class' => 'form-control form-control-sm cashfree-secret ' . (getLogInUser()->language == 'ar' || getLogInUser()->language == 'fa' ? 'payment-input-left' : 'payment-input-right'), 'placeholder' => __('messages.setting.cashfree_secret'), 'data-toggle' => 'password']) }}
                                                <span class="position-absolute d-flex align-items-center top-0 bottom-0 payment-eye-icon @if (getLogInUser()->language == 'ar' || getLogInUser()->language == 'fa') start-0 pe-2 @else end-0 pe-2 ps-2 @endif input-icon input-password-hide cursor-pointer text-gray-600">
                                                    <i class="bi bi-eye-slash-fill fs-7"></i>
                                                </span>
                                            </div>
                                        ...
                                        <div class="mb-0">
                                            {{ Form::label('cashfree_mode', __('messages.setting.cashfree_mode') . ':', ['class' => 'form-label cashfree-secret-label mb-2 required fs-7']) }}
                                            {{ Form::select('cashfree_mode', $cashfreeMode, $setting['cashfree_mode'] ?? null, ['class' => 'form-control form-control-sm cashfree-secret', 'data-control' => 'select2', 'data-minimum-results-for-search' => 'Infinity']) }}
                                        </div>
                                    </div>
                                </div>
                            </div>
