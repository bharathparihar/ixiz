...
@section('content')
    ...
    <!-- start hero section -->
    <section class="hero-section position-relative pb-60" @if (checkFrontLanguageSession() == 'ar' || checkFrontLanguageSession() == 'fa') dir="rtl" @endif>
    ...
    <section class="features-section overflow-hidden @if (checkFrontLanguageSession() == 'ar' || checkFrontLanguageSession() == 'fa') rtl @endif" id="frontFeaturesTab">
        <div class="container">
    ...
    <section class="pricing-plan-section pb-100 @if (checkFrontLanguageSession() == 'ar' || checkFrontLanguageSession() == 'fa') rtl @endif" id="frontPricingTab">
        <div class="container">
            <div class="section-heading text-center mb-60">
                            ...
                            <div class="pricing-card-body">
                                <div class="text-center">
                                    ...
                                    <div
                                        ...
                                        @if ($plan->custom_select == 1 && $plan->planCustomFields->isNotEmpty())
                                            <h2 class="price text-center fw-5 mb-30" @if (checkFrontLanguageSession() == 'ar' || checkFrontLanguageSession() == 'fa') dir="rtl" @endif>
                                                @php
                                                ...
                                                @if(getSuperAdminSettingValue('currency_after_amount') == 0)
                                                    ...
                                                    <span class="custom-price-{{ $plan->id }}">
                                                        {{ $formattedPrice }}
                                                    </span>
                                                @else
                                                    <span class="custom-price-{{ $plan->id }}">
                                        ...
                                        @else
                                            <h2 class="price text-center fw-5 mb-30" id="price_{{ $plan->id }}" @if (checkFrontLanguageSession() == 'ar' || checkFrontLanguageSession() == 'fa') dir="rtl" @endif>
                                        ...
                                        @endif
                                        <div
                                            class="d-flex justify-content-center align-items-center {{ getLoggedInUserRoleId() != getSuperAdminRoleId() ? 'mb-4' : 'ms-2' }}" @if (checkFrontLanguageSession() == 'ar' || checkFrontLanguageSession() == 'fa') dir="rtl" @endif>
                                            @if ($plan->custom_select == 1 && $plan->planCustomFields->isNotEmpty())
                                                {{-- <label
                                ...
                                <ul class="pricing-plan-list ps-xl-4 ps-lg-3 ps-md-4 ps-3 mb-60">
                                        ...
                                        <li class="active-check"
                                            ...
                                            <span class="check-box">
                                                <i class="fa-solid fa-check"
                                                    style="font-size: 18px; color: #7638f9;"></i>
                                            </span>
                                            <label
                                    ...
                                    <li class="active-check"
                                        @if (checkFrontLanguageSession() == 'ar' || checkFrontLanguageSession() == 'fa') dir="rtl" @endif>
                                        <span class="check-box">
                                            <i class="fa-solid fa-check" style="font-size: 18px; color: #7638f9;"></i>
                                        </span>
    ...
    @if (!$testimonials->isEmpty())
        <section class="testimonial-section @if (checkFrontLanguageSession() == 'ar' || checkFrontLanguageSession() == 'fa') rtl @endif">
            <div class="section-heading text-center mb-60">
