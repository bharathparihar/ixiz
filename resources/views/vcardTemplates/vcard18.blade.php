    ...
    <div class="container p-0">
        ...
        <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
            ...
            <div class="profile-section position-relative">
                <div class="main-bg-vector pb-3">
                    <img src="{{ asset('assets/img/vcard18/main-bg-vcard18.jpg') }}" alt="images"
                        class="w-100 h-100 object-fit-cover" />
                </div>
                <div class="card d-flex flex-column flex-sm-row gap-4 gap-sm-5 align-items-center"
                    ...
                    <div class="card-body p-0">
                        <div
                            class="profile-name d-flex justify-content-center align-items-center align-items-sm-start flex-column">
                            ...
                            <p class="fs-16 text-primary mb-0 text-decoration-underline">
            ...
            <div class="profile-desc px-30 pt-50 text-center fs-14 position-relative">
            ...
            @if (checkFeature('social_links') && isset($vcard->socialLink) && getSocialLink($vcard))
                <div class="social-media d-flex justify-content-center pt-40 px-30 position-relative">
                    <div class="position-absolute vector-1 vector-all">
                        <img src="{{ asset('assets/img/vcard18/vcard18-vector-1.png') }}" class="w-100" />
                    </div>
                    <div
                        class="social-icons  d-flex flex-wrap justify-content-center h-100 w-100 object-fit-cover fs-14">
            ...
            @if (checkFeature('custom-links') && $customLink->isNotEmpty())
                <div class="custom-link-section">
                    <div class="custom-link d-flex flex-wrap justify-content-center pt-50 w-100 px-30 gap-3">
                ...
                @if (
                    ...
                    <div class="contact-section position-relative px-30 pt-50">
                        <div class="position-absolute vector-2 vector-all">
                            <img src="{{ asset('assets/img/vcard18/vcard18-vector-2.png') }}" class="w-100" />
                        </div>
                            ...
                            <div class="row row-gap-20px" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                    ...
                                    <div class="col-md-6">
                                        <div class="contact-box d-flex align-items-center">
                                            <div class="contact-icon d-flex justify-content-center align-items-center">
                                                <img src="{{ asset('assets/img/vcard18/email.svg') }}" />
                                            </div>
                                ...
                                @if ($vcard->phone)
                                    <div class="col-md-6">
                                        <div class="contact-box d-flex align-items-center">
                                            <div class="contact-icon d-flex justify-content-center align-items-center">
                                                <img src="{{ asset('assets/img/vcard18/phone.svg') }}" />
                                            </div>
                                            <div class="contact-desc">
                                ...
                                @if ($vcard->dob)
                                    <div class="col-md-6">
                                        <div class="contact-box d-flex align-items-center">
                                            <div class="contact-icon d-flex justify-content-center align-items-center">
                                                <img src="{{ asset('assets/img/vcard18/dob.svg') }}" />
                                            </div>
                                            <div class="contact-desc">
                                ...
                                @if ($vcard->location)
                                    <div class="col-md-6">
                                        <div class="contact-box d-flex align-items-center">
                                            <div class="contact-icon d-flex justify-content-center align-items-center">
                                                <img src="{{ asset('assets/img/vcard18/location.svg') }}" />
                                            </div>
                                            <div class="contact-desc">
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                <div class="qr-code-section pt-50 px-30 position-relative">
                    <div class="position-absolute vector-3 vector-all">
                        <img src="{{ asset('assets/img/vcard18/vcard18-vector-3.png') }}" class="w-100" />
                    </div>
                    <div class="half-circle-right">
                    </div>
                    <div class="section-heading text-center">
            ...
            <div class="our-services-section pt-50 position-relative">
                <div class="position-absolute vector-4 vector-all">
                    <img src="{{ asset('assets/img/vcard18/vcard18-vector-4.png') }}" class="w-100" />
                </div>
                <div class="half-circle-left">
                </div>
                {{-- service --}}
                                ...
                                <div class="px-20">
                                    <div class="services-slider-view">
                                        @foreach ($vcard->services as $service)
                                            <div>
                                                <div class="service-card card d-flex flex-column align-items-center">
                                                    <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
                                                        class="text-decoration-none card-img {{ $service->service_url ? 'pe-auto' : 'pe-none' }}"
                                                        target="{{ $service->service_url ? '_blank' : '' }}">
                                                        <img src="{{ $service->service_icon }}"
                                                            class="card-img-top service-new-image object-fit-cover w-100 h-100"
                                                            alt="{{ $service->name }}" loading="lazy">
                                                    </a>
                                                    <div class="text-center services-desc">
                                                        <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
                                                        ...
                                                        <div class="description-text">
                                                            <p
                                                                class="card-text  text-gray-200 mb-0 {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}">
                            ...
                            @else
                                <div class="px-30">
                                    <div class="row row-gap-20px">
                                        @foreach ($vcard->services as $service)
                                            <div class="col-sm-6">
                                                <div class="service-card h-100 card d-flex flex-column align-items-center"
                                                    @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                                    <div class="card-img">
                                                        <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
                                                            class="text-decoration-none"
                                                    ...
                                                    <div class="card-body text-center pb-0">
                                                        <h3 class="card-title fw-5 p-0">{{ ucwords($service->name) }}
                                                        </h3>
                                                        <div class="description-text">
                                                            <p
                ...
                @if (checkFeature('gallery') && $vcard->gallery->count())
                    <div class="gallery-section pt-50 px-30 position-relative">
                        <div class="position-absolute vector-5 vector-all">
                            <img src="{{ asset('assets/img/vcard18/vcard18-vector-5.png') }}" class="w-100" />
                        </div>
                        <div class="half-circle-right">
                        </div>
                        <div class="section-heading text-center overflow-hidden">
                ...
                @if (checkFeature('products') && $vcard->products->count())
                    <div class="product-section bg-gray pt-50 px-20 position-relative">
                        <div class="position-absolute vector-6 vector-all">
                            <img src="{{ asset('assets/img/vcard18/vcard18-vector-6.png') }}" class="w-100" />
                        </div>
                        <div class="half-circle-left">
                        </div>
                                ...
                                <div class="">
                                    <a @if ($product->product_url) href="{{ $product->product_url }}" @endif
                                        ...
                                        <div class="product-card card">
                                            ...
                                            <div class="product-desc card-body text-center px-4 py-3">
                                                <div class="d-flex justify-content-center gap-2 flex-column">
                                                    <h3 class="product-title text-black fw-5 mb-0">
                                                        {{ $product->name }}</h3>
                                                        <div class="d-flex justify-content-between mt-2 product-info">
                                                            <div class="overflow-hidden">
                                                                @if ($product->currency_id && $product->price)
                                                                    <span
                                                                        class="product-amount text-primary fw-5">{{ currencyFormat($product->price, 2, $product->currency->currency_code) }}</span>
                                                                @elseif($product->price)
                                                                    <span
                                                                        class="product-amount text-primary fw-5">{{ currencyFormat($product->price, 2, getUserCurrencyIcon($vcard->user->id)) }}</span>
                                                                @endif
                                                            </div>
                        ...
                        <div class="text-center mt-5">
                            <div class="text-center view-more btn-primary d-inline-flex gap-2 align-items-center">
                                <a class="mb-0 fs-16"
            ...
            @if ((isset($managesection) && $managesection['whatsapp_store']) || empty($managesection))
                @if ($whatsappStore->count())
                    <div class="whatsapp-store-product-section bg-gray pt-50 px-20 position-relative">
                        <div class="position-absolute vector-12 vector-all">
                            <img src="{{ asset('assets/img/vcard18/vcard18-vector-12.png') }}" class="w-100" />
                        </div>
                        <div class="half-circle-left">
                        </div>
                        <div class="section-heading text-center overflow-hidden mb-40 px-3">
                            <h2 class="mb-0 d-inline-block"> {{ __('messages.feature.whatsapp_store') }}</h2>
                        </div>
                            ...
                            @foreach ($whatsappStore as $product)
                                <div>
                                    <div class="whatsapp-store-box card">
                                        ...
                                        <div class="whatsapp-store-content card-body text-center px-4 py-3"
                                            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                ...
                @if (checkFeature('testimonials') && $vcard->testimonials->count())
                    <div class="testimonial-section pt-50 px-20 position-relative">
                        <div class="position-absolute vector-7 vector-all">
                            <img src="{{ asset('assets/img/vcard18/vcard18-vector-7.png') }}" class="w-100" />
                        </div>
                        <div class="half-circle-right">
                        </div>
                        <div class="section-heading text-center overflow-hidden">
                        ...
                        <div class="testimonial-slider">
                            @foreach ($vcard->testimonials as $testimonial)
                                <div>
                                    ...
                                    <div class="testimonial-card d-flex pb-1 flex-column gap-3">
                                        <div class="position-relative testimonial-triangle">
                                            <div class="card-body text-center">
                                                <div class="quote-img quote-left-img mb-2">
                                                    <img src="{{ asset('assets/img/vcard18/quote-vcard18.png') }}"
                                                        loading="lazy" />
                                                </div>
                                                <p
                                                    class="card-desc fw-4 text-gray-200 mb-2 text-center {{ \Illuminate\Support\Str::length($testimonial->description) > 80 ? 'more' : '' }}">
                ...
                @if (checkFeature('insta_embed') && $vcard->instagramEmbed->count())
                    <div class="pt-50 position-relative">
                        <div class="position-absolute vector-8 vector-all">
                            <img src="{{ asset('assets/img/vcard18/vcard18-vector-8.png') }}" class="w-100" />
                        </div>
                        <div class="half-circle-left">
                        </div>
                        <div class="px-30">
                ...
                @if (checkFeature('blog') && $vcard->blogs->count())
                    <div class="blog-section pt-50 px-20 position-relative">
                        <div class="position-absolute vector-9 vector-all">
                            <img src="{{ asset('assets/img/vcard18/vcard18-vector-9.png') }}" class="w-100" />
                        </div>
                        <div class="half-circle-right">
                        </div>
                        <div class="section-heading text-center overflow-hidden px-3">
                                ...
                                <div>
                                    <div class="blog-card d-flex flex-column">
                                        ...
                                        <div class="card-body w-100"
                                            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                            <a href="{{ $vcardBlogUrl }}">
                                                <h2 class="fw-5 text-primary blog-head">
                                                    {{ $blog->title }}
                                                </h2>
                                            ...
                                            <div class="d-flex align-items-center justify-content-end">
                                                <a href="{{ $vcardBlogUrl }}"
                                                    class="btn fs-14 d-inline-flex align-items-center justify-content-end gap-2 px-3 btn-secondary py-2"
                                                    tabindex="-1">
                ...
                @if (checkFeature('iframes') && $vcard->iframes->count())
                    <div class="iframe-section pt-50 px-30 position-relative">
                        <div class="position-absolute vector-10 vector-all">
                            <img src="{{ asset('assets/img/vcard18/vcard18-vector-10.png') }}" class="w-100" />
                        </div>
                        <div class="half-circle-left">
                        </div>
                        <div class="section-heading text-center mb-40 overflow-hidden px-3">
                ...
                @if ($vcard->businessHours->count())
                    ...
                    <div class="business-hour-section pt-50 px-30 position-relative">
                        <div class="position-absolute vector-11 vector-all">
                            <img src="{{ asset('assets/img/vcard18/vcard18-vector-11.png') }}" class="w-100" />
                        </div>
                        <div class="half-circle-right">
                        </div>
                        <div class="section-heading text-center overflow-hidden mb-40">
                                ...
                                <div class="col-sm-6">
                                    <div class="business-hour align-items-center">
                                        ...
                                        <div class="text-start d-flex gap-2"
                                            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                            <span
                                                class="text-gray-200">{{ __('messages.business.' . \App\Models\BusinessHour::DAY_OF_WEEK[$key]) }}:</span>
                                            <span
                    ...
                    <div class="appointment-section pt-50 px-30 position-relative">
                        ...
                        <div class="appointment">
                                ...
                                <div class="col-sm-12 mx-auto">
                                    <div class="position-relative">
                                        ...
                                        <span class="calendar-icon">
                                            <img src=" {{ asset('assets/img/vcard18/calendar.svg') }}"
                                                loading="lazy" />
                                        </span>
                                    </div>
                                </div>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-sm-12">
                                    <div class="text-center">
                                        <button type="submit" class=" appointmentAdd btn btn-primary mx-auto d-none">
                ...
                @if (checkFeature('payment_link') && $vcard->paymentLinks->count())
                    <div class="main-section">
                        <div class="payment-link-section pt-40 px-20">
                            ...
                            <div class="section-heading text-center overflow-hidden mb-40 px-3">
                                <h2 class="mb-0 d-inline-block"> {{ __('messages.vcard.payment_links') }}</h2>
                            </div>
            ...
            <div class="contact-us-section px-30 pt-50 position-relative">
                <div class="position-absolute vector-13 vector-all">
                    <img src="{{ asset('assets/img/vcard18/vcard18-vector-13.png') }}" class="w-100" />
                </div>
                <div class="half-circle-right">
                </div>
                            ...
                            <form action="" id="enquiryForm" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    @if (!empty($vcard->privacy_policy) || !empty($vcard->term_condition))
                                        <div class="col-12">
                                            <div class="form-check mb-3 terms-condition">
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
                <div class="create-vcard-section pt-50 px-30 position-relative">
                    <div class="position-absolute vector-14 vector-all">
                        <img src="{{ asset('assets/img/vcard18/vcard18-vector-14.png') }}" class="w-100" />
                    </div>
                    <div class="half-circle-left">
                    </div>
                    <div class="section-heading text-center overflow-hidden mb-40">
                    ...
                    <div class="vcard-link-card card">
                        <div class="d-flex justify-content-center align-items-center gap-3"
                            ...
                            <a href="{{ config('app.url') . '/register?referral-code=' . $vcard->user->affiliate_code }}"
                                target="_blank"
                                class="text-primary link-text">{{ route('register', ['referral-code' => $vcard->user->affiliate_code]) }}
                            </a>
                    ...
                    <div class="d-flex align-items-center justify-content-center"
                        ...
                        @if ($contactRequest == 1)
                            <a href="{{ Auth::check() ? route('add-contact', $vcard->id) : 'javascript:void(0);' }}"
                                class="btn btn-primary add-contact-btn gap-2
                        ...
                        @else
                            <a href="{{ route('add-contact', $vcard->id) }}"
                                class="btn btn-primary add-contact-btn gap-2"><i
            ...
            <div class="btn-section cursor-pointer @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
                <div class="fixed-btn-section">
                    @if (empty($vcard->hide_stickybar))
                        <div
                            class="bars-btn corporate-bars-btn  @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') vcard-bars-btn-left @endif">
                            <img src="{{ asset('assets/img/vcard18/sticky.svg') }}" loading="lazy" />
                        </div>
                    @endif
                        ...
                        <div class="sub-btn-div @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') sub-btn-div-left @endif">
                            ...
                            @if (empty($vcard->hide_stickybar))
                                <div
                                    ...
                                    <a type="button"
                                        class="vcard18-btn-group vcard18-sticky-btn  d-flex justify-content-center text-decoration-none align-items-center text-white px-2 mb-3 py-2"
                ...
                @if ($vcard->location_url && isset($url[5]))
                    <div class="pt-50 px-30 position-relative">
                        <div class="position-absolute vector-15 vector-all">
                            <img src="{{ asset('assets/img/vcard18/vcard18-vector-15.png') }}" class="w-100" />
                        </div>
                        <div class="half-circle-right">
                        </div>
