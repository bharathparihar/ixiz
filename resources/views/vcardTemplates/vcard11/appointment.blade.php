    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                {{ Form::hidden('to_time', null, ['id' => 'toTime']) }} {{ Form::hidden('date', null, ['id' => 'Date']) }}
                ...
                @if (isset($appointmentDetail->is_paid) &&
                    ...
                    <div class="mb-3">
                        ...
                        {{ Form::select('payment_method', $appointmentDetail->is_paid == 0 ? \App\Models\Appointment::PAYMENT_METHOD : $paymentMethod, null, ['class' => 'form-control custom-placeholder  form-select form-select-solid select2Selector', 'data-control' => 'select2', 'required', 'id' => 'appointmentPaymentMethod', 'placeholder' => __('messages.common.payment_methods')]) }}
                    </div>
                    <div class="mt-3">
