        ...
        <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
            ...
            @if (getLanguage($vcard->default_language) != 'Arabic' && getLanguage($vcard->default_language) != 'Persian')
                <div class="profile-section position-relative">
                    <div
                        ...
                        <div
                            ...
                            <div class="profile-name">
                                ...
                                <p class="fs-16 text-decoration-underline text-primary mb-0">
                    ...
                    @if (checkFeature('social_links') && getSocialLink($vcard))
                        <div
                            class="social-media px-30 d-flex flex-wrap justify-content-center pt-40 position-relative">
                            <div class="position-absolute vector-all vector-2">
                                <img src="{{ asset('assets/img/vcard28/vector-2.png') }}" alt="bg-img"
                                    class="w-100" />
                            </div>
                            <div
            ...
            @else
                <div class="rtl" dir="rtl">
                    <div class="profile-section">
                        ...
                        @if (checkFeature('social_links') && getSocialLink($vcard))
                            <div
                                class="social-media px-30 d-flex flex-wrap justify-content-center position-relative pt-40">
                                <div class="position-absolute vector-all vector-2">
                                    <img src="{{ asset('assets/img/vcard28/vector-2.png') }}" alt="bg-img"
                                        class="w-100" />
                                </div>
                                            ...
                                            <div class="d-flex justify-content-between mt-2 product-info">
                                                <div class="amount fw-6 mb-0 text-primary lh-1">
                                                    @if ($product->currency_id && $product->price)
                                                        <div
                                                            class="text-primary amount-price">
                                ...
                                <div>
                                    <div class="whatsapp-store-box card h-100">
                                        ...
                                        <div class="whatsapp-store-content card-body text-center"
                                            ...
                                            <h3 class="text-black whatsapp-store-name mb-3 fw-5">
                                                {{ $product->store_name }}
                                            </h3>
                    ...
                    <div class="">
                        <div class="section-heading text-center pt-50 position-relative">
                            <div class="position-absolute vector-all vector-4 text-start">
                                <img src="{{ asset('assets/img/vcard28/hour-bg.png') }}" alt="bg-img"
                                    class="w-100" />
                            </div>
            ...
            @if ((isset($managesection) && $managesection['linkedin_embed']) || empty($managesection))
                @if (checkFeature('linkedin_embed') && $vcard->linkedinEmbed->count())
                    <div class="section-heading text-center pt-50 position-relative">
                        <h2 class="pb-3">{{ __('messages.feature.linkedin_embed') }}</h2>
                ...
                @if (checkFeature('blog') && $vcard->blogs->count())
                    <div class="blog-section pt-50 px-20 position-relative">
                        <div class="position-absolute vector-all vector-5 text-end">
                            <img src="{{ asset('assets/img/vcard28/vector-4.png') }}" alt="bg-img"
                                class="w-100" />
                        </div>
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                <div class="qr-code-section pt-50 px-30 position-relative">
                    ...
                    <div class="qr-code d-flex justify-content-center align-items-center flex-wrap flex-sm-nowrap mb-30"
                        @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                ...
                @if (checkFeature('iframes') && $vcard->iframes->count())
                    <div class="iframe-section pt-50 position-relative">
                        <div class="position-absolute vector-all vector-8 text-end">
                            <img src="{{ asset('assets/img/vcard28/qr-bg3.png') }}" alt="bg-img"
                                class="w-100" />
                        </div>
                        <div class="section-heading text-center">
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
                <div class="create-vcard-section pt-50 px-30 mb-2 position-relative">
                    <div class="position-absolute vector-all vector-10 text-end">
                        <img src="{{ asset('assets/img/vcard28/profile-bg1.png') }}" alt="bg-img"
                            class="w-100" />
                    </div>
                    <div class="section-heading">
                ...
                @if ($vcard->location_type == 0 && ($vcard->location_url && isset($url[5])))
                    <div class="px-30 pt-50 position-relative">
                        <div class="position-absolute vector-all vector-11">
                            <img src="{{ asset('assets/img/vcard28/vector-5.png') }}" alt="bg-img"
                                class="w-100" />
                        </div>
            ...
            <div class="btn-section cursor-pointer @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
                <div class="fixed-btn-section">
                    @if (empty($userSetting['hide_stickybar']))
                        <div
                            class="bars-btn pet-clinic-bars-btn bg-primary @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') vcard-bars-btn-left @endif">
