...
<body>
    ...
    <div class="container p-0">
        ...
        @endif
        <div
            class="main-content mx-auto w-100 overflow-hidden body-bg-black @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
            ...
            {{-- language --}}
            <div
                class="d-flex justify-content-end position-absolute top-0 mx-3 language-btn @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') start-0 end-auto @else end-0 @endif">
            ...
            {{-- profile section --}}
            <div class="profile-section pt-40 px-30 position-relative"
                @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                <div class="p-1 border-gradient main-card">
                    <div class="flex-sm-row gap-3 gap-sm-4 align-items-center w-100 position-relative z-1 card">
                        <div
                            class="position-absolute top-0 w-100 h-100 main-vector-bg  @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') start-0 @else end-0 @endif">
                            <img src={{ asset('assets/img/vcard35/main-vector-bg-2.png') }}
                                class="w-100 h-100 object-fit-cover" />
                        </div>
                        <div class="position-relative card-profile">
                            <div class="card-img rounded-circle">
                                <img src="{{ $vcard->profile_url }}"
                                    class="h-100 w-100 rounded-circle object-fit-cover" />
                                <div class="bg-animated">
                                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 288 288">
                                        <linearGradient id="PSgrad_0" x1="70.711%" x2="0%" y1="70.711%"
                                            y2="0%">
                        ...
                        <div
                            class="card-body text-center p-0  @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') text-sm-end @else text-sm-start @endif">
            ...
            @if (checkFeature('social_links') && getSocialLinkIcon($vcard))
                <div class="pt-50 px-30 position-relative">
                    <div class="position-absolute vector-all vector-1">
                        <img src="{{ asset('assets/img/vcard35/vector-bg-1.png') }}" alt="images"
                            class="w-100" />
                    </div>
                    <div class="social-media-section social-media  d-flex gap-3 flex-wrap justify-content-center"
                        @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        @foreach (getSocialLinkIcon($vcard) as $social)
                            <a href="{{ $social['url'] }}" target="_blank" class="text-decoration-none social-tag">
                ...
                @if (
                    ...
                    <div class="contact-section position-relative pt-50 px-30">
                        <div class="position-absolute vector-all vector-2 text-end">
                            <img src="{{ asset('assets/img/vcard35/vector-bg-2.png') }}" alt="images"
                                class="w-100" />
                        </div>
                        <div class="section-heading">
                            <h2>{{ __('messages.contact_us.contact') }}</h2>
                        </div>
                        <div class="row align-items-center row-gap-20px"
                            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            @if ($vcard->email)
                                <div class="col-12 col-sm-6">
                                    <div class="contact-box d-flex align-items-center">
                                        <div class="contact-icon d-flex justify-content-center align-items-center">
                                            <div class="contact-mask-img">
                                                <svg width="20" height="18" viewBox="0 0 22 18"
                                        ...
                                        <div class="contact-desc">
                                            <a href="mailto:{{ $vcard->email }}"
                                                class="text-white fs-14 mb-0 @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') me-1 @endif">{{ $vcard->email }}</a>
                                        </div>
                                    </div>
                                </div>
                            @endif
                                    ...
                                    <div class="contact-box d-flex align-items-center">
                                        ...
                                        <div class="contact-desc">
                                            <a href="mailto:{{ $vcard->alternative_email }}"
                                                class="text-white fs-14 mb-0 @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') me-1 @endif">{{ $vcard->alternative_email }}</a>
                                        </div>
                                    </div>
                                </div>
                            @endif
                                    ...
                                    <div class="contact-box d-flex align-items-center">
                                        ...
                                        <div class="contact-desc">
                                            <a href="tel:+{{ $vcard->region_code }}{{ $vcard->phone }}"
                                                class="text-white fs-14 mb-0 @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') me-1 @endif">+{{ $vcard->region_code }}{{ $vcard->phone }}</a>
                                        </div>
                                    </div>
                                </div>
                            @endif
                            @if ($vcard->alternative_phone)
                                <div class="col-12 col-sm-6">
                                    <div class="contact-box d-flex align-items-center">
                                        <div class="contact-icon d-flex justify-content-center align-items-center">
                                            <div class="contact-mask-img">
                                                <svg width="20" height="22" viewBox="0 0 22 22"
                                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                                        d="M4.54095 9.54438C6.32071 12.958 8.84849 15.5472 12.1888 17.3248C12.3306 17.4021 12.666 17.3119 12.8078 17.1831C13.5687 16.4617 14.3167 15.7275 15.039 14.9675C15.4388 14.5424 15.8773 14.478 16.4318 14.581C17.7473 14.8129 19.0757 15.0448 20.404 15.1994C21.4616 15.3282 21.8356 15.676 21.8356 16.758C21.8356 17.9174 21.8356 19.0638 21.8356 20.2231C21.8356 21.4726 21.4358 21.8591 20.159 21.8333C11.0796 21.6787 2.95464 15.238 0.81377 6.4013C0.439762 4.84264 0.323691 3.20669 0.181825 1.5965C0.0915477 0.643272 0.620317 0.179538 1.57468 0.179538C2.83857 0.166656 4.10246 0.166656 5.36635 0.166656C6.29492 0.166656 6.68183 0.591746 6.7979 1.51921C6.97845 2.88465 7.22349 4.25009 7.48143 5.60265C7.5846 6.18231 7.48143 6.64605 7.05583 7.05825C6.20464 7.88267 5.37925 8.70709 4.54095 9.54438Z"
                                                        fill="#a98345" />
                                        ...
                                        <div class="contact-desc">
                                            <a href="tel:+{{ $vcard->alternative_region_code }}{{ $vcard->alternative_phone }}"
                                                class="text-white fs-14 mb-0 @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') me-1 @endif">+{{ $vcard->alternative_region_code }}{{ $vcard->alternative_phone }}</a>
                                        </div>
                                    </div>
                                </div>
                            @endif
                            @if ($vcard->dob)
                                <div class="col-12 col-sm-6">
                                    <div class="contact-box d-flex align-items-center">
                                        <div class="contact-icon d-flex justify-content-center align-items-center">
                                            <div class="contact-mask-img">
                                                <svg width="24" height="22" viewBox="0 0 26 22"
                                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <div class="contact-desc">
                                            <p
                                                class="text-white fs-14 mb-0 @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') me-1 @endif">
                                                {{ $vcard->dob }}</p>
                                        </div>
                                    </div>
                                </div>
                ...
                @if (checkFeature('gallery') && $vcard->gallery->count())
                    <div class="gallery-section pt-50 px-20 position-relative">
                        <div class="position-absolute vector-all vector-3">
                            <img src="{{ asset('assets/img/vcard35/vector-bg-3.png') }}" alt="images"
                                class="w-100" />
                        </div>
                        <div class="section-heading">
                ...
                @if (checkFeature('services') && $vcard->services->count())
                    <div class="our-services-section pt-50 position-relative">
                        <div class="position-absolute vector-all vector-4 text-end">
                            <img src="{{ asset('assets/img/vcard35/vector-bg-4.png') }}" alt="images"
                                class="w-100" />
                        </div>
                        <div class="section-heading">
                            ...
                            @if ($vcard->services_slider_view)
                                <div class="services-slider-view px-20">
                                    @foreach ($vcard->services as $service)
                                        <div>
                                            <div class="service-card h-100 p-1 border-gradient">
                                ...
                                <div class="px-30">
                                    <div class="row row-gap-20px" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                        @foreach ($vcard->services as $service)
                                            <div class="col-sm-6">
                                                <div
                                                    class="service-card card d-flex flex-column align-items-center h-100 p-1 border-gradient">
                                                    <div class="card-img">
                                                        <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
                                                    ...
                                                    <div
                                                        class="card-body text-center bg-secondary @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian')  @endif">
            ...
            @if ((isset($managesection) && $managesection['appointments']) || empty($managesection))
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="appointment-section position-relative px-30 pt-50 position-relative"
                        @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        <div class="position-absolute vector-all vector-5">
                            <img src="{{ asset('assets/img/vcard35/vector-bg-5.png') }}" alt="images"
                                class="w-100" />
                        </div>
                        ...
                        <div class="appointment border-gradient">
                            <div class="p-2 bg-secondary rounded-10">
                                <div class="row">
                                    <div class="col-12">
                                    ...
                                    <div class="col-12 text-center">
                                        <button
                                            class="btn btn-primary appoint-btn mt-3 appointmentAdd d-none">{{ __('messages.make_appointments') }}</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                @if (checkFeature('products') && $vcard->products->count())
                    <div class="product-section position-relative pt-50 px-20 position-relative">
                        <div class="position-absolute vector-all vector-6 text-end">
                            <img src="{{ asset('assets/img/vcard35/vector-bg-6.png') }}" alt="images"
                                class="w-100" />
                        </div>
                        <div class="section-heading">
                        ...
                        <div class="product-slider">
                            @foreach ($vcard->products as $product)
                                <div>
                                    <div class="product-card card p-1 border-gradient">
                                        <a @if ($product->product_url) href="{{ $product->product_url }}" @endif
                                            ...
                                            <div
                                                class="product-desc card-body d-flex flex-column align-items-center justify-content-between">
                                                <div class="bg-secondary p-1 rounded-10 w-100">
                                                    <div>
                                                        <h6 class="product-title text-dark text-center">
                                                            {{ $product->name }}</h6>
                                                            <div class="d-flex justify-content-between mt-2 product-info">
                                                                <div>
                                                                    @if ($product->currency_id && $product->price)
                                                                        <span
                                                                            class="product-amount lh-1 fw-bold text-primary">{{ currencyFormat($product->price, 2, $product->currency->currency_code) }}</span>
                                                                    @elseif($product->price)
                                                                        <span
                                                                            class="product-amount lh-1 fw-bold text-primary">{{ currencyFormat($product->price, 2, getUserCurrencyIcon($vcard->user->id)) }}</span>
                                                                    @endif
                                                                </div>
            ...
            @if ((isset($managesection) && $managesection['whatsapp_store']) || empty($managesection))
                @if ($whatsappStore->count())
                    <div class="whatsapp-store-product-section position-relative pt-50 px-20">
                        ...
                        <div class="position-absolute vector-all vector-7 text-start">
                            <img src="{{ asset('assets/img/vcard35/vector-bg-2.png') }}" class="w-100" />
                        </div>
                        ...
                        <div class="whatsapp-store-slider">
                            @foreach ($whatsappStore as $product)
                                <div>
                                    <div class="whatsapp-store-box card p-1 border-gradient">
                                        ...
                                        <div
                                            class="whatsapp-store-content card-body d-flex flex-column align-items-center justify-content-between">
                                            <div class="bg-secondary p-1 rounded-10 w-100">

                                                <h6 class="whatsapp-store-name text-dark text-center mb-2">
                                                    {{ $product->store_name }}
                                                </h6>
                ...
                @if (checkFeature('testimonials') && $vcard->testimonials->count())
                    <div class="testimonial-section pt-50 px-20 position-relative">
                        <div class="position-absolute vector-all vector-7">
                            <img src="{{ asset('assets/img/vcard35/vector-bg-7.png') }}" alt="images"
                                class="w-100" />
                        </div>
                        <div class="section-heading">
                        ...
                        <div class="position-relative">
                            <div class="testimonial-slider">
                                @foreach ($vcard->testimonials as $testimonial)
                                    <div>
                                        <div class="main-testimonial-card p-3">
                                            <div
                                                class="quote-img quote-left d-flex justify-content-center align-items-center">
                                                <img src="{{ asset('assets/img/vcard35/quote-left.svg') }}"
                                                    loading="lazy" />
                                            </div>
                                            <div
                                                class="quote-img quote-right d-flex justify-content-center align-items-center">
                                                <img src="{{ asset('assets/img/vcard35/quote-right.svg') }}"
                                                    loading="lazy" />
                                            </div>
                                            <div class="p-2 testimonial-card">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <p
                                                        class="text-primary text-center text-decoration-underline mb-0 fw-5 title-text">
                                                        {!! $testimonial->name !!}
                                                    </p>
                                                </div>
                                            </div>
                ...
                @if (checkFeature('insta_embed') && $vcard->instagramEmbed->count())
                    <div class="insta-feed-section pt-50 px-30 position-relative">
                        <div class="position-absolute vector-all vector-8 text-end">
                            <img src="{{ asset('assets/img/vcard35/vector-bg-8.png') }}" alt="images"
                                class="w-100" />
                        </div>
                        <div class="section-heading">
                ...
                @if ($vcard->businessHours->count())
                    ...
                    <div class="business-hour-section pt-50 px-30 position-relative"
                        ...
                        <div class="position-absolute vector-all vector-9">
                            <img src="{{ asset('assets/img/vcard35/vector-bg-9.png') }}" alt="images"
                                class="w-100" />
                        </div>
                        <div class="section-heading">
                        ...
                        <div class="row justify-content-center row-gap-20px"
                            ...
                            @foreach ($businessDaysTime as $key => $dayTime)
                                <div class="col-sm-6">
                                    <div
                                        class="business-hour-card d-flex gap-2 align-items-center justify-content-center">
                                        <div class="time-icon">
                                            <div class="time-msk-img">
                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <span
                                                class="fs-14 fw-5 text-white">{{ $dayTime ?? __('messages.common.closed') }}</span>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
                ...
                @if (checkFeature('blog') && $vcard->blogs->count())
                    <div class="blog-section pt-50 px-20 position-relative">
                        <div class="position-absolute vector-all vector-10 text-end">
                            <img src="{{ asset('assets/img/vcard35/vector-bg-10.png') }}" alt="images"
                                class="w-100" />
                        </div>
                        <div class="section-heading">
                        ...
                        <div class="blog-slider">
                            @foreach ($vcard->blogs as $index => $blog)
                                ...
                                ?>
                                <div>
                                    <div class="blog-card card" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                        ...
                                        <div class="card-body w-100">
                                            <div>
                                                ...
                                                <div class="d-flex align-items-center justify-content-end">
                                                    <a href="{{ $vcardBlogUrl }}"
                                                        class="btn-primary text-white fs-14 rounded-pill px-2 py-1 d-inline-flex align-items-center justify-content-end gap-2">
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                <div class="qr-code-section pt-50 px-30 position-relative">
                    <div class="position-absolute vector-all vector-11">
                        <img src="{{ asset('assets/img/vcard35/vector-bg-11.png') }}" alt="images"
                            class="w-100" />
                    </div>
                    <div class="section-heading">
                    ...
                    <div @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        <div class="qr-code mx-auto  position-relative border-gradient p-1">
                            <div class="d-flex rounded-10 flex-sm-row flex-column gap-3 align-items-center bg-secondary p-3"
                                @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                ...
                                <div
                                    ...
                                    <h5 class="fw-6 text-dark">{{ __('messages.vcard.scan_to_contact') }}</h5>
                                    <p class="desc text-gray-300 mb-0 fs-14">
                                        {{ __('messages.vcard.qr_section_desc') }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                @if (checkFeature('iframes') && $vcard->iframes->count())
                    <div class="iframe-section pt-40 position-relative px-20">
                        <div class="position-absolute vector-all vector-12 text-end">
                            <img src="{{ asset('assets/img/vcard35/vector-bg-12.png') }}" alt="images"
                                class="w-100" />
                        </div>
                        <div class="section-heading">
            ...
            @if ((isset($managesection) && $managesection['payment_link']) || empty($managesection))
                @if (checkFeature('payment_link') && $vcard->paymentLinks->count())
                    <div class="payment-link-section px-20 pt-50 position-relative"
                        ...
                        <div class="section-heading">
                            <h2 class="left-bg">{{ __('messages.vcard.payment_links') }}</h2>
                        </div>
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
                <div class="contact-us-section pt-50 px-30 position-relative">
                    <div class="position-absolute vector-all vector-13">
                        <img src="{{ asset('assets/img/vcard35/vector-bg-13.png') }}" alt="images"
                            class="w-100" />
                    </div>
                    <div class="section-heading">
                    ...
                    @if (getLanguage($vcard->default_language) != 'Arabic' && getLanguage($vcard->default_language) != 'Persian')
                        <div class="contact-form position-relative p-2 border-gradient">
                            <div class="p-2 bg-secondary rounded-10">
                                            ...
                                            <div class="mb-3">
                                                <div class="wrapper-file-input">
                                                    <div class="input-box" id="fileInputTrigger">
                                                        ...
                                                        class="text-dark fs-12">{{ __('messages.file_supported') }}</small>
                                                </div>
                                                ...
                                                <div class="d-flex gap-3">
                                                    ...
                                                    <label class="form-check-label fs-14" for="privacyPolicyCheckbox">
                                                        ...
                                                        <a href="{{ $vcardPrivacyAndTerm }}" target="_blank"
                                                            class="text-decoration-none link-info text-primary fw-5 text-decoration-underline fs-14">{!! __('messages.vcard.term_and_condition') !!}</a>
                                                        <span class="text-dark">&</span>
                                                        <a href="{{ $vcardPrivacyAndTerm }}" target="_blank"
                                                            class="text-decoration-none link-info text-primary fw-5 text-decoration-underline fs-14">{{ __('messages.vcard.privacy_policy') }}</a>
                                                    </label>
                                                </div>
                                            </div>
                                        @endif
                    ...
                    @endif
                    @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian')
                        <div class="contact-form position-relative p-2 border-gradient" dir="rtl">
                            <div class="p-2 bg-secondary rounded-10">
                                <form action="" id="enquiryForm" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
                <div class="create-vcard-section pt-50 px-30 position-relative"
                    ...
                    <div class="position-absolute vector-all vector-14 text-end">
                        <img src="{{ asset('assets/img/vcard35/vector-bg-14.png') }}" alt="images"
                            class="w-100" />
                    </div>
                    <div class="section-heading">
                        <h2>{{ __('messages.create_vcard') }}</h2>
                    </div>
                    <div class="vcard-link-card card" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        <div class="d-flex justify-content-center align-items-center gap-3">
                            <a href="{{ config('app.url') . '/register?referral-code=' . $vcard->user->affiliate_code }}"
                                class="fw-5 text-primary link-text">{{ route('register', ['referral-code' => $vcard->user->affiliate_code]) }}</a>
                ...
                @if ($vcard->location_type == 0 && ($vcard->location_url && isset($url[5])))
                    <div class="pt-50 px-30 position-relative">
                        <div class="position-absolute vector-all vector-15">
                            <img src="{{ asset('assets/img/vcard35/vector-bg-15.png') }}" alt="images"
                                class="w-100" />
                        </div>
                        <div class="map-section">
                            <div class="map-location d-flex gap-2 align-items-center "
                                @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                <div class="location-icon d-flex justify-content-center align-items-center">
                                    <div class="location-msk-img">
                                        <svg width="20" height="24" viewBox="0 0 20 26" fill="none"
                                            ...
                                            <defs>
                                                <clipPath id="clip0_4578_1300">
                                                    <rect width="19.2308" height="25" fill="#a98344"
            ...
            @if ($vcard->enable_contact)
                <div class="add-to-contact-section">
                    <div class="add-to-contact-btn text-center" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        @if ($contactRequest == 1)
            ...
            {{-- <div
                            class="btn-section cursor-pointer @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
            ...
            <div class="btn-section cursor-pointer @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
                <div class="fixed-btn-section">
                    <div
                        class="bars-btn real-estate-bars-btn @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') vcard-bars-btn-left @endif">
                    ...
                    <div class="sub-btn d-none">
                        <div class="sub-btn-div @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') sub-btn-div-left @endif">
                                ...
                                <div class="icon-search-container mb-3" data-ic-class="search-trigger">
                                    ...
                                    <div class="share-wp-btn-div">
                                        <a href="javascript:void(0)"
                                            class="vcard35-sticky-btn vcard35-btn-group d-flex justify-content-center text-primary align-items-center rounded-0 text-decoration-none py-1 rounded-pill justify-content share-wp-btn">
                            ...
                            @if (empty($vcard->hide_stickybar))
                                <div
                                    class="{{ isset($vcard->whatsapp_share) ? 'vcard35-btn-group' : 'stickyIcon' }}">
                                    <button type="button"
