...
<body>
    ...
    <div class="container p-0">
        ...
        <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
            ...
            {{-- profile detail --}}
            <div class="profile-section pt-40 position-relative">
                <div
                    class="position-absolute  w-100 h-100 main-bg-vector @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') start-0 @else end-0 @endif">
                    <img src="{{ asset('assets/img/vcard27/main-vector-bg.png') }}" alt="images"
                        class="w-100 h-100 object-fit-cover" />
                </div>
                <div class="px-30 position-relative">
                    <div class="card d-flex flex-sm-row align-items-center position-relative gap-3 gap-sm-4"
                        ...
                        <div class="card-body p-0 text-sm-start text-center">
                            <div class="profile-name">
                                ...
                                <p class="fs-18 text-decoration-underline text-primary-200 mb-0">
                                    {{ ucwords($vcard->company) }}</p>
                                <p class="fs-14 mb-0 text-gray-100">{{ ucwords($vcard->occupation) }}</p>
                                <p class="fs-14 mb-0 text-gray-100">{{ ucwords($vcard->job_title) }}</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            @if (checkFeature('social_links') && getSocialLink($vcard))
                <div class="social-media pt-40 d-flex flex-wrap justify-content-center px-30 position-relative">
                    <div class="position-absolute vector-all vector-bg-2">
                        <img src="{{ asset('assets/img/vcard27/vector-bg-1.png') }}" alt="images"
                            class="w-100" />
                    </div>

                    <div class="social-icons d-flex justify-content-center flex-wrap gap-3 w-100">
            ...
            @if (checkFeature('custom-links') && $customLink->isNotEmpty())
                <div class="custom-link-section pt-50 px-30 position-relative">
                ...
                @if (
                    ...
                    <div class="contact-section pt-50 px-30 position-relative">
                        <div class="position-absolute vector-all vector-bg-4 text-end">
                            <img src="{{ asset('assets/img/vcard27/vector-bg-2.png') }}" alt="images"
                                class="w-100" />
                        </div>
                        {{-- contact section --}}
                        @if ((isset($managesection) && $managesection['contact_list']) || empty($managesection))
                                        ...
                                        <div class="col-sm-6">
                                            <div class="contact-box d-flex align-items-center">
                                                <div
                                                    ...
                                                    <img src="{{ asset('assets/img/vcard27/email.svg') }}"
                                                        alt="" />
                                                </div>
                                    ...
                                    @if ($vcard->phone)
                                        <div class="col-sm-6">
                                            <div class="contact-box d-flex align-items-center">
                                                <div
                                                    class="contact-icon d-flex justify-content-center align-items-center">
                                                    <img src="{{ asset('assets/img/vcard27/phone.svg') }}"
                                                        alt="" />
                                                </div>
                                                <div class="contact-desc">
                                    ...
                                    @if ($vcard->dob)
                                        <div class="col-sm-6">
                                            <div class="contact-box d-flex align-items-center">
                                                <div
                                                    class="contact-icon d-flex justify-content-center align-items-center">
                                                    <img src="{{ asset('assets/img/vcard27/dob.svg') }}"
                                                        alt="" />
                                                </div>
                                                <div class="contact-desc">
                                    ...
                                    @if ($vcard->location)
                                        <div class="col-sm-6">
                                            <div class="contact-box d-flex align-items-center">
                                                <div
                                                    class="contact-icon d-flex justify-content-center align-items-center">
                                                    <img src="{{ asset('assets/img/vcard27/location.svg') }}"
                                                        alt="" />
                                                </div>
                                                <div class="contact-desc">
            ...
            @if ((isset($managesection) && $managesection['services']) || empty($managesection))
                @if (checkFeature('services') && $vcard->services->count())
                    <div class="our-services-section pt-50 px-30 position-relative">
                        <div class="position-absolute vector-all vector-bg-5">
                            <img src="{{ asset('assets/img/vcard27/vector-bg-3.png') }}" alt="images"
                                class="w-100" />
                        </div>
                        <div class="section-heading">
                                        ...
                                        <div>
                                            <div class="service-card h-100">
                                                ...
                                                <div class="text-center card-body p-0">
                                                    ...
                                                    <p
                                                        class="card-text description-text text-gray-100 mb-0 {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="service-card h-100">
                                                <div
                                                    ...
                                                    <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
                                                        class="{{ $service->service_url ? 'pe-auto' : 'pe-none' }} d-block w-100 h-100"
                                                        target="{{ $service->service_url ? '_blank' : '' }}">
                                                        <img src="{{ $service->service_icon }}" alt="branding"
                                                            loading="lazy"
                                                            class="service-img w-100 object-fit-cover h-100" />
                                                    </a>
                                                </div>
                                                <div class="card-body text-center p-0">
                                                    <h3 class="card-title text-black mb-10">
                                                        {{ ucwords($service->name) }}
                                                    </h3>
                                                    <p
                                                        class="mb-0 description-text text-gray-100 text-center {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}">
                ...
                @if (checkFeature('gallery') && $vcard->gallery->count())
                    <div class="gallery-section pt-50 position-relative">
                        <div class="position-absolute vector-all vector-bg-6 text-end">
                            <img src="{{ asset('assets/img/vcard27/vector-bg-4.png') }}" alt="images"
                                class="w-100" />
                        </div>
            ...
            @if ((isset($managesection) && $managesection['appointments']) || empty($managesection))
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="appointment-section pt-50 position-relative">
                        <div class="appointment-main px-30">
                            <div class="position-absolute vector-all vector-bg-7">
                                <img src="{{ asset('assets/img/vcard27/vector-bg-5.png') }}" alt="images"
                                    class="w-100" />
                            </div>
                            <div class="section-heading">
                ...
                @if (checkFeature('products') && $vcard->products->count())
                    <div class="product-section pt-50 px-20 position-relative">
                        <div class="position-absolute vector-all vector-bg-8 text-end">
                            <img src="{{ asset('assets/img/vcard27/vector-bg-6.png') }}" alt="images"
                                class="w-100" />
                        </div>
                            ...
                            @foreach ($vcard->products as $product)
                                <div class="">
                                    <div class="product-card card">
                                        <div class="product-img card-img position-relative z-index-1">
                                        ...
                                        <div
                                            class="product-desc card-body p-3 text-center position-relative z-index-1 pb-0">
                                            <h3 class="text-black mb-3">
                                                {{ $product->name }}
                                            </h3>
                                            <div class="d-flex justify-content-between mt-2 product-info">
                                                <p class="amount mb-0 fw-6 text-primary">
                                                    @if ($product->currency_id && $product->price)
                                                        <span
                                                            class="text-primary">{{ currencyFormat($product->price, 2, $product->currency->currency_code) }}</span>
                                                    @elseif($product->price)
                                                        <span
                                                            class="text-primary">{{ currencyFormat($product->price, 2, getUserCurrencyIcon($vcard->user->id)) }}</span>
                                                    @endif
                                                </p>
                        ...
                        <div class="mt-5 text-center view-more mx-auto">
                ...
                @if ($whatsappStore->count())
                    <div class="whatsapp-store-product-section pt-50 px-20 mt-50 position-relative">
                        <div class="position-absolute vector-75 whatsapp-store-vector-1 text-start">
                            <img src="{{ asset('assets/img/vcard27/vector-bg-10.png') }}"
                                ...
                                <div>
                                    <div class="whatsapp-store-box card h-100">
                                        ...
                                        <div class="whatsapp-store-content card-body text-center"
                                            ...
                                            <h3 class="whatsapp-store-name text-black mb-3">
                                                {{ $product->store_name }}
                                            </h3>
                ...
                @if (checkFeature('testimonials') && $vcard->testimonials->count())
                    <div class="testimonial-section pt-50 position-relative">
                        <div class="position-absolute vector-all vector-bg-9">
                            <img src="{{ asset('assets/img/vcard27/vector-bg-7.png') }}" alt="images"
                                class="w-100" />
                        </div>
                                    ...
                                    <div>
                                        <div class="testimonial-card card">
                                            <div class="testimonial-profile-img">
                                                <div class="testimonial-img w-100 h-100">
                                            ...
                                            <div class="card-body p-0">
                                                <div class="text-center">
                                                    ...
                                                    <div class="d-flex gap-sm-3 gap-2 justify-content-between">
                                                        <div class="quote-left">
                                                            <img src="{{ asset('assets/img/vcard27/quote-left.png') }}"
                                                                alt="quote" />
                                                        </div>
                                                        <p
                                                            class="desc text-gray-100 mb-0 {{ \Illuminate\Support\Str::length($testimonial->description) > 80 ? 'more' : '' }}">
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                <div class="qr-code-section pt-50  position-relative">
                    <div class="qr-code-main px-30">
                        <div class="position-absolute vector-all vector-bg-10 text-end">
                            <img src="{{ asset('assets/img/vcard27/vector-bg-8.png') }}" alt="images"
                                class="w-100" />
                        </div>
                        <div class="section-heading">
                            <h2>{{ __('messages.vcard.qr_code') }}</h2>
                        </div>
                        <div class="qr-code d-flex flex-column flex-sm-row justify-content-center gap-3 flex-wrap flex-sm-nowrap mx-auto align-items-center"
                            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            ...
                            <div class="text-sm-start text-center position-relative z-index-1">
                ...
                @if (checkFeature('insta_embed') && $vcard->instagramEmbed->count())
                    <div class="pt-50 px-30 position-relative">
                        <div class="position-absolute vector-all vector-bg-11">
                            <img src="{{ asset('assets/img/vcard27/vector-bg-9.png') }}" alt="images"
                                class="w-100" />
                        </div>
                        <div class="section-heading px-30">
                        ...
                        <nav>
                            <div class="row insta-toggle">
                                <div class="nav nav-tabs border-0 px-0" id="nav-tab" role="tablist">
                                    ...
                                    <button
                                        class="d-flex align-items-center justify-content-center pb-2 instagram-btn reelsbtn  border-0 text-dark mr-0"
                ...
                @if (checkFeature('blog') && $vcard->blogs->count())
                    <div class="blog-section pt-50 px-20 position-relative">
                        <div class="position-absolute vector-all vector-bg-12 text-end">
                            <img src="{{ asset('assets/img/vcard27/vector-bg-10.png') }}" alt="images"
                                class="w-100" />
                        </div>
                        <div class="section-heading px-3">
                                    ...
                                    <div class="blog-card card">
                                        ...
                                        <div class="card-body p-0 text-start">
                                            ...
                                            <div class="d-flex align-items-center justify-content-end"
                                                @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                                <a href="{{ $vcardBlogUrl }}"
                                                    class="text-white read-more d-inline-flex align-items-center justify-content-end gap-2"
                                                    tabindex="-1">
                ...
                @if ($vcard->businessHours->count())
                    ...
                    <div class="business-hour-section pt-50 px-30 position-relative">
                        <div class="position-absolute vector-all vector-bg-13">
                            <img src="{{ asset('assets/img/vcard27/vector-bg-11.png') }}" alt="images"
                                class="w-100" />
                        </div>
                        <div class="section-heading">
                                ...
                                @foreach ($businessDaysTime as $key => $dayTime)
                                    <div class="col-sm-6">
                                        <div class="business-hour"
                                            ...
                                            <div class="fs-16 text-primary text-center lh-1">
                ...
                @if (checkFeature('iframes') && $vcard->iframes->count())
                    <div class="iframe-section pt-50 px-20 position-relative">
                        <div class="position-absolute vector-all vector-bg-14 text-end">
                            <img src="{{ asset('assets/img/vcard27/vector-bg-12.png') }}" alt="images"
                                class="w-100" />
                        </div>
                        <div class="text-center">
                            <div class="section-heading">
                ...
                @if (checkFeature('payment_link') && $vcard->paymentLinks->count())
                    <div class="main-section">
                        <div class="payment-link-section pt-40 px-20">
                            <div class="position-absolute vector-all text-end">
                            <img src="{{ asset('assets/img/vcard27/vector-bg-6.png') }}" alt="images"
                                class="w-100" />
                        </div>
                            <div class="section-heading px-3">
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
                <div class="contact-us-section pt-50 px-30">
                    <div class="position-absolute vector-all vector-bg-15">
                        <img src="{{ asset('assets/img/vcard27/vector-bg-13.png') }}" alt="images"
                            class="w-100" />
                    </div>
                    <div class="section-heading">
                        ...
                        <div class="contact-form" dir="rtl">
                            <form action="" id="enquiryForm" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    @endif
                                    <div class="col-12 text-center">
                                        <button class="send-btn btn btn-secondary send-msg-btn" type="submit">
                                            {{ __('messages.contact_us.send_message') }}
                                        </button>
                                    </div>
                                </div>
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
                <div class="create-vcard-section px-30 pt-50 position-relative text-end">
                    <div class="position-absolute vector-all vector-bg-16">
                        <img src="{{ asset('assets/img/vcard27/vector-bg-14.png') }}" alt="images"
                            class="w-100" />
                    </div>
                    <div class="section-heading">
                        ...
                        <div class="vcard-link-card card">
                            <div class="d-flex align-items-center justify-content-center gap-2"
                                ...
                                <a href="{{ config('app.url') . '/register?referral-code=' . $vcard->user->affiliate_code }}"
                                    class="text-primary link-text fw-5">{{ route('register', ['referral-code' => $vcard->user->affiliate_code]) }}</a>
                ...
                @if ($vcard->location_type == 0 && ($vcard->location_url && isset($url[5])))
                    <div class="pt-50 px-30 position-relative">
                        <div class="position-absolute vector-all vector-bg-1">
                            <img src="{{ asset('assets/img/vcard27/vector-bg-15.png') }}" alt="images"
                                class="w-100" />
                        </div>
                        <div class="map-section">
                            <div class="map-location d-flex gap-3 px-2 align-items-center pb-3 pt-2"
                                @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                <div class="location-icon d-flex justify-content-center align-items-center">
                                    <img src="{{ asset('assets/img/vcard27/location.svg') }}">
                                </div>
                                <p class="text-black mb-0">Surat</p>
                            </div>
                            <div class="">
            ...
            @endif
            {{-- pet-bottom-img --}}
            <div class="pet-bottom position-relative w-100 h-100 pt-4">
                <img src="{{ asset('assets/img/vcard27/pet-bottom.png') }}" alt="images" class="w-100 h-100">
            </div>
            {{-- add to contact --}}
                    ...
                    <div class="text-center d-flex align-items-center justify-content-center"
                        ...
                        @if ($contactRequest == 1)
                            <a href="{{ Auth::check() ? route('add-contact', $vcard->id) : 'javascript:void(0);' }}"
                                class="add-contact-btn btn-primary d-flex align-items-center justify-content-center gap-2 {{ Auth::check() ? 'auth-contact-btn' : 'ask-contact-detail-form' }}"
                        ...
                        @else
                            <a href="{{ route('add-contact', $vcard->id) }}"
                                class="add-contact-btn btn-primary d-flex align-items-center justify-content-center gap-2"><i
                    ...
                    <div>
                        <a class="text-decoration-none text-dark cursor-pointer terms-policies-btn"
                            href="{{ $vcardPrivacyAndTerm }}"><small
                                class="fw-5">{!! __('messages.vcard.term_policy') !!}</small></a>
                    </div>
                @endif
            </div>
            {{-- sticky btn --}}
            <div class="btn-section cursor-pointer @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
                <div class="fixed-btn-section">
                    @if (empty($userSetting['hide_stickybar']))
                        <div
                            class="bars-btn bg-primary pet-shop-bars-btn @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') vcard-bars-btn-left @endif">
                            <img src="{{ asset('assets/img/vcard27/sticky.svg') }}" />
                        </div>
                    @endif
                ...
                <div class="modal-body">
                    ...
                    <a href="http://pinterest.com/pin/create/link/?url={{ $shareUrl }}" target="_blank"
                        ...
                        <div class="row">
                            ...
                            <div class="col-1 p-1">
                                <svg xmlns="http://www.w3.org/2000/svg" class="arrow" class="arrow"
                                    version="1.0" height="16px" viewBox="0 0 512.000000 512.000000"
                                    preserveAspectRatio="xMidYMid meet">
                                    <g transform="translate(0.000000,512.000000) scale(0.100000,-0.100000)"
                                        fill="#000000" stroke="none">
                                        <path
