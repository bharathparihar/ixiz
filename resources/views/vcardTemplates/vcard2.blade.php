...
<head>
    ...
    {{-- css link --}}
    <link rel="stylesheet" href="{{ mix('assets/css/vcard2.css') }}">
...
<body>
    <div class="container p-0">
        ...
        @endif
        <div
            class="vcard-two main-content w-100 mx-auto overflow-hidden content-blur  allSection @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
            {{-- banner --}}
            <div class="vcard-two__banner w-100 position-relative">
                ...
                @if ($vcard->cover_type == 0)
                    <img src="{{ $vcard->cover_url }}"
                        class="img-fluid banner-image position-relative {{ $coverClass }}" alt="background"
                        loading="lazy" />
                @elseif($vcard->cover_type == 1)
                    @if (strpos($vcard->cover_url, '.mp4') !== false ||
                        ...
                        <video class="cover-video img-fluid banner-image position-relative {{ $coverClass }}" autoplay loop muted playsinline alt="background video" id="cover-video">
                ...
                @elseif ($vcard->cover_type == 2)
                    <div class="youtube-link-2">
                        <iframe
                            ...
                            class="cover-video img-fluid banner-image position-relative {{ $coverClass }}"
                ...
                <div
                    class="d-flex justify-content-end position-absolute top-0 end-0 me-3 custom-language language-btn ms-3">
            ...
            {{-- profile --}}
            <div class="vcard-two__profile position-relative @if ($vcard->cover_type == 2) profile-margin @endif">
            ...
            {{-- profile details --}}
            <div
                class="vcard-two__profile-details py-3 px-3 p-5 @if ($vcard->cover_type == 2) profile-desc-margin @endif">
                <div class="max-w-350">
                            ...
                            @foreach ($customLink as $value)
                                @if ($value->show_as_button == 1)
                                    <a href="{{ $value->link }}"
                                        ...
                                        class="m-2 d-flex justify-content-center align-items-center text-decoration-none link-text text-black btn mt-2">
                                        {{ $value->link_name }}
                                    </a>
                                @else
                                    <a href="{{ $value->link }}"
            ...
            @if ((isset($managesection) && $managesection['contact_list']) || empty($managesection))
                @if (getLanguage($vcard->default_language) != 'Arabic' && getLanguage($vcard->default_language) != 'Persian')
                    <div class="vcard-two__event py-3 px-3 ms-3">
                        ...
                        @if ($vcard->phone)
                            <div class="event-details d-flex">
                                ...
                                <span> <a href="tel:+{{ $vcard->region_code }}{{ $vcard->phone }}"
                                        class="event-name text-center pt-3 mb-0 email-btn text-decoration-none"
                        ...
                        @if ($vcard->alternative_phone)
                            <div class="event-details d-flex">
                                <div class="event-image">
                                    <img src="{{ asset('assets/img/vcard2/old-typical-phonevcard2.png') }}"
                                        height="23px" alt="phone" class="" />
                                </div>
                ...
                @endif
                @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian')
                    <div class="vcard-two__event py-3 px-3 ms-3" dir="rtl">
                        @if ($vcard->email)
                            <div class="event-details d-flex">
                                <div class="event-image">
                                    <img src="{{ asset('assets/img/vcard2/vcard2-email.png') }}" alt="email"
                            ...
                            <div class="col-12">
                                @if (getLanguage($vcard->default_language) != 'Arabic' && getLanguage($vcard->default_language) != 'Persian')
                                    <div class="card qr-code-card p-3 border-0">
                                        <h4 class="vcard-two-heading  text-center pb-4">
                                                ...
                                                <div class="d-flex service-sub-card">
                                                    ...
                                                    <div class="w-100">
                                                        <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
                                                            ...
                                                            target="{{ $service->service_url ? '_blank' : '' }}">
                                                            <h5 class="card-title title-text service-title">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="card service-card h-100">
                                                ...
                                                <div class="card-body pt-3  p-0">
                                                    ...
                                                    <p
                                                        class="card-text text-gray-600 {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}">
                                                        {!! \Illuminate\Support\Str::limit($service->description, 170, '...') !!}</p>
                                                    @if ($vcard->show_service_enquiry_btn == true)
                                                        @if ($service->service_url)
                                                            <div class="text-center enquiry-btn">
                                    ...
                                    <div class="w-100 p-2">
                                        <a @if ($product->product_url) href="{{ $product->product_url }}" @endif
                                            ...
                                            <div class="card product-card p-3 border-0 w-100 h-100">
                                                ...
                                                <div class="product-details mt-3 d-flex flex-column justify-content-between">
                                          <div>
                                            <h4 class="product-name">{{ $product->name }}</h4>
                                                    ...
                                                    <div class="d-flex justify-content-between mt-2 product-info">
                                                        <div class="product-amount fs-18">
                                                            @if ($product->currency_id && $product->price)
                                                                <span
                                                                    class="text-black fs-18 product-price-{{ $product->id }}">{{ currencyFormat($product->price, 2, $product->currency->currency_code) }}</span>
                                                            @elseif($product->price)
                                                                <span
                                                                    class="text-black fs-18 product-price-{{ $product->id }}">{{ currencyFormat($product->price, 2, getUserCurrencyIcon($vcard->user->id)) }}</span>
                                                            @endif
                                                        </div>
            ...
            @if ((isset($managesection) && $managesection['whatsapp_store']) || empty($managesection))
                @if ($whatsappStore->count())
                    <div class="vcard-two__whatsapp-store mt-3 py-12 position-relative px-3 mt-0">
                        <h4 class="vcard-two-heading text-center pb-2">
                            {{ __('messages.feature.whatsapp_store') }}
                        </h4>

                        <div class="container">
                            <div class="row g-3 whatsapp-store-slider">
                                @foreach ($whatsappStore as $store)
                                    <div class="w-100 p-2">
                                        <div class="card whatsapp-store-card p-3 border-0 w-100 h-100">
                                            <div class="whatsapp-store-profile">
                                                <img src="{{ $store->cover_url }}" alt="store" class="w-100"
                                                    height="208px" loading="lazy" />
                                            </div>

                                            <div class="whatsapp-store-details mt-3">
            ...
            @if ((isset($managesection) && $managesection['insta_embed']) || empty($managesection))
                @if (checkFeature('insta_embed') && $vcard->instagramEmbed->count())
                    <div class="pt-2">
                        <h4 class="vcard-two-heading text-center pb-2 mt-5">{{ __('messages.feature.insta_embed') }}
                        </h4>
                        <nav>
                            <div class="row insta-toggle">
                                <div class="nav nav-tabs px-0" id="nav-tab" role="tablist">
                                    <button
                                        class="d-flex align-items-center justify-content-center active postbtn instagram-btn fs-2 text-decoration-none py-2"
                                    ...
                                    <button
                                        class="d-flex align-items-center justify-content-center instagram-btn reelsbtn fs-2 text-decoration-none py-2"
            ...
            @if ((isset($managesection) && $managesection['linkedin_embed']) || empty($managesection))
                @if (checkFeature('linkedin_embed') && $vcard->linkedinEmbed->count())
                    <div class="pt-2">
                        <h4 class="vcard-two-heading text-center pb-2 mt-5">
                                        ...
                                        <div class="card blog-card p-4 border-0 w-100 h-100 blog-block">
                                            ...
                                            <div class="blog-details mt-4">
                                                <a href="{{ $vcardBlogUrl }}" class="text-decoration-none">
                                                 ...
                                                 <a href="{{ $vcardBlogUrl }}"
                                                class="mt-3 read-more d-flex align-items-center justify-content-end gap-2">
            ...
            @if ((isset($managesection) && $managesection['iframe']) || empty($managesection))
                @if (checkFeature('iframes') && $vcard->iframes->count())
                    <div class="vcard-two__blog py-5  mt-5">
                        <h4 class="vcard-two-heading text-center pt-3 m-0 mb-3">{{ __('messages.vcard.iframe') }}
                        </h4>
            ...
            @if ((isset($managesection) && $managesection['payment_link']) || empty($managesection))
                @if (checkFeature('payment_link') && $vcard->paymentLinks->count())
                    <div class="main-section">
                        <div class="payment-link-section py-5  mt-5">
                            <h4 class="vcard-two-heading text-center pt-3 m-0 mb-3">{{ __('messages.vcard.payment_links') }}</h4>
                                            ...
                                            <div class="contact-form px-sm-5">
                                                ...
                                                <div class="mb-3">
                                                    <input type="text" name="name"
                                                        class="form-control text-start" id="name"
                                                        placeholder="{{ __('messages.form.your_name') }}">
                                                </div>
                                                <div class="mb-3">
                                                    <input type="email" name="email"
                                                        class="form-control text-start" id="email"
                                                        placeholder="{{ __('messages.form.your_email') }}">
                                                </div>
                                                <div class="mb-3">
                                                    <input type="tel" name="phone"
                                                        class="form-control text-start" id="phone"
                ...
                <div
                    ...
                    <div class="sub-btn d-none">
                        <div class="sub-btn-div @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') sub-btn-div-left @endif">
                            ...
                            @endif
                            @if (empty($vcard->hide_stickybar))
                                <div class="{{ isset($vcard->whatsapp_share) ? 'vcard2-btn-group' : 'stickyIcon' }}">
                                    <button type="button"
                        ...
                        <div class="" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            @if ($contactRequest == 1)
                                <a href="{{ Auth::check() ? route('add-contact', $vcard->id) : 'javascript:void(0);' }}"
                                    class="vcard2-sticky-btn add-contact-btn d-flex justify-content-center text-white align-items-center rounded px-5 text-decoration-none py-1 justify-content-center
                    ...
                    <div class="modal-dialog news-modal modal-dialog-centered">
                        <div class="modal-content animate-bottom" id="newsLatter-content">
                            ...
                            <div class="modal-body">
                                ...
                                <p class="modal-desc text-start mt-1">{{ __('messages.vcard.update_directly') }}</p>
                                <form action="" method="post" id="newsLatterForm">
                                    ...
                                    <div
                                        ...
                                        <div class="w-100">
                                            <input type="email"
                                                class="email-input form-control bg-dark border-dark text-light w-100"
                                                placeholder="{{ __('messages.form.enter_your_email') }}"
                                                aria-label="Email" name="email" id="emailSubscription"
                                                aria-describedby="email-send">
                                        </div>
