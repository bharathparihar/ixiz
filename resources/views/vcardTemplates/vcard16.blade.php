...
<body>
    ...
    <div class="container p-0">
        ...
        <div class="main-content mx-auto w-100 overflow-hidden  @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
            ...
            <div class="profile-section px-30 pt-30 pb-50 position-relative">

                <div class="row justify-content-end">
                    <div class="col-12">
                        <div
                            class="card flex-sm-row gap-3 align-items-center position-relative @if ($vcard->cover_type == 2) profile-margin @endif">
                            <div class="profile-bg">
                                <img src="{{ asset('assets/img/vcard16/profile-bg-vector.png') }}"
                                    alt="profile-bg" />

                            </div>
                            <div class="card-img d-flex justify-content-center align-items-center">
                                <img src="{{ $vcard->profile_url }}" class="h-100 w-100 object-fit-cover"
                                    loading="lazy" />
                            </div>
                            <div class="card-body text-center p-0">
                                <div class="profile-name">
                                    <h2 class=" text-primary fs-28 fw-bold mb-0 font-hedvig">
                                        {{ ucwords($vcard->first_name . ' ' . $vcard->last_name) }}
                                        @if ($vcard->is_verified)
                                            <i class="verification-icon bi-patch-check-fill"></i>
                                        @endif
                                    </h2>
                                    <p class="fs-18 text-decoration-underline fw-5 mb-0">
                                        {{ ucwords($vcard->company) }}</p>
                                    <p class="fs-14 text-gray-300 mb-0">{{ ucwords($vcard->occupation) }}</p>
                                    <p class="fs-14 text-gray-300 mb-0">{{ ucwords($vcard->job_title) }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            @if (checkFeature('social_links') && getSocialLink($vcard))
                <div class="social-media mt-0 pt-50 px-30 d-flex justify-content-center">

                    <div class="social-icons d-flex justify-content-center flex-wrap w-100">
            ...
            <div class="px-30 pt-50 position-relative">
                <div class="position-absolute vector-2 vector-all">
                    <img src="{{ asset('assets/img/vcard16/vector-2.png') }}" alt="images" class="w-100" />
                </div>
                ...
                @if (checkFeature('custom-links') && $customLink->isNotEmpty())
                    <div class="custom-link-section">
                        <div
                            class="custom-link d-flex flex-wrap justify-content-center pt-50 gap-2 w-100 position-relative">
            ...
            @if (((isset($managesection) && $managesection['contact_list']) || empty($managesection)) && $hasContactData)
                <div class="contact-section pt-50 position-relative">
                    <div class="position-absolute vector-1 text-end vector-all">
                        <img src="{{ asset('assets/img/vcard16/vector-3.png') }}" alt="images" class="w-100" />
                    </div>
                    <div class="section-heading text-center mb-40">
                        <h2 class="text-primary text-center">{{ __('messages.contact_us.contact') }}</h2>
                    </div>
                    <div class="px-30">
                            ...
                            <div class="row row-gap-20px">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="contact-box">
                                            <div class="contact-icon d-flex justify-content-center align-items-center">
                                                <img src="{{ asset('assets/img/vcard16/email.svg') }}" />
                                            </div>
                                            <div class="contact-desc">
                                                <a href="mailto:{{ $vcard->email }}"
                                                    class="event-name text-center mb-0 text-decoration-none">{{ $vcard->email }}</a>
                                            </div>
                                        </div>
                                    </div>
                                @endif
                                        ...
                                        <div class="contact-box">
                                            ...
                                            <div class="contact-desc">
                                                <a href="mailto:{{ $vcard->alternative_email }}"
                                                    class="event-name text-center mb-0 text-decoration-none">{{ $vcard->alternative_email }}</a>
                                            </div>
                                        </div>
                                    </div>
                                @endif
                                ...
                                @if ($vcard->phone)
                                    <div class="col-sm-6">
                                        <div class="contact-box">
                                            <div class="contact-icon d-flex justify-content-center align-items-center">
                                                <img src="{{ asset('assets/img/vcard16/phone.svg') }}" />
                                            </div>
                                            <div class="contact-desc">
                                                <a href="tel:+ {{ $vcard->region_code }}
                                            {{ $vcard->phone }}"
                                                    class="text-primary mb-0 fs-14"
                                ...
                                @if ($vcard->dob)
                                    <div class="col-sm-6">
                                        <div class="contact-box">
                                            <div class="contact-icon d-flex justify-content-center align-items-center">
                                                <img src="{{ asset('assets/img/vcard16/dob-icon.svg') }}" />
                                            </div>
                                            <div class="contact-desc">
                                                <p class="text-primary fs-14 mb-0">{{ $vcard->dob }}</p>
                                            </div>
                                        </div>
                                    </div>
                                @endif
                                ...
                                @if ($vcard->location)
                                    <div class="col-sm-6">
                                        <div class="contact-box">
                                            <div class="contact-icon d-flex justify-content-center align-items-center">
                                                <img src="{{ asset('assets/img/vcard16/location.svg') }}" />
                                            </div>
                                            <div class="contact-desc">
                                                <p class="text-primary fs-14 mb-0">{!! ucwords($vcard->location) !!}</p>
                                            </div>
                                        </div>
                                    </div>
                                @endif
            ...
            @if ((isset($managesection) && $managesection['appointments']) || empty($managesection))
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="appointment-section pt-50 mt-50 pb-3 bg-primary position-relative">
                        <div class="position-absolute vector-3 vector-all">
                            <img src="{{ asset('assets/img/vcard16/vector-1.png') }}" alt="images"
                                class="w-100" />
                        </div>
                        <div class="section-heading text-center mb-40">
                            <h2 class="text-white text-center mb-0">{{ __('messages.make_appointments') }}</h2>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-12 mb-20">
                                    <div class="position-relative">
                                        {{ Form::text('date', null, [
                                            'class' => ' date form-control appointment-input
                                                                                                                text-start',
                                ...
                                <div class="col-12 text-center mt-2">
                                    <button
                                        class="btn btn-white appoint-btn appointmentAdd d-none">{{ __('messages.make_appointments') }}</button>
                                </div>
                            </div>
            ...
            @if ((isset($managesection) && $managesection['services']) || empty($managesection))
                @if (checkFeature('services') && $vcard->services->count())
                    <div class="our-services-section pt-50">
                        <div class="section-heading text-center mb-40">
                            <h2 class="text-primary text-center">{{ __('messages.vcard.our_service') }}</h2>
                        </div>
                        <div class="services-bg">
                            <img src="{{ asset('assets/img/vcard16/vector-13.png') }}" alt=""
                                            ...
                                            <div>
                                                <div class="service-card h-100">
                                                    <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
                                                        class="card-img text-decoration-none img {{ $service->service_url ? 'pe-auto' : 'pe-none' }}"
                                            ...
                                            <div class="col-sm-6">
                                                <div class="service-card card h-100 align-items-center">
                                                    <div
                                                        ...
                                                        <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
                                                            class="text-decoration-none w-100 h-100 d-block"
                                                            target="{{ $service->service_url ? '_blank' : '' }}">
                                                            <img src="{{ $service->service_icon }}" alt=""
                                                                class="object-fit-cover w-100" loading="lazy" />
                                                        </a>
                                                    </div>
                                                    <div class="card-body text-center">
                                                        <h3 class="card-title fw-4">
                                                            {{ $service->name }}</h3>
                                                        <p
                                                            class="mb-0 description-text {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}">
            ...
            @if ((isset($managesection) && $managesection['galleries']) || empty($managesection))
                @if (checkFeature('gallery') && $vcard->gallery->count())
                    <div class="gallery-section px-20 position-relative pt-50">
                        <div class="gallery-bg position-absolute vector-all">
                            <img src="{{ asset('assets/img/vcard16/gallery-bg.png') }}" class="w-100"
                                loading="lazy">
                        </div>
                        <div>
                            <div class="section-heading text-center mb-40">
                                <h2 class="text-center mb-0">{{ __('messages.plan.gallery') }}</h2>
                            </div>
                                        ...
                                        <div class="wrapper">
                                            <div class="gallery-images">
                                                ...
                                                @if ($file->type == App\Models\Gallery::TYPE_IMAGE)
                                                    <div class="gallery-img img-2 mx-auto">
                                                ...
                                                @elseif($file->type == App\Models\Gallery::TYPE_AUDIO)
                                                    <div class="audio-container">
                                                        <img src="{{ asset('assets/img/music.jpeg') }}"
                                                            alt="Album Cover" class="audio-image" height="135">
            ...
            @if ((isset($managesection) && $managesection['products']) || empty($managesection))
                @if (checkFeature('products') && $vcard->products->count())
                    <div class="product-section pt-50 px-20 position-relative">
                        <div class="position-absolute vector-5 vector-all text-end">
                            <img src="{{ asset('assets/img/vcard16/vector-8.png') }}" alt="images"
                                class="w-100" />
                        </div>
                        <div class="section-heading text-center mb-40">
                            <h2 class="text-primary text-center">{{ __('messages.plan.products') }}</h2>
                        </div>
                        <div class="mb-4">
                                    ...
                                    <div class="">
                                        <div class="product-card card">
                                            <a @if ($product->product_url) href="{{ $product->product_url }}" @endif
                                                ...
                                                <div
                                                    class="product-desc card-body d-flex align-items-center flex-column gap-2">
                                                    <div class="product-title">
                                                        <h3 class="text-gray-300 text-center fw-normal mb-0">
                                                            {{ $product->name }}</h3>
                                                    </div>
                                                    <div class="d-flex justify-content-between mt-2 product-info w-100">
                                                        <div class="product-amount text-primary  fs-18">
                                                            @if ($product->currency_id && $product->price)
                                                                <span
                                                                    class="text-dark">{{ currencyFormat($product->price, 2, $product->currency->currency_code) }}</span>
                                                            @elseif($product->price)
                                                                <span
                                                                    class="text-dark">{{ currencyFormat($product->price, 2, getUserCurrencyIcon($vcard->user->id)) }}</span>
                                                            @endif
                                                        </div>
            ...
            @if ((isset($managesection) && $managesection['whatsapp_store']) || empty($managesection))
                @if ($whatsappStore->count())
                    <div class="whatsapp-store-product-section pt-50 px-20 position-relative">
                        <div class="position-absolute vector-5 vector-all text-end">
                            <img src="{{ asset('assets/img/vcard16/vector-16.png') }}" alt="images"
                                class="w-100" />
                        </div>
                                ...
                                @foreach ($whatsappStore as $product)
                                    <div>
                                        <div class="whatsapp-store-box card">
                                            ...
                                            <div class="whatsapp-store-content card-body d-flex align-items-center flex-column gap-2"
            ...
            @if ((isset($managesection) && $managesection['testimonials']) || empty($managesection))
                @if (checkFeature('testimonials') && $vcard->testimonials->count())
                    <div class="testimonial-section pt-50 px-20 position-relative">
                        <div class="section-heading text-center mb-40">
                            <h2 class="text-center mb-0">{{ __('messages.plan.testimonials') }}</h2>
                        </div>
                                ...
                                <div class="">
                                    <div class="testimonial-card">
                                        ...
                                        <div class="card-body p-0  text-center">
                                            <h6 class="card-title mb-4 text-white">
                                                {{ ucwords($testimonial->name) }}
                                            </h6>
                                            <div class="position-relative">
                                                <div class="position-absolute quote-left">
                                                    <img src="{{ asset('assets/img/vcard16/quote-left.svg') }}"
                                                        alt="quote-left" />
                                                </div>
                                                <p
                                                    class="text-gray-300 mb-4 {{ \Illuminate\Support\Str::length($testimonial->description) > 80 ? 'more' : '' }}">
                                                    {!! $testimonial->description !!}
                                                </p>
                                                <div class="position-absolute quote-right">
                                                    <img src="{{ asset('assets/img/vcard16/quote-right.svg') }}"
                                                        alt="quote-right" />
                                                </div>
                                            </div>
            ...
            @if ((isset($managesection) && $managesection['insta_embed']) || empty($managesection))
                @if (checkFeature('insta_embed') && $vcard->instagramEmbed->count())
                    <div class="insta-section pt-50 position-relative">
                        <div class="position-absolute vector-6 vector-all text-end">
                            <img src="{{ asset('assets/img/vcard16/vector-6.png') }}" alt="images"
                                class="w-100" />
                        </div>
                        <div class="section-heading text-center mb-40">
                            <h2 class="text-primary text-center">{{ __('messages.feature.insta_embed') }}</h2>
                        </div>
                        <nav class="px-30">
            ...
            @if ((isset($managesection) && $managesection['linkedin_embed']) || empty($managesection))
                @if (checkFeature('linkedin_embed') && $vcard->linkedinEmbed->count())
                    <div class="insta-section pt-50 position-relative">
                        <div class="pt-2">
                            <div class="section-heading text-center mb-40">
                                <h2 class="text-primary text-center">{{ __('messages.feature.linkedin_embed') }}</h2>
                            </div>

                            <div class="linkedin-feed px-20">
                                <div class="row overflow-hidden m-0 mt-2 row-gap-20px" loading="lazy">
                                    <!-- "Post" content -->
            ...
            @if ((isset($managesection) && $managesection['blogs']) || empty($managesection))
                @if (checkFeature('blog') && $vcard->blogs->count())
                    <div class="blog-section pb-1 pt-50">
                        <div class="section-heading text-center mb-40">
                            <h2 class="text-primary text-center">{{ __('messages.feature.blog') }}</h2>
                        </div>
                        <div class="px-20">
                            <div class="blog-slider">
                                @foreach ($vcard->blogs as $blog)
                                    ...
                                    ?>
                                    <div class="">
                                        <div class="blog-card card  align-items-center "
                                            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                            <div class="card-img overflow-hidden">
                                                <a href="{{ $vcardBlogUrl }}">
                                                    <img src="{{ $blog->blog_icon }}" alt="profile"
                                                        class="w-100 h-100 blog-img" loading="lazy" />
                                                </a>
                                            </div>
                                            <div class="card-body w-100 text-sm-start">
                                                <a href="{{ $vcardBlogUrl }}">
                                                    <h6 class="card-title text-primary">{{ $blog->title }}</h6>
                                                </a>
                                                ...
                                                <div class="d-flex align-items-center justify-content-end">
                                                    <a href="{{ $vcardBlogUrl }}"
                                                        class="d-inline-flex align-items-center justify-content-end gap-2 read-more">
                        ...
                        <div class="blog-bg vector-all">
                            <img src="{{ asset('assets/img/vcard16/vector-14.png') }}" loading="lazy"
                                class="w-100">
                        </div>
                    </div>
                @endif
            ...
            @if ((isset($managesection) && $managesection['business_hours']) || empty($managesection))
                @if ($vcard->businessHours->count())
                    ...
                    @endphp
                    <div class="business-hour-section pt-50 mt-50 pb-30 bg-primary position-relative">
                        <div class="position-absolute vector-7 vector-all">
                            <img src="{{ asset('assets/img/vcard16/vector-7.png') }}" alt="images"
                                class="w-100" />
                        </div>
                        <div class="section-heading text-center mb-40">
                            <h2 class="text-white text-center mb-2">{{ __('messages.business.business_hours') }}</h2>
                        </div>
                        <div class="px-30">
                            <div class="bussiness-hour-card row justify-content-center row-gap-20px"
                                @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                @foreach ($businessDaysTime as $key => $dayTime)
                                    <div class="col-sm-6">
                                        <div class="days d-flex gap-2 align-items-center">
                                            ...
                                            <div>
                                                <div class="fs-14 text-decoration-underline">
                                                    {{ __('messages.business.' . \App\Models\BusinessHour::DAY_OF_WEEK[$key]) }}
                                                </div>
                                                <div class="fw-5"> {{ $dayTime ?? __('messages.common.closed') }}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        {{-- <div class="business-hour-bg vector-all text-end">
                        <img src="{{ asset('assets/img/vcard16/hour-bg-img.png') }}" class="w-100" />
                    </div> --}}
                    </div>
                @endif
            @endif
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                <div class="qr-code-section pt-50 position-relative">
                    <div class="position-absolute vector-4 vector-all">
                        <img src="{{ asset('assets/img/vcard16/vector-15.png') }}" alt="images" class="w-100" />
                    </div>
                    <div class="section-heading text-center mb-40">
                        <h2 class="text-primary text-center">{{ __('messages.vcard.qr_code') }}</h2>
                    </div>
                    <div class="px-30">
                        <div class="align-items-center flex-sm-row flex-column-reverse justify-content-center"
                            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            <div
                                class="qr-code d-flex w-100 justify-content-center position-relative ms-sm-auto mx-auto flex-wrap flex-sm-nowrap">
                ...
                @if (checkFeature('iframes') && $vcard->iframes->count())
                    <div class="iframe-section pt-50 px-20 position-relative">
                        <div class="position-absolute vector-8 vector-all text-end">
                            <img src="{{ asset('assets/img/vcard16/vector-11.png') }}" alt="images"
                                class="w-100" />
                        </div>
                        <div class="section-heading text-center mb-40">
                            <h2 class="text-center mb-0">{{ __('messages.vcard.iframe') }}</h2>
                        </div>
                        <div>
            ...
            @if ((isset($managesection) && $managesection['payment_link']) || empty($managesection))
                @if (checkFeature('payment_link') && $vcard->paymentLinks->count())
                    <div class="payment-link-section px-20 pt-50 position-relative"
                        ...
                        <div class="position-absolute vector-8 vector-all text-end">
                            <img src="{{ asset('assets/img/vcard16/vector-2.png') }}" alt="images"
                                class="w-100" />
                        </div>
                        <div class="section-heading text-center mb-40">
                            <h2 class="text-center mb-0">{{ __('messages.vcard.payment_links') }}</h2>
                        </div>
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
                <div class="contact-us-section pt-50 px-30 position-relative">
                    <div class="position-absolute vector-9 vector-all">
                        <img src="{{ asset('assets/img/vcard16/vector-16.png') }}" alt="images" class="w-100" />
                    </div>
                    <div class="section-heading text-center mb-40">
                        <h2 class="text-primary text-center">{{ __('messages.contact_us.inquries') }}</h2>
                    </div>
                    @if (getLanguage($vcard->default_language) != 'Arabic' && getLanguage($vcard->default_language) != 'Persian')
                        <div class="contact-form position-relative">
                            <form action="" id="enquiryForm" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            <textarea class="form-control h-100" rows="4" name="message"
                                        ...
                                        <div class="col-12">
                                            <div class="d-flex gap-1">
                                                ...
                                                <label class="form-check-label fs-14" for="privacyPolicyCheckbox">
                                                    <span
                                                        class="text-gray-300">{{ __('messages.vcard.agree_to_our') }}</span>
                                                    <a href="{{ $vcardPrivacyAndTerm }}" target="_blank"
                                                        class="fw-5 link-info">{!! __('messages.vcard.term_and_condition') !!}</a>
                                                    <span class="text-dark">&</span>
                                                    <a href="{{ $vcardPrivacyAndTerm }}" target="_blank"
                                                        class="fw-5 link-info">{{ __('messages.vcard.privacy_policy') }}</a>
                                                </label>
                                            </div>
                                        </div>
                                    @endif
                                    <div class="col-12 text-center mt-4">
                                        <button class="contact-btn send-btn btn-primary" type="submit">
                            ...
                            <form action="" id="enquiryForm" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 text-center mt-4 mb-2">
                                        <button class="contact-btn send-btn btn-primary w-50" type="submit">
                                            {{ __('messages.contact_us.send_message') }}
                                        </button>
                                    </div>
                                </div>
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
                <div class="create-vcard-section bg-primary mt-50 pt-50 pb-50 position-relative px-30">
                    <div class="position-absolute vector-10 vector-all text-end">
                        <img src="{{ asset('assets/img/vcard16/vector-9.png') }}" alt="images" class="w-100" />
                    </div>
                    <div class="section-heading text-center mb-40">
                        <h2 class="text-white text-center mb-2">{{ __('messages.create_vcard') }}</h2>
                    </div>
            ...
            @if ((isset($managesection) && $managesection['map']) || empty($managesection))
                @if ($vcard->location_type == 0 && ($vcard->location_url && isset($url[5])))
                    <div class="pt-50 px-30 position-relative">
                        <div class="position-absolute vector-12 vector-all">
                            <img src="{{ asset('assets/img/vcard16/vector-4.png') }}" alt="images"
                                class="w-100" />
                        </div>
                ...
                @if ($vcard->location_type == 1 && !empty($vcard->location_embed_tag))
                    <div class="px-30 pt-50 position-relative">
                        ...
                        <div class="map-section">
                            ...
                            <div class="map-location d-flex gap-2 align-items-center pt-2"
                                @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                <div class="location-icon d-flex justify-content-center align-items-center">
                    ...
                    <div class="d-inline-block" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        @if ($contactRequest == 1)
                            <a href="{{ Auth::check() ? route('add-contact', $vcard->id) : 'javascript:void(0);' }}"
                                class="vcard16-sticky-btn add-contact-btn gap-2 sticky-vcard16-div d-flex justify-content-center  align-items-center
                        ...
                        @else
                            <a href="{{ route('add-contact', $vcard->id) }}"
                                class="vcard16-sticky-btn add-contact-btn gap-2 sticky-vcard16-div d-flex justify-content-center ms-0 align-items-center px-5 text-decoration-none py-1 justify-content-center"><i
            ...
            <div class="btn-section cursor-pointer @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
                <div class="fixed-btn-section">
                    @if (empty($vcard->hide_stickybar))
                        <div
                            class="bars-btn lawyer-bars-btn @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') vcard-bars-btn-left @endif">
                            <img src="{{ asset('assets/img/vcard16/sticky.svg') }}" loading="lazy" />
                        </div>
                    @endif
                    <div class="sub-btn d-none">
                        <div class="sub-btn-div @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') sub-btn-div-left @endif">
                            ...
                            @if (empty($vcard->hide_stickybar))
                                <div
                                    class="{{ isset($vcard->whatsapp_share) ? 'vcard16-btn-group' : 'stickyIcon' }}">
                                    <button type="button"
