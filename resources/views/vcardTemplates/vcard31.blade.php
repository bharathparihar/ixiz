...
<head>
    ...
    {{-- css link --}}
    <link rel="stylesheet" href="{{ mix('assets/css/vcard31.css') }}">
...
<body>
        ...
        <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
                        ...
                        <div>
                            ...
                            <div class="text-end d-flex">
                                <button id="installPwaBtn"
                                    class="pwa-install-button btn-primary w-50 mb-1 btn">{{ __('messages.pwa.install') }}
                                </button>
                                <button
                    ...
                    <div class="support-banner d-flex align-items-center justify-content-center">
                        ...
                        <div class="">
                            ...
                            <div class="text-center mt-3">
                                <a href="{{ $banners->url }}" class="act-now btn-primary" target="_blank"
            ...
            <div class="profile-section pt-50 px-30 position-relative">
                <div class="profile-bg-img">
                    <img src="{{ asset('assets/img/vcard31/main-profile-bg-img.png') }}" alt="bg-img" />
                </div>
                <div class="card d-flex flex-column flex-sm-row align-items-center gap-3 gap-sm-4">
                    <div class="card-img position-relative">
                        <img src="{{ $vcard->profile_url }}" class="w-100 h-100 object-fit-cover" loading="lazy" />
                    </div>
                    <div class="card-body p-0">
                        <div
                            class="profile-name text-center @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') text-sm-end @else text-sm-start @endif">
                            <h3 class=" mb-0 fs-28">
                            ...
                            <p class="text-primary mb-1 fs-16 company-name d-inline-block">
                                {{ ucwords($vcard->company) }}</p>
                            <p class="text-gray-200 fs-14 mb-0">{{ ucwords($vcard->occupation) }}</p>
                            <p class="text-gray-200 fs-14 mb-0">{{ ucwords($vcard->job_title) }}</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="fs-14 text-secondary text-center profile-desc pt-40 px-30 position-relative">
                <div class="vector-img img-1">
                    <img src="{{ asset('assets/img/vcard31/vector-img1.png') }}" alt="bg-img" />
                </div>
                {!! $vcard->description !!}
            </div>
            {{-- social-media --}}
            @if (checkFeature('social_links') && getSocialLink($vcard))
                <div class="social-media d-flex flex-wrap pt-40 px-30">
                    <div
                        class="social-icons d-flex justify-content-center text-decoration-none flex-wrap text-primary bg-gray-100 rounded-pill w-100">
            ...
            @if (checkFeature('custom-links') && $customLink->isNotEmpty())
                <div class="custom-link-section position-relative">
                    <div class="vector-img img-2 text-end">
                        <img src="{{ asset('assets/img/vcard31/vector-img2.png') }}" alt="bg-img" />
                    </div>
                    <div class="custom-link d-flex flex-wrap justify-content-center pt-50 w-100 gap-3">
            ...
            @if ((isset($managesection) && $managesection['contact_list']) || empty($managesection))
                @if (
                    ...
                    <div class="pt-50">
                        <div class="contact-section pt-40 pb-40 px-30 bg-light position-relative">
                            <div class="vector-all-right position-absolute">
                                <img src="{{ asset('assets/img/vcard31/vector-all-img.png') }}" alt="bg-img"
                                    class="w-100 h-100 object-fit-cover" />
                            </div>
                            <div class="vector-img img-3">
                                <img src="{{ asset('assets/img/vcard31/vector-img3.png') }}" alt="bg-img" />
                            </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="contact-box d-flex align-items-center">
                                                <div
                                                    ...
                                                    <img src="{{ asset('assets/img/vcard31/email.svg') }}" />
                                                </div>
                                                <div class="contact-desc">
                                                    <a href="mailto:{{ $vcard->email }}"
                                                        class="text-white fs-14 fw-5 word-wrap">{{ $vcard->email }}</a>
                                                </div>
                                            </div>
                                        </div>
                                    @endif
                                            ...
                                            <div class="contact-box d-flex align-items-center">
                                                ...
                                                <div class="contact-desc">
                                                    <a href="mailto:{{ $vcard->alternative_email }}"
                                                        class="text-white fs-14 fw-5 word-wrap">{{ $vcard->alternative_email }}</a>
                                                </div>
                                            </div>
                                        </div>
                                    @endif
                                    @if ($vcard->phone)
                                        <div class="col-sm-6">
                                            <div class="contact-box d-flex align-items-center">
                                                <div
                                                    class="contact-icon d-flex justify-content-center align-items-center">
                                                    <img src="{{ asset('assets/img/vcard31/phone.svg') }}" />
                                                </div>
                                                <div class="contact-desc">
                                    ...
                                    @if ($vcard->dob)
                                        <div class="col-sm-6">
                                            <div class="contact-box d-flex align-items-center">
                                                <div
                                                    class="contact-icon d-flex justify-content-center align-items-center">
                                                    <img src="{{ asset('assets/img/vcard31/dob.svg') }}" />
                                                </div>
                                                <div class="contact-desc">
                                    ...
                                    @if ($vcard->location)
                                        <div class="col-sm-6">
                                            <div class="contact-box d-flex align-items-center">
                                                <div
                                                    class="contact-icon d-flex justify-content-center align-items-center">
                                                    <img src="{{ asset('assets/img/vcard31/location.svg') }}" />
                                                </div>
                                                <div class="contact-desc">
            ...
            @if ((isset($managesection) && $managesection['services']) || empty($managesection))
                @if (checkFeature('services') && $vcard->services->count())
                    <div class="our-services-section pt-50">
                        ...
                        <div class="vector-img img-4 text-end">
                            <img src="{{ asset('assets/img/vcard31/vector-img4.png') }}" alt="bg-img" />
                        </div>
                        <div class="section-heading">
                                            ...
                                            <div>
                                                <div class="service-card h-100">
                                                    ...
                                                    <div class="card-body text-center">
                                                        ...
                                                        <p
                                                            class="mb-0 description-text text-gray-100 {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}">
            ...
            @if ((isset($managesection) && $managesection['appointments']) || empty($managesection))
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="appointment-section pt-50 px-30 position-relative">
                        ...
                        <div class="vector-img img-5">
                            <img src="{{ asset('assets/img/vcard31/vector-img5.png') }}" alt="bg-img" />
                        </div>
                        <div class="section-heading">
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-12">
                                        ...
                                        <div class=text-center d-flex justify-content-center>
                                            <button
                                                class="appointmentAdd btn btn-primary w-100 position-relative d-none">
            ...
            @if ((isset($managesection) && $managesection['galleries']) || empty($managesection))
                @if (checkFeature('gallery') && $vcard->gallery->count())
                    <div class="gallery-section position-relative pt-50 px-20">
                        <div class="vector-all-left position-absolute">
                            <img src="{{ asset('assets/img/vcard31/vector-all-img.png') }}" alt="bg-img"
                                class="w-100 h-100 object-fit-cover" />
                        </div>
                        <div class="vector-img img-6 text-end">
                            <img src="{{ asset('assets/img/vcard31/vector-img6.png') }}" alt="bg-img" />
                        </div>
                        <div class="section-heading">
            ...
            @if ((isset($managesection) && $managesection['products']) || empty($managesection))
                @if (checkFeature('products') && $vcard->products->count())
                    <div class="product-section position-elative pt-50 px-20">
                        <div class="vector-all-right position-absolute">
                            <img src="{{ asset('assets/img/vcard31/vector-all-img.png') }}" alt="bg-img"
                                class="w-100 h-100 object-fit-cover" />
                        </div>
                        <div class="vector-img img-7">
                            <img src="{{ asset('assets/img/vcard31/vector-img7.png') }}" alt="bg-img" />
                        </div>
                        <div class="section-heading">
                        ...
                        <div class="">
                            <div class="product-slider">
                                @foreach ($vcard->products as $product)
                                    <div class="">
                                        <div class="product-card card justify-content-end">
                                            <a @if ($product->product_url) href="{{ $product->product_url }}" @endif
                                                ...
                                                <div class="product-desc text-center desc-div">
                                                    <h3 class="text-gray-100 fw-5 mb-2 product-title">
                                                        {{ $product->name }}</h3>
                                                    <div class="d-flex justify-content-between mt-2 product-info">
                                                        <h4 class="text-center text-primary mb-0">
                                                            @if ($product->currency_id && $product->price)
                                                                <span
                                                                    class="fs-18 fw-6 text-primary product-amount">{{ currencyFormat($product->price, 2, $product->currency->currency_code) }}</span>
                                                            @elseif($product->price)
                                                                <span
                                                                    class="fs-18 fw-6 text-primary product-amount">{{ currencyFormat($product->price, 2, getUserCurrencyIcon($vcard->user->id)) }}</span>
                                                            @endif
                                                        </h4>
                        ...
                        <div class="mt-5 text-center">
                            <a class="view-more d-inline-flex gap-2 align-items-center"
            ...
            @if ((isset($managesection) && $managesection['whatsapp_store']) || empty($managesection))
                @if ($whatsappStore->count())
                    <div class="whatsapp-store-product-section position-relative pt-50 px-20">
                        ...
                        <div class="vector-img img-7">
                            <img src="{{ asset('assets/img/vcard31/vector-img15.png') }}" alt="bg-img" />
                        </div>
                        ...
                        <div>
                            <div class="whatsapp-store-slider">
                                @foreach ($whatsappStore as $product)
                                    <div>
                                        <div class="whatsapp-store-box card justify-content-end">
                                            ...
                                            <div class="whatsapp-store-content text-center desc-div"
                                                @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>

                                                <h3 class="text-gray-100 fw-5 mb-2 whatsapp-store-name">
                                                    {{ $product->store_name }}
                                                </h3>
            ...
            @if ((isset($managesection) && $managesection['testimonials']) || empty($managesection))
                @if (checkFeature('testimonials') && $vcard->testimonials->count())
                    <div class="pt-50">
                        <div class="testimonial-section position-relative pt-40 pb-40 px-20 bg-light">
                            <div class="vector-all-left position-absolute">
                                <img src="{{ asset('assets/img/vcard31/vector-all-img.png') }}" alt="bg-img"
                                    class="w-100 h-100 object-fit-cover" />
                            </div>
                            <div class="vector-img img-8 text-end">
                                <img src="{{ asset('assets/img/vcard31/vector-img8.png') }}" alt="bg-img" />
                            </div>
                            <div class="section-heading">
                                    ...
                                    <div>
                                        <div class="testimonial-card card">
                                            ...
                                            <div class="card-body p-0 text-center">
                                                <h3 class="text-white text-decoration-underline">
                                                    {{ ucwords($testimonial->name) }}
                                                </h3>
                                                <div class="quote-img text-center mb-3">
                                                    <img src="{{ asset('assets/img/vcard31/quote-img.svg') }}"
                                                        class="mx-auto" />
                                                </div>
                                                <p
            ...
            @if ((isset($managesection) && $managesection['insta_embed']) || empty($managesection))
                @if (checkFeature('insta_embed') && $vcard->instagramEmbed->count())
                    <div class="pt-50 px-30 position-relative">
                        ...
                        <div class="vector-img img-9">
                            <img src="{{ asset('assets/img/vcard31/vector-img9.png') }}" alt="bg-img" />
                        </div>
                        <div class="section-heading">
                    ...
                    <div id="postContent" class="insta-feed">
                        <div class="row overflow-hidden m-0 mt-3 px-20 row-gap-20px" loading="lazy">
                            <!-- "Post" content -->
                    ...
                    <div class="d-none insta-feed" id="reelContent">
                        <div class="row overflow-hidden m-0 mt-3 px-20 row-gap-20px">
                            <!-- "Reel" content -->
                            @foreach ($vcard->InstagramEmbed as $InstagramEmbed)
            ...
            @if ((isset($managesection) && $managesection['blogs']) || empty($managesection))
                @if (checkFeature('blog') && $vcard->blogs->count())
                    <div class="blog-section position-relative pt-50 px-20">
                        ...
                        <div class="vector-img img-10 text-end">
                            <img src="{{ asset('assets/img/vcard31/vector-img10.png') }}" alt="bg-img" />
                        </div>
                        <div class="section-heading">
                                    ...
                                    <div class="blog-card">
                                        ...
                                        <div class="card-body">
                                            <div class="text-start">
                                                <h3 class="text-primary fw-5 mb-1 blog-head">
                                                    {{ $blog->title }}
                                                </h3>
                                                <p class="mb-0 text-gray-100 blog-desc">
                                                ...
                                                <div class="mt-1 d-flex align-items-center justify-content-end"
                                                    @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                                    <a href="{{ $vcardBlogUrl }}"
                                                        class="d-inline-flex align-items-center justify-content-end gap-2 fs-14 read-more text-white">
            ...
            @if ((isset($managesection) && $managesection['business_hours']) || empty($managesection))
                @if ($vcard->businessHours->count())
                    ...
                    <div class="business-hour-section pt-50 position-relative">
                        <div class="business-hour-bg pt-40 pb-40 px-30 bg-light position-relative">
                            <div class="vector-all-right position-absolute">
                                <img src="{{ asset('assets/img/vcard31/vector-all-img.png') }}" alt="bg-img"
                                    class="w-100 h-100 object-fit-cover" />
                            </div>
                            <div class="vector-img img-11">
                                <img src="{{ asset('assets/img/vcard31/vector-img11.png') }}" alt="bg-img" />
                            </div>
                                ...
                                <div @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                    <div class="row justify-content-center">
                                        ...
                                        @foreach ($businessDaysTime as $key => $dayTime)
                                            <div class="col-sm-6 px-sm-2 mb-3">
                                                <div class="hour d-flex align-items-center">
                                                    <div class="time-icon">
                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                            class="icon icon-tabler icon-tabler-calendar-time text-primary"
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                <div class="qr-code-section pt-50 px-30 position-relative">
                    ...
                    <div class="vector-img img-12 text-end">
                        <img src="{{ asset('assets/img/vcard31/vector-img12.png') }}" alt="bg-img" />
                    </div>
                    <div class="section-heading">
                        ...
                        <div class="qr-code mx-auto position-relative">
                            <div class="d-flex flex-sm-row flex-column gap-3 align-items-center"
                                ...
                                <div class="text-sm-start text-center">
                                    <h5 class="fw-6 text-white">{{ __('messages.vcard.scan_to_contact') }}</h5>
                ...
                @if (checkFeature('iframes') && $vcard->iframes->count())
                    <div class="iframe-section pt-50 px-20 position-relative">
                        ...
                        <div class="vector-img img-13">
                            <img src="{{ asset('assets/img/vcard31/vector-img13.png') }}" alt="bg-img" />
                        </div>
                        <div class="section-heading ">
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
                <div class="contact-us-section position-relative pt-50 px-30">
                    ...
                    <div class="vector-img img-14 text-end">
                        <img src="{{ asset('assets/img/vcard31/vector-img14.png') }}" alt="bg-img" />
                    </div>
                    <div class="section-heading">
                                        ...
                                        <div class="mb-3">
                                            <div class="wrapper-file-input">
                                                <div class="input-box" id="fileInputTrigger">
                                                    ...
                                                    class="text-gray-100">{{ __('messages.file_supported') }}</small>
                                            </div>
                                    ...
                                    @if (!empty($vcard->privacy_policy) || !empty($vcard->term_condition))
                                        <div class="col-12 mb-4 d-flex gap-2">
                                            <input type="checkbox" name="terms_condition"
                                                ...
                                                placeholder>&nbsp;
                                            <label class="fs-14 form-check-label" for="privacyPolicyCheckbox">
                                                <span
                                                    class="text-gray-100">{{ __('messages.vcard.agree_to_our') }}</span>
                                                <a href="{{ $vcardPrivacyAndTerm }}" target="_blank"
                                                    class="link-info fs-14 fw-5 text-decoration-underline text-white">{!! __('messages.vcard.term_and_condition') !!}</a>
                                                <span class="text-gray-100">&</span>
                                                <a href="{{ $vcardPrivacyAndTerm }}" target="_blank"
                                                    class="link-info fs-14 fw-5 text-decoration-underline text-white">{{ __('messages.vcard.privacy_policy') }}</a>
                                            </label>
                                        </div>
                                    @endif
                                        ...
                                        <div class="col-12 mb-4 d-flex gap-2">
                                            ...
                                            <label class="form-check-label" for="privacyPolicyCheckbox">
                                                <span
                                                    class="text-gray-100">{{ __('messages.vcard.agree_to_our') }}</span>
                                                <a href="{{ $vcardPrivacyAndTerm }}" target="_blank"
                                                    class="text-decoration-underline text-white fs-14 fw-5 link-info">{!! __('messages.vcard.term_and_condition') !!}</a>
                                                <span class="text-gray-100">&</span>
                                                <a href="{{ $vcardPrivacyAndTerm }}" target="_blank"
                                                    class="text-decoration-underline text-white fs-14 fw-5 link-info">{{ __('messages.vcard.privacy_policy') }}</a>
                                            </label>
                                        </div>
                                    @endif
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
                <div class="create-vcard-section position-relative pt-50 px-30">
                    <div class="vector-all-right position-absolute">
                        <img src="{{ asset('assets/img/vcard31/vector-all-img.png') }}" alt="bg-img"
                            class="w-100 h-100 object-fit-cover" />
                    </div>
                    <div class="vector-img img-15">
                        <img src="{{ asset('assets/img/vcard31/vector-img15.png') }}" alt="bg-img" />
                    </div>
                    <div class="section-heading">
                    ...
                    <div class="vcard-link-card card">
                        <div class="d-flex align-items-center gap-3 justify-content-center"
                            ...
                            <a href="{{ config('app.url') . '/register?referral-code=' . $vcard->user->affiliate_code }}"
                                class="text-primary link-text fw-normal">{{ route('register', ['referral-code' => $vcard->user->affiliate_code]) }}</a>
            ...
            @if ((isset($managesection) && $managesection['map']) || empty($managesection))
                @if ($vcard->location_type == 0 && ($vcard->location_url && isset($url[5])))
                    <div class="pt-50 px-30 position-relative">
                        <div class="vector-img img-16 text-end">
                            <img src="{{ asset('assets/img/vcard31/vector-img16.png') }}" alt="bg-img" />
                        </div>
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="26"
                                        ...
                                        <defs>
                                            <clipPath id="clip0_1803_1106">
                                                <rect width="20" height="26" fill="#da242b" />
                                            </clipPath>
                                        </defs>
                                    </svg>
                                </div>
                                <p class="text-white fw-5  mb-0">{!! ucwords($vcard->location) !!}</p>
                            </div>
                            <div class="map">
                    ...
                    <div class="text-center d-flex align-items-center justify-content-center"
                        ...
                        @if ($contactRequest == 1)
                            <a href="{{ Auth::check() ? route('add-contact', $vcard->id) : 'javascript:void(0);' }}"
                                class="add-contact-btn btn btn-primary gap-2 d-flex justify-content-center align-items-center {{ Auth::check() ? 'auth-contact-btn' : 'ask-contact-detail-form' }}"
                        ...
                        @else
                            <a href="{{ route('add-contact', $vcard->id) }}"
                                class="add-contact-btn rounded-2 btn-primary gap-2 d-flex justify-content-center align-items-center"><i
            ...
            <div class="d-flex justify-content-evenly pt-4 pb-2">
                ...
                @if (!empty($vcard->privacy_policy) || !empty($vcard->term_condition))
                    <div>
                        <a class="text-decoration-none text-primary fw-5 fs-14 cursor-pointer terms-policies-btn"
            ...
            <div class="btn-section cursor-pointer  @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
                <div class="fixed-btn-section">
                    @if (empty($vcard->hide_stickybar))
                        <div
                            class="bars-btn handyman-bars-btn @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') vcard-bars-btn-left @endif">
                            <img src="{{ asset('assets/img/vcard31/sticky.svg') }}" />
                        </div>
                    @endif
                    <div class="sub-btn d-none">
                        <div class="sub-btn-div @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') sub-btn-div-left @endif">
                                ...
                                <div class="icon-search-container mb-3" data-ic-class="search-trigger">
                                    ...
                                    <div class="share-wp-btn-div">
                                        <a href="javascript:void(0)"
                                            class="vcard31-sticky-btn vcard31-btn-group d-flex justify-content-center text-primary align-items-center rounded-0 text-decoration-none py-1 rounded-pill justify-content share-wp-btn">
                            ...
                            @if (empty($vcard->hide_stickybar))
                                <div
                                    class="{{ isset($vcard->whatsapp_share) ? 'vcard31-btn-group' : 'stickyIcon' }}">
                                    <button type="button"
                                        class="vcard31-btn-group vcard31-share vcard31-sticky-btn mb-3 px-2 py-1"><i
                                            class="fas fa-share-alt fs-4 pt-1"></i></button>
                                    @if (!empty($vcard->enable_download_qr_code))
                                        <a type="button"
                                            class="vcard31-btn-group vcard31-sticky-btn d-flex justify-content-center  align-items-center  px-2 mb-3 py-2"
    ...
    @endif
    {{-- share modal code --}}
    <div id="vcard31-shareModel" class="modal fade" role="dialog">
