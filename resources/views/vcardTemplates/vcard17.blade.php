...
<head>
    ...
    @endif
    <meta property="og:image" content="{{ $vcard->cover_type == App\Models\Vcard::VIDEO || $vcard->cover_type == App\Models\Vcard::YOUTUBE_link ? $vcard->profile_url : $vcard->cover_url }}" />
    ...
    {{-- css link --}}
    <link rel="stylesheet" href="{{ mix('assets/css/vcard17.css') }}">
    ...
    <div class="container p-0">
        ...
        <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
                        ...
                        <div>
                            ...
                            <div class="text-end d-flex gap-2">
                                <button id="installPwaBtn"
                                    class="pwa-install-button w-50 mb-1 btn btn-gradient">{{ __('messages.pwa.install') }}
                                </button>
                                <button
                ...
                @if (isset($banners->title))
                    <div class="support-banner d-flex align-items-center justify-content-center">
                        ...
                        <div class="text-center">
                            ...
                            <div class="text-center">
                                <a href="{{ $banners->url }}" class="act-now btn btn-gradient" target="_blank"
                ...
                <div>
                    ...
                    @elseif($vcard->cover_type == 1)
                        @if (strpos($vcard->cover_url, '.mp4') !== false ||
                            ...
                            <video class="cover-video {{ $coverClass }}" autoplay loop muted playsinline
            ...
            <div class="profile-section pt-50 px-30 position-relative">
                <div class="bg-vector vector-1">
                    <img src="{{ asset('assets/img/vcard17/bg-vector-1.svg') }}" alt="bg-vector" />
                </div>
                <div class="card flex-sm-row align-items-center">
                    <div class="profile-card-bg h-100">
                        <img src="{{ asset('assets/img/vcard17/profile-card-bg.png') }}"
                            class="h-100 obeject-fit-cover" />
                    </div>
                    ...
                    <div class="card-body text-sm-start text-center pt-1 pt-sm-3">
                        <div class="profile-name">
                            <h4 class="text-white fs-24 mb-0 fw-bold">
                                {{ ucwords($vcard->first_name . ' ' . $vcard->last_name) }}
                                @if ($vcard->is_verified)
                                    <i class="verification-icon bi-patch-check-fill"></i>
                                @endif
                            </h4>
                            <p class="fs-18 animatedText mb-0 fw-5"></p>
                            <p class="fs-14 text-white mb-0 fw-5">{{ ucwords($vcard->occupation) }}</p>
                            <p class="fs-14 text-white mb-0 fw-5">{{ ucwords($vcard->job_title) }}</p>
                        </div>
                    </div>
                </div>
                {{-- social media icon --}}
            ...
            @if (checkFeature('social_links') && getSocialLink($vcard))
                <div class="vcard-seventeen__social social-media pt-50 px-30 position-relative">
                    <div class="social-media-icons d-flex justify-content-center  flex-wrap">
            ...
            @if (checkFeature('custom-links') && $customLink->isNotEmpty())
                <div class="custom-link-section position-relative">
                    <div class="bg-vector vector-15 text-end">
                        <img src="{{ asset('assets/img/vcard17/bg-vector-15.png') }}" alt="bg-vector" />
                    </div>
                    <div class="custom-link d-flex flex-wrap justify-content-center pt-50 px-30 w-100 ">
            ...
            <div class="position-relative">
                <div class="bg-vector vector-16">
                    <img src="{{ asset('assets/img/vcard17/bg-vector-16.png') }}" alt="bg-vector" />
                </div>
                ...
                @if (
                    ...
                    <div class="contact-section pt-50 pb-50 mt-50 px-30 position-relative">
                        <div class="bg-vector vector-2 text-end">
                            <img src="{{ asset('assets/img/vcard17/bg-vector-2.svg') }}" alt="bg-vector" />
                        </div>
                        <div class="overlay"></div>
                        <div class="section-heading text-center mb-40">
                            <h2>Contacts</h2>
                        </div>
                        <div class="row row-gap-20" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            @if ($vcard->email)
                                <div class="col-sm-6">
                                    <div class="contact-box">
                                        <div class="contact-icon d-flex justify-content-center align-items-center">
                                            <img src="{{ asset('assets/img/vcard17/email.svg') }}" />
                                        </div>
                                        <div class="contact-desc">
                                            <a href="mailto:{{ $vcard->email }}"
                                                class="text-white fs-14 fw-5">{{ $vcard->email }}</a>
                                        </div>
                                    </div>
                                </div>
                            @endif
                                    ...
                                    <div class="contact-box">
                                        ...
                                        <div class="contact-desc">
                                            <a href="mailto:{{ $vcard->alternative_email }}"
                                                class="text-white fs-14 fw-5">{{ $vcard->alternative_email }}</a>
                                        </div>
                                    </div>
                                </div>
                            @endif
                            @if ($vcard->phone)
                                <div class="col-sm-6">
                                    <div class="contact-box">
                                        <div class="contact-icon d-flex justify-content-center align-items-center">
                                            <img src="{{ asset('assets/img/vcard17/phone.svg') }}" />
                                        </div>
                                        <div class="contact-desc">
                                            <a href="tel:+{{ $vcard->region_code }}{{ $vcard->phone }}"
                                                class="text-white fs-14 fw-5"
                            ...
                            @if ($vcard->dob)
                                <div class="col-sm-6">
                                    <div class="contact-box">
                                        <div class="contact-icon d-flex justify-content-center align-items-center">
                                            <img src="{{ asset('assets/img/vcard17/dob.svg') }}" />
                                        </div>
                                        <div class="contact-desc">
                                            <p class="text-white fs-14 fw-5 mb-0">
                                                {{ $vcard->dob }}</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            @if ($vcard->location)
                                <div class="col-sm-6">
                                    <div class="contact-box">
                                        <div class="contact-icon d-flex justify-content-center align-items-center">
                                            <img src="{{ asset('assets/img/vcard17/location.svg') }}" />
                                        </div>
                                        <div class="contact-desc">
                                            <p class="text-white fs-14 fw-5 mb-0">{!! ucwords($vcard->location) !!}</p>
                                        </div>
                                    </div>
                                </div>
                            @endif
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                <div class="qr-code-section pt-50 px-30 position-relative">
                    <div class="bg-vector vector-3">
                        <img src="{{ asset('assets/img/vcard17/bg-vector-3.svg') }}" alt="bg-vector" />
                    </div>
                    <div class="bg-vector vector-17 text-end">
                        <img src="{{ asset('assets/img/vcard17/bg-vector-17.png') }}" alt="bg-vector" />
                    </div>
                    <div class="section-heading text-center mb-40">
                        <h2>{{ __('messages.vcard.qr_code') }}</h2>
                    </div>
                    <div class="qr-code mx-auto d-flex flex-sm-row flex-column  position-relative z-1 align-items-center"
                        @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        <div class="qr-code-img text-center" id="qr-code-seventeen">
                        ...
                        <div
                            class=" text-center desc-text @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') text-sm-end @else text-sm-start @endif">
                            <h5 class="fw-6 text-gradient">{{ __('messages.vcard.scan_to_contact') }}</h5>
                            <p class="fs-14 text-white mb-0">{{ __('messages.vcard.qr_section_desc') }}</p>
                        </div>
                ...
                @if (checkFeature('services') && $vcard->services->count())
                    <div class="our-services-section pt-50 position-relative">
                        <div class="bg-vector vector-4 text-end">
                            <img src="{{ asset('assets/img/vcard17/bg-vector-4.svg') }}" alt="bg-vector" />
                        </div>
                        <div class="section-heading text-center mb-40">
                                            ...
                                            <div class="service-card">
                                                ...
                                                <div class="card-body text-center">
                                                    <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
                                                        ...
                                                        target="{{ $service->service_url ? '_blank' : '' }}">
                                                        <h5 class="card-title title-text text-center text-gradient">
                                                            {{ ucwords($service->name) }}</h5>
                                                    </a>
                                                    <p
                                                        class="card-text description-text text-center text-white mb-0 {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}">
                                    ...
                                    <div class="row">
                                        @foreach ($vcard->services as $service)
                                            <div class="col-sm-6 mb-40">
                                                <div class="service-card d-flex flex-column align-items-center gap-2"
                                                    @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                                    <div
                                                    ...
                                                    <div class="card-body text-center">
                                                        <h3 class="card-title fs-18 text-gradient text-center">
                                                            {{ ucwords($service->name) }}
                                                        </h3>
                                                        <p
                                                            class="mb-0 text-white text-center {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}">
            ...
            @if ((isset($managesection) && $managesection['galleries']) || empty($managesection))
                @if (checkFeature('gallery') && $vcard->gallery->count())
                    <div class="gallery-section pt-50 pb-50 mt-50 px-20 position-relative">
                        <div class="bg-vector vector-5">
                            <img src="{{ asset('assets/img/vcard17/bg-vector-5.svg') }}" alt="bg-vector" />
                        </div>
                        <div class="bg-vector vector-18 text-end">
                            <img src="{{ asset('assets/img/vcard17/bg-vector-18.png') }}" alt="bg-vector" />
                        </div>
                        <div class="section-heading text-center mb-40">
                                        ...
                                        <div class="gallery-img-wrapper">
                                            <div class="gallery-img">
                                                ...
                                                @elseif($file->type == App\Models\Gallery::TYPE_VIDEO)
                                                    <div class="d-flex align-items-center video-container bg-white ">
            ...
            @if ((isset($managesection) && $managesection['products']) || empty($managesection))
                @if (checkFeature('products') && $vcard->products->count())
                    <div class="product-section pt-50 position-relative">
                        <div class="bg-vector vector-6 text-end">
                            <img src="{{ asset('assets/img/vcard17/bg-vector-6.svg') }}" alt="bg-vector" />
                        </div>
                        <div class="bg-vector vector-19">
                            <img src="{{ asset('assets/img/vcard17/bg-vector-19.png') }}" alt="bg-vector" />
                        </div>
                        <div class="section-heading text-center mb-40">
                                    ...
                                    <a @if ($product->product_url) href="{{ $product->product_url }}" @endif
                                        ...
                                        <div class="card product-card">
                                            ...
                                            <div
                                                ...
                                                <h3 class="product-title text-white fw-5 text-center">
                                                    {{ $product->name }}</h3>
                                                <div class="d-flex justify-content-between mt-2 product-info w-100">
                                                    <div class="product-amount">
                                                        @if ($product->currency_id && $product->price)
                                                            <span
                                                                class="fw-5 text-gradient amount text-center">{{ currencyFormat($product->price, 2, $product->currency->currency_code) }}</span>
                                                        @elseif($product->price)
                                                            <span
                                                                class="fw-5 text-gradient amount text-center">{{ currencyFormat($product->price, 2, getUserCurrencyIcon($vcard->user->id)) }}</span>
                                                        @endif
                                                    </div>
                        ...
                        <div class="mx-auto text-center mt-5">
                            <a class="mb-0 text-decoration-underline btn btn-gradient view-more"
                                href="{{ $vcardProductUrl }}">{{ __('messages.analytics.view_more') }}
                                <i class="fa-solid fa-arrow-right-long right-arrow-animation ms-2"></i></a>
                            </a>
                        </div>
                    </div>
                @endif
            ...
            @if ((isset($managesection) && $managesection['whatsapp_store']) || empty($managesection))
                @if ($whatsappStore->count())
                    <div class="whatsapp-store-product-section pt-50 position-relative">

                        <div class="bg-vector vector-6 text-end">
                            <img src="{{ asset('assets/img/vcard17/bg-vector-26.png') }}" alt="bg-vector" />
                        </div>
                        ...
                        <div class="whatsapp-store-slider">
                            @foreach ($whatsappStore as $product)
                                <div>
                                    <div class="card whatsapp-store-box">
                                        ...
                                        <div class="whatsapp-store-content card-body d-flex flex-column justify-content-center align-items-center"
                                            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>

                                            <h3 class="whatsapp-store-name text-white fw-5 text-center">
                                                {{ $product->store_name }}
                                            </h3>
            ...
            @if ((isset($managesection) && $managesection['testimonials']) || empty($managesection))
                @if (checkFeature('testimonials') && $vcard->testimonials->count())
                    <div class="testimonial-section pt-50 pb-50 mt-50 px-20 position-relative">
                        <div class="bg-vector vector-7">
                            <img src="{{ asset('assets/img/vcard17/bg-vector-7.svg') }}" alt="bg-vector" />
                        </div>
                        <div class="bg-vector vector-23 text-end">
                            <img src="{{ asset('assets/img/vcard17/bg-vector-23.png') }}" alt="bg-vector" />
                        </div>
                        <div class="overlay"></div>
                        ...
                        <div class="testimonial-slider">
                            @foreach ($vcard->testimonials as $testimonial)
                                <div>
                                    <div class="card flex-sm-row align-items-center position-relative">
                                        <div class="quote-img quote-left-img">
                                            <img src="{{ asset('assets/img/vcard17/quote-left-img.svg') }}"
                                                loading="lazy" />
                                        </div>
                                        <div class="quote-img quote-right-img">
                                            <img src="{{ asset('assets/img/vcard17/quote-right-img.svg') }}"
                                                loading="lazy" />
                                        </div>
                                        <div class="card-img">
                                        ...
                                        <div class="card-body text-center">
                                            <div class="testimonial-desc">
                                                <h3 class="text-gradient fw-6">{{ ucwords($testimonial->name) }}</h3>
                                                <p
                                                    class="text-white mb-0 {{ \Illuminate\Support\Str::length($testimonial->description) > 80 ? 'more' : '' }}">
            ...
            @if ((isset($managesection) && $managesection['insta_embed']) || empty($managesection))
                @if (checkFeature('insta_embed') && $vcard->instagramEmbed->count())
                    <div class="insta-feed-section pt-50 px-20 position-relative">
                        <div class="bg-vector vector-8 text-end">
                            <img src="{{ asset('assets/img/vcard17/bg-vector-8.svg') }}" alt="bg-vector" />
                        </div>
                        <div class="bg-vector vector-22">
                            <img src="{{ asset('assets/img/vcard17/bg-vector-22.png') }}" alt="bg-vector" />
                        </div>
                        <div class="section-heading text-center mb-40">
                            <h2>{{ __('messages.feature.insta_embed') }}</h2>
                        </div>
                        <nav>
                            <div class="row insta-toggle mx-0">
                                <div class="nav nav-tabs border-0" id="nav-tab" role="tablist">
                                    <button
                                        class="d-flex align-items-center justify-content-center py-2 active postbtn instagram-btn border-0 text-white"
                                    ...
                                    <button
                                        class="d-flex align-items-center justify-content-center py-2 instagram-btn reelsbtn border-0 text-white"
                        ...
                        <div id="postContent" class="insta-feed">
                            <div class="row overflow-hidden m-0 mt-4" loading="lazy">
                                <!-- "Post" content -->
                                @foreach ($vcard->InstagramEmbed as $InstagramEmbed)
                                    @if ($InstagramEmbed->type == 0)
                                        <div class="col-12 col-sm-6">
                                            <div class="insta-feed-iframe">
                        ...
                        <div class="d-none insta-feed" id="reelContent">
                            <div class="row overflow-hidden m-0 mt-4">
                                <!-- "Reel" content -->
                                @foreach ($vcard->InstagramEmbed as $InstagramEmbed)
            ...
            @if ((isset($managesection) && $managesection['blogs']) || empty($managesection))
                @if (checkFeature('blog') && $vcard->blogs->count())
                    <div class="blog-section px-20 pt-50 pb-50 mt-50 position-reelative">
                        <div class="bg-vector vector-9">
                            <img src="{{ asset('assets/img/vcard17/bg-vector-9.svg') }}" alt="bg-vector" />
                        </div>
                        <div class="bg-vector vector-20 text-end">
                            <img src="{{ asset('assets/img/vcard17/bg-vector-20.png') }}" alt="bg-vector" />
                        </div>
                        <div class="section-heading text-center mb-40">
                                ...
                                <div>
                                    <div class="blog-card-wrapper">
                                        <div class="blog-card card">
                                            ...
                                            <div class="card-body">
                                                <h2 class="fs-18 fw-5 text-gradient blog-title">
                                                    {{ $blog->title }}
                                                </h2>
            ...
            @if ((isset($managesection) && $managesection['business_hours']) || empty($managesection))
                @if ($vcard->businessHours->count())
                    ...
                    <div class="business-hour-section pt-50 position-relative"
                        @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        <div class="bg-vector vector-10 text-end">
                            <img src="{{ asset('assets/img/vcard17/bg-vector-10.svg') }}" alt="bg-vector" />
                        </div>

                        <div class="bg-vector vector-21">
                            <img src="{{ asset('assets/img/vcard17/bg-vector-21.png') }}" alt="bg-vector" />
                        </div>
                        <div class="section-heading text-center mb-40">
                            <h2>{{ __('messages.business.business_hours') }}</h2>
                        </div>
                        <div class="business-hour-card pt-50 pb-50 px-30">
                            <div class="overlay"></div>
                            <div class="row row-gap-20 justify-content-center">
                                ...
                                @foreach ($businessDaysTime as $key => $dayTime)
                                    <div class="col-sm-6">
                                        <div class="business-hour d-flex align-items-center">
                                            <div class="days-icon">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                                                    ...
                                                    <path
                                                        ...
                                                        fill="url(#paint0_linear_10208_971)" />
                                                    <circle cx="18.4995" cy="18.5" r="5.63333"
                                                        fill="#161616" />
                                                    <g clip-path="url(#clip0_10208_971)">
                                                        <path
                                                            d="M18.5 12C14.9138 12 12 14.9138 12 18.5C12 22.0862 14.9138 25 18.5 25C22.0862 25 25 22.0862 25 18.5C25 14.9138 22.0862 12 18.5 12ZM18.5 23.6552C15.6534 23.6552 13.3448 21.3465 13.3448 18.5C13.3448 15.6534 15.6534 13.3448 18.5 13.3448C21.3465 13.3448 23.6552 15.6534 23.6552 18.5C23.6552 21.3465 21.3465 23.6552 18.5 23.6552Z"
                                                            fill="url(#paint1_linear_10208_971)" />
                                                        <path
                                                            d="M18.0516 13.8154H18.724V15.1603H18.0516V13.8154ZM21.6378 18.0741H22.9826V18.7465H21.6378V18.0741ZM13.793 18.0741H15.1378V18.7465H13.793V18.0741ZM18.0516 21.6603H18.724V23.0051H18.0516V21.6603Z"
                                                            fill="url(#paint2_linear_10208_971)" />
                                                        <path
                                                            d="M20.7971 15.6088C20.9952 15.6088 21.1557 15.4483 21.1557 15.2502C21.1557 15.0522 20.9952 14.8916 20.7971 14.8916C20.599 14.8916 20.4385 15.0522 20.4385 15.2502C20.4385 15.4483 20.599 15.6088 20.7971 15.6088Z"
                                                            fill="url(#paint3_linear_10208_971)" />
                                                        <path
                                                            d="M21.9182 16.9536C22.1163 16.9536 22.2768 16.793 22.2768 16.5949C22.2768 16.3969 22.1163 16.2363 21.9182 16.2363C21.7201 16.2363 21.5596 16.3969 21.5596 16.5949C21.5596 16.793 21.7201 16.9536 21.9182 16.9536Z"
                                                            fill="url(#paint4_linear_10208_971)" />
                                                        <path
                                                            d="M14.9699 20.9877C15.168 20.9877 15.3286 20.8272 15.3286 20.6291C15.3286 20.4311 15.168 20.2705 14.9699 20.2705C14.7719 20.2705 14.6113 20.4311 14.6113 20.6291C14.6113 20.8272 14.7719 20.9877 14.9699 20.9877Z"
                                                            fill="url(#paint5_linear_10208_971)" />
                                                        <path
                                                            d="M16.091 22.333C16.2891 22.333 16.4497 22.1724 16.4497 21.9743C16.4497 21.7763 16.2891 21.6157 16.091 21.6157C15.893 21.6157 15.7324 21.7763 15.7324 21.9743C15.7324 22.1724 15.893 22.333 16.091 22.333Z"
                                                            fill="url(#paint6_linear_10208_971)" />
                                                        <path
                                                            d="M21.8069 21.1001C22.0049 21.1001 22.1655 20.9395 22.1655 20.7414C22.1655 20.5434 22.0049 20.3828 21.8069 20.3828C21.6088 20.3828 21.4482 20.5434 21.4482 20.7414C21.4482 20.9395 21.6088 21.1001 21.8069 21.1001Z"
                                                            fill="url(#paint7_linear_10208_971)" />
                                                        <path
                                                            d="M20.4612 22.2207C20.6592 22.2207 20.8198 22.0601 20.8198 21.862C20.8198 21.664 20.6592 21.5034 20.4612 21.5034C20.2631 21.5034 20.1025 21.664 20.1025 21.862C20.1025 22.0601 20.2631 22.2207 20.4612 22.2207Z"
                                                            fill="url(#paint8_linear_10208_971)" />
                                                        <path
                                                            d="M15.0823 16.6171C15.2803 16.6171 15.4409 16.4566 15.4409 16.2585C15.4409 16.0605 15.2803 15.8999 15.0823 15.8999C14.8842 15.8999 14.7236 16.0605 14.7236 16.2585C14.7236 16.4566 14.8842 16.6171 15.0823 16.6171Z"
                                                            fill="url(#paint9_linear_10208_971)" />
                                                        <path
                                                            d="M16.426 15.4965C16.6241 15.4965 16.7846 15.336 16.7846 15.1379C16.7846 14.9399 16.6241 14.7793 16.426 14.7793C16.2279 14.7793 16.0674 14.9399 16.0674 15.1379C16.0674 15.336 16.2279 15.4965 16.426 15.4965Z"
                                                            fill="url(#paint10_linear_10208_971)" />
                                                        <path
                                                            d="M20.4389 18.7467C20.4389 18.5562 20.2932 18.4105 20.1026 18.4105H18.7242V15.9002C18.7242 15.7097 18.5785 15.564 18.388 15.564C18.1975 15.564 18.0518 15.7097 18.0518 15.9002V18.7467C18.0518 18.9372 18.1975 19.0829 18.388 19.0829H20.1026C20.2932 19.0829 20.4389 18.9372 20.4389 18.7467Z"
                                                            fill="url(#paint11_linear_10208_971)" />
                                                    </g>
                                                    <defs>
                                                        <linearGradient id="paint0_linear_10208_971" x1="10"
                                                            y1="0" x2="10" y2="20"
                                                            gradientUnits="userSpaceOnUse">
                                                            <stop stop-color="#FFAE00" />
                                                            <stop offset="1" stop-color="#F54200" />
                                                        </linearGradient>
                                                        <linearGradient id="paint1_linear_10208_971" x1="18.5"
                                                            y1="12" x2="18.5" y2="25"
                                                            gradientUnits="userSpaceOnUse">
                                                            <stop stop-color="#FD9301" />
                                                            <stop offset="1" stop-color="#F64701" />
                                                        </linearGradient>
                                                        <linearGradient id="paint2_linear_10208_971" x1="18.3878"
                                                            y1="13.8154" x2="18.3878" y2="23.0051"
                                                            gradientUnits="userSpaceOnUse">
                                                            <stop stop-color="#FD9301" />
                                                            <stop offset="1" stop-color="#F64701" />
                                                        </linearGradient>
                                                        <linearGradient id="paint3_linear_10208_971" x1="20.7971"
                                                            y1="14.8916" x2="20.7971" y2="15.6088"
                                                            gradientUnits="userSpaceOnUse">
                                                            <stop stop-color="#FD9301" />
                                                            <stop offset="1" stop-color="#F64701" />
                                                        </linearGradient>
                                                        <linearGradient id="paint4_linear_10208_971" x1="21.9182"
                                                            y1="16.2363" x2="21.9182" y2="16.9536"
                                                            gradientUnits="userSpaceOnUse">
                                                            <stop stop-color="#FD9301" />
                                                            <stop offset="1" stop-color="#F64701" />
                                                        </linearGradient>
                                                        <linearGradient id="paint5_linear_10208_971" x1="14.9699"
                                                            y1="20.2705" x2="14.9699" y2="20.9877"
                                                            gradientUnits="userSpaceOnUse">
                                                            <stop stop-color="#FD9301" />
                                                            <stop offset="1" stop-color="#F64701" />
                                                        </linearGradient>
                                                        <linearGradient id="paint6_linear_10208_971" x1="16.091"
                                                            y1="21.6157" x2="16.091" y2="22.333"
                                                            gradientUnits="userSpaceOnUse">
                                                            <stop stop-color="#FD9301" />
                                                            <stop offset="1" stop-color="#F64701" />
                                                        </linearGradient>
                                                        <linearGradient id="paint7_linear_10208_971" x1="21.8069"
                                                            y1="20.3828" x2="21.8069" y2="21.1001"
                                                            gradientUnits="userSpaceOnUse">
                                                            <stop stop-color="#FD9301" />
                                                            <stop offset="1" stop-color="#F64701" />
                                                        </linearGradient>
                                                        <linearGradient id="paint8_linear_10208_971" x1="20.4612"
                                                            y1="21.5034" x2="20.4612" y2="22.2207"
                                                            gradientUnits="userSpaceOnUse">
                                                            <stop stop-color="#FD9301" />
                                                            <stop offset="1" stop-color="#F64701" />
                                                        </linearGradient>
                                                        <linearGradient id="paint9_linear_10208_971" x1="15.0823"
                                                            y1="15.8999" x2="15.0823" y2="16.6171"
                                                            gradientUnits="userSpaceOnUse">
                                                            <stop stop-color="#FD9301" />
                                                            <stop offset="1" stop-color="#F64701" />
                                                        </linearGradient>
                                                        <linearGradient id="paint10_linear_10208_971" x1="16.426"
                                                            y1="14.7793" x2="16.426" y2="15.4965"
                                                            gradientUnits="userSpaceOnUse">
                                                            <stop stop-color="#FD9301" />
                                                            <stop offset="1" stop-color="#F64701" />
                                                        </linearGradient>
                                                        <linearGradient id="paint11_linear_10208_971" x1="19.2453"
                                                            y1="15.564" x2="19.2453" y2="19.0829"
                                                            gradientUnits="userSpaceOnUse">
                                                            <stop stop-color="#FD9301" />
                                                            <stop offset="1" stop-color="#F64701" />
                                                        </linearGradient>
                                            ...
                                            <div>
                                                ...
                                                <div class="text-center text-gradient fs-14 fw-5">
            ...
            @if ((isset($managesection) && $managesection['appointments']) || empty($managesection))
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="appointment-section pt-50 px-30 position-relative"
                        @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        <div class="bg-vector vector-11">
                            <img src="{{ asset('assets/img/vcard17/bg-vector-11.svg') }}" alt="bg-vector" />
                        </div>
                        <div class="bg-vector vector-24 text-end">
                            <img src="{{ asset('assets/img/vcard17/bg-vector-24.png') }}" alt="bg-vector" />
                        </div>
                        <div class="section-heading text-center mb-40">
                        ...
                        <div class="appointment">
                            ...
                            <div class="">
                                ...
                                <div class="text-center">
                                    <button type="submit"
                                        class="appointmentAdd appoint-btn btn btn-gradient d-none mt-3">
            ...
            @if ((isset($managesection) && $managesection['iframe']) || empty($managesection))
                @if (checkFeature('iframes') && $vcard->iframes->count())
                    <div class="iframe-section px-20 pt-50 pb-1 position-relative">
                        <div class="bg-vector vector-12 text-end">
                            <img src="{{ asset('assets/img/vcard17/bg-vector-12.svg') }}" alt="bg-vector" />
                        </div>
                        <div class="bg-vector vector-25">
                            <img src="{{ asset('assets/img/vcard17/bg-vector-25.png') }}" alt="bg-vector" />
                        </div>
                        <div class="section-heading text-center mb-40">
                ...
                @if (checkFeature('payment_link') && $vcard->paymentLinks->count())
                    <div class="main-section">
                        <div class="payment-link-section pt-40 px-20">
                            <div class="bg-vector vector-7 text-end">
                                <img src="{{ asset('assets/img/vcard17/bg-vector-7.svg') }}" alt="bg-vector" />
                            </div>
                            <div class="section-heading text-center mb-40">
                                    ...
                                    <div class="slide px-2 py-4">
                                        <div class="pl-strip">
                                            ...
                                            <div class="pl-strip-content">
                                                <h5 class="pl-strip-title text-gradient">{{ Illuminate\Support\Str::limit($paymentLink->label, 25, '...') }}</h5>
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
                <div class="contact-us-section px-30 pt-50 pb-50 mt-50 position-relative">
                    <div class="bg-vector vector-13">
                        <img src="{{ asset('assets/img/vcard17/bg-vector-13.svg') }}" alt="bg-vector" />
                    </div>
                    <div class="bg-vector vector-26 text-end">
                        <img src="{{ asset('assets/img/vcard17/bg-vector-26.png') }}" alt="bg-vector" />
                    </div>
                    <div class="section-heading text-center mb-40">
                                        ...
                                        @if (!empty($vcard->privacy_policy) || !empty($vcard->term_condition))
                                            <div class="col-12 d-flex gap-2">
                                                ...
                                                <label class="form-check-label fs-14" for="privacyPolicyCheckbox">
                                                    <span
                                                        class="text-gray-100">{{ __('messages.vcard.agree_to_our') }}</span>
                                                    <a href="{{ $vcardPrivacyAndTerm }}" target="_blank"
                                                        class="text-decoration-none link-info text-decoration-underline text-white fw-5">{!! __('messages.vcard.term_and_condition') !!}</a>
                                                    <span class="text-gray-100">&</span>
                                                    <a href="{{ $vcardPrivacyAndTerm }}" target="_blank"
                                                        class="text-decoration-none link-info text-decoration-underline text-white fw-5">{{ __('messages.vcard.privacy_policy') }}</a>
                                                </label>
                                            </div>
                                        @endif
                                        <div class="col-12 text-center mt-4">
                                            <button class="btn send-btn contact-btn btn-gradient" type="submit">
                            ...
                            <div class="contact-form" dir="rtl">
                                <form action="" id="enquiryForm" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <input type="tel" name="phone" class="form-control text-end"
                                                placeholder="{{ __('messages.form.phone') }}"
                                                onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,&quot;&quot;)" />
                                        </div>
                                        <div class="col-12">
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
                <div class="create-vcard-section pt-50 px-30 position-relative">
                    <div class="bg-vector vector-14 text-end">
                        <img src="{{ asset('assets/img/vcard17/bg-vector-14.svg') }}" alt="bg-vector" />
                    </div>
                    <div class="bg-vector vector-27">
                        <img src="{{ asset('assets/img/vcard17/bg-vector-27.png') }}" alt="bg-vector" />
                    </div>
                    ...
                    <div class="vcard-link-card card">
                        <a target="_blank"
                            ...
                            class="text-primary link-text fw-5 d-flex justify-content-between align-items-center position-relative text-gradient gap-3"
                            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>{{ route('register', ['referral-code' => $vcard->user->affiliate_code]) }}
            ...
            @if ((isset($managesection) && $managesection['map']) || empty($managesection))
                @if ($vcard->location_type == 0 && ($vcard->location_url && isset($url[5])))
                    <div class="map-section px-30 pt-50 position-relative">
                        <div class="bg-vector vector-28 text-end">
                            <img src="{{ asset('assets/img/vcard17/bg-vector-28.png') }}" alt="bg-vector" />
                        </div>
                        <div class="map-box">
                            <div class="map-location d-flex gap-3 align-items-center pb-3 pt-1"
                                @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                <div class="location-icon d-flex justify-content-center align-items-center">
                                    <img src="{{ asset('assets/img/vcard25/location.svg') }}" />
                                </div>
                                <p class="text-gradient mb-0">{!! ucwords($vcard->location) !!}</p>
                            </div>
                            <div>
            ...
            @if ($vcard->enable_contact)
                <div class="add-to-contact-section px-30 text-center">
                    <div class="d-inline-block" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        @if ($contactRequest == 1)
                            <a href="{{ Auth::check() ? route('add-contact', $vcard->id) : 'javascript:void(0);' }}"
                                class="add-contact-btn  d-flex gap-2 justify-content-center align-items-center btn btn-gradient text-decoration-none justify-content-center
                        ...
                        @else
                            <a href="{{ route('add-contact', $vcard->id) }}"
                                class="add-contact-btn  d-flex gap-2 justify-content-center align-items-center btn btn-gradient text-decoration-none justify-content-center"><i
            ...
            <div class="d-flex justify-content-evenly py-2">
                @if (checkFeature('advanced'))
                    @if (checkFeature('advanced')->hide_branding && $vcard->branding == 0)
                        ...
                        @else
                            <div class="text-center">
                                <small class="text-gradient">{{ __('messages.made_by') }}
                ...
                @if (!empty($vcard->privacy_policy) || !empty($vcard->term_condition))
                    <div>
                        <a class="text-decoration-none text-gradient cursor-pointer terms-policies-btn"
            ...
            <div class="btn-section cursor-pointer @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
                <div class="fixed-btn-section">
                    @if (empty($vcard->hide_stickybar))
                        <div
                            class="bars-btn developer-bars-btn @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') vcard-bars-btn-left @endif">
                            <img src="{{ asset('assets/img/vcard17/sticky.svg') }}" loading="lazy" />
                        </div>
                    @endif
                    ...
                    <div class="modal-body">
                        ...
                        <form action="" method="post" id="newsLatterForm">
                            ...
                            <div class="mb-1 mt-1 d-flex gap-1 justify-content-center align-items-center email-input">
                                <div class="w-100">
                                    <input type="email"
                                        class="text-white form-control bg-dark border-dark email-input w-100"
