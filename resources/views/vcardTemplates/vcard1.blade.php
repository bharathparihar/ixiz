...
<body>
    <div class="container p-0">
        ...
        @endif
        <div
            class="vcard-one main-content  w-100 mx-auto content-blur allSection @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
            {{--        banner --}}
            <div class="vcard-one__banner w-100 position-relative">
                ...
                @if ($vcard->cover_type == 0)
                    <img src="{{ $vcard->cover_url }}" class="img-fluid {{ $coverClass }}" alt="background image"
                        loading="lazy" />
                @elseif($vcard->cover_type == 1)
                    @if (strpos($vcard->cover_url, '.mp4') !== false ||
                        ...
                        <video class="cover-video {{ $coverClass }}" autoplay loop muted playsinline alt="background video"
                            id="cover-video">
            ...
            {{-- profile --}}
            <div class="vcard-one__profile position-relative @if ($vcard->cover_type == 2) profile-margin @endif">
            ...
            <div
                ...
                <h4 class="profile-name pt-2 mb-0 @if ($vcard->cover_type == 2) profile-desc-margin @endif">
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                <div class="vcard-one__qr-code mt-3 py-4 px-3">
                                                    ...
                                                    <div class="d-flex justify-content-between mt-2 product-info">
                                                        <div>
                                                            @if ($product->currency_id && $product->price)
                                                                <span
                                                                    class="text-black product-price-{{ $product->id }}">{{ currencyFormat($product->price, 2, $product->currency->currency_code) }}</span>
                                                            @elseif($product->price)
                                                                <span
                                                                    class="text-black product-price-{{ $product->id }}">{{ currencyFormat($product->price, 2, getUserCurrencyIcon($vcard->user->id)) }}</span>
                                                            @endif
                                                        </div>
            ...
            @if ((isset($managesection) && $managesection['whatsapp_store']) || empty($managesection))
                @if ($whatsappStore->count())
                    <div class="vcard-one__whatsapp-store mt-0 pb-5">
                        <h4 class="vcard-one-heading text-center mt-3">{{ __('messages.feature.whatsapp_store') }}
                        </h4>
                        <div class="container">
                            <div class="row g-4 whatsapp-store-slider overflow-hidden">
                                @foreach ($whatsappStore as $store)
                                    <div class="col-6 mb-2">
                                        <div class="card whatsapp-store-box p-2 border-0 w-100 h-100">
                                            ...
                                            <div class="whatsapp-store-details mt-3">
                                                ...
                                                <div class="d-flex align-items-center justify-content-center mt-2">
                                                    <a href="{{ route('whatsapp.store.show', $store->url_alias) }}"
                                                        target="_blank" class="btn btn-wp-visit-store mt-3">
            ...
            @if ((isset($managesection) && $managesection['testimonials']) || empty($managesection))
                @if (checkFeature('testimonials') && $vcard->testimonials->count())
                    <div class="vcard-one__testimonial pt-5">
                        <h4 class="vcard-one-heading text-center pb-4 mt-5">{{ __('messages.plan.testimonials') }}
                        </h4>
                        <div class="container">
                        ...
                        <nav>
                            <div class="row insta-toggle">
                                <div class="nav nav-tabs px-0" id="nav-tab" role="tablist">
                                    <button
                                        class="d-flex align-items-center justify-content-center active postbtn instagram-btn fs-2 text-dark py-2"
                                    ...
                                    <button
                                        class="d-flex align-items-center justify-content-center instagram-btn reelsbtn fs-2 text-dark py-2"
            ...
            @if ((isset($managesection) && $managesection['linkedin_embed']) || empty($managesection))
                @if (checkFeature('linkedin_embed') && $vcard->linkedinEmbed->count())
                    <div class="pt-5">
                        <h4 class="vcard-one-heading text-center pb-4">{{ __('messages.feature.linkedin_embed') }}
                        </h4>
                        ...
                        <div class="container">
                            <div class="row g-3 mb-0 justify-content-center blog-slider overflow-hidden">
                                @foreach ($vcard->blogs as $blog)
                                    ...
                                    ?>
                                    <div class="col-6 mb-2">
                                        <div class="card blog-card p-sm-2 p-4 border-0 w-100 h-100"
            ...
            @if ((isset($managesection) && $managesection['business_hours']) || empty($managesection))
                @if ($vcard->businessHours->count())
                    ...
                    @endphp
                    <div class="vcard-one__timing py-3 px-1 mt-0" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
            ...
            @if ((isset($managesection) && $managesection['iframe']) || empty($managesection))
                @if (checkFeature('iframes') && $vcard->iframes->count())
                    <div class="vcard-one_iframe my-3 py-4 mt-0">
            ...
            @if ((isset($managesection) && $managesection['payment_link']) || empty($managesection))
                @if (checkFeature('payment_link') && $vcard->paymentLinks->count())
                    <div class="main-section">
                        <div class="payment-link-section my-3 py-4 mt-0">
                            <h4 class="vcard-one-heading text-center">{{ __('messages.vcard.payment_links') }}</h4>
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
                <div class="vcard-one__contact py-4 mb-0 mt-0">
                        ...
                        <form id="enquiryForm" enctype="multipart/form-data">
                            ...
                            @if (getLanguage($vcard->default_language) != 'Arabic' && getLanguage($vcard->default_language) != 'Persian')
                                <div class="contact-form px-3">
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">
                                            {{ __('messages.contact_us.message') }}<span
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" name="name"
                                                class="form-control border-end-0 text-start"
                                                placeholder="{{ __('messages.form.your_name') }}">
                                        </div>
                                    </div>
                                    <div class="mb-3">
            ...
            <div class="d-flex justify-content-evenly made-by">
                ...
                @if (!empty($vcard->privacy_policy) || !empty($vcard->term_condition))
                    <div>
                        <a class="text-decoration-none text-dark cursor-pointer" href="{{ $vcardPrivacyAndTerm }}">
                ...
                <div
                    ...
                    <div class="sub-btn d-none">
                        <div class="sub-btn-div @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') sub-btn-div-left @endif">
                            ...
                            @endif
                            @if (empty($vcard->hide_stickybar))
                                <div class="{{ isset($vcard->whatsapp_share) ? 'vcard1-btn-group' : 'stickyIcon' }}">
                                    <button type="button"
                            ...
                            <div class="" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                @if ($contactRequest == 1)
                                    <a href="{{ Auth::check() ? route('add-contact', $vcard->id) : 'javascript:void(0);' }}"
                                        class="vcard1-sticky-btn add-contact-btn d-flex justify-content-center text-white align-items-center rounded px-5 text-decoration-none py-1 justify-content-center
                            ...
                            <div class="modal-content animate-bottom" id="newsLatter-content">
                                <div class="newsmodal-header px-0 position-relative">
                                    <button type="button" class="btn-close close-modal" data-bs-dismiss="modal"
                                        aria-label="Close" id="closeNewsLatterModal">
                                    </button>
