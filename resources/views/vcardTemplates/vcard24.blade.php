                                        ...
                                        <div>
                                            <div class="service-card h-100 text-start">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <p
                                                        class="card-text text-gray-200 description-text text-center mb-0 {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}">
            ...
            @if ((isset($managesection) && $managesection['products']) || empty($managesection))
                @if (checkFeature('products') && $vcard->products->count())
                    <div class="product-section pt-40 px-20 position-relative">
                                            ...
                                            <div class="mask">
                                                <div class="content">
                                                    ...
                                                    <div class="product-desc card-body p-3">
                                                        <div class="">
                                                            <h3
                                                                class="text-gray-200 text-center fw-5 mb-0 product-title">
                                                                {{ $product->name }}</h3>
                        ...
                        <div class="text-center">
                            <a class="view-all btn btn-primary fs-6 fw-5 text-decoration-underline text-center d-inline-flex align-items-center gap-2"
                ...
                @if ($whatsappStore->count())
                    <div class="whatsapp-store-product-section pt-50 px-20 mt-50 position-relative">
                        ...
                        <div class="position-absolute vector-75 whatsapp-store-vector-1 text-start">
                            <img src="{{ asset('assets/img/vcard24/bg-vector-13.png') }}"
                                class="w-100 h-100 object-fit-cover" alt="bg-vector" loading="lazy" />
                        </div>
                                ...
                                <div>
                                    <div class="whatsapp-store-box card h-100">
                                        ...
                                        <div class="whatsapp-store-content card-body text-center"
                                            ...
                                            <a class="btn btn-pink d-inline-flex align-items-center justify-content-center w-70 rounded-pill fw-normal"
                                                href="{{ route('whatsapp.store.show', $product->url_alias) }}"><span class="fs-14">{{ __('messages.vcard.visit_store') }}</span>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    @foreach ($vcard->testimonials as $testimonial)
                                        <div class="">
                                            <div class="testimonial-card card bg-transparent d-flex  flex-column justify-content-center"
                                                ...
                                                <div
                                                    class="d-flex gap-2 align-items-center justify-content-center  pt-3">
                                                    <div class="card-img">
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                <div class="qr-code-section position-relative pt-40 px-30">
                    <div class="position-absolute vector-all bg-vector-12">
                        <img src="{{ asset('assets/img/vcard24/bg-vector-12.png') }}" loading="lazy"
                            class="w-100" />
                    </div>
                    <div class="section-heading blue text-center">
                ...
                @if (checkFeature('payment_link') && $vcard->paymentLinks->count())
                    <div class="main-section">
                        <div class="payment-link-section pt-40 px-20">
                            ...
                            <div class="section-heading cyan text-center">
                    ...
                    <div class="text-center" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        ...
                        @else
                            <a href="{{ route('add-contact', $vcard->id) }}"
                                class="btn btn-cyan add-contact-btn"><i class="fas fa-download fa-address-book"></i>
                                &nbsp;{{ __('messages.setting.add_contact') }}</a>
                        @endif
                    </div>
                </div>
