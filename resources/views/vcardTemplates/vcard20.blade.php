...
<body>
    <div class="bg-effect-vcard20 position-fixed top-0 start-0 w-100 h-100">
        <div class="bg-main w-50 h-100 position-absolute top-0 start-0">
            <img src="{{ asset('assets/img/vcard20/bg-effect-vcard20.png') }}" loading="lazy"
    ...
    <div class="container p-0">
        ...
        @endif
        <div class="main-content mx-auto w-100 overflow-hidden bg-white @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
            {{-- Pwa support --}}
            ...
            <div class="banner-section position-relative w-100">
                <div class="banner-img @if ($vcard->cover_type == 2) h-auto @endif">
                    ...
                    @endif
                    <div class="d-flex justify-content-end position-absolute top-0 end-0 mx-3 z-index-10 language-btn">
            ...
            <div class="profile-section position-relative bg-white pt-40 px-30">
                <div class="position-absolute top-0 start-0 w-100 h-100">
                    <img src="{{ asset('assets/img/vcard20/hero-main-bg.png') }}" loading="lazy"
                        class="w-100 h-100 object-fit-cover" />
                </div>
                <div class="card flex-sm-row align-items-center gap-2 gap-sm-4"
                    ...
                    <div
                        class="card-body p-0 text-sm-start text-center @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') text-sm-end @endif">
                        <div class="profile-name">
                            <h2 class="text-white fs-24 mb-0">
                                {{ ucwords($vcard->first_name . ' ' . $vcard->last_name) }}
                                @if ($vcard->is_verified)
                                    <i class="verification-icon bi-patch-check-fill"></i>
                                @endif
                            </h2>
                            <p class="fs-18 text-primary text-decoration-underline fw-5 mb-0">
                                {{ ucwords($vcard->company) }}</p>
                            <p class="fs-14 text-gray-100 fw-5 mb-0">{{ ucwords($vcard->occupation) }}</p>
                            <p class="fs-14 text-gray-100 fw-5 mb-0">{{ ucwords($vcard->job_title) }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            @if (checkFeature('social_links') && getSocialLink($vcard))
                <div class="social-media pt-40 d-flex flex-wrap justify-content-center gap-3 px-30 position-relative">
                    <div class="position-absolute vector-1 vector-all">
                        <img src="{{ asset('assets/img/vcard20/vcard20-bg-vector-1.png') }}" loading="lazy"
                            class="w-100 h-100 object-fit-cover" />
                    </div>
                        ...
                        @foreach ($customLink as $value)
                            @if ($value->show_as_button == 1)
                                <a href="{{ $value->link }}"
                                    ...
                                    class="mx-2 d-flex justify-content-center align-items-center text-decoration-none link-text text-white font-primary btn">
                                    {{ $value->link_name }}
                                </a>
                            @else
                                <a href="{{ $value->link }}"
                                    @if ($value->open_new_tab == 1) target="_blank" @endif
                                    class="mx-2 d-flex justify-content-center align-items-center text-decoration-none link-text text-white">
                                    {{ $value->link_name }}
                                </a>
                            @endif
                        @endforeach
                ...
                @if (
                    ...
                    <div class="contact-section position-relative px-30 pt-40">
                        <div class="position-absolute vector-2 vector-all">
                            <img src="{{ asset('assets/img/vcard20/vcard20-bg-vector-2.png') }}" loading="lazy"
                                class="w-100 h-100 object-fit-cover" />
                        </div>
                        ...
                        <div class="">
                                            ...
                                            <div class="contact-box">
                                                <div class="contact-icon-box">
                                                    <div
                                                        ...
                                                        <img src="{{ asset('assets/img/vcard20/email.svg') }}" />
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="contact-box">
                                                <div class="contact-icon-box">
                                                    <div
                                                        class="contact-icon d-flex justify-content-center align-items-center">
                                                        <img src="{{ asset('assets/img/vcard20/phone.svg') }}" />
                                                    </div>
                                                </div>
                                                <div class="contact-desc">
                                                    <a href="tel:+{{ $vcard->region_code }}{{ $vcard->phone }}"
                                                        class="text-white fw-5"
                                        ...
                                        <div class="col-sm-6">
                                            <div class="contact-box">
                                                <div class="contact-icon-box">
                                                    <div
                                                        class="contact-icon d-flex justify-content-center align-items-center">
                                                        <img src="{{ asset('assets/img/vcard20/dob.svg') }}" />
                                                    </div>
                                                </div>
                                                <div class="contact-desc">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="contact-box">
                                                <div class="contact-icon-box">
                                                    <div
                                                        class="contact-icon d-flex justify-content-center align-items-center">
                                                        <img src="{{ asset('assets/img/vcard20/location.svg') }}" />
                                                    </div>
                                                </div>
                                                <div class="contact-desc">
                            ...
                            @endif
                            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian')
                                <div class="row row-gap-30px" dir="rtl">
                                    @if ($vcard->email)
                                        <div class="col-sm-6">
                                            <div class="contact-box">
                                                <div class="contact-icon-box">
            ...
            @if ((isset($managesection) && $managesection['services']) || empty($managesection))
                @if (checkFeature('services') && $vcard->services->count())
                    <div class="our-services-section pt-40 position-relative">
                        <div class="position-absolute vector-3 vector-all">
                            <img src="{{ asset('assets/img/vcard20/vcard20-bg-vector-3.png') }}" loading="lazy"
                                class="w-100 h-100 object-fit-cover" />
                        </div>
                                                ...
                                                <div class="service-card h-100">
                                                    <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
                                                        ...
                                                        <img src="{{ $service->service_icon }}"
                                                            class="w-100 h-100 object-fit-cover service-new-image"
                                                    ...
                                                    <div class="text-center card-body pb-0">
                                                        ...
                                                        <p
                                                            class="card-desc description-text text-gray-100 mb-0 {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}">
                                            ...
                                            <div class="col-sm-6 d-flex flex-column">
                                                <div class="service-card card h-100">
                                                    ...
                                                    <div class="card-body p-0 text-center">
                                                        ...
                                                        <p
                                                            class="card-desc mb-0 text-gray-100 {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}">
            ...
            @if ((isset($managesection) && $managesection['galleries']) || empty($managesection))
                @if (checkFeature('gallery') && $vcard->gallery->count())
                    <div class="gallery-section pt-40 px-20 position-relative">
                        <div class="position-absolute vector-4 vector-all">
                            <img src="{{ asset('assets/img/vcard20/vcard20-bg-vector-4.png') }}" loading="lazy"
                                class="w-100 h-100 object-fit-cover" />
                        </div>
                        <div class="section-heading text-center mb-40 overflow-hidden">
                            <h2 class="text-white mb-1 d-inline-block">
            ...
            @if ((isset($managesection) && $managesection['products']) || empty($managesection))
                @if (checkFeature('products') && $vcard->products->count())
                    <div class="product-section bg-gray pt-40 px-20 position-relative">
                        <div class="position-absolute vector-5 vector-all">
                            <img src="{{ asset('assets/img/vcard20/vcard20-bg-vector-5.png') }}" loading="lazy"
                                class="w-100 h-100 object-fit-cover" />
                        </div>
                        <div class="section-heading text-center overflow-hidden mb-40">
                            <h2 class="text-white mb-1 d-inline-block">
                                ...
                                <div>
                                    <div class="product-card card">
                                        ...
                                        <div class="product-desc card-body text-center p-0">
                                            <h3 class="text-white card-title  mb-1">{{ $product->name }}</h3>
                                            <div class="d-flex justify-content-between mt-2 product-info">
                                                <div class="product-amount text-primary fw-bold">
                        ...
                        <div class="text-center mt-4">
                            <a class="fs-6 text-center text-black view-more d-inline-flex gap-2 align-items-center"
                ...
                @if ($whatsappStore->count())
                    ...
                    <div class="whatsapp-store-product-section pt-50 px-20 mt-50 position-relative">
                        ...
                        <div class="position-absolute vector-75 whatsapp-store-vector-1 text-start">
                            <img src="{{ asset('assets/img/vcard20/vcard20-bg-vector-1.png') }}"
                                class="w-100 h-100 object-fit-cover" />
                        </div>
                                ...
                                <div>
                                    <div class="whatsapp-store-box card h-100">
                                        ...
                                        <div class="whatsapp-store-content card-body text-center"
                                            ...
                                            <h3 class="text-white whatsapp-store-name card-title  mb-1">{{ $product->store_name }}</h3>
                ...
                @if (checkFeature('testimonials') && $vcard->testimonials->count())
                    <div class="testimonial-section pt-40 pb-40 position-relative">
                        <div class="position-absolute vector-6 vector-all">
                            <img src="{{ asset('assets/img/vcard20/vcard20-bg-vector-6.png') }}" loading="lazy"
                                class="w-100 h-100 object-fit-cover" />
                        </div>
                        <div class="section-heading text-center mb-40 px-30 overflow-hidden">
                            <h2 class="text-white mb-1 d-inline-block">
                                ...
                                @foreach ($vcard->testimonials as $testimonial)
                                    <div>
                                        <div class="testimonial-card">
                                            ...
                                            <div class="card-body position-relative px-0  text-center text-white">
                                                <div class="left-quote position-absolute top-0">
                                                    <img src="{{ asset('assets/img/vcard20/right-quote.png') }}"
                                                        alt="images" />
                                                </div>
                                                <h6 class="name text-white">{{ ucwords($testimonial->name) }}</h6>
                                                <p
                                                    class="mb-2 text-gray-100 {{ \Illuminate\Support\Str::length($testimonial->description) > 80 ? 'more' : '' }}">
                                                    {!! $testimonial->description !!} </p>
                                                <div class="right-quote position-absolute bottom-0">
                                                    <img src="{{ asset('assets/img/vcard20/left-quote.png') }}"
                                                        alt="images" />
                                                </div>
                                            </div>
                                        </div>
                ...
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="appointment-section pt-40 pb-40 px-30 position-relative">
                        <div class="position-absolute vector-7 vector-all">
                            <img src="{{ asset('assets/img/vcard20/vcard20-bg-vector-7.png') }}" loading="lazy"
                                class="w-100 h-100 object-fit-cover" />
                        </div>
                        ...
                        <div class="appointment">
                            <div>
                                <div class="position-relative date-input">
                                    ...
                                    <span class="calendar-icon">
                                        <img src="{{ asset('assets/img/vcard20/calendar.svg') }}" loading="lazy" />
                                    </span>
                                    </span>
                                </div>
                            </div>
                            ...
                            <div class="text-center">
                                <button class="appointmentAdd btn btn-primary d-none">
            ...
            @if ((isset($managesection) && $managesection['insta_embed']) || empty($managesection))
                @if (checkFeature('insta_embed') && $vcard->instagramEmbed->count())
                    <div class="insta-feed-main pt-40 pb-40 position-relative">
                        <div class="position-absolute vector-8 vector-all">
                            <img src="{{ asset('assets/img/vcard20/vcard20-bg-vector-8.png') }}" loading="lazy"
                                class="w-100 h-100 object-fit-cover" />
                        </div>
                        <div class="px-30">
                            <div class="section-heading text-center mb-30 overflow-hidden">
                                <h2 class="text-white mb-1 d-inline-block">
                        ...
                        <div id="postContent" class="insta-feed px-30 mt-4">
                        ...
                        <div class="d-none insta-feed px-30 mt-4" id="reelContent">
            ...
            @if ((isset($managesection) && $managesection['linkedin_embed']) || empty($managesection))
                @if (checkFeature('linkedin_embed') && $vcard->linkedinEmbed->count())
                    <div class="pt-40 pb-40 position-relative">
                        <div class="pt-2">
                            <div class="section-heading text-center mb-30 overflow-hidden">
                                <h2 class="text-white mb-1 d-inline-block">
            ...
            @if ((isset($managesection) && $managesection['blogs']) || empty($managesection))
                @if (checkFeature('blog') && $vcard->blogs->count())
                    <div class="blog-section pt-40 pb-40 px-20 position-relative">
                        <div class="position-absolute vector-9 vector-all">
                            <img src="{{ asset('assets/img/vcard20/vcard20-bg-vector-9.png') }}" loading="lazy"
                                class="w-100 h-100 object-fit-cover" />
                        </div>
                                    ...
                                    <div class="blog-card  card">
                                        ...
                                        <div class="card-body w-100"
                                            ...
                                            <a href="{{ $vcardBlogUrl }}">
                                                ...
                                                <p class="text-gray-100 blog-desc mb-1">
                                                    {{ Illuminate\Support\Str::words(str_replace('&nbsp;', ' ', strip_tags($blog->description)), 100, '...') }}
                                                </p>
                                            </a>
                                            <div class="d-flex align-items-center justify-content-end">
                                                <a href="{{ $vcardBlogUrl }}"
                                                    class="btn btn-primary px-2 py-1 fs-14 d-inline-flex align-items-center justify-content-end gap-2"
                                                    tabindex="-1">
            ...
            @if ((isset($managesection) && $managesection['business_hours']) || empty($managesection))
                @if ($vcard->businessHours->count())
                    ...
                    @endphp
                    <div class="business-hour-section pt-40 px-30 pb-40 position-relative">
                        <div class="position-absolute vector-10 vector-all">
                            <img src="{{ asset('assets/img/vcard20/vcard20-bg-vector-10.png') }}" loading="lazy"
                                class="w-100 h-100 object-fit-cover" />
                        </div>
                        <div class="section-heading text-center mb-40 overflow-hidden">
                            <h2 class="text-white mb-1 d-inline-block">
                        ...
                        @if (getLanguage($vcard->default_language) != 'Arabic' && getLanguage($vcard->default_language) != 'Persian')
                            <div class="business-hour-card row row-gap-30px justify-content-center position-relative">
                                @php
                                    ...
                                    <div class="col-sm-6">
                                        <div class="business-hour align-items-center">
                                            <div class="time-icon-box">
                                                <div
                                                    class="time-icons d-flex align-items-center justify-content-center">
                                            ...
                                            <div class="text-center">
                                                <span
                                                    class="text-white">{{ __('messages.business.' . \App\Models\BusinessHour::DAY_OF_WEEK[$key]) }}:</span>
                                                <span
                                                    class="text-primary">{{ $dayTime ?? __('messages.common.closed') }}</span>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                <div class="qr-code-section pt-40 px-30 pb-40 position-relative">
                    <div class="position-absolute vector-11 vector-all">
                        <img src="{{ asset('assets/img/vcard20/vcard20-bg-vector-11.png') }}" loading="lazy"
                            class="w-100 h-100 object-fit-cover" />
                    </div>
                    <div class="section-heading text-center mb-40 overflow-hidden">
                        <h2 class="text-white mb-1 d-inline-block">
            ...
            @if ((isset($managesection) && $managesection['iframe']) || empty($managesection))
                @if (checkFeature('iframes') && $vcard->iframes->count())
                    <div class="iframe-section pt-40 pb-40 position-relative px-30">
                        <div class="position-absolute vector-12 vector-all">
                            <img src="{{ asset('assets/img/vcard20/vcard20-bg-vector-12.png') }}" loading="lazy"
                                class="w-100 h-100 object-fit-cover" />
                        </div>
                        <div class="section-heading text-center mb-40 overflow-hidden">
                ...
                @if (checkFeature('payment_link') && $vcard->paymentLinks->count())
                    <div class="main-section">
                        <div class="payment-link-section pt-40 px-20">
                            <div class="position-absolute vector-all">
                                <img src="{{ asset('assets/img/vcard20/vcard20-bg-vector-1.png') }}" loading="lazy"
                                    class="w-100 h-100 object-fit-cover" />
                            </div>
                        <div class="section-heading text-center mb-40 overflow-hidden">
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
                <div class="contact-us-section pt-40 pb-40 px-30 position-relative">
                    <div class="position-absolute vector-13 vector-all">
                        <img src="{{ asset('assets/img/vcard20/vcard20-bg-vector-13.png') }}" loading="lazy"
                            class="w-100 h-100 object-fit-cover" />
                    </div>
                    <div class="section-heading text-center overflow-hidden mb-40">
                        <h2 class="text-white mb-1 d-inline-block">
                                        ...
                                        <div class="col-12 mb-3 d-flex gap-2">
                                            ...
                                            <label class="form-check-label fs-14" for="privacyPolicyCheckbox">
                                                ...
                                                <a href="{{ $vcardPrivacyAndTerm }}" target="_blank"
                                                    class="text-decoration-underline link-info">{!! __('messages.vcard.term_and_condition') !!}</a>
                                                <span class="text-white">&</span>
                                                <a href="{{ $vcardPrivacyAndTerm }}" target="_blank"
                                                    class="text-decoration-underline link-info">{{ __('messages.vcard.privacy_policy') }}</a>
                                            </label>
                                        </div>
                                    @endif
                                        ...
                                        <div class="col-12 mb-4">
                                            ...
                                            <label class="form-check-label" for="privacyPolicyCheckbox">
                                                <span
                                                    class="text-white">{{ __('messages.vcard.agree_to_our') }}</span>
                                                <a href="{{ $vcardPrivacyAndTerm }}" target="_blank"
                                                    class="text-decoration-underline text-primary fs-6">{!! __('messages.vcard.term_and_condition') !!}</a>
                                                <span class="text-white">&</span>
                                                <a href="{{ $vcardPrivacyAndTerm }}" target="_blank"
                                                    class="text-decoration-underline text-primary fs-6">{{ __('messages.vcard.privacy_policy') }}</a>
                                            </label>
                                        </div>
                                    @endif
                                    <div class="col-12 text-center">
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
                <div class="create-vcard-section pt-40 pb-40 px-30 position-relative">
                    <div class="position-absolute vector-14 vector-all">
                        <img src="{{ asset('assets/img/vcard20/vcard20-bg-vector-14.png') }}" loading="lazy"
                            class="w-100 h-100 object-fit-cover" />
                    </div>
                ...
                @if ($vcard->location_url && isset($url[5]))
                    <div class="pt-50 px-30 position-relative">
                        <div class="position-absolute vector-15 vector-all">
                            <img src="{{ asset('assets/img/vcard20/vcard20-bg-vector-15.png') }}" loading="lazy"
                                class="w-100 h-100 object-fit-cover" />
                        </div>
                        <div class="map-section">
                            <div class="map-location d-flex gap-3 align-items-center"
                                ...
                                <p class="text-white fs-16 fw-bold mb-0">{!! ucwords($vcard->location) !!}</p>
                            </div>
                            <div>
                                @if ($vcard->location_url && isset($url[5]))
            ...
            <div class="btn-section cursor-pointer @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
                <div class="fixed-btn-section">
                    @if (empty($vcard->hide_stickybar))
                        <div
                            class="bars-btn food-services-bars-btn @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') vcard-bars-btn-left @endif">
                            <img src="{{ asset('assets/img/vcard20/sticky.svg') }}" loading="lazy" />
                        </div>
                    @endif
                                ...
                                <div class="icon-search-container mb-3" data-ic-class="search-trigger">
                                    ...
                                    <div class="share-wp-btn-div">
                                        <a href="javascript:void(0)"
                                            class="vcard20-sticky-btn vcard20-btn-group d-flex justify-content-center text-white align-items-center rounded-0 text-decoration-none py-1 rounded-pill justify-content share-wp-btn">
                            ...
                            @if (empty($vcard->hide_stickybar))
                                <div
                                    ...
                                    @if (!empty($vcard->enable_download_qr_code))
                                        <a type="button"
                                            class="vcard20-btn-group vcard20-sticky-btn d-flex justify-content-center text-white align-items-center  px-2 mb-3 py-2"
                                            id="qr-code-btn" download="qr_code.png"><i
                                                class="fa-solid fa-qrcode fs-4 text-white"></i></a>
                                    @endif
                                    {{-- <a type="button"
                                    class="vcard20-btn-group vcard20-sticky-btn d-flex justify-content-center text-white align-items-center  px-2 mb-3 py-2 d-none"
                        ...
                        <form action="" method="post" id="newsLatterForm">
                            ...
                            <div class="mb-1 mt-1 d-flex gap-1 justify-content-center align-items-center email-input">
                                ...
                                <button class="btn ms-1" type="submit"
                                    id="email-send">{{ __('messages.subscribe') }}</i></button>
                            </div>
                        </form>
                    </div>
                </div>
