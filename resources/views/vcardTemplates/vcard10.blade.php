...
<head>
    ...
    {{-- css link --}}
    <link rel="stylesheet" href="{{ mix('assets/css/vcard10.css') }}">
...
<body>
    <div class="container p-0">
        ...
        @endif
        <div
            class="vcard-ten main-content w-100 mx-auto overflow-hidden content-blur allSection  @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
            {{-- Pwa support --}}
                                        ...
                                        <div
                                            ...
                                            <div class="event-detail ms-sm-3 mt-sm-0 mt-4">
                                                ...
                                                <h5><a href="tel:+{{ $vcard->region_code }}{{ $vcard->phone }}"
                                                        class="event-name text-sm-start text-center mb-0 text-decoration-none"
                                                    ...
                                                    <div class="w-100">
                                                     ...
                                                     @if ($vcard->show_service_enquiry_btn == true)
                                                        @if ($service->service_url)
                                                            <div class="text-center enquiry-btn mt-2">
                                                                <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
                                                                    target="{{ $service->service_url ? '_blank' : '' }}"
                                    ...
                                    @foreach ($vcard->services as $service)
                                        <div class="col-sm-6">
                                            <div class="card service-card">
                                                ...
                                                <div class="card-body py-2 px-2 ps-2">
                                                    <div>
                                                        <h5 class="card-title text-gray-100">
                                                            {{ ucwords($service->name) }}
                                                        </h5>
                                                        <p
                                                            class="card-text text-gray-300 {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}">
                                                            {!! \Illuminate\Support\Str::limit($service->description, 170, '...') !!}</p>
                                                        </div>
                                                    @if ($vcard->show_service_enquiry_btn == true)
                                                        @if ($service->service_url)
                                                    ...
                                                    <div class="d-flex justify-content-between mt-2 product-info">
                                                        <div class="product-amount">
                                                            @if ($product->currency_id && $product->price)
                                                                <span
                                                                    class="text-whitek">{{ currencyFormat($product->price, 2, $product->currency->currency_code) }}</span>
                                                            ...
                                                            @if ($product->product_url)
                                                                <div class="enquiry-btn">
                                                                    <a href="{{ $product->product_url ?? 'javascript:void(0)' }}"
                                                                        ...
                                                                        class="btn btn-primary-enquiry text-white @if(!$product->product_url) disabled @endif">
            ...
            @if ((isset($managesection) && $managesection['whatsapp_store']) || empty($managesection))
                @if ($whatsappStore->count())
                    <div class="vcard-ten__whatsapp_store pb-12 px-sm-3 px-2 position-relative mt-0">
                        ...
                        <div class="container">
                            <div class="row g-3 whatsapp-store-slider">
                                @foreach ($whatsappStore as $store)
                                    <div class="col-6 h-100">
                                        <div
                                            class="card whatsapp-store-box p-4 border-0 w-100 position-relative shadow h-100 card-height">
                                            ...
                                            <div class="whatsapp-store-content">
                                                ...
                                                <div class="d-flex align-items-center justify-content-between pb-2 mobile-w-100">
                                                    <div class="text-center mobile-w-100">
                                        ...
                                        <div
                                            ...
                                            <div class="testimonial-user mt-auto d-flex flex-sm-row flex-column align-items-center justify-content-sm-start justify-content-center"
                                                ...
                                                <div class="user-details d-flex flex-column ms-sm-3 mt-sm-0 mt-2">
                                                    <span
                                                        class="user-name text-sm-start text-center text-sm-end" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') @endif>{{ ucwords($testimonial->name) }}</span>
                    ...
                    <nav>
                        <div class="row insta-toggle">
                            <div class="nav nav-tabs px-0" id="nav-tab" role="tablist">
                                <button
                                    class="d-flex align-items-center justify-content-center py-0 active postbtn instagram-btn fs-2 border-0"
                                ...
                                <button
                                    class="d-flex align-items-center justify-content-center py-2 instagram-btn reelsbtn fs-2 border-0"
            ...
            @if ((isset($managesection) && $managesection['linkedin_embed']) || empty($managesection))
                @if (checkFeature('linkedin_embed') && $vcard->linkedinEmbed->count())
                    <div class="pt-2">
                        <h4 class="vcard-ten-heading text-center pb-4">{{ __('messages.feature.linkedin_embed') }}
                        </h4>
            ...
            @if ((isset($managesection) && $managesection['blogs']) || empty($managesection))
                @if (checkFeature('blog') && $vcard->blogs->count())
                    <div class="vcard-ten__blog py-5 px-sm-3 px-2 position-relative mt-5">
                                    ...
                                    <div class="col-6 mb-2">
                                        <div class="card blog-card p-5 border-0 w-100 h-100 shadow">
                                            <div class="blog-image">
                                             ...
                                             <div class="blog-details mt-4 d-flex flex-column">
                                                    <a href="{{ $vcardBlogUrl }}" class="text-decoration-none">
                                                          <h4 class="text-sm-start text-center title-color mb-3 text-black">
                                                        {{ $blog->title }}</h4>
                                                        <p class="mb-1">
                                                    ...
                                                    <a href="{{ $vcardBlogUrl }}"
                                                    class="mt-3 read-more d-flex align-items-center justify-content-end gap-2 text-black title-color text-decoration-none">
            ...
            @if ((isset($managesection) && $managesection['business_hours']) || empty($managesection))
                @if ($vcard->businessHours->count())
                    ...
                    <div class="vcard-ten__timing py-4 px-sm-3 px-2 position-relative mb-5">
                        ...
                        <div class="row g-3 mx-sm-5" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            @php
                    ...
                    <div class="vcard-ten__appointment py-4 px-sm-4 px-3 my-5 position-relative ">
                        ...
                        <div class="container">
                            <div class="appointment-card p-3">
                                ...
                                <button type="button"
                                    class="appointmentAdd appoint-btn rounded mt-4 d-block mx-auto d-none">{{ __('messages.make_appointments') }}</button>
                            </div>
                        </div>
                    </div>
            ...
            @if ((isset($managesection) && $managesection['payment_link']) || empty($managesection))
                @if (checkFeature('payment_link') && $vcard->paymentLinks->count())
                    <div class="main-section">
                        <div class="payment-link-section py-4 px-sm-3 px-2 position-relative mt-5 mb-3 pb-7">
                            <h4 class="vcard-ten-heading text-center">{{ __('messages.vcard.payment_links') }}</h4>
            ...
            @php
                $currentSubs = $vcard
                    ...
                    ->first();
            @endphp
            <div class="vcard-ten__contact px-sm-3 px-2 position-relative z-0">
            ...
            {{-- hide stickybar --}}
            <div class="w-100 d-flex justify-content-center  position-fixed" style="top:50%; left:0; z-index:99;">
                <div
