        ...
        <div
                        ...
                        <div class="card d-flex flex-sm-row align-items-center gap-4 flex-column py-4 px-4">
                            ...
                            <div class="card-body p-0 ">
                                <div class="position-relative text-sm-start text-center">
                                    ...
                                    <p class="fs-14 text-gray-100 mb-0"><span class="profile-designation">
            ...
            @if (((isset($managesection) && $managesection['contact_list']) || empty($managesection)) && $hasContactData)
                <div class="contact-section position-relative px-30 pt-50">
                    ...
                    <div class="chest-expander-img vector-bg" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                ...
                                @if ($vcard->alternative_email)
                                    <div class="col-sm-6">
                                        <div class="contact-box">
                                            ...
                                            <div class="contact-desc text-center">
                                                <a href="mailto:{{ $vcard->email }}"
                                                    class="event-name text-center mb-0 text-decoration-none text-white">{{ $vcard->alternative_email }}</a>
                                            </div>
                                        </div>
                                    </div>
                                @endif
                                    ...
                                    <div class="col-sm-6">
                                        <div class="contact-box">
                                            ...
                                            <div class="contact-desc text-center mt-1">
                                                <a href="mailto:{{ $vcard->email }}"
                                                    class="event-name text-center mb-0 text-decoration-none text-white">{{ $vcard->email }}</a>
                                            </div>
                                        </div>
                                    </div>
                                @endif
                ...
                @if (checkFeature('services') && $vcard->services->count())
                    <div class="our-services-section pt-50 position-relative">
                        <div class="dumbbell-img vector-bg text-end">
                            <img src="{{ asset('assets/img/vcard12/vector-8.png') }}" alt="dumbbell"
                                class="w-100" />
                        </div>
                        <div class="section-heading px-30 text-center overflow-hidden">
                            <h2 class="text-white mb-0 d-inline-block">
                    ...
                    <div>
                        <div
                            ...
                            <div
                                ...
                                <h4 class="fw-bold mb-3 text-white">{{ __('messages.vcard.scan_to_contact') }}</h4>
                                <div class="text-gray-100">{{ __('messages.vcard.qr_section_desc') }}</div>
                            </div>
                        </div>
                    </div>
                </div>
                                            ...
                                            <div class="">
                                                <div class="gallery-all position-relative">
                                                    ...
                                                    <a href="{{ $file->gallery_image }}"
                                                        data-lightbox="gallery-images" class="gallery-img"><img
                                                            src="{{ $file->gallery_image }}" alt="profile"
                                                            class="w-100 h-100 object-fit-contain scale-hover"
                                                            loading="lazy" /></a>
                                                </div>
                                            </div>
                                        @elseif($file->type == App\Models\Gallery::TYPE_FILE)
                                            <div class="">
                                                <a id="file_url" href="{{ $file->gallery_image }}"
                                                    ...
                                                    loading="lazy">
                                                    <div class="gallery-item gallery-file-item scale-hover"
                                        ...
                                        <div class="product-card card">
                                            <div class="product-img card-img">
                                                <img src="{{ $product->product_icon }}"
                                                    class="img-fluid h-100 w-100 scale-hover" loading="lazy" />
                                            </div>
            ...
            @if ((isset($managesection) && $managesection['whatsapp_store']) || empty($managesection))
                @if ($whatsappStore->count())
                    <div class="whatsapp-store-product-section pt-50 px-20 position-relative">
                        <div class="position-absolute vector-bg-11 vector-bg mt--20">
                            <img src="{{ asset('assets/img/vcard12/vector-10.png') }}" alt="images" />
                        </div>
                        <div class="section-heading text-center overflow-hidden">
                            <h2 class="text-white mb-0 d-inline-block">
                                ...
                                <div>
                                    <div class="whatsapp-store-box card">
                                        ...
                                        <div class="whatsapp-store-content card-body text-center"
                                            ...
                                            <h3 class="whatsapp-store-name mb-3 fw-5 text-white text-center">
                                                {{ $product->store_name }}
                                            </h3>
                                ...
                                @foreach ($vcard->testimonials as $testimonial)
                                    <div class="">
                                        <div class="testimonial-card h-100 bg-black position-relative px-30 pt-4 pb-4">
                                            <div
                                                class="card-body d-flex flex-column justify-content-between p-0 text-center gap-3">
                                                <div class="quote-img-top">
                                                    <img src="{{ asset('assets/img/vcard12/quote-img.png') }}"
                                                        class="h-100 mx-auto" loading="lazy" />
                                                </div>
                                                <div class="position-relative">
                ...
                @if (checkFeature('insta_embed') && $vcard->instagramEmbed->count())
                    <div class="pt-50 position-relative">
                        <div class="position-absolute vector-bg-12 vector-bg">
                            <img src="{{ asset('assets/img/vcard12/vector-10.png') }}" loading="lazy"
                                class="w-100" />
                        </div>
                        <div class="section-heading text-center overflow-hidden">
                            <h2 class="text-white mb-0 d-inline-block">
            ...
            @if ((isset($managesection) && $managesection['linkedin_embed']) || empty($managesection))
                @if (checkFeature('linkedin_embed') && $vcard->linkedinEmbed->count())
                    <div class="pt-50 position-relative">
                        <div class="section-heading text-center overflow-hidden">
                            <h2 class="text-white mb-0 d-inline-block">{{ __('messages.feature.linkedin_embed') }}
                            </h2>
                        </div>
                ...
                @if (checkFeature('blog') && $vcard->blogs->count())
                    <div class="blog-section pt-50 position-relative px-20">
                        <div class="position-absolute vector-bg-8 vector-bg text-end">
                            <img src="{{ asset('assets/img/vcard12/vector-9.png') }}" alt="images"
                                class="w-100" />
                        </div>
                                ...
                                <div class="">
                                    <div class="blog-card blog-1 card">
                                        ...
                                        <div class="card-body d-flex flex-column justify-content-end"
                                            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                            <a href="{{ $vcardBlogUrl }}">
                                                <h4 class="card-title text-primary fw-5 mb-2">{{ $blog->title }}
                                                </h4>
            ...
            @if ((isset($managesection) && $managesection['business_hours']) || empty($managesection))
                @if ($vcard->businessHours->count())
                    ...
                    @endphp
                    <div class="bussiness-hour-section pt-50 px-30 position-relative"
                        @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                ...
                                @foreach ($businessDaysTime as $key => $dayTime)
                                    <div class="col-sm-6">
                                        <div
                                            ...
                                            <div
                                                class="time-day-icon d-flex align-items-center justify-content-center">
                                            ...
                                            <div class="d-flex flex-column gap-1">
                                                <div class="fs-14 text-gray-100 lh-1">
                                                    {{ __('messages.business.' . \App\Models\BusinessHour::DAY_OF_WEEK[$key]) . ':' }}
                                                </div>
                                                <div class="fs-14 text-white">{!! $dayTime ?? '<span class="text-primary">' . __('messages.common.closed') . '</span>' !!}</div>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
                ...
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="appointment-section pt-50 position-relative">
                        <div class="position-absolute vector-bg-appointment vector-bg text-end">
                            <img src="{{ asset('assets/img/vcard12/testimonial-bg.png') }}" alt="images"
                                class="w-100" />
                        </div>
            ...
            @if ((isset($managesection) && $managesection['payment_link']) || empty($managesection))
                @if (checkFeature('payment_link') && $vcard->paymentLinks->count())
                    <div class="main-section">
                        <div class="payment-link-section pt-40 px-20 position-relative">
                            <div class="position-absolute vector-bg-3 vector-bg">
                                <img src="{{ asset('assets/img/vcard12/vector-3.png') }}" alt="images" />
                            </div>
                            <div class="section-heading text-center mx-30 overflow-hidden">
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
                <div class="contact-us-section">
                    ...
                    <div class="contact-after-img vector-bg text-end">
                        <img src="{{ asset('assets/img/vcard12/contact-after-img.png') }}" alt="iamges"
                            class="w-100" />
                    </div>
                    <div class="px-30">
                        @if (getLanguage($vcard->default_language) != 'Arabic' && getLanguage($vcard->default_language) != 'Persian')
                                                ...
                                                <div class="d-flex gap-2 align-items-center">
                                                    ...
                                                    <label class="form-check-label fs-14" for="privacyPolicyCheckbox">
                                                        ...
                                                        <a href="{{ $vcardPrivacyAndTerm }}" target="_blank"
                                                            class="text-decoration-none fs-14 fw-6 text-primary">{!! __('messages.vcard.term_and_condition') !!}</a>
                                                        <span class="text-white">&</span>
                                                        <a href="{{ $vcardPrivacyAndTerm }}" target="_blank"
                                                            class="text-decoration-none fs-14 fw-6 text-primary">{{ __('messages.vcard.privacy_policy') }}</a>
                                                    </label>
                                                </div>
                                            </div>
                                        @endif
                                                ...
                                                <div class="d-flex gap-2 align-items-center">
                                                    ...
                                                    <label class="form-check-label" for="privacyPolicyCheckbox">
                                                        <span
                                                            class="text-white">{{ __('messages.vcard.agree_to_our') }}</span>
                                                        <a href="{{ $vcardPrivacyAndTerm }}" target="_blank"
                                                            class="text-decoration-none fs-6 text-primary">{!! __('messages.vcard.term_and_condition') !!}</a>
                                                        <span class="text-white">&</span>
                                                        <a href="{{ $vcardPrivacyAndTerm }}" target="_blank"
                                                            class="text-decoration-none fs-6 text-primary">{{ __('messages.vcard.privacy_policy') }}</a>
                                                    </label>
                                                </div>
                                            </div>
                                        @endif
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
                {{-- create vcard --}}
                <div class="create-vcard-section px-30 pt-50 position-relative"
                    @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                    ...
                    <div @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        @if ($contactRequest == 1)
                            <a href="{{ Auth::check() ? route('add-contact', $vcard->id) : 'javascript:void(0);' }}"
                                class="add-contact-btn btn-primary gap-2 d-flex justify-content-center align-items-center
