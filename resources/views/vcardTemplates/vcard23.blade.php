        ...
        <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
            ...
            <div class="banner-section position-relative @if ($vcard->cover_type == 2) banner-img-23 @endif">
                <div class="banner-img">
                    @php
                        $coverClass =
                            $vcard->cover_image_type == 0 ? 'object-fit-cover w-100' : 'object-fit-cover w-100';
                    @endphp
                ...
                <div class="d-flex justify-content-end position-absolute top-0 end-0 language-btn mx-3">
            ...
            {{-- profile seciton --}}
            <div class="profile-section pt-50">
                <div class="px-30">
                    <div class="profile-bg-img position-absolute">
                        <img src="{{ asset('assets/img/vcard23/profile-bg1.png') }}" alt="profile-bg1"
                            class="w-100 h-100" loading="lazy" />
                    </div>
                    <div
                        class="card d-flex flex-sm-row align-items-center gap-3 position-relative border-0 bg-transparent">
                        {{-- <div class="profile-bg-img position-absolute">
                            <img src="{{ asset('assets/img/vcard23/profile-bg.png') }}" alt="profile-bg" class="w-100 h-100" loading="lazy" />
                        </div> --}}
                        <div>
                        ...
                        <div class="card-body p-0 w-50">
                            <div class="profile-name">
                                <h2 class="mb-0 fs-24 fw-6 text-black">
                                    {{ ucwords($vcard->first_name . ' ' . $vcard->last_name) }}
                                    @if ($vcard->is_verified)
                                        <i class="verification-icon bi-patch-check-fill text-primary"></i>
                                    @endif
                                </h2>
                                <p class="fs-16 mb-0 text-primary">{{ ucwords($vcard->company) }}</p>
                                <p class="fs-14 mb-0 text-black">{{ ucwords($vcard->occupation) }}</p>
                                <p class="fs-14 mb-0 text-black">{{ ucwords($vcard->job_title) }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                @if (checkFeature('social_links') && getSocialLink($vcard))
                    <div class="social-media d-flex justify-content-center pt-40 position-relative">
                        <div class="bg-vector vector-1 position-absolute">
                            <img src="{{ asset('assets/img/vcard23/vector7.png') }}" alt="vector"
                                class="w-100 h-100" loading="lazy" />
                        </div>
            ...
            @if ((isset($managesection) && $managesection['contact_list']) || empty($managesection))
                @if (
                    ...
                    <div class="contact-section pt-50 px-30 position-relative"
                        ...
                        <div class="bg-vector vector-3 position-absolute end-0 text-end">
                            <img src="{{ asset('assets/img/vcard23/vector3.png') }}" alt="vector"
                                class="w-100 h-100" loading="lazy" />
                        </div>
                        <div class="section-heading text-center">
                            <h2 class="text-white text-center mb-0">{{ __('messages.contact_us.contact') }}</h2>
                            <span></span>
                        </div>
                                    ...
                                    <div class="contact-bg">
                                        <div class="contact-box">
                                            <div class="contact-icon d-flex justify-content-center align-items-center">
                                                <img src="{{ asset('assets/img/vcard23/email.svg') }}"
                                                    loading="lazy" />
                                            </div>
                                            <div class="contact-desc text-center">
                                                <a href="mailto:{{ $vcard->email }}"
                                                    class="text-white fs-14 fw-5 text-center">{{ $vcard->email }}</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="contact-box">
                                            ...
                                            <div class="contact-desc text-center">
                                                <a href="mailto:{{ $vcard->alternative_email }}"
                                                    class="text-white fs-14 fw-5 text-center">{{ $vcard->alternative_email }}</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            @if ($vcard->phone)
                                <div class="col-sm-6">
                                    <div class="contact-bg mail-3">
                                        <div class="contact-box">
                                            <div class="contact-icon d-flex justify-content-center align-items-center">
                                                <img src="{{ asset('assets/img/vcard23/phone.svg') }}"
                                                    loading="lazy" />
                                            </div>
                                            <div class="contact-desc text-center">
                                                <a href="tel:+{{ $vcard->region_code }}{{ $vcard->phone }}"
                                                    class="text-white fs-14 fw-5 text-center"
                            ...
                            @if ($vcard->dob)
                                <div class="col-sm-6">
                                    <div class="contact-bg mail-2">
                                        <div class="contact-box">
                                            <div class="contact-icon d-flex justify-content-center align-items-center">
                                                <img src="{{ asset('assets/img/vcard23/dob.svg') }}"
                                                    loading="lazy" />
                                            </div>
                                            <div class="contact-desc text-center">
                                                <p class="mb-0 text-white fs-14 fw-5 text-center"> {{ $vcard->dob }}
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            @if ($vcard->location)
                                <div class="col-sm-6">
                                    <div class="contact-bg mail-3">
                                        <div class="contact-box">
                                            <div class="contact-icon d-flex justify-content-center align-items-center">
                                                <img src="{{ asset('assets/img/vcard23/location.svg') }}"
                                                    loading="lazy" />
                                            </div>
                                            <div class="contact-desc text-center">
                                                <p class="text-white mb-0 fs-14 fw-5 text-center">
            ...
            @if ((isset($managesection) && $managesection['services']) || empty($managesection))
                @if (checkFeature('services') && $vcard->services->count())
                    <div class="our-services-section pt-50">
                        <div class="bg-vector vector-4 position-absolute text-end">
                            <img src="{{ asset('assets/img/vcard23/vector16.png') }}" alt="vector"
                                class="w-100 h-100" loading="lazy" />
                        </div>
                        <div class="section-heading text-center">
                            <h2 class="text-white text-center mb-0">{{ __('messages.vcard.our_service') }}</h2>
                            <span></span>
                        </div>
                        <div class="services">
                            ...
                            @else
                                <div class="row px-30 row-gap-20px">
                                    @foreach ($vcard->services as $service)
                                        <div class="col-sm-6">
                                            <div class="service-card-wrapper h-100">
                                                <div class="service-card h-100">
                                                    ...
                                                    <div class="card-body position-relative w-100 h-100">
                                                        <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
                                                            class="text-decoration-none"
                                                            target="{{ $service->service_url ? '_blank' : '' }}">
                                                            <h5 class="card-title title-text">
            ...
            @if ((isset($managesection) && $managesection['appointments']) || empty($managesection))
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="appointment-section pt-50 px-30">
                        <div class="bg-vector vector-5 position-absolute top-0">
                            <img src="{{ asset('assets/img/vcard23/vector8.png') }}" alt="vector"
                                class="w-100 h-100" loading="lazy" />
                        </div>
                        <div class="section-heading text-center">
                        ...
                        <div class="appointment-bg">
                            <div class="appointment">
                                ...
                                <div class="text-center max-w-fit appointment-btn mx-auto">
            ...
            @if ((isset($managesection) && $managesection['galleries']) || empty($managesection))
                @if (checkFeature('gallery') && $vcard->gallery->count())
                    <div class="gallery-section pt-50 px-20 position-relative">
                        <div class="bg-vector vector-6 position-absolute text-end">
                            <img src="{{ asset('assets/img/vcard23/vector15.png') }}" alt="vector"
                                class="w-100 h-100" loading="lazy" />
                        </div>
                        <div class="section-heading text-center">
                            <h2 class="text-white text-center mb-0">{{ __('messages.plan.gallery') }}</h2>
                            <span></span>
                        </div>
                        <div class="position-relative">
            ...
            @if ((isset($managesection) && $managesection['testimonials']) || empty($managesection))
                @if (checkFeature('testimonials') && $vcard->testimonials->count())
                    <div class="testimonial-section pt-50 px-20 position-relative">
                        <div class="bg-vector vector-7 position-absolute">
                            <img src="{{ asset('assets/img/vcard23/vector4.png') }}" alt="vector"
                                class="w-100 h-100" loading="lazy" />
                        </div>
                        <div class="bg-vector vector-7 position-absolute">
                            <img src="{{ asset('assets/img/vcard23/vector13.png') }}" alt="vector"
                                class="w-100 h-100" loading="lazy" />
                        </div>
                        <div class="section-heading text-center">
                            <h2 class="text-white text-center mb-0">{{ __('messages.plan.testimonials') }}</h2>
                            <span></span>
                        </div>
                            ...
                            @foreach ($vcard->testimonials as $testimonial)
                                <div>
                                    <div class="testimonial-card card">
                                        ...
                                        <div class="card-body p-0 pt-5 position-relative">
                                            <div class="position-absolute quote-img">
                                                <svg width="28" viewBox="0 0 16 16" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
            ...
            @if ((isset($managesection) && $managesection['products']) || empty($managesection))
                @if (checkFeature('products') && $vcard->products->count())
                    <div class="product-section pt-50">
                        <div class="bg-vector vector-8 position-absolute top-0">
                            <img src="{{ asset('assets/img/vcard23/vector9.png') }}" alt="vector"
                                class="w-100 h-100" loading="lazy" />
                        </div>
                        <div class="section-heading text-center">
                            <h2 class="text-white text-center mb-0">{{ __('messages.plan.products') }}</h2>
                            <span></span>
                        </div>
                        <div class="">
                            <div class="product-slider px-20">
                                @foreach ($vcard->products as $product)
                                    <div>
                                        <div class="product-card card overflow-hidden">
                                            ...
                                            <div class="product-desc card-body p-3 text-center position-relative">
                                                <div class="">
                                                    <h3 class="fs-18 fw-5 mb-1 text-black">
                                                        {{ $product->name }}
                                                    </h3>
                ...
                @if ($whatsappStore->count())
                    <div class="whatsapp-store-product-section pt-50 px-20 mt-50 position-relative">
                        ...
                        <div class="position-absolute vector-75 whatsapp-store-vector-1 text-start">
                            <img src="{{ asset('assets/img/vcard23/vector10.png') }}"
                                class="w-100 h-100 object-fit-cover" loading="lazy" />
                        </div>

                        <div class="section-heading text-center">
                            <h2 class="text-white text-center mb-0">{{ __('messages.feature.whatsapp_store') }}</h2>
                            <span></span>
                        </div>
            ...
            @if ((isset($managesection) && $managesection['insta_embed']) || empty($managesection))
                @if (checkFeature('insta_embed') && $vcard->instagramEmbed->count())
                    <div class="instagram-feed pt-50 px-30 position-relative">
                        <div class="bg-vector vector-8 end-0 top-0 position-absolute">
                            <img src="{{ asset('assets/img/vcard23/vector9.png') }}" alt="vector"
                                class="w-100 h-100" loading="lazy" />
                        </div>
                        <div class="section-heading text-center">
                            <h2 class="text-white text-center mb-0">{{ __('messages.feature.insta_embed') }}</h2>
                            <span></span>
                        </div>
                        <nav>
            ...
            @if ((isset($managesection) && $managesection['linkedin_embed']) || empty($managesection))
                @if (checkFeature('linkedin_embed') && $vcard->linkedinEmbed->count())
                    <div class="instagram-feed pt-50 px-30 position-relative">
                        <div class="section-heading text-center">
                            <h2 class="text-black text-center mb-0">{{ __('messages.feature.linkedin_embed') }}</h2>
                            <span></span>
                        </div>
            ...
            @if ((isset($managesection) && $managesection['blogs']) || empty($managesection))
                @if (checkFeature('blog') && $vcard->blogs->count())
                    <div class="blog-section pt-50 position-relative">
                        <div class="bg-vector vector-9 position-absolute text-end">
                            <img src="{{ asset('assets/img/vcard23/vector5.png') }}" alt="vector"
                                class="w-100 h-100" loading="lazy" />
                        </div>
                        <div class="section-heading text-center">
                            <h2 class="text-white text-center mb-0">{{ __('messages.feature.blog') }}</h2>
                            <span></span>
                        </div>
                        <div class="blog-slider px-20">
                                ...
                                <div>
                                    <div class="blog-card overflow-hidden">
                                        ...
                                        <div class="card-body text-start position-relative">
                                            <h5 class="text-primary fs-18 card-title">{{ $blog->title }}</h5>
            ...
            @if ((isset($managesection) && $managesection['business_hours']) || empty($managesection))
                @if ($vcard->businessHours->count())
                    ...
                    <div class="business-hour-section pt-50 px-30 position-relative">
                        <div class="bg-vector vector-10 position-absolute top-0">
                            <img src="{{ asset('assets/img/vcard23/vector18.png') }}" alt="vector"
                                class="w-100 h-100" loading="lazy" />
                        </div>
                        <div class="section-heading text-center">
                            <h2 class="text-white text-center mb-0">{{ __('messages.business.business_hours') }}</h2>
                            <span></span>
                        </div>
                        <div class="business-hours row row-gap-20px justify-content-center py-3 mx-0"
                            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                <div class="qr-code-section pt-50 px-30 position-relative">
                    <div class="bg-vector vector-11 position-absolute text-end">
                        <img src="{{ asset('assets/img/vcard23/vector4.png') }}" alt="vector" class="w-100 h-100"
                            loading="lazy" />
                    </div>
                    <div class="section-heading text-center">
                        <h2 class="text-white text-center mb-0">{{ __('messages.vcard.qr_code') }}</h2>
                        <span></span>
                    </div>
            ...
            @if ((isset($managesection) && $managesection['iframe']) || empty($managesection))
                @if (checkFeature('iframes') && $vcard->iframes->count())
                    <div class="iframe-section pt-50 position-relative">
                        <div class="bg-vector vector-12 position-absolute">
                            <img src="{{ asset('assets/img/vcard23/vector12.png') }}" alt="vector"
                                class="w-100 h-100" loading="lazy" />
                        </div>
                        <div class="section-heading text-center">
                            <h2 class="text-white text-center mb-0">{{ __('messages.vcard.iframe') }}</h2>
                            <span></span>
                        </div>
                        <div class="iframe-slider px-20">
                ...
                @if (checkFeature('payment_link') && $vcard->paymentLinks->count())
                    <div class="main-section">
                        <div class="payment-link-section pt-40 px-20">
                            <div class="bg-vector vector-12 position-absolute">
                                <img src="{{ asset('assets/img/vcard23/vector1.png') }}" alt="vector"
                                    class="w-100 h-100" loading="lazy" />
                            </div>
                            <div class="section-heading text-center">
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
                <div class="contact-us-section pt-50 px-30 position-relative">
                    <div class="bg-vector vector-13 position-absolute end-0">
                        <img src="{{ asset('assets/img/vcard23/vector14.png') }}" alt="vector"
                            class="w-100 h-100" loading="lazy" />
                    </div>
                    <div class="section-heading text-center">
                        <h2 class="text-white text-center mb-0">{{ __('messages.contact_us.inquries') }}</h2>
                        <span></span>
                    </div>
                                        ...
                                        <div class="col-12 mb-4 d-flex gap-2">
                                            ...
                                            <label class="form-check-label fs-14" for="privacyPolicyCheckbox">
                                                ...
                                                <a href="{{ $vcardPrivacyAndTerm }}" target="_blank"
                                                    class="text-decoration-none link-info text-secondary">{!! __('messages.vcard.term_and_condition') !!}</a>
                                                <span class="text-white">&</span>
                                                <a href="{{ $vcardPrivacyAndTerm }}" target="_blank"
                                                    class="text-decoration-none link-info text-secondary">{{ __('messages.vcard.privacy_policy') }}</a>
                                            </label>
                                        </div>
                                    @endif
                                    <div class="col-12 text-center mt-2">
                                        <button class="contact-btn send-btn btn btn-primary" type="submit">
                                        ...
                                        <div class="col-12 mb-4 d-flex gap-2">
                                            ...
                                            <label class="form-check-label" for="privacyPolicyCheckbox">
                                                <span
                                                    class="text-white">{{ __('messages.vcard.agree_to_our') }}</span>
                                                <a href="{{ $vcardPrivacyAndTerm }}" target="_blank"
                                                    class="text-decoration-none link-info fs-6 text-secondary">{!! __('messages.vcard.term_and_condition') !!}</a>
                                                <span class="text-white">&</span>
                                                <a href="{{ $vcardPrivacyAndTerm }}" target="_blank"
                                                    class="text-decoration-none link-info fs-6 text-secondary">{{ __('messages.vcard.privacy_policy') }}</a>
                                            </label>
                                        </div>
                                    @endif
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
                <div class="create-vcard-section pt-50 px-30 position-relative">
                    <div class="bg-vector vector-14 position-absolute">
                        <img src="{{ asset('assets/img/vcard23/vector6.png') }}" alt="vector" class="w-100 h-100"
                            loading="lazy" />
                    </div>
                    <div class="section-heading text-center">
                        <h2 class="text-white text-center mb-0">{{ __('messages.create_vcard') }}</h2>
                        <span></span>
                    </div>
                    <div class="">
                        <div class="vcard-link-card card">
                            <div class="d-flex align-items-center justify-content-center gap-3"
                                ...
                                <a href="{{ config('app.url') . '/register?referral-code=' . $vcard->user->affiliate_code }}"
                                    class="text-primary text-start link-text fw-5">{{ route('register', ['referral-code' => $vcard->user->affiliate_code]) }}</a>
                ...
                @if ((isset($managesection) && $managesection['map']) || empty($managesection))
                    @if ($vcard->location_type == 0 && ($vcard->location_url && isset($url[5])))
                        <div class="map-section">
                            <div class="bg-vector vector-15 position-absolute text-end">
                                <img src="{{ asset('assets/img/vcard23/vector11.png') }}" alt="vector"
                                    class="w-100 h-100" loading="lazy" />
                            </div>
                    ...
                    <div class="text-center d-flex align-items-center justify-content-center"
                        ...
                        @if ($contactRequest == 1)
                            <a href="{{ Auth::check() ? route('add-contact', $vcard->id) : 'javascript:void(0);' }}"
                                class="add-contact-btn rounded-2
                        ...
                        @else
                            <a href="{{ route('add-contact', $vcard->id) }}" class="add-contact-btn"><i
                ...
                @else
                    @if ($vcard->made_by)
                        <a @if (!is_null($vcard->made_by_url)) href="{{ $vcard->made_by_url }}" @endif
                            ...
                            <small class="text-primary">{{ __('messages.made_by') }} {{ $vcard->made_by }}</small>
                        </a>
                    @else
                        <div class="text-center">
                            <small class="text-primary">{{ __('messages.made_by') }}
                    ...
                    <div>
                        <a class="text-decoration-none cursor-pointer terms-policies-btn"
                            href="{{ $vcardPrivacyAndTerm }}"><small
                                class="text-primary">{!! __('messages.vcard.term_policy') !!}</small></a>
                    </div>
                @endif
            </div>
            ...
            <div class="btn-section cursor-pointer @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
                <div class="fixed-btn-section">
                    @if (empty($vcard->hide_stickybar))
                        <div
                            class="bars-btn consulting-bars-btn @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') vcard-bars-btn-left @endif">
                                ...
                                <div
                                    ...
                                    <button type="button"
                                        class="vcard23-btn-group vcard23-share vcard23-sticky-btn mb-3 px-2 py-1"><i
                                            class="fas fa-share-alt fs-4 text-white mt-1"></i></button>
                        ...
                        <div class="modal-content animate-bottom" id="newsLatter-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form action="" method="post" id="newsLatterForm">
                                    ...
                                    <div
                                        class="mb-2 mt-3 d-flex gap-1 justify-content-center align-items-center email-input">
                                        <div class="w-100">
                                            <input type="email"
                    ...
                    <div class="modal-content" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        ...
                        <div class="modal-body">
                            ...
                            <a href="http://twitter.com/share?url={{ $shareUrl }}&text={{ $vcard->name }}&hashtags=sharebuttons"
                                ...
                                <div class="row">
                                    <div class="col-2">
                                        <span class="fa-2x"><svg xmlns="http://www.w3.org/2000/svg"
                                                height="1em"
