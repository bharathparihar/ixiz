...
<head>
    ...
    {{-- css link --}}
    <link rel="stylesheet" href="{{ mix('assets/css/vcard4.css') }}">
...
<body>
    <div class="container p-0">
        ...
        @endif
        <div
            class="main-content vcard w-100 mx-auto content-blur allSection  @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
            ...
            <div class="vcard__banner w-100 position-relative">
                ...
                @elseif($vcard->cover_type == 1)
                    @if (strpos($vcard->cover_url, '.mp4') !== false ||
                        ...
                        <video class="cover-video banner-image {{ $coverClass }}" autoplay loop muted playsinline
                ...
                @elseif ($vcard->cover_type == 2)
                    <div class="youtube-link-4">
                        <iframe
                            ...
                            class="cover-video banner-image {{ $coverClass }}" frameborder="0"
            ...
            @if (getLanguage($vcard->default_language) != 'Arabic' && getLanguage($vcard->default_language) != 'Persian')
                <div
                    class="vcard__profile d-flex px-4 flex-sm-row flex-column @if ($vcard->cover_type == 2) profile-margin @endif">
                    <div class="vcard__avatar">
                        <img src="{{ $vcard->profile_url }}" class="rounded-circle" loading="lazy" />
                    </div>
                    <div class="vcard__position d-flex flex-column mx-sm-4 align-items-center">
                        <div class="d-flex flex-column vcard_details">
                            ...
                            <span
                                class="avatar-designation text-sm-start text-center p-1">{{ ucwords($vcard->occupation) }}</span>
                            <span
                                class="avatar-designation text-sm-start text-center ms-1">{{ ucwords($vcard->job_title) }}</span>
                            <span
                                class="avatar-company text-sm-start text-center">{{ ucwords($vcard->company) }}</span>
                        </div>
                        @if (checkFeature('social_links') && getSocialLink($vcard))
                            <div class="social-icons d-flex flex-wrap justify-content-center pt-4 vcard__social">
                                @foreach (getSocialLink($vcard) as $value)
                                    <span
                                        class="icons rounded-circle d-flex justify-content-center align-items-center">
                                        {!! $value !!}
                                    </span>
                                @endforeach
                            </div>
            ...
            {{-- profile details --}}
            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian')
                <div class="vcard__profile d-flex align-items-center px-4 flex-sm-row flex-column" dir="rtl">
                    <div class="vcard__avatar">
                        <img src="{{ $vcard->profile_url }}" class="rounded-circle" loading="lazy" />
                    </div>
                                ...
                                <div class="col-sm-6 col-12">
                                    <div
                                        ...
                                        <a href="tel:+{{ $vcard->region_code }}{{ $vcard->phone }}"
                                            class="event-name text-center mb-0 pt-2 text-decoration-none"
            ...
            @if ((isset($managesection) && $managesection['galleries']) || empty($managesection))
                @if (checkFeature('gallery') && $vcard->gallery->count())
                    <div class="pt-4 px-4 mt-0 pb-7 mb-5 pb-9">
            ...
            @if ((isset($managesection) && $managesection['products']) || empty($managesection))
                @if (checkFeature('products') && $vcard->products->count())
                    <div class="pt-4 px-4 position-relative mt-0 ">
                        <div class="vcard__product mt-3 pb-6 mb-5">
                            ...
                            <div class="container mt-2">
                                        ...
                                        <div class="col-6">
                                            <a @if ($product->product_url) href="{{ $product->product_url }}" @endif
                                                ...
                                                <div class="card product-card h-100 border-0 w-100">
                                                    ...
                                                    <div class="product-details mt-3 d-flex justify-content-between flex-column">
                                                        <div>
                                                            <h4>{{ $product->name }}</h4>
                                                           {{--  <p class="mb-2">
                                                                {{ $product->description }}
                                ...
                                <div class="text-center me-5 ms-5 pt-5 mt-5">
            ...
            @if ((isset($managesection) && $managesection['whatsapp_store']) || empty($managesection))
                @if ($whatsappStore->count())
                    <div class="container">
                        <div class="vcard__whatsapp-store mt-3 pb-16">
                            <div class="whatsapp-store-header-title">
                                <h4 class="vcard__heading mb-4 text-center">
                                    {{ __('messages.feature.whatsapp_store') }}
                                </h4>
                            </div>

                            <div class="row g-4 justify-content-center whatsapp-store-vcard">
                                @foreach ($whatsappStore as $store)
                                    <div class="col-6">
                                        <div class="card whatsapp-store-shadow h-100 border-0 w-100">
            ...
            @if ((isset($managesection) && $managesection['testimonials']) || empty($managesection))
                @if (checkFeature('testimonials') && $vcard->testimonials->count())
                    <div class="px-4 mt-5 pb-7">
                        <div class="vcard__testimonial mb-5 pb-4">
                                        ...
                                        <div class="col-6">
                                            <div class="card testimonial-card h-100 border-0 w-100">
                                                <img src="{{ $testimonial->image_url }}"
                                                    class="testimonial-image d-block mx-auto" loading="lazy" />
                        ...
                        <nav>
                            <div class="row insta-toggle">
                                <div class="nav nav-tabs px-0" id="nav-tab" role="tablist">
                                    <button
                                        class="d-flex align-items-center justify-content-center active postbtn instagram-btn fs-2 border-0 py-2"
                                    ...
                                    <button
                                        class="d-flex align-items-center justify-content-center instagram-btn reelsbtn fs-2 border-0 py-2"
            ...
            @if ((isset($managesection) && $managesection['linkedin_embed']) || empty($managesection))
                @if (checkFeature('linkedin_embed') && $vcard->linkedinEmbed->count())
                    <div class="mt-5">
                        <h4 class="vcard__heading text-center pt-5">{{ __('messages.feature.linkedin_embed') }}
                        </h4>
                ...
                @if ($vcard->businessHours->count())
                    ...
                    <div class="vcard__timing mb-10 mt-0">
                        <div class="px-4 hours-section">
                            ...
                            <div class="row g-3 mx-sm-4" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
            ...
            @if ((isset($managesection) && $managesection['appointments']) || empty($managesection))
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="vcard__appointment mt-0 mb-5 pb-4">
                        ...
                        <div class="container">
                            <div class="appointment">
                                ...
                                <button type="button"
                                    class="appointmentAdd appoint-btn rounded text-white mt-4 d-block mx-auto d-none">{{ __('messages.make_appointments') }}
                                </button>
            ...
            @if ((isset($managesection) && $managesection['payment_link']) || empty($managesection))
                @if (checkFeature('payment_link') && $vcard->paymentLinks->count())
                    <div class="main-section">
                        <div class="payment-link-section pb-5">
                            <h4 class="vcard__heading heading-line position-relative text-center mb-5">{{ __('messages.vcard.payment_links') }}</h4>
            ...
            @php
                $currentSubs = $vcard
                    ...
                    ->first();
            @endphp
            <div class="vcard__contact-us">
                @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
                    <div class="px-4 mb-5 mt-8 inquries">
                                ...
                                <div class="contact-form px-sm-5" dir="rtl">
                                    ...
                                    <div class="mb-3">
                                        <input type="tel" name="phone" class="form-control text-start"
                                            id="phone" placeholder="{{ __('messages.form.enter_phone') }}"
                                            onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,&quot;&quot;)">
                                    </div>
                                    <div class="mb-3">
                                        <textarea class="form-control text-start" placeholder="{{ __('messages.form.type_message') }}" name="message"
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
                <div class="container mb-10">
                    ...
                    <div class=" link-back p-4 text-center rounded">
            ...
            @if ((isset($managesection) && $managesection['map']) || empty($managesection))
                ...
                @endif
            @endif
            <div class="d-flex justify-content-evenly pt-8">
                ...
                <div
                    ...
                    <div class="sub-btn d-none">
                        <div class="sub-btn-div @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') sub-btn-div-left @endif">
                            ...
                            @endif
                            @if (empty($vcard->hide_stickybar))
                                <div class="{{ isset($vcard->whatsapp_share) ? 'vcard4-btn-group' : 'stickyIcon' }}">
                                    <button type="button"
                    ...
                    <div class="w-100 d-flex justify-content-center sticky-vcard-div sticky-vcard4-div">
                            ...
                            <div class="" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                @if ($contactRequest == 1)
                                    <a href="{{ Auth::check() ? route('add-contact', $vcard->id) : 'javascript:void(0);' }}"
                                        class="vcard4-sticky-btn add-contact-btn d-flex justify-content-center text-white align-items-center rounded px-5 text-decoration-none py-1 justify-content-center
                                ...
                                <div class="modal-content animate-bottom" id="newsLatter-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form action="" method="post" id="newsLatterForm">
                                            ...
                                            <div
                                                class="mb-3 mt-5 d-flex gap-1 justify-content-center align-items-center email-input border-none">
                                                <div class="w-100">
                                                    <input type="email"
                                                        class="form-control bg-dark border-dark text-light email-input"
