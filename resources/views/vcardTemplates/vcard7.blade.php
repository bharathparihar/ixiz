...
<head>
    ...
    {{-- css link --}}
    <link rel="stylesheet" href="{{ mix('assets/css/vcard7.css') }}">
...
<body>
    <div class="container main-section  @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
        ...
        <div class="row d-flex justify-content-center content-blur">
            <div class="main-bg p-0 collapse show allSection">
                ...
                @endif
                {{-- End support banner --}}
                <div class="main-banner position-relative @if ($vcard->cover_type == 2) banner-height @endif ">
                    @php
                    ...
                    @elseif($vcard->cover_type == 1)
                        @if (strpos($vcard->cover_url, '.mp4') !== false ||
                            ...
                            <video height="400px" class="cover-video banner-image {{ $coverClass }}" autoplay loop muted playsinline alt="background video" id="cover-video">
                ...
                <div class="container @if ($vcard->cover_type == 2) profile-margin @endif">
                    <div class="main-profile ">
                        <div class="profile-img my-8">
                            <div class="mb-4">
                                            ...
                                            <div class="card border-0 bg-transparent h-100">
                                                <div class="event-icon text-center h-100">
                                                    ...
                                                    <a href="tel:+{{ $vcard->region_code }}{{ $vcard->phone }}"
                                                        class="mb-0 event-text text-decoration-none"
                        ...
                        @if (getLanguage($vcard->default_language) != 'Arabic' && getLanguage($vcard->default_language) != 'Persian')
                            <div class="main-Qr-section mb-5">
                                ...
                                <div class="row d-flex">
                                    <div class="col-lg-6">
                                        <div class="text-center mb-4 qr-svg-padding-10px" id="qr-code-seven">
                                            @if (isset($customQrCode['applySetting']) && $customQrCode['applySetting'] == 1)
                                                {!! QrCode::color(
                                                    ...
                                                    )->style($customQrCode['style'])->eye($customQrCode['eye_style'])->size(146)->format('svg')->generate(Request::url()) !!}
                                            @else
                                                {!! QrCode::size(146)->format('svg')->generate(Request::url()) !!}
                                            @endif
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                ...
                @if ((isset($managesection) && $managesection['galleries']) || empty($managesection))
                    @if (checkFeature('gallery') && $vcard->gallery->count())
                        <div class="container p-3 my-3">
                            <div class="gallery-main-section mb-8 mt-0 pb-1">
                ...
                @if ((isset($managesection) && $managesection['products']) || empty($managesection))
                    @if (checkFeature('products') && $vcard->products->count())
                        <div class="container  mt-0">
                            <div class="product-main-section pb-4 mb-2">
                                ...
                                <div class="text-center pt-3 pb-6 mt-10">
                ...
                @if ((isset($managesection) && $managesection['whatsapp_store']) || empty($managesection))
                    @if ($whatsappStore->count())
                        <div class="container mt-0">
                            <div class="whatsapp-store-product-section pb-16 mb-2">

                                <div class="header-whatsapp-store-product">
                                    <h2 class="mb-4 text-center">
                                        {{ __('messages.feature.whatsapp_store') }}
                                    </h2>
                                </div>

                                <div class="row whatsapp-store-product-vcard d-flex justify-content-center g-3">
                                    @foreach ($whatsappStore as $store)
                                        <div class="col-6 px-3">
                                            <div class="card shadow-whatsapp-store-product w-100 border-0 h-100">
                ...
                @if ((isset($managesection) && $managesection['testimonials']) || empty($managesection))
                    @if (checkFeature('testimonials') && $vcard->testimonials->count())
                        <div class="container mb-5 pb-6">
                            <div class="testimonial-main-section pb-4 mb-2">
                ...
                @if ((isset($managesection) && $managesection['linkedin_embed']) || empty($managesection))
                    @if (checkFeature('linkedin_embed') && $vcard->linkedinEmbed->count())
                        <div class="pt-5">
                            <h4 class="insta-head text-center pb-4">{{ __('messages.feature.linkedin_embed') }}
                            </h4>
                ...
                @if ((isset($managesection) && $managesection['blogs']) || empty($managesection))
                    @if (checkFeature('blog') && $vcard->blogs->count())
                        <div class="container vcard-seven-blog pt-5 my-5 pb-1">
                                            ...
                                            <div class="card blog-card p-2 border-0 w-100 h-100">
                                              ...
                                              <div class="blog-details mt-4">
                                                    <a href="{{ $vcardBlogUrl }}" class="text-decoration-none">
                                                        <h4 class="text-white pb-3 mb-0 title-olor text-black">
                                                            {{ $blog->title }}
                                                        </h4>
                                                        <p class="mb-1">
                ...
                @if ((isset($managesection) && $managesection['business_hours']) || empty($managesection))
                    @if ($vcard->businessHours->count())
                        ...
                        @endphp
                        <div class="container my-5 pt-4" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            <div class="business-main-section pb-3">
                    ...
                    @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                        <div class="container py-5 my-5">
                            ...
                            <div class="appointment">
                                ...
                                <button type="button"
                                    class="appointmentAdd appoint-btn mt-4 d-block shadow mx-auto btn btn-lg d-none">{{ __('messages.make_appointments') }}
                                </button>
                                        ...
                                        <div class="mb-2">
                                            <div class="card iframe-card p-2 border-0">
                                                <iframe src="{{ $iframe->url }}" frameborder="0"
                                                    ...
                                                    allowfullscreen height="400" loading="lazy">
                                                </iframe>
                                            </div>
                                        </div>
                                    @endforeach
                ...
                @if ((isset($managesection) && $managesection['payment_link']) || empty($managesection))
                    @if (checkFeature('payment_link') && $vcard->paymentLinks->count())
                        <div class="main-section">
                            <div class="payment-link-section container my-5">
                                <div class="header-title">
                                    <h4 class="text-center mb-4">{{ __('messages.vcard.payment_links') }}</h4>
                                </div>
                                        ...
                                        <div class="row" dir="rtl">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 mb-3 input-group">
                                                        <span
                                                            class="input-group-text contact-icon border-start-0 bg-transparent"
                                                            id="basic-addon1"><i class="far fa-envelope"></i></span>
                                                        <input type="email" name="email"
                                                ...
                                                <div class="row">
                                                    <div class="col-12 mb-3">
                                                        <label for="exampleFormControlTextarea1"
                                                            class="form-label mb-0">{{ __('messages.user.your_message') }}
                                                            <span class="text-danger">*</span></label>
                                                        <textarea class="form-control contact-input bg-transparent text-start" name="message" id="message" rows="7"
                                                            placeholder="{{ __('messages.form.type_message') }}"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                ...
                @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
                    <div class="container my-5 pt-4">
                        <div class="link-section">
                            ...
                            <div class="bg-white p-4 text-center rounded link-bg affiliate-link">
                    ...
                    <div
                        ...
                        <div class="sub-btn d-none">
                            <div class="sub-btn-div @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') sub-btn-div-left @endif">
                                ...
                                @if (empty($vcard->hide_stickybar))
                                    <div
                                        class="{{ isset($vcard->whatsapp_share) ? 'vcard7-btn-group' : 'stickyIcon' }}">
                                        <button type="button"
                ...
                {{-- add-contact --}}
                <div class="w-100 d-flex justify-content-center sticky-vcard-div mb-4">
                        ...
                        <div class="" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            @if ($contactRequest == 1)
                                <a href="{{ Auth::check() ? route('add-contact', $vcard->id) : 'javascript:void(0);' }}"
                                    class="vcard7-sticky-btn add-contact-btn d-flex justify-content-center ms-0 text-dark align-items-center rounded px-5 text-decoration-none py-1 justify-content-center shadow
                                ...
                                <div class="modal-body">
                                    ...
                                    <form action="" method="post" id="newsLatterForm">
                                        ...
                                        <div
                                            ...
                                            <div class="w-100">
                                                <input type="email"
                                                    class="email-input form-control bg-dark border-dark text-light"
    ...
    <script>
        ...
        $('.whatsapp-store-product-vcard').slick({
            dots: false,
            infinite: true,
            arrows: true,
            speed: 300,
