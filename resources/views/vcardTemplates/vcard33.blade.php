...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/custom-vcard.css?$mixID') }}">
...
<body>
    ...
    <div class="container p-0">
        ...
        @endif
        <div
            class="main-content mx-auto w-100 overflow-hidden position-relative @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
            {{-- Pwa support --}}
                    ...
                    <div class="support-banner d-flex align-items-center justify-content-center">
                        ...
                        <div>
                            ...
                            <div class="text-center mt-3">
                                <a href="{{ $banners->url }}" class="act-now text-white overflow-hidden" target="blank"
                                    data-turbo="false">
                                    <div class="wave"></div>
            ...
            <div class="profile-section position-relative pt-40">
                <div class="profile-bg h-100"> <img src="{{ asset('assets/img/vcard33/profile-bg2.png') }}"
                        class="w-100 h-100 object-fit-cover" alt="images" /></div>
                <div class="card d-flex flex-sm-row gap-3 gap-sm-5 align-items-center px-30">
                    ...
                    <div class="card-body p-0 text-sm-start text-center">
                        <div class="profile-name">
                            ...
                            <p class="fs-18 text-primary mb-1 fw-5 text-decoration-underline">
            ...
            @if (checkFeature('social_links') && getSocialLink($vcard))
                <div class="social-media-section pt-40 position-relative px-30"
                    ...
                    <div class="position-absolute vector-all vector-1">
                        <img src="{{ asset('assets/img/vcard33/vector-bg-1.png') }}" class="w-100"
                            alt="images" />
                    </div>
                    <div class="social-media d-flex flex-wrap justify-content-center">
                        @foreach (getSocialLink($vcard) as $value)
                            <span
                                class="social-icon d-flex justify-content-center align-items-center position-relative">
                                {!! $value !!}
                                <div class="play-svg d-flex">
                                    <svg width="50" height="50" viewBox="0 0 50 50" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M0.904941 25.0022V10.1471C0.904942 1.64099 7.36193 -1.91343 15.2509 2.20481L29.8832 9.85294L43.6303 17.0598C51.9879 21.4232 51.9879 28.5811 43.6303 32.9445L29.8573 40.1513L15.2249 47.7995C7.33589 51.9177 0.878905 48.3388 0.878906 39.8572V25.0022H0.904941Z"
                                            fill="url(#paint0_linear_654_3)" />
                                        <defs>
                                            <linearGradient id="paint0_linear_654_3" x1="33.5" y1="40"
                                                x2="4" y2="-3.68222e-06" gradientUnits="userSpaceOnUse">
                                                <stop stop-color="#7566E3" />
                                                <stop offset="1" stop-color="#CE4D86" />
                                            </linearGradient>
                                        </defs>
                                    </svg>
                                </div>
            ...
            @if (checkFeature('custom-links') && $customLink->isNotEmpty())
                <div class="custom-link-section">
                    <div class="custom-link d-flex flex-wrap gap-3 justify-content-center pt-30 px-30 w-100">
                ...
                @if (
                    ...
                    <div class="pt-50 px-30 position-relative">
                        <div class="position-absolute vector-all vector-2 text-end">
                            <img src="{{ asset('assets/img/vcard33/vector-bg-2.png') }}" class="w-100"
                                alt="images" />
                        </div>
                        <div class="contact-section">
                            <div class="section-heading text-center text-primary">
                                <h2 class="mb-0 fw-6 text-gradient">{{ __('messages.contact_us.contact') }}</h2>
                            </div>
                                        ...
                                        <div class="col-sm-6 mb-4">
                                            <div class="contact-box d-flex align-items-center">
                                                <div
                                                    ...
                                                    <img src="{{ asset('assets/img/vcard33/email.svg') }}" />
                                                    <div class="play-svg">
                                                        <svg width="45" height="45" viewBox="0 0 50 50"
                                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path
                                                                d="M0.0265553 25.0022L0.026556 9.85C0.0265564 1.17377 6.61268 -2.45174 14.6594 1.74886L29.5844 9.54996L43.6064 16.901C52.1312 21.3516 52.1312 28.6527 43.6064 33.1033L29.5579 40.4543L14.6329 48.2554C6.58612 52.456 -2.08198e-07 48.8055 1.69959e-07 40.1543L8.3228e-07 25.0022L0.0265553 25.0022Z"
                                                                fill="white" />
                                                        </svg>
                                                    </div>
                                                </div>
                                    ...
                                    @if ($vcard->phone)
                                        <div class="col-sm-6 mb-4">
                                            <div class="contact-box d-flex align-items-center">
                                                <div
                                                    class="contact-icon d-flex justify-content-center align-items-center">
                                                    <img src="{{ asset('assets/img/vcard33/phone.svg') }}" />
                                                    <div class="play-svg">
                                                        <svg width="45" height="45" viewBox="0 0 50 50"
                                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path
                                                ...
                                                <div class="contact-desc">
                                                    <a href="tel:+{{ $vcard->region_code }}{{ $vcard->phone }}"
                                                        class="text-white fs-14 fw-5">+{{ $vcard->region_code }}{{ $vcard->phone }}</a>
                                                </div>
                                            </div>
                                        </div>
                                    @endif
                                            ...
                                            <div class="contact-box d-flex align-items-center">
                                                ...
                                                <div class="contact-desc">
                                                    <a href="tel:+{{ $vcard->alternative_region_code }}{{ $vcard->alternative_phone }}"
                                                        class="text-white fs-14 fw-5">+{{ $vcard->alternative_region_code }}{{ $vcard->alternative_phone }}</a>
                                                </div>
                                            </div>
                                        </div>
                                    @endif
                                    @if ($vcard->dob)
                                        <div class="col-sm-6 mb-sm-0 mb-4">
                                            <div class="contact-box d-flex align-items-center">
                                                <div
                                                    class="contact-icon d-flex justify-content-center align-items-center">
                                                    <img src="{{ asset('assets/img/vcard33/dob.svg') }}" />
                                                    <div class="play-svg">
                                                        <svg width="45" height="45" viewBox="0 0 50 50"
                                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path
                                                ...
                                                <div class="contact-desc">
                                                    <p class="mb-0 text-white fs-14 fw-5">{{ $vcard->dob }}</p>
                                                </div>
                                            </div>
                                        </div>
                                    @endif
                                    @if ($vcard->location)
                                        <div class="col-sm-6">
                                            <div class="contact-box d-flex align-items-center">
                                                <div
                                                    class="contact-icon d-flex justify-content-center align-items-center">
                                                    <img src="{{ asset('assets/img/vcard33/location.svg') }}" />
                                                    <div class="play-svg">
                                                        <svg width="45" height="45" viewBox="0 0 50 50"
                                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path
                                                ...
                                                <div class="contact-desc">
                                                    <p class="mb-0 text-white fs-14 fw-5">{!! ucwords($vcard->location) !!}</p>
                                                </div>
                                            </div>
                                        </div>
                                    @endif
                ...
                @if (checkFeature('gallery') && $vcard->gallery->count())
                    <div class="gallery-section pt-50 position-relative">
                        <div class="position-absolute vector-all vector-3">
                            <img src="{{ asset('assets/img/vcard33/vector-bg-3.png') }}" class="w-100"
                                alt="images" />
                        </div>
                        <div class="section-heading text-center">
                            <h2 class="mb-0 fw-6 text-gradient">{{ __('messages.plan.gallery') }}</h2>
                        </div>
                ...
                @if (checkFeature('services') && $vcard->services->count())
                    <div class="our-services-section pt-50 position-relative">
                        <div class="position-absolute vector-all vector-4 text-end">
                            <img src="{{ asset('assets/img/vcard33/vector-bg-4.png') }}" class="w-100"
                                alt="images" />
                        </div>
                        <div class="section-heading text-center">
                            <h2 class="mb-0 fw-6 text-gradient">{{ __('messages.vcard.our_service') }}</h2>
                        </div>
                        <div class="services">
                                        ...
                                        @foreach ($vcard->services as $service)
                                            <div class="card-wrapper">
                                                <div class="service-card h-100">
                                                    <div
                                                        class="card-img d-flex justify-content-center align-items-center. position-relative">
                                                    ...
                                                    <div class="card-body w-100">
                                                        ...
                                                        <p
                                                            class="mb-0 text-white text-center description-text {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}">
                ...
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="pt-50 position-relative">
                        <div class="position-absolute vector-all vector-5">
                            <img src="{{ asset('assets/img/vcard33/vector-bg-5.png') }}" class="w-100"
                                alt="images" />
                        </div>
                        <div class="appointment-section pt-60 pb-60 px-30"
                            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            <div class="section-heading text-center text-white">
                                <h2 class="mb-0 fw-6">{{ __('messages.make_appointments') }}</h2>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 mx-auto">
                                        <div class="position-relative">
                                            {{ Form::text('date', null, [
                                                'class' => 'date form-control appointment-input text-start',
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="text-center">
                                            <button class="appoint-btn appointmentAdd btn btn-gradient d-none mt-3">
                                                <div class="wave"></div>
                ...
                @if (checkFeature('products') && $vcard->products->count())
                    <div class="product-section pt-50 px-20 position-relative">
                        <div class="position-absolute vector-all vector-6 text-end">
                            <img src="{{ asset('assets/img/vcard33/vector-bg-6.png') }}" class="w-100"
                                alt="images" />
                        </div>
                        <div class="section-heading text-center">
                            <h2 class="mb-0 fw-6 text-gradient">{{ __('messages.plan.products') }}</h2>
                        </div>
                                    ...
                                    <div class="card-wrapper">
                                        <div class="product-card card">
                                            <a @if ($product->product_url) href="{{ $product->product_url }}" @endif
                                                ...
                                                <div
                                                    class="product-desc card-body w-100 position-relative overflow-hidden">
                                                    <div>
                                                        <h3 class="text-center fw-5 mb-0 product-title">
                                                            {{ $product->name }}</h3>
                                                        <div class="d-flex justify-content-between mt-2 product-info">
                                                            <p class="amount product-amount mb-0">
                                                                @if ($product->currency_id && $product->price)
                                                                    <span
                                                                        class="fw-6 text-white">{{ currencyFormat($product->price, 2, $product->currency->currency_code) }}</span>
                                                                @elseif($product->price)
                                                                    <span
                                                                        class="fw-6 text-white">{{ currencyFormat($product->price, 2, getUserCurrencyIcon($vcard->user->id)) }}</span>
                                                                @endif
                                                            </p>
                        ...
                        <div class="mx-auto mt-4 text-center">
                            <a class=" btn btn-gradient d-inline-flex gap-2 align-items-center view-more"
                                href="{{ route('showProducts', ['id' => $vcard->id, 'alias' => $vcard->url_alias]) }}">
                                <div class="wave"></div>
                                {{ __('messages.analytics.view_more') }} <i
                                    class="fa-solid fa-arrow-right-long right-arrow-animation"></i>
                            </a>
                        </div>
                    </div>
                @endif
                ...
                @if ($whatsappStore->count())
                    <div class="whatsapp-store-product-section pt-50 px-20 position-relative">
                        ...
                        <div class="position-absolute vector-all vector-11">
                            <img src="{{ asset('assets/img/vcard33/vector-bg-12.png') }}" class="w-100"
                                alt="images" />
                        </div>

                        <div class="section-heading text-center">
                            <h2 class="mb-0 fw-6 text-gradient">{{ __('messages.feature.whatsapp_store') }}</h2>
                        </div>
                                ...
                                <div>
                                    <div class="card-wrapper">
                                        <div class="whatsapp-store-box card">
                                            <div class="whatsapp-store-img card-img position-relative overflow-hidden">
                                                <img src="{{ $product->cover_url }}"
                                                    class="w-100 h-100 object-fit-cover"
                                                    alt="store" />
                                            </div>

                                            <div class="whatsapp-store-content card-body w-100 position-relative overflow-hidden"
                                                @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>

                                                <div>
                                                    <h3 class="text-center fw-5 mb-0 whatsapp-store-name">
                                                        {{ $product->store_name }}
                                                    </h3>
                ...
                @if (checkFeature('testimonials') && $vcard->testimonials->count())
                    <div class="pt-50 px-20 position-relative">
                        <div class="position-absolute vector-all vector-7">
                            <img src="{{ asset('assets/img/vcard33/vector-bg-7.png') }}" class="w-100"
                                alt="images" />
                        </div>
                        <div class="testimonial-section  position-relative">
                            <div class="section-heading text-center">
                                <h2 class="mb-0 fw-6 text-gradient">{{ __('messages.plan.testimonials') }}</h2>
                            </div>
                                    ...
                                    <div>
                                        <div class="testimonial-card card">
                                            ...
                                            <div class="testimonial-content">
                                                <div
                                                    class="quote-left quote d-flex align-items-center justify-content-center">
                                                    <img src=" {{ asset('assets/img/vcard33/quote-left.svg') }}"
                                                        alt="quote-left" />
                                                </div>
                                                <div
                                                    class="quote-right quote d-flex align-items-center justify-content-center">
                                                    <img src=" {{ asset('assets/img/vcard33/quote-right.svg') }}"
                                                        alt="quote-left" />
                                                </div>
                                                ...
                                                <div class="card-body p-0 text-center">
                                                    <h3 class="text-primary text-decoration-underline mb-10">
                ...
                @if (checkFeature('insta_embed') && $vcard->instagramEmbed->count())
                    <div class="pt-50 position-relative">
                        <div class="position-absolute vector-all vector-8 text-end">
                            <img src="{{ asset('assets/img/vcard33/vector-bg-8.png') }}" class="w-100"
                                alt="images" />
                        </div>
                        <div>
                            <div class="section-heading text-center">
                                <h2 class="mb-0 fw-6 text-gradient">{{ __('messages.feature.insta_embed') }}</h2>
                            </div>
                            <nav class="px-30">
                ...
                @if (checkFeature('linkedin_embed') && $vcard->linkedinEmbed->count())
                    <div class="pt-50 position-relative">
                        <div class="section-heading mb-5 text-center">
                            <h2 class="mb-0 fw-6 text-gradient">{{ __('messages.feature.linkedin_embed') }}</h2>
                        </div>
                ...
                @if (checkFeature('blog') && $vcard->blogs->count())
                    <div class="blog-section pt-50 px-20 position-relative">
                        <div class="position-absolute vector-all vector-9">
                            <img src="{{ asset('assets/img/vcard33/vector-bg-9.png') }}" class="w-100"
                                alt="images" />
                        </div>
                        <div class="section-heading text-center">
                            <h2 class="mb-0 fw-6 text-gradient">{{ __('messages.feature.blog') }}</h2>
                        </div>
                                ...
                                <div>
                                    <div class="card-wrapper">
                                        <div class="blog-card card"
                                            ...
                                            <div class="card-body">
                                                <h5 class="fw-5 text-white mb-2">{{ $blog->title }}</h5>
                                                ...
                                                <div class="mt-3 d-flex align-items-center justify-content-end">
                                                    <a href="{{ route('vcard.show-blog', [$vcard->url_alias, $blog->id]) }}"
                                                        class="d-inline-flex align-items-center justify-content-end gap-2 bg-white text-primary fs-14 read-more">
                                                        {{ __('messages.vcard_11.read_more') }} <i
                ...
                @if ($vcard->businessHours->count())
                    ...
                    <div class="pt-50 px-30 position-relative">
                        <div class="position-absolute vector-all vector-10 text-end">
                            <img src="{{ asset('assets/img/vcard33/vector-bg-10.png') }}" class="w-100"
                                alt="images" />
                        </div>
                        <div class="business-hour-section position-relative">
                            <div class="section-heading text-center">
                                <h2 class="mb-0 fw-6 text-gradient">{{ __('messages.business.business_hours') }}</h2>
                            </div>
                            @if (getLanguage($vcard->default_language) != 'Arabic' && getLanguage($vcard->default_language) != 'Persian')
                                <div class="row row-gap-15px justify-content-center">
                                    ...
                                    @foreach ($businessDaysTime as $key => $dayTime)
                                        <div class="col-sm-6">
                                            <div
                                                class="business-hour-card d-flex align-items-center flex-wrap flex-sm-nowrap gap-2">
                                                <div class="time-icons text-primary position-relative">
                                                    <div class="calender-icon">
                                                        <img src=" {{ asset('assets/img/vcard33/calender-icon.svg') }}"
                                                            alt="business-hour-bg-img" class="w-100">
                                                    </div>
                                                    <div class="play-svg">
                                                        <svg width="45" height="45" viewBox="0 0 50 50"
                                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <div class="d-flex gap-1 flex-column">
                                                    ...
                                                    <div
                                                        class="d-flex gap-3 align-items-center justify-content-end fs-14 fw-5 text-white">
                            ...
                            @endif
                            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian')
                                <div class="row row-gap-15px justify-content-center" dir="rtl">
                                    @php
                                        $weekFormat = $vcard->week_format ?? 1;
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                <div class="qr-code-section pt-50 px-30 position-relative">
                    <div class="position-absolute vector-all vector-11">
                        <img src="{{ asset('assets/img/vcard33/vector-bg-11.png') }}" class="w-100"
                            alt="images" />
                    </div>
                    <div class="section-heading text-center">
                        <h2 class="mb-0 fw-6 text-gradient">{{ __('messages.vcard.qr_code') }}</h2>
                    </div>
                    <div class="card-wrapper">
                        <div class="qr-code mx-auto position-relative">
                            <div class="qr-content">
                                <div class="d-flex gap-3 align-items-center flex-wrap flex-sm-nowrap justify-content-center text-center text-sm-start"
                                    ...
                                    <div>
                                        <h5 class="text-white fs-20 fw-6">{{ __('messages.vcard.scan_to_contact') }}
                                        </h5>
                                        <p class="fs-14 text-white mb-0">{{ __('messages.vcard.qr_section_desc') }}
                                        </p>
                                    </div>
                                </div>
                            </div>
            ...
            @if ((isset($managesection) && $managesection['iframe']) || empty($managesection))
                @if (checkFeature('iframes') && $vcard->iframes->count())
                    <div class="iframe-section pt-50 px-20 position-relative">
                        ...
                        <div class="section-heading text-center">
                            <h2 class="mb-0 fw-6 text-gradient">{{ __('messages.vcard.iframe') }}</h2>
                        </div>
            ...
            @if ((isset($managesection) && $managesection['payment_link']) || empty($managesection))
                @if (checkFeature('payment_link') && $vcard->paymentLinks->count())
                    <div class="payment-link-section px-20 pt-50 position-relative"
                        ...
                        <div class="section-heading text-center">
                            <h2 class="mb-0 fw-6 text-gradient">{{ __('messages.vcard.payment_links') }}</h2>
                        </div>
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
                <div class="pt-50 px-30 position-relative">
                    <div class="position-absolute vector-all vector-13">
                        <img src="{{ asset('assets/img/vcard33/vector-bg-13.png') }}" class="w-100"
                            alt="images" />
                    </div>
                    <div class="contact-us-section position-relative">
                        <div class="section-heading text-center">
                            <h2 class="mb-0 fw-6 text-gradient">{{ __('messages.contact_us.inquries') }}</h2>
                        </div>
                        @if (getLanguage($vcard->default_language) != 'Arabic' && getLanguage($vcard->default_language) != 'Persian')
                            <div class="contact-form">
                                <form action="" id="enquiryForm" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 px-0">
                                            <textarea class="form-control h-100" placeholder="{{ __('messages.form.type_message') }}" name="message"
                                                rows="3"></textarea>
                                        </div>
                                            ...
                                            <div class="mb-3 mt-3 px-0">
                                                ...
                                                <div class="wrapper-file-section">
                                                    <div class="selected-files" id="selectedFilesSection"
                                                        ...
                                                        <ul class="file-list ps-0" id="fileList"></ul>
                                                    </div>
                                                </div>
                                            </div>
                                        @endif
                                        @if (!empty($vcard->privacy_policy) || !empty($vcard->term_condition))
                                            <div class="col-12 mb-4 mt-2 d-flex gap-2 px-0">
                                                ...
                                                <label class="form-check-label fs-14" for="privacyPolicyCheckbox">
                                                    <span
                                                        class="text-black fs-14">{{ __('messages.vcard.agree_to_our') }}</span>
                                                    <a href="{{ route('vcard.show-privacy-policy', [$vcard->url_alias, $vcard->id]) }}"
                                                        target="_blank"
                                                        class="text-decoration-underline link-info text-primary fs-14">{!! __('messages.vcard.term_and_condition') !!}</a>
                                                    <span class="text-black fs-14">&</span>
                                                    <a href="{{ route('vcard.show-privacy-policy', [$vcard->url_alias, $vcard->id]) }}"
                                                        target="_blank"
                                                        class="text-decoration-underline link-info text-primary fs-14">{{ __('messages.vcard.privacy_policy') }}</a>
                                                </label>
                                            </div>
                                        @endif
                                        <div class="col-12 text-center">
                                            <button class="btn btn-gradient w-100 send-btn" type="submit">
                                                <div class="wave"></div>
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
                <div class="create-vcard-section pt-50 px-30 position-relative">
                    <div class="position-absolute vector-all vector-14 text-end">
                        <img src="{{ asset('assets/img/vcard33/vector-bg-14.png') }}" class="w-100"
                            alt="images" />
                    </div>
                    <div class="content">
                        <div class="section-heading text-center">
                            <h2 class="mb-0 fw-6 text-gradient">{{ __('messages.create_vcard') }}</h2>
                        </div>
                        <div class="card-wrapper">
                                ...
                                <div class="vcard-link-card card">
                                    <div class="d-flex gap-3 align-items-center justify-content-center"
                                        ...
                                        <a href="{{ config('app.url') . '/register?referral-code=' . $vcard->user->affiliate_code }}"
                                            class="text-white fs-14 d-block">{{ route('register', ['referral-code' => $vcard->user->affiliate_code]) }}</a>
                ...
                @if ($vcard->location_url && isset($url[5]))
                    <div class="pt-50 px-30 position-relative">
                        <div class="position-absolute vector-all vector-15">
                            <img src="{{ asset('assets/img/vcard33/vector-bg-15.png') }}" class="w-100"
                                alt="images" />
                        </div>
                        <div class="map-section">
                            <div class="map-content">
                                <div class="map-location d-flex gap-2 align-items-center py-2"
                                    @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                ...
                                <iframe width="100%" height="300px"
                                    ...
                                    style="border-radius:0 0 18px 18px;"></iframe>
                            </div>
                        </div>
                    </div>
                @endif
                    ...
                    <div class="text-center d-flex align-items-center justify-content-center"
                        ...
                        @if ($contactRequest == 1)
                            <a href="{{ Auth::check() ? route('add-contact', $vcard->id) : 'javascript:void(0);' }}"
                                class="add-contact-btn add-contact-btn rounded-4 btn btn-gradient {{ Auth::check() ? 'auth-contact-btn' : 'ask-contact-detail-form' }}"
                                data-action="{{ Auth::check() ? route('contact-request.store') : 'show-modal' }}">
                                <div class="wave"></div>
                                <i class="fas fa-download fa-address-book fs-20"></i>
                                &nbsp;{{ __('messages.setting.add_contact') }}
                            </a>
                        @else
                            <a href="{{ route('add-contact', $vcard->id) }}"
                                class="add-contact-btn rounded-4 btn btn-gradient">
                                <div class="wave"></div>
            ...
            <div class="d-flex py-2 justify-content-evenly">
                @if (checkFeature('advanced'))
                    @if (checkFeature('advanced')->hide_branding && $vcard->branding == 0)
                        ...
                        @else
                            <div class="text-center">
                                <small class="text-gradient fw-5">{{ __('messages.made_by') }}
                ...
                <div class="fixed-btn-section">
                    @if (empty($vcard->hide_stickybar))
                        <div class="bars-btn musician-bars-btn">
                            <img src="{{ asset('assets/img/vcard33/sticky.svg') }}" />
                        ...
                        <div class="sub-btn-div @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') sub-btn-div-left @endif">
                            ...
                            @if (empty($vcard->hide_stickybar))
                                <div class="{{ isset($vcard->whatsapp_share) ? '' : 'stickyIcon' }}">
                                    <div class="vcard33-sticky-btn mb-3">
                                        <button type="button" class="vcard33-btn-group vcard33-share">
                                            {{-- <i class="fas fa-share-alt fs-4 pt-1 text-gradient"></i> --}}
                                    ...
                                    @if (!empty($vcard->enable_download_qr_code))
                                        <div class="vcard33-sticky-btn">
                                            <a type="button"
                                                class="vcard33-btn-group d-flex justify-content-center  align-items-center "
            ...
            <div class="modal-dialog news-modal modal-dialog-centered">
                <div class="modal-content animate-bottom" id="newsLatter-content">
                    ...
                    <div class="modal-body">
                        <h3 class="content text-start text-gradient p-lg-0">
    ...
    @endif
    {{-- share modal code --}}
    <div id="vcard33-shareModel" class="modal fade" role="dialog">
                    ...
                    <div class="col-12 justify-content-between social-link-modal">
                        <div class="input-group">
                            ...
                            <span id="vcardUrlCopy{{ $vcard->id }}" class="d-none" target="_blank">
                                {{ $vcardUrl }} </span>
                            <button class="copy-vcard-clipboard copy-btn btn-dark" title="Copy Link"
                                data-id="{{ $vcard->id }}">
