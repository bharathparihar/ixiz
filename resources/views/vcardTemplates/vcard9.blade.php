...
<head>
    ...
    {{-- css link --}}
    <link rel="stylesheet" href="{{ mix('assets/css/vcard9.css') }}">
...
<body>
    <div class="container p-0">
        ...
        @endif
        <div
            class="vcard-nine main-content w-100 mx-auto overflow-hidden content-blur allSection  @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
            {{-- Pwa support --}}
            ...
            <div class="vcard-nine__banner w-100 position-relative">
                ...
                @elseif($vcard->cover_type == 1)
                    @if (strpos($vcard->cover_url, '.mp4') !== false ||
                        ...
                        <video class="cover-video img-fluid banner-image {{ $coverClass }}" autoplay loop muted playsinline
                ...
                @elseif ($vcard->cover_type == 2)
                    <div class="youtube-link-9">
                        <iframe
                            ...
                            class="cover-video img-fluid banner-image {{ $coverClass }}" frameborder="0"
            ...
            {{-- profile --}}
            <div
                class="vcard-nine__profile position-relative @if ($vcard->cover_type == 2) profile-margin @endif">
            ...
            {{-- profile details --}}
            <div
                class="vcard-nine__profile-details py-3 px-sm-3 px-2 @if ($vcard->cover_type == 2) profile-desc-margin @endif"">
                            ...
                            @foreach ($customLink as $value)
                                @if ($value->show_as_button == 1)
                                    <a href="{{ $value->link }}"
                                        ...
                                        class="m-2 d-flex justify-content-center align-items-center text-decoration-none link-text text-black font-primary btn mt-2">
                                        {{ $value->link_name }}
                                    </a>
                                @else
                                    <a href="{{ $value->link }}"
                                    ...
                                    <div class="col-sm-6 col-12">
                                        <div
                                            ...
                                            <span class="event-icon d-flex justify-content-center align-items-center">
                                                <img src="{{ asset('assets/img/vcard9/vcard9-email.png') }}"
                                                    alt="email" />
                                            </span>
                                ...
                                @if ($vcard->alternative_email)
                                    <div class="col-sm-6 col-12">
                                        <div
                                            class="card event-card px-3 py-4 h-100 border-0 flex-sm-row flex-column align-items-center">
                                            <span class="event-icon d-flex justify-content-center align-items-center">
                                                <img src="{{ asset('img/vcard9/vcard9-alternate-email.png') }}"
                                        ...
                                        <div
                                            ...
                                            <div class="event-detail ms-sm-3 mt-sm-0 mt-4">
                                                ...
                                                <h5><a href="tel:+{{ $vcard->region_code }}{{ $vcard->phone }}"
                                                        class="event-name text-center mb-0 text-decoration-none"
                                ...
                                @if ($vcard->alternative_phone)
                                    <div class="col-sm-6 col-12">
                                        <div
                                            class="card event-card px-3 py-4 h-100 border-0 flex-sm-row flex-column align-items-center">
                                            <span class="event-icon d-flex justify-content-center align-items-center">
                                                <img src="{{ asset('img/vcard9/alter-phone.png') }}"
                                                    alt="phone" />
                                            </span>
                                            <div class="event-detail ms-sm-3 mt-sm-0 mt-4">
                                                <h6 class="text-sm-start text-center">
                                ...
                                @if ($vcard->dob)
                                    <div class="col-sm-6 col-12">
                                        <div
                                            ...
                                            <div class="event-detail ms-sm-3 mt-sm-0 mt-4">
                                                <h6 class="text-sm-start text-center">{{ __('messages.vcard.dob') }}
                                                </h6>
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                <div class="vcard-nine__qr-code py-4 px-3 position-relative px-sm-3 my-5">
                                ...
                                <div class="mx-2">
                                    <div class="qr-profile mb-3 d-flex justify-content-center">
                                        <img src="{{ $vcard->profile_url }}" alt="qr profile"
                                            class="mx-auto d-block rounded-circle" loading="lazy" />
                                    </div>
            ...
            @if ((isset($managesection) && $managesection['services']) || empty($managesection))
                @if (checkFeature('services') && $vcard->services->count())
                    <div class="vcard-nine__service  px-3 position-relative px-sm-3 mt-0">
                                    ...
                                    @foreach ($vcard->services as $service)
                                        <div>
                                            <div class="service-card my-1 h-100">
                                                         <div class="d-flex service-sub-card">
                                                        ...
                                                        @if ($vcard->show_service_enquiry_btn == true)
                                                                    @if ($service->service_url)
                                                                        <div class="text-center enquiry-btn mt-3">
                                                                            <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
                                                                                target="{{ $service->service_url ? '_blank' : '' }}"
                                        ...
                                        <div class="col-sm-6">
                                            <div class="card service-card">
                                                ...
                                                <div class="card-body py-4">
                                                    ...
                                                    <p
                                                        class="card-text {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}">
                                                        {!! \Illuminate\Support\Str::limit($service->description, 170, '...') !!}</p>
                                                    @if ($vcard->show_service_enquiry_btn == true)
                                                        @if ($service->service_url)
            ...
            @if ((isset($managesection) && $managesection['galleries']) || empty($managesection))
                @if (checkFeature('gallery') && $vcard->gallery->count())
                    <div class="vcard-nine__gallery px-3 position-relative px-sm-3 my-5">
                        <h4 class="heading-left heading-line position-relative text-center mb-0">
                            {{ __('messages.plan.gallery') }}</h4>
                        <div class="container">
                            <div class="row g-3 gallery-slider mt-0 p-0">
            ...
            @if ((isset($managesection) && $managesection['products']) || empty($managesection))
                @if (checkFeature('products') && $vcard->products->count())
                    <div class="vcard-nine__product py-4 px-3 position-relative px-sm-3 mt-0">
                        ...
                        <div class="container">
                                            ...
                                            <div class="card product-card p-3 border-0 w-100 product-block h-100">
                                                <div class="product-profile">
                                                    <img src="{{ $product->product_icon }}" alt="profile"
                                                        class="w-100 object-fit-contain" height="208px" />
                                                </div>
                                                    ...
                                                    <div class="d-flex justify-content-between mt-2 product-info">
                                                        <div class="product-amount">
                                                            @if ($product->currency_id && $product->price)
                                                                <span
                                                                    class="text-black">{{ currencyFormat($product->price, 2, $product->currency->currency_code) }}</span>
                                                            @elseif($product->price)
                                                                <span
                                                                    class="text-black">{{ currencyFormat($product->price, 2, getUserCurrencyIcon($vcard->user->id)) }}</span>
                                                            @endif
                                                        </div>
                                                            ...
                                                            @if ($product->product_url)
                                                                <div class="enquiry-btn">
                                                                    <a href="{{ $product->product_url ?? 'javascript:void(0)' }}"
                                                                        ...
                                                                        {{ __('messages.contact_us.enquiry') }}
                                                                    </a>
                                                                </div>
                                                            @endif
                                                        @endif
                            ...
                            <div class="text-center me-5 ms-5 mt-10">
            ...
            @if ((isset($managesection) && $managesection['whatsapp_store']) || empty($managesection))
                @if ($whatsappStore->count())
                    <div class="vcard-nine__whatsapp_store px-3 position-relative px-sm-3 mb-3 mt-0">
                        <div class="main-whatsapp-store mt-3 pb-12">

                            <h4 class="heading-left heading-line position-relative text-center">
                                {{ __('messages.feature.whatsapp_store') }}
                            </h4>

                            <div class="row whatsapp-store-vcard d-flex justify-content-center g-3">
                                @foreach ($whatsappStore as $store)
                                    <div class="col-6">
                                        <div class="card whatsapp-store-shadow w-100 p-3">

                                            <div class="whatsapp-store-profile">
                                                <img src="{{ $store->cover_url }}" alt="store"
                                                    class="w-100 object-fit-contain" height="208px" loading="lazy" />
                                            </div>

                                            <div class="whatsapp-store-details">
                                                <h4>{{ $store->store_name }}</h4>

                                                <div class="d-flex align-items-center justify-content-center mt-2 pb-2">
                                                    <a href="{{ route('whatsapp.store.show', $store->url_alias) }}"
                                                        target="_blank"
                                                        class="btn btn-wp-visit-store pt-2">
            ...
            @if ((isset($managesection) && $managesection['testimonials']) || empty($managesection))
                @if (checkFeature('testimonials') && $vcard->testimonials->count())
                    <div class="vcard-nine__testimonial px-3 position-relative px-sm-3 mb-3 mt-0">
                        <h4 class="heading-left heading-line position-relative text-center">
                            {{ __('messages.plan.testimonials') }}</h4>
                        <div class="container">
                            <div class="row g-3 testimonial-slider m-0 p-0">
                                        ...
                                        <div class="card testimonial-card p-3 border-0 w-100 h-100">
                                            <div class="testimonial-user d-flex flex-sm-row flex-column align-items-center justify-content-sm-start justify-content-center"
                                                ...
                                                <div class="user-details d-flex flex-column ms-sm-3 mt-sm-0 mt-2">
                                                    <span
                                                        class="user-name text-sm-start text-center" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') text-sm-end" @endif>{{ ucwords($testimonial->name) }}</span>
                                                    <span class="user-designation
                                                        text-sm-start text-center"></span>
                                                </div>
                                            </div>
                                            <p
            ...
            @if ((isset($managesection) && $managesection['insta_embed']) || empty($managesection))
                @if (checkFeature('insta_embed') && $vcard->instagramEmbed->count())
                    <div class="my-5 pt-3">
                        <h4 class="heading-right text-center my-5 py-5">{{ __('messages.feature.insta_embed') }}</h4>
                    </div>
                    <nav>
                        <div class="row insta-toggle">
                            <div class="nav nav-tabs px-0" id="nav-tab" role="tablist">
                                <button
                                    class="d-flex align-items-center justify-content-center py-2 active postbtn instagram-btn fs-2"
                                ...
                                <button
                                    class="d-flex align-items-center justify-content-center py-2 instagram-btn reelsbtn fs-2"
            ...
            @if ((isset($managesection) && $managesection['linkedin_embed']) || empty($managesection))
                @if (checkFeature('linkedin_embed') && $vcard->linkedinEmbed->count())
                    <div class=" pt-3">
                        <h4 class="heading-left text-center my-5 py-5">{{ __('messages.feature.linkedin_embed') }}
                        </h4>
            ...
            @if ((isset($managesection) && $managesection['blogs']) || empty($managesection))
                @if (checkFeature('blog') && $vcard->blogs->count())
                    <div class="vcard-nine__blog position-relative mt-5">
                        <h4 class="heading-right heading-line position-relative text-center">
                                        ...
                                        <div class="card blog-card p-2 border-0 w-100 h-100">
                                            <div class="blog-image">
                                             ...
                                             <div class="blog-details mt-4">
                                                    <a href="{{ $vcardBlogUrl }}" class="text-decoration-none">
                                                        <h4
                                                        class="text-sm-start text-center title-color mb-2 text-black">
                                                        {{ $blog->title }}</h4>
                                                        <p class="mb-1">
                                                    ...
                                                    <a href="{{ $vcardBlogUrl }}"
                                                    class="mt-3 read-more d-flex align-items-center justify-content-end gap-2 text-black">
                                                    <span>{{ __('messages.vcard_11.read_more') }}</span>
            ...
            @if ((isset($managesection) && $managesection['business_hours']) || empty($managesection))
                @if ($vcard->businessHours->count())
                    ...
                    @endphp
                    <div class="vcard-nine__timing position-relative px-sm-3 mb-5">
                        <h4 class="heading-left position-relative text-center mb-5">
                            {{ __('messages.business.business_hours') }}</h4>
                        <div class="container" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            <div class="row g-3">
                                @php
            ...
            @if ((isset($managesection) && $managesection['appointments']) || empty($managesection))
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="vcard-nine__appointment py-3 px-sm-4 px-3 mt-2 position-relative mb-10 mt-0">
                        <h4 class="heading-right heading-line position-relative text-center mb-10">
                        ...
                        <div class="container">
                            <div class="appointment-card p-3">
                                ...
                                <button type="button"
                                    class="appointmentAdd appoint-btn text-white mt-4 d-block mx-auto d-none">{{ __('messages.make_appointments') }}
                                </button>
                            </div>
                        </div>
                    </div>
            ...
            @if ((isset($managesection) && $managesection['iframe']) || empty($managesection))
                @if (checkFeature('iframes') && $vcard->iframes->count())
                    <div class="vcard-nine__blog position-relative mt-0">
                        <h4 class="heading-left heading-line position-relative text-center">
                            {{ __('messages.vcard.iframe') }}</h4>
                        <div class="container pt-4 my-0 p-0 ">
                            <div class="g-4 iframe-slider overflow-hidden">
                                @foreach ($vcard->iframes as $iframe)
                                    <div class="pb-2">
                                        <div class="card iframe-card p-3 border-0 w-100 h-100">
            ...
            @if ((isset($managesection) && $managesection['payment_link']) || empty($managesection))
                @if (checkFeature('payment_link') && $vcard->paymentLinks->count())
                    <div class="main-section">
                        <div class="payment-link-section position-relative mt-0">
                            <h4 class="heading-left heading-line position-relative text-center">{{ __('messages.vcard.payment_links') }}</h4>
                            <div class="payment-link-slider px-2">
            ...
            {{-- enquiry form --}}
            <div class="vcard-nine__contact  px-3 position-relative px-sm-3 mb-10 pt-4">
                {{-- contact us --}}
                @php
                    $currentSubs = $vcard
                        ->subscriptions()
                                        ...
                                        <div class="contact-form px-sm-2">
                                            ...
                                            <div class="mb-3">
                                                <input type="tel" name="phone" class="form-control"
                                                    id="mobile" placeholder="{{ __('messages.form.phone') }}"
                                                    ...
                                                    <div class="wrapper-file-input">
                                                        <div class="input-box" id="fileInputTrigger">
                                                            <h4> <i
                                                                ...
                                                                name="attachment" hidden multiple accept=".jpg, .jpeg, .png" />
                                            ...
                                            @endif
                                            <button type="submit"
                                                class="contact-btn text-white mt-4 d-block mx-auto mb-2">{{ __('messages.contact_us.send_message') }}
                                            </button>
                                        </div>
                                    @endif
                                    @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian')
                                        <div class="contact-form px-sm-2" dir="rtl">
                                            <div id="enquiryError" class="alert alert-danger d-none"></div>
                                            <div class="mb-3">
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
                <div class="container mb-10 mt-10 px-3">
                    <h4 class="heading-left position-relative text-center">
                        {{ __('messages.create_vcard') }}</h4>
                    <div class="copy-link bg-white p-4 text-center rounded mt-7 affiliate-link mx-3">
            ...
            <div class="w-100 d-flex justify-content-center  position-fixed" style="top:50%; left:0; z-index: 9999;">
                <div
                    class="vcard-bars-btn position-relative @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') vcard-bars-btn-left @endif">
                    ...
                    <div class="sub-btn d-none">
                        <div class="sub-btn-div @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') sub-btn-div-left @endif">
                            ...
                            @endif
                            @if (empty($vcard->hide_stickybar))
                                <div class="{{ isset($vcard->whatsapp_share) ? 'vcard9-btn-group' : 'stickyIcon' }}">
                                    <button type="button"
                    ...
                    <div class="" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        @if ($contactRequest == 1)
                            <a href="{{ Auth::check() ? route('add-contact', $vcard->id) : 'javascript:void(0);' }}"
                                class="vcard9-sticky-btn add-contact-btn  d-flex justify-content-center ms-0 text-white align-items-center rounded px-5 text-decoration-none py-1  justify-content-center
                    ...
                    <div class="modal-dialog news-modal modal-dialog-centered">
                        <div class="modal-content animate-bottom" id="newsLatter-content">
                            <div class="newsmodal-header">
                                <button type="button" class="btn-close close-modal p-5 position-absolute top-0 end-0"
                            ...
                            <div class="modal-body">
                                ...
                                <p class="modal-desc text-start">{{ __('messages.vcard.update_directly') }}
                                </p>
                                <form action="" method="post" id="newsLatterForm">
                                    ...
                                    <div
                                        ...
                                        <div class="w-100">
                                            <input type="email" class="text-light form-control bg-dark border-dark"
