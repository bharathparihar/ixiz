        ...
        <div class="vcard-nine main-content w-100 mx-auto overflow-hidden content-blur collapse show allSection">
            ...
            <div class="vcard-nine__product_details_page py-3 mb-10 mt-0">
                <div class="row justify-content-between" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                    <div class="col-4">
                        <h4
                            class="heading-left heading-line position-relative text-center @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') heading-right @endif">
                            {{ __('messages.vcard.products') }}</h4>
                    </div>
                    <div class="col-4 mt-3 text-center">
                        <a class="btn product-btn text-white text-decoration-none rounded-2" href="{{ $vcardUrl }}"
                                            ...
                                            @if ($product->product_url)
                                                <div class="ms-1 my-5">
                                                    <a href="{{ $product->product_url ?? 'javascript:void(0)' }}"
                                                        ...
                                                        class="btn product-btn text-white text-decoration-none rounded-2 btn-product-enquiry @if(!$product->product_url) disabled @endif">
