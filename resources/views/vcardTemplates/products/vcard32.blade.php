...
<head>
    ...
    <link rel="stylesheet" href="{{ mix('assets/css/vcard32.css') }}">
    {{-- google font --}}
    ...
    <div class="container p-0">
        <div class="vcard-thirtytwo main-content bg-light  w-100 mx-auto content-blur allSection collapse show">
            <div class="vcard-one__product py-3 mt-0 px-30">
                <div class="d-flex align-items-center gap-3 mb-5 justify-content-between"
                    @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                    <div>
                        <h4 class="product-heading mb-0 text-primary fs-24">{{ __('messages.vcard.products') }}</h4>
                    </div>
                            ...
                            <div class="product-card card mb-5">
                                <div class="product-img card-img">
                                    <a @if ($product->product_url) href="{{ $product->product_url }}" @endif
                                        ...
                                        <div
                                            class=" {{ $product->media->count() < 2 ? 'd-block' : '' }} product-img-slider overflow-hidden">
                                            @foreach ($product->media as $media)
                                                <div>
                                                    <div class="product-img-height h-100 text-center w-100 mx-auto">
                                ...
                                <div class="card-body px-0 pb-0 pt-4">
                                    ...
                                    <p class="fs-14 text-gray mb-3">{{ $product->description }}</p>
