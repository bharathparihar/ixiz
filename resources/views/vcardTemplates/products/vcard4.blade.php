...
<body>
    <div class="container p-0">
        <div class="vcard-four vcard main-content mx-auto content-blur allSection collapse show">

            <div class="vcard__product_details_page py-3 mb-10 mt-0">
                <div class="row justify-content-between" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                    <div class="col-4">
                        <h4 class="vcard-four-heading p-5">{{ __('messages.vcard.products') }}</h4>
                    </div>
