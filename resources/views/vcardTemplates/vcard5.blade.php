...
<head>
    ...
    {{-- css link --}}
    <link rel="stylesheet" href="{{ mix('assets/css/vcard5.css') }}">
...
<body>
    <div class="container main-section px-0  @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
            ...
            <div class="main-bg p-0 collapse show allSection">
                ...
                <div class="head-img position-relative">
                    ...
                    @if ($vcard->cover_type == 0)
                        <img src="{{ $vcard->cover_url }}" height="400px" class="img-fluid {{ $coverClass }}"
                            loading="lazy" />
                    @elseif($vcard->cover_type == 1)
                        @if (strpos($vcard->cover_url, '.mp4') !== false ||
                            ...
                            <video height="400px" class="cover-video {{ $coverClass }}" autoplay loop muted playsinline
                ...
                <div class="mb-15">
                    @if (getLanguage($vcard->default_language) != 'Arabic' && getLanguage($vcard->default_language) != 'Persian')
                        <div
                            class="profile-img align-items-start top-0 @if ($vcard->cover_type == 2) profile-margin @endif">
                            <img src="{{ $vcard->profile_url }}" width="150px"
                                class="pro-img me-sm-4 rounded-circle mb-4" loading="lazy" />
                            <div>
                                <h3 class="big-title  @if ($vcard->cover_type == 2) bg-title-margin @endif">
                    ...
                    @endif
                    @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian')
                        <div class="profile-img align-items-start top-0" dir="rtl">
                            <img src="{{ $vcard->profile_url }}" width="150px"
                                class="pro-img me-sm-4 rounded-circle mb-4" loading="lazy" />
                            <div>
                                <h3 class="big-title @if ($vcard->cover_type == 2) bg-title-margin @endif">
                        ...
                        <div class="about-section mb-4">
                            <div class="row">
                                ...
                                @if ($vcard->alternative_email)
                                    <div class="col-sm-6 pb-4">
                                        <div class="about-details">
                                            <img src="{{ asset('img/vcard5/alter-email.png') }}" class="mb-2"
                                                height="31" width="40" />
                                    ...
                                    <div class="col-sm-6 pb-4">
                                        <div class="about-details">
                                            ...
                                            <p><a href="tel:+{{ $vcard->region_code }}{{ $vcard->phone }}"
                                                    class="about-title mb-0 text-decoration-none"
                                ...
                                @if ($vcard->alternative_phone)
                                    <div class="col-sm-6 pb-4">
                                        <div class="about-details">
                                            <img src="{{ asset('/img/vcard5-alter-phone.png') }}" class="mb-2" />
                                            <p>
                                            ...
                                            <div>
                                                <div class="service-card my-1 h-100">
                                                      <div class="d-flex service-sub-card">
                                                        ...
                                                        <div class="w-100 d-flex flex-column justify-content-between align-items-start card-bodys">
                                                            <div>
                                                                <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
                                ...
                                <div class="row gallery-vcard d-flex justify-content-center g-3">
                                    @foreach ($vcard->gallery as $file)
                                        ...
                                        <div class="col-6 h-100">
                                            <div class="card gallery-shadow w-100 h-100">
                    ...
                    @if (checkFeature('products') && $vcard->products->count())
                        <div class="container">
                            <div class="main-product mt-3 pb-3">
                                                        ...
                                                        <div class="d-flex justify-content-between mt-2 product-info">
                                                            <div class="product-amount">
                                                                @if ($product->currency_id && $product->price)
                                                                    <span
                                                                        class="text-black fs-18">{{ currencyFormat($product->price, 2, $product->currency->currency_code) }}</span>
                                                                @elseif($product->price)
                                                                    <span
                                                                        class="text-black fs-18">{{ currencyFormat($product->price, 2, getUserCurrencyIcon($vcard->user->id)) }}</span>
                                                                @endif
                                                            </div>
                                ...
                                <div class="text-center me-5 my-3 ms-5 mt-10 p-5">
                ...
                @if ((isset($managesection) && $managesection['whatsapp_store']) || empty($managesection))
                    @if ($whatsappStore->count())
                        <div class="container">
                            <div class="main-whatsapp-store mt-3 pb-16">
                                ...
                                <div class="row whatsapp-store-vcard d-flex justify-content-center g-3">
                                    @foreach ($whatsappStore as $store)
                                        <div class="col-6">
                                            <div class="card whatsapp-store-shadow w-100">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="d-flex align-items-center"
                                                                ...
                                                                <img src="{{ $testimonial->image_url }}"
                                                                    class="me-3 testi-logo rounded-circle ms-2"
                                                                    loading="lazy" />
                        ...
                        <nav>
                            <div class="row insta-toggle">
                                <div class="nav nav-tabs px-0" id="nav-tab" role="tablist">
                                    <button
                                        class="d-flex align-items-center justify-content-center active postbtn instagram-btn fs-2 py-2"
                                    ...
                                    <button
                                        class="d-flex align-items-center justify-content-center instagram-btn reelsbtn fs-2  py-2"
                ...
                @if ((isset($managesection) && $managesection['linkedin_embed']) || empty($managesection))
                    @if (checkFeature('linkedin_embed') && $vcard->linkedinEmbed->count())
                        <div class="pt-5">
                            <h4 class="insta-heading text-center pb-4">{{ __('messages.feature.linkedin_embed') }}
                            </h4>
                ...
                @if ((isset($managesection) && $managesection['blogs']) || empty($managesection))
                    @if (checkFeature('blog') && $vcard->blogs->count())
                        <div class="container pt-5 py-3 blog-section mb-4">
                ...
                @if ((isset($managesection) && $managesection['appointments']) || empty($managesection))
                    @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                        <div class="container py-3 mt-0 appointment-section mb-6">
                            <h4 class="appointment-heading mb-4 position-relative text-center">
                ...
                @if ((isset($managesection) && $managesection['payment_link']) || empty($managesection))
                    @if (checkFeature('payment_link') && $vcard->paymentLinks->count())
                        <div class="">
                            <div class="payment-link-section py-3 mb-7 pb-5">
                                <h4 class="mb-4 text-center payment-link-heading">{{ __('messages.vcard.payment_links') }}</h4>
                ...
                @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
                    @if (getLanguage($vcard->default_language) != 'Arabic' && getLanguage($vcard->default_language) != 'Persian')
                        <div class="container py-4 pt-0 inquiry-section">
                            <h4 class="contact-heading mb-4 text-center">{{ __('messages.contact_us.inquries') }}
                            </h4>
                                            ...
                                            <div class="row">
                                                <div class="col-12 mb-3">
                                                    <label for="exampleFormControlTextarea1"
                                                        class="form-label">{{ __('messages.user.your_message') }}
                    ...
                    @endif
                    @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian')
                        <div class="container py-4 pt-0 inquiry-section" dir="rtl">
                            <h4 class="contact-heading mb-4 text-center">{{ __('messages.contact_us.inquries') }}
                            </h4>
                            <div class="main-contact mb-10">
                                <form id="enquiryForm" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="row">
                                                ...
                                                <div class="col-12 mb-3 input-group">
                                                    <span
                                                        class="input-group-text bg-white contact-input border-start-0"
                                                        id="basic-addon1"><i class="far fa-user"></i></span>
                                                    <input type="text" name="name"
                                                        class="form-control contact-input border-end-0 text-start"
                                                        id="name"
                                                        placeholder="{{ __('messages.form.your_name') }}">
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-12 mb-3">
                                                    <label for="exampleFormControlTextarea1"
                                                        class="form-label">{{ __('messages.user.your_message') }}
                                                        <span class="text-danger">*</span></label>
                                                    <textarea class="form-control contact-input text-start" name="message" id="message" rows="7"
                                                        placeholder="{{ __('messages.form.type_message') }}"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                        @if ($contactRequest == 1)
                                            <a href="{{ Auth::check() ? route('add-contact', $vcard->id) : 'javascript:void(0);' }}"
                                                class="add-contact-btn d-flex justify-content-center ms-0 text-white align-items-center rounded px-5 text-decoration-none py-1 justify-content-center
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="col-12 justify-content-between social-link-modal">
                                                <div class="input-group">
                                                    ...
                                                    <button class="copy-vcard-clipboard btn btn-dark"
                    ...
                    @if (isset($enable_pwa) && $enable_pwa == 1 && !isiOSDevice())
                        <div class="mt-0" id="pwa-container">
                            <div class="pwa-support d-flex align-items-center justify-content-center">
                                <div>
                                    <h1 class="text-start pwa-heading">{{ __('messages.pwa.add_to_home_screen') }}
                                    </h1>
                                    <p class="text-start pwa-text text-dark">{{ __('messages.pwa.pwa_description') }}
                                    </p>
