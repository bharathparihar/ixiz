...
<head>
    ...
    <link rel="stylesheet" href="{{ mix('assets/css/vcard14.css') }}" />
        ...
        <div class="container p-0">
            ...
            <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
                ...
                @if (isset($enable_pwa) && $enable_pwa == 1 && !isiOSDevice())
                    <div class="mt-0" id="pwa-container">
                        <div class="pwa-support d-flex align-items-center justify-content-center">
                            <div>
                                <h1 class="text-start text-gradient pwa-heading">
                                    {{ __('messages.pwa.add_to_home_screen') }}</h1>
                                <p class="text-start pwa-text text-white">{{ __('messages.pwa.pwa_description') }} </p>
                ...
                @if ((isset($managesection) && $managesection['banner']) || empty($managesection))
                    @if (isset($banners->title))
                        <div class="support-banner d-flex align-items-center justify-content-center">
                            <button type="button" class="text-start banner-close"><i
                                    class="fa-solid fa-xmark text-primary"></i></button>
                            <div class="text-center">
                                <h1 class="text-center text-gradient support_heading">{{ $banners->title }}</h1>
                                <p class="text-center text-white support_text">{{ $banners->description }}</p>
                                <div class="text-center">
                    ...
                    @endif
                @endif
                <div class="banner-section main-section m-0 position-relative">
                ...
                <div class="profile-section main-section px-30 pt-30 pb-30 position-relative overflow-hidden">
                    <div class="position-absolute vector-main-1">
                        <img src="{{ asset('assets/img/vcard14/vector-main-1.png') }}" alt="vector-img"
                            class="w-100" />
                    </div>
                            ...
                            <div class="card flex-sm-row align-items-center">
                                <div class="card-img me-sm-3">
                                    <img src="{{ $vcard->profile_url }}"
                                        class="h-100 w-100 object-fit-cover profileImage" loading="lazy" />
                                </div>
                                <div class="card-body text-sm-start text-center p-0">
                                    <div class="profile-name">
                                        ...
                                        <p class="fs-16 text-gradient mb-0">{{ ucwords($vcard->company) }}</p>
                                        <p class="fs-14 text-gray-100 mb-0">{{ ucwords($vcard->occupation) }}</p>
                    ...
                    @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian')
                        <div>
                            <div class="card flex-sm-row align-items-center p-sm-2" dir="rtl">
                                <div class="card-img ms-sm-3 ms-0">
                                    <img src="{{ $vcard->profile_url }}"
                                        class="h-100 w-100 object-fit-cover profileImage" loading="lazy" />
                                </div>
                                <div class="card-body text-sm-start text-center p-0">
                                    <div class="profile-name">
                                        <h2 class="text-black fs-24 mb-0">
                                            {{ ucwords($vcard->first_name . ' ' . $vcard->last_name) }}
                                            @if ($vcard->is_verified)
                                                <i class="verification-icon bi-patch-check-fill"></i>
                                            @endif
                                        </h2>
                                        <p class="fs-18 text-primary-200 mb-0">{{ ucwords($vcard->company) }}</p>
                                        <p class="fs-14 text-gray-100 mb-0">{{ ucwords($vcard->occupation) }}</p>
                                        <p class="fs-14 text-gray-100 mb-0">{{ ucwords($vcard->job_title) }}</p>
                                    </div>
                                </div>
                ...
                @if (
                    !empty($vcard->description) ||
                        (checkFeature('social_links') && getSocialLink($vcard)) ||
                        (checkFeature('custom-links') && count($customLink) > 0))
                    <div class="main-section pt-30 pb-30 px-30 position-relative">
                        <div class="position-absolute vector-all vector-1">
                            <img src="{{ asset('assets/img/vcard14/vector-1.png') }}" alt="vector-img"
                                class="w-100" />
                        </div>
                        @if (!empty($vcard->description))
                        ...
                        @if (checkFeature('social_links') && getSocialLink($vcard))
                            <div class="social-media d-flex justify-content-end">
                                <div class="social-media-icon flex-1 d-flex justify-content-center">
                                    <div class="social-icons d-flex justify-content-center pt-40 flex-wrap w-100">
                        ...
                        @if (checkFeature('custom-links') && count($customLink) > 0)
                ...
                @if (((isset($managesection) && $managesection['contact_list']) || empty($managesection)) && $hasContactData)
                    <div class="contact-section main-section pt-30 pb-30 px-30 position-relative">
                        <div class="position-absolute vector-all vector-2">
                            <img src="{{ asset('assets/img/vcard14/vector-2.png') }}" alt="vector-img"
                                class="w-100" />
                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="contact-box">
                                                <div
                                                    ...
                                                    <img src="{{ asset('assets/img/vcard14/email.svg') }}" />
                                                </div>
                                    ...
                                    @if ($vcard->phone)
                                        <div class="col-sm-6">
                                            <div class="contact-box">
                                                <div
                                                    class="contact-icon d-flex justify-content-center align-items-center">
                                                    <img src="{{ asset('assets/img/vcard14/phone-icon.svg') }}" />
                                                </div>
                                                <div class="contact-desc">
                                    ...
                                    @if ($vcard->dob)
                                        <div class="col-sm-6">
                                            <div class="contact-box">
                                                <div
                                                    class="contact-icon d-flex justify-content-center align-items-center">
                                                    <img src="{{ asset('assets/img/vcard14/dob-icon.svg') }}" />
                                                </div>
                                                <div class="contact-desc">
                                    ...
                                    @if ($vcard->location)
                                        <div class="col-sm-6">
                                            <div class="contact-box">
                                                <div
                                                    class="contact-icon d-flex justify-content-center align-items-center">
                                                    <img src="{{ asset('assets/img/vcard14/location-icon.svg') }}" />
                                                </div>
                                                <div class="contact-desc">
                                                    <p class=" mb-0 fs-12">{!! ucwords($vcard->location) !!}</p>
                                                </div>
                                            </div>
                                        </div>
                                    @endif
                                            ...
                                            <div class="contact-box">
                                                ...
                                                <div class="contact-desc">
                                                    <a href="mailto:{{ $vcard->alternative_email }}"
                                                        class="">{{ $vcard->alternative_email }}</a>
                                                </div>
                                            </div>
                                        </div>
                                    @endif
                                    ...
                                    @if ($vcard->phone)
                                        <div class="col-sm-6">
                                            <div class="contact-box">
                                                ...
                                                <div class="contact-desc">
                                                    <a href="tel:+{{ $vcard->region_code }} {{ $vcard->phone }}"
                                                        class="" dir="ltr">+{{ $vcard->region_code }}
                                                        {{ $vcard->phone }}</a>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    @if (checkFeature('gallery') && $vcard->gallery->count())
                        <div class="gallery-section main-section pt-30 pb-30 position-relative">
                            <div class="position-absolute vector-all vector-3">
                                <img src="{{ asset('assets/img/vcard14/vector-3.png') }}" alt="vector-img"
                                    class="w-100" />
                            </div>
                            <div class="section-heading px-30">
                                <h2 class="text-white mb-0">{{ __('messages.plan.gallery') }}</h2>
                            </div>
                            <div class="px-40">
                ...
                @if ((isset($managesection) && $managesection['services']) || empty($managesection))
                    @if (checkFeature('services') && $vcard->services->count())
                        <div class="our-services-section main-section pt-30 pb-30 position-relative">
                            <div class="position-absolute vector-all vector-4">
                                <img src="{{ asset('assets/img/vcard14/vector-4.png') }}" alt="vector-img"
                                    class="w-100" />
                            </div>
                            <div class="section-heading">
                                <h2 class="text-white mb-0">{{ __('messages.vcard.our_service') }}</h2>
                            </div>
                            <div class="services">
                                            ...
                                            @foreach ($vcard->services as $service)
                                                <div>
                                                    <div class="service-card h-100">
                                                        ...
                                                        <div class="text-center pt-3 card-body pb-0">
                                                            <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
                                                                class="text-decoration-none"
                                                                target="{{ $service->service_url ? '_blank' : '' }}">
                                                                <h5 class="card-title title-text text-gradient">
                                                                    {{ ucwords($service->name) }}</h5>
                                                            </a>
                                                            <p
                                                                class="card-text description-text text-white mb-0 {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}">
                                                    ...
                                                    <div class="service-card d-flex flex-column h-100"
                                                        ...
                                                        <div
                                                            ...
                                                            <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
                                                                ...
                                                                target="{{ $service->service_url ? '_blank' : '' }}">
                                                                <img src="{{ $service->service_icon }}"
                                                                    alt="{{ $service->name }}" class="w-100 h-100"
                                                                    loading="lazy">
                                                            </a>
                                                        </div>
                                                        <div class="card-body pt-3 px-0 pb-0 text-center d-flex flex-column justify-content-between align-items-center">
                                                       <div>
                                                        <h3 class="card-title text-gradient">
                                                                {{ ucwords($service->name) }}
                                                            </h3>
                                                            <p class="mb-0 text-white description-text">
                ...
                @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                    <div class="qr-code-section main-section pt-30 pb-30  px-30 position-relative">
                        <div class="position-absolute vector-all vector-5">
                            <img src="{{ asset('assets/img/vcard14/vector-5.png') }}" alt="vector-img"
                                class="w-100" />
                        </div>
                        <div class="section-heading">
                            <h2 class="text-white mb-0">{{ __('messages.vcard.qr_code') }}</h2>
                        </div>
                        <div class="qr-code mx-auto position-relative">
                            <div class="d-flex gap-3 align-items-center flex-wrap flex-sm-nowrap justify-content-center text-center text-sm-start"
                                ...
                                <div>
                                    ...
                                    <p class="fs-14 text-gray mb-0">{{ __('messages.vcard.qr_section_desc') }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    @if (checkFeature('products') && $vcard->products->count())
                        <div class="product-section main-section pt-30 pb-30 position-relative">
                            <div class="position-absolute vector-all vector-6">
                                <img src="{{ asset('assets/img/vcard14/vector-6.png') }}" alt="vector-img"
                                    class="w-100" />
                            </div>
                            <div class="section-heading">
                                <h2 class="text-white mb-0">{{ __('messages.plan.products') }}</h2>
                            </div>
                            <div class="px-20">
                                        ...
                                        <a @if ($product->product_url) href="{{ $product->product_url }}" @endif
                                            ...
                                            <div class="">
                                                <div class="product-card card">
                                                    ...
                                                    <div class="product-desc card-body d-flex justify-content-center flex-column">
                                                        <div
                                                            ...
                                                            <div class="d-flex justify-content-between mt-2 product-info w-100">
                                                                <div class="product-amount">
                                                                    @if ($product->currency_id && $product->price)
                                                                        <span
                                                                            class=" text-gradient">{{ currencyFormat($product->price, 2, $product->currency->currency_code) }}</span>
                                                                    @elseif($product->price)
                                                                        <span
                                                                            class="text-gradient">{{ currencyFormat($product->price, 2, getUserCurrencyIcon($vcard->user->id)) }}</span>
                                                                    @endif
                                                                ...
                                                                @if ($vcard->show_product_enquiry_btn == true)
                                                                    @if ($product->product_url)
                                                                        <div class="enquiry-btn">
                                                                            <button type="button" onclick="window.open('{{ $product->product_url }}', '_blank')"
                            ...
                            <div class="text-center mt-5">
                                <a class="fs-6 text-decoration-underline btn-primary view-more d-inline-flex gap-2 align-items-center"
                                    href="{{ $vcardProductUrl }}">{{ __('messages.analytics.view_more') }}
                                    <i
                                        class="fa-solid fa-arrow-right right-arrow-animation text-decoration-none"></i></a>
                            </div>
                        </div>
                ...
                @if ((isset($managesection) && $managesection['whatsapp_store']) || empty($managesection))
                    @if ($whatsappStore->count())
                        <div class="whatsapp-store-product-section main-section pt-30 pb-30 position-relative">
                            <div class="position-absolute vector-all vector-6">
                                <img src="{{ asset('assets/img/vcard14/vector-2.png') }}" alt="vector-img"
                                    class="w-100" />
                            </div>
                            <div class="section-heading">
                                <h2 class="text-white mb-0">{{ __('messages.feature.whatsapp_store') }}</h2>
                            </div>
                            <div class="px-20">
                                        ...
                                        <div class="">
                                            <div class="whatsapp-store-box card">
                                                <div class="whatsapp-store-img card-img">
                                                    <img src="{{ $product->cover_url }}" class="object-fit-contain"
                                                        loading="lazy" />
                                                </div>
                                                <div class="whatsapp-store-content card-body">
                                                    <div
                                                        class="d-flex justify-content-center align-items-center flex-column">
                                                        <div class="whatsapp-store-name text-center">
                                                            <h3 class="text-white">
                                                                {{ $product->store_name }}
                                                            </h3>
                                                        </div>
                    ...
                    @if (checkFeature('testimonials') && $vcard->testimonials->count())
                        <div class="testimonial-section main-section pt-30 pb-30 position-relative">
                            <div class="position-absolute vector-all vector-7">
                                <img src="{{ asset('assets/img/vcard14/vector-7.png') }}" alt="vector-img"
                                    class="w-100" />
                            </div>
                            <div class="section-heading">
                                <h2 class="text-white mb-0">{{ __('messages.plan.testimonials') }}</h2>
                            </div>
                            <div class="px-20">
                                            ...
                                            <div class="testimonial-card position-relative">
                                                ...
                                                <div class="card-body p-0">
                                                    <div class="text-sm-start text-center">
                                                        <p
                                                            class="desc text-dark {{ \Illuminate\Support\Str::length($testimonial->description) > 80 ? 'more' : '' }}">
                                                            {!! $testimonial->description !!}
                                                        </p>
                                                        <div class="d-flex flex-column gap-2 align-items-center justify-content-center"
                                                            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                                            <div class="profile-img me-3 ms-2">
                    ...
                    @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                        <div class="appointment-section main-section pt-30 pb-30 px-30 position-relative">
                            <div class="position-absolute vector-all vector-8">
                                <img src="{{ asset('assets/img/vcard14/vector-8.png') }}" alt="vector-img"
                                    class="w-100" />
                            </div>
                            <div class="section-heading">
                                <h2 class="text-white mb-0">{{ __('messages.make_appointments') }}</h2>
                            </div>
                            <div class="appointment-card  p-3">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="position-relative">
                                            {{ Form::text('date', null, [
                                                'class' => 'date appointment-input text-start',
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="col-12 d-flex justify-content-center">
                                        <button type="submit" class="btn btn-primary appointmentAdd d-none">
                ...
                @if ((isset($managesection) && $managesection['insta_embed']) || empty($managesection))
                    @if (checkFeature('insta_embed') && $vcard->instagramEmbed->count())
                        <div class="main-section pt-30 pb-30 position-relative">
                            <div class="position-absolute vector-all vector-9">
                                <img src="{{ asset('assets/img/vcard14/vector-9.png') }}" alt="vector-img"
                                    class="w-100" />
                            </div>
                            <div class="insta-feed">
                                <div class="section-heading">
                                    <h2 class="text-white mb-0">{{ __('messages.feature.insta_embed') }}
                                    </h2>
                                </div>
                            </div>
                            <nav class="px-30">
                                <div class="row insta-toggle">
                                    <div class="nav nav-tabs border-0 pe-0" id="nav-tab" role="tablist">
                                        <button
                                            class="d-flex align-items-center justify-content-center pb-2 active postbtn instagram-btn  border-0 text-light"
                                        ...
                                        <button
                                            class="d-flex align-items-center justify-content-center pb-2 instagram-btn reelsbtn  border-0 text-light"
                            ...
                            <div id="postContent" class="insta-feed px-30">
                                <div class="row overflow-hidden mt-3 row-gap-15px" loading="lazy">
                                    <!-- "Post" content -->
                            ...
                            <div class="d-none insta-feed px-30" id="reelContent">
                                <div class="row overflow-hidden mt-3 row-gap-15px">
                                    <!-- "Reel" content -->
                                    @foreach ($vcard->InstagramEmbed as $InstagramEmbed)
                        ...
                        <div class="main-section pt-30 pb-30 position-relative">
                            <div class="pt-2">
                                ...
                                <div class="linkedin-feed px-30">
                                    <div class="row overflow-hidden mt-2 row-gap-15px" loading="lazy">
                                        <!-- "Post" content -->
                    ...
                    @if (checkFeature('blog') && $vcard->blogs->count())
                        <div class="blog-section main-section pt-30 pb-30 position-relative">
                            <div class="position-absolute vector-all vector-10">
                                <img src="{{ asset('assets/img/vcard14/vector-10.png') }}" alt="vector-img"
                                    class="w-100" />
                            </div>
                            <div class="section-heading">
                                <h2 class="text-white mb-0">{{ __('messages.feature.blog') }}</h2>
                            </div>
                                    ...
                                    <div>
                                        <div class="blog-card">
                                            ...
                                            <div
                                                ...
                                                <h5 class="text-gradient fs-20 mb-2"> {{ $blog->title }}</h5>
                                                <div class="text-dark blog-desc mb-1">
                                                    {!! $blog->description !!}
                                                </div>
                                                <div
                                                    class="text-end @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') ms-0 @else ms-auto @endif">
                                                    <a href="{{ $vcardBlogUrl }}"
                    ...
                    @if ($vcard->businessHours->count())
                        ...
                        <div class="bussiness-hour-section main-section px-30 pt-30 pb-30 position-relative">
                            <div class="position-absolute vector-all vector-11">
                                <img src="{{ asset('assets/img/vcard14/vector-11.png') }}" alt="vector-img"
                                    class="w-100" />
                            </div>
                            <div class="section-heading">
                                <h2 class="text-white mb-0">{{ __('messages.business.business_hours') }}
                                </h2>
                            </div>
                            <div class="position-relative">
                                <div class="row bussiness-hour-card row-gap-15px justify-content-center"
                                    ...
                                    @foreach ($businessDaysTime as $key => $dayTime)
                                        <div class="col-md-6">
                                            <div
                                                class="d-flex align-items-center justify-content-center flex-wrap flex-sm-nowrap gap-3 business-box">
                                                ...
                                                <div class="d-flex  mt-3 justify-content-center gap-2 ">
                                                    ...
                                                    <div
                                                        class="d-flex gap-3 align-items-center justify-content-end fs-14 text-black">
                ...
                @if ((isset($managesection) && $managesection['iframe']) || empty($managesection))
                    @if (checkFeature('iframes') && $vcard->iframes->count())
                        <div class="main-section px-30 pt-30 pb-30 position-relative">
                            <div class="position-absolute vector-all vector-12">
                                <img src="{{ asset('assets/img/vcard14/vector-12.png') }}" alt="vector-img"
                                    class="w-100" />
                            </div>
                            <div class="section-heading">
                ...
                @if ((isset($managesection) && $managesection['payment_link']) || empty($managesection))
                    @if (checkFeature('payment_link') && $vcard->paymentLinks->count())
                        <div class="main-section">
                            <div class="payment-link-section pt-40 px-20 pb-40 position-relative">
                                <div class="position-absolute vector-all vector-12">
                                    <img src="{{ asset('assets/img/vcard14/vector-1.png') }}" alt="vector-img"
                                        class="w-100" />
                                </div>
                                <div class="section-heading text-center">
                                    <h2 class="text-white text-center mb-0">{{ __('messages.vcard.payment_links') }}</h2>
                                    <span></span>
                                </div>
                                            ...
                                            <div class="pl-strip">
                                                ...
                                                <div class="pl-strip-content">
                                                    ...
                                                    @if (
                                                        ...
                                                        <p class="pl-strip-desc mb-0 text-gradient">
                ...
                @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
                    <div class="contact-us-section main-section px-30 pt-30 pb-30 position-relative">
                        <div class="position-absolute vector-all vector-13">
                            <img src="{{ asset('assets/img/vcard14/vector-13.png') }}" alt="vector-img"
                                class="w-100" />
                        </div>
                        <div class="section-heading">
                            <h2 class="text-white mb-0">{{ __('messages.contact_us.inquries') }}</h2>
                        </div>
                        @if (getLanguage($vcard->default_language) != 'Arabic' && getLanguage($vcard->default_language) != 'Persian')
                                            ...
                                            <div class="mb-3 mt-3">
                                                <div class="wrapper-file-input">
                                                    <div class="input-box" id="fileInputTrigger">
                                                        ...
                                                        class="text-white">{{ __('messages.file_supported') }}</small>
                                                </div>
                                                ...
                                                <div class="d-flex gap-2">
                                                    ...
                                                    <label class="form-check-label fs-14" for="privacyPolicyCheckbox">
                                                        ...
                                                        <a href="{{ $vcardPrivacyAndTerm }}" target="_blank"
                                                            class="text-decoration-none link-info fs-14 text-primary">{!! __('messages.vcard.term_and_condition') !!}</a>
                                                        <span class="text-white">&</span>
                                                        <a href="{{ $vcardPrivacyAndTerm }}" target="_blank"
                                                            class="text-decoration-none link-info fs-14 text-primary">{{ __('messages.vcard.privacy_policy') }}</a>
                                                    </label>
                                                </div>
                                            </div>
                                        @endif
                        ...
                        @endif
                        @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian')
                            <div class="contact-form mb-4 p-3" dir="rtl">
                                <form action="" id="enquiryForm" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div id="enquiryError" class="alert alert-danger d-none"></div>
                                        ...
                                        <div class="col-12 d-flex justify-content-center mt-4 pb-2">
                                            <button
                                                class="contact-btn btn btn-primary rounded-2 d-flex align-items-center mb-4"
                                                type="submit">
                                                {{ __('messages.contact_us.send_message') }}
                                            </button>
                                        </div>
                ...
                @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
                    <div class="create-vcard-section main-section px-30 pt-30 pb-30 position-relative">
                        <div class="position-absolute vector-all vector-14">
                            <img src="{{ asset('assets/img/vcard14/vector-14.png') }}" alt="vector-img"
                                class="w-100" />
                        </div>
                        <div class="section-heading">
                            <h2 class="text-white mb-0">{{ __('messages.create_vcard') }}</h2>
                        </div>
                        <div class="vcard-link-card card">
                            <div class="d-flex align-items-center justify-content-center gap-3"
                                @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                <a href="{{ config('app.url') . '/register?referral-code=' . $vcard->user->affiliate_code }}"
                                    class="text-dark link-text"
                                    target="_blank">{{ route('register', ['referral-code' => $vcard->user->affiliate_code]) }}
                                </a>
                                <i class="icon fa-solid fa-arrow-up-right-from-square share-icon text-dark"></i>
                            </div>
                        </div>
                    </div>
                @endif
                ...
                @if ((isset($managesection) && $managesection['map']) || empty($managesection))
                    @if ($vcard->location_type == 0 && ($vcard->location_url && isset($url[5])))
                        <div class="main-section px-30 pt-30 pb-30 position-relative">
                            <div class="position-absolute vector-15 vector-all">
                                <img src="{{ asset('assets/img/vcard14/vector-15.png') }}" alt="vector-img"
                                    class="w-100" />
                            </div>
                            <div class="iframe-card-box">
                                <div class="map-location d-flex gap-2 mb-2 align-items-center py-2"
                                    @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                ...
                                <iframe width="100%" height="300px" class="overflow-hidden"
                    ...
                    @if ($vcard->location_type == 1 && !empty($vcard->location_embed_tag))
                        <div class="main-section px-30 pt-30 pb-30 position-relative">
                            ...
                            <div class="iframe-card-box">
                                <div class="map-location d-flex gap-2 mb-2 align-items-center"
                                    @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                    <div class="location-icon d-flex justify-content-center align-items-center">
                                        <img src="{{ asset('assets/img/vcard14/location-icon.svg') }}" />
                                    </div>
                        ...
                        <div class="" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            @if ($contactRequest == 1)
                                <a href="{{ Auth::check() ? route('add-contact', $vcard->id) : 'javascript:void(0);' }}"
                                    class="btn add-contact-btn d-flex justify-content-center ms-0 gap-2 align-items-center  text-decoration-none justify-content-center
                            ...
                            @else
                                <a href="{{ route('add-contact', $vcard->id) }}"
                                    class="btn btn-primary add-contact-btn d-flex justify-content-center ms-0 gap-2 align-items-center rounded px-5 text-decoration-none p-2  py-1 justify-content-center"><i
                ...
                <div class="btn-section cursor-pointer @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
                    <div class="fixed-btn-section">
                        @if (empty($vcard->hide_stickybar))
                            <div
                                class="bars-btn event-bars-btn @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') vcard-bars-btn-left @endif">
                                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                                    viewBox="0 0 25 25" fill="none">
                                    <path
                                        d="M15.413 0.540771H22.4892C23.5719 0.540851 24.4597 1.42874 24.4599 2.51147V9.58765C24.4598 10.6777 23.5731 11.5583 22.4892 11.5583H15.413C14.322 11.5581 13.4424 10.6786 13.4423 9.58765V2.51147C13.4425 1.42774 14.3232 0.540993 15.413 0.540771Z"
                                        stroke="#ffffff" />
                                    <path
                                        d="M2.97168 0.5H8.74609C10.113 0.500108 11.2178 1.61252 11.2178 2.97168V8.74609C11.2177 10.114 10.114 11.2177 8.74609 11.2178H2.97168C1.61252 11.2178 0.500108 10.113 0.5 8.74609V2.97168L0.512695 2.71973C0.631537 1.56119 1.56119 0.631537 2.71973 0.512695L2.97168 0.5Z"
                                        stroke="#ffffff" />
                                    <path
                                        d="M2.97168 13.783H8.74609C10.114 13.7831 11.2178 14.8867 11.2178 16.2546V22.0291C11.2177 23.3881 10.1129 24.5006 8.74609 24.5007H2.97168C1.6136 24.5007 0.500109 23.3871 0.5 22.0291V16.2546L0.512695 16.0017C0.631233 14.837 1.56023 13.9136 2.71973 13.7957L2.97168 13.783Z"
                                        stroke="#ffffff" />
                                    <path
                                        d="M16.254 13.783H22.0284C23.3875 13.7831 24.5 14.8877 24.5 16.2546V22.0291C24.4999 23.387 23.3863 24.5006 22.0284 24.5007H16.254C14.8871 24.5007 13.7824 23.3882 13.7823 22.0291V16.2546L13.795 16.0007C13.913 14.8359 14.8352 13.9136 16 13.7957L16.254 13.783Z"
                                        stroke="#ffffff" />
                                </svg>
                            </div>
                        @endif
                                    ...
                                    <div class="icon-search-container mb-3" data-ic-class="search-trigger">
                                        ...
                                        <div class="share-wp-btn-div">
                                            <a href="javascript:void(0)"
                                                class="vcard14-sticky-btn vcard14-btn-group d-flex justify-content-center align-items-center text-black rounded-0 text-decoration-none py-1 rounded-pill justify-content share-wp-btn">
                                                <i class="fa-solid fa-paper-plane text-white"></i> </a>
                                        </div>
                                    </div>
                                @endif
                                @if (empty($vcard->hide_stickybar))
                                    <div
                                        class="{{ isset($vcard->whatsapp_share) ? 'vcard14-btn-group' : 'stickyIcon' }}">
                                        <a type="button"
                                            class="social-btn event-sub-btn mb-3 px-2 py-1  vcard14-share"><i
                                                class="fas fa-share-alt fs-4 text-white"></i></a>
                                    ...
                                    id="videobtn"><i class="fa-solid fa-video fs-4 text-white"></i></a>
                                --}}
                                    </div>
                                @endif
                            </div>
                ...
                <div class="d-flex justify-content-evenly main-section pt-3 pb-3 flex-wrap flex-sm-nowrap">
                    ...
                    @if (!empty($vcard->privacy_policy) || !empty($vcard->term_condition))
                        <div>
                            <a class="text-decoration-none text-gradient  fw-5 cursor-pointer terms-policies-btn"
                                href="{{ $vcardPrivacyAndTerm }}"><span
                                    class="fs-14">{!! __('messages.vcard.term_policy') !!}</span></a>
                        </div>
                    @endif
                </div>
            </div>
...
<script>
        ...
        class FlameParticle {
            ...
            draw() {
                ...
                ctx.fillStyle = `hsla(${parseInt(this.color.substring(4))}, 100%, 50%, ${opacity * 0.7})`;
                ctx.fill();
