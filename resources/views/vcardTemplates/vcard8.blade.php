...
<head>
    ...
    {{-- css link --}}
    <link rel="stylesheet" href="{{ mix('assets/css/vcard8.css') }}">
...
<body>
    <div class="container p-0">
        ...
        @endif
        <div
            class="vcard-eight main-content w-100 mx-auto overflow-hidden content-blur allSection  @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
            {{-- Pwa support --}}
            ...
            <div class="vcard-eight__banner w-100 position-relative">
                ...
                @if ($vcard->cover_type == 0)
                    <img src="{{ $vcard->cover_url }}"
                        class="img-fluid banner-image position-relative {{ $coverClass }}" alt="banner"
                        loading="lazy" />
                @elseif($vcard->cover_type == 1)
                    @if (strpos($vcard->cover_url, '.mp4') !== false ||
                        ...
                        <video height="400px"
                            class="cover-video img-fluid banner-image position-relative {{ $coverClass }}" autoplay loop muted playsinline alt="background video" id="cover-video">
            ...
            <div>
                @if (getLanguage($vcard->default_language) != 'Arabic' && getLanguage($vcard->default_language) != 'Persian')
                    <div
                        class="vcard-eight__profile d-flex align-items-center px-4 flex-sm-row flex-column position-relative @if ($vcard->cover_type == 2) profile-margin @endif">
                ...
                @endif
                @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian')
                    <div class="vcard-eight__profile d-flex align-items-center px-4 flex-sm-row flex-column position-relative @if ($vcard->cover_type == 2) profile-margin @endif"
                        dir="rtl">
                        <div class="vcard-eight__avatar">
                            <img src="{{ $vcard->profile_url }}" class="rounded-circle" loading="lazy" />
                        </div>
            ...
            @if ((isset($managesection) && $managesection['contact_list']) || empty($managesection))
                @if ($vcard->email || $vcard->phone || $vcard->dob || $vcard->location || $vcard->alternative_email)
                    <div class="vcard-eight__event py-3 px-sm-4 px-3 mt-2 position-relative">
                        <div class="row">
                            <div class="col-12">
                                <div class="card event-card px-sm-4 px-3">
                                    <div class="row g-4">
                                        @if ($vcard->email)
                                            <div class="col-sm-6 col-12">
                                                <div class="contact-card">
                                                    ...
                                                    <div class="event-details">
                                                     ...
                                                     {{--<span class="text-white text-center d-block mb-1">{{ __('messages.admin.email') }}</span> --}}
                                        ...
                                        <div class="col-sm-6">
                                            <div class="card service-card">
                                                ...
                                                <div class="card-body py-4">
                                                    ...
                                                    <p
                                                        class="card-text text-white-50 {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}">
                                                        {!! \Illuminate\Support\Str::limit($service->description, 170, '...') !!}</p>
                                                    @if ($vcard->show_service_enquiry_btn == true)
                                                        @if ($service->service_url)
                                                            <div class="text-center enquiry-btn">
            ...
            @if ((isset($managesection) && $managesection['products']) || empty($managesection))
                @if (checkFeature('products') && $vcard->products->count())
                    <div class="vcard-eight__product py-4 position-relative px-sm-4 px-3 mt-0">
                        ...
                        <div class="text-center pt-3 pb-3 mt-10">
            ...
            @if ((isset($managesection) && $managesection['whatsapp_store']) || empty($managesection))
                @if ($whatsappStore->count())
                    <div class="vcard-eight__whatsapp_store py-16 position-relative px-sm-4 px-3 mt-0">
                        <h4
                            class="vcard-eight-heading heading-line position-relative text-center d-block mx-auto pb-3">
                            {{ __('messages.feature.whatsapp_store') }}
                        </h4>

                        <div class="row g-3 whatsapp-store-slider mt-2">
                            @foreach ($whatsappStore as $store)
                                <div class="col-6 h-100">
                                    <div class="card whatsapp-store-box p-3 border-0 w-100 card-height h-100">
                                        ...
                                        <div class="card blog-card p-2 border-0 w-100 h-100 pt-5">
                                            ...
                                            <div class="blog-details mt-4">
                                                    <a href="{{ $vcardBlogUrl }}" class="text-decoration-none">
                                                        <h4
                                                        class="text-sm-start text-center title-color mb-2 text-white">
                                                        {{ $blog->title }}</h4>
                                                        <p class="mb-1">
            ...
            @if ((isset($managesection) && $managesection['payment_link']) || empty($managesection))
                @if (checkFeature('payment_link') && $vcard->paymentLinks->count())
                    <div class="main-section">
                        <div class="payment-link-section position-relative mt-5 mt-0 pb-1">
                            <h4 class="vcard-eight-heading heading-line position-relative text-center d-block mx-auto pb-3">{{ __('messages.vcard.payment_links') }}</h4>
                                ...
                                <div class="col-12 px-0">
                                    <form id="enquiryForm" enctype="multipart/form-data">
                                        ...
                                        <div class="contact-form px-sm-3">
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label">{{ __('messages.user.your_message') }}
