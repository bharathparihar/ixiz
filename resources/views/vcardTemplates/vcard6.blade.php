...
<head>
    ...
    {{-- css link --}}
    <link rel="stylesheet" href="{{ mix('assets/css/vcard6.css') }}">
        ...
        <div class="row d-flex justify-content-center content-blur">
            <div class="main-bg p-0 allSection collapse show">
                ...
                <div class="position-relative">
                    ...
                    <div class="container @if ($vcard->cover_type == 2) main-profile-div @endif">
                        <div
                            class="main-profile position-relative @if ($vcard->cover_type == 2) profile-margin @endif">
                                    ...
                                    <div class="row d-flex mb-4 justify-content-center">
                                        <div class="col-md-4">
                                            <img src="{{ $vcard->profile_url }}"
                                                class="@if ($vcard->cover_type == 2) yt-pro-img @endif pro-img img-fluid position-relative"
                                                loading="lazy" />
                                        </div>
                                        <div class="col-md-8 user-details-section">
                                            <div>
                                                ...
                                                <p class="small-title text-light">{{ ucwords($vcard->occupation) }}
                                                </p>
                                            ...
                                            <div class="social-section">
                                                @if (checkFeature('social_links') && getSocialLink($vcard))
                                                    <div class="social-icon d-flex flex-wrap justify-content-md-start justify-content-center">
                                        ...
                                        @if (checkFeature('custom-links') && $customLink->isNotEmpty())
                                            <div class="custom-link-section">
                                                <div
                                                    class="custom-link d-flex flex-wrap justify-content-center pb-4 pt-4 w-100 ">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <span class="pt-2 px-2 profile-description fs-6">{!! $vcard->description !!}
                                            </span>
                                        </div>
                                    </div>
                                @endif
                                @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian')
                                    <div class="row d-flex mb-4 justify-content-center" dir="rtl">
                                        <div class="col-md-4">
                                            <img src="{{ $vcard->profile_url }}"
                                                class="@if ($vcard->cover_type == 2) yt-pro-img @endif pro-img img-fluid position-relative"
                                                loading="lazy" />
                                                    ...
                                                    <div class="card border-0 bg-transparent">
                                                        <div class="event-icon text-white">
                                                            ...
                                                            <a href="tel:+{{ $vcard->region_code }}{{ $vcard->phone }}"
                                                                class="email-text text-white text-decoration-none"
                        ...
                        <div class="container mt-3 mb-5">
                            @if (getLanguage($vcard->default_language) != 'Arabic' && getLanguage($vcard->default_language) != 'Persian')
                                <div class="main-Qr-section mb-5">
                                    <div>
                                        <h4 class="mb-4 text-center heading-title">{{ __('messages.vcard.qr_code') }}
                                        </h4>
                                    </div>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="card service-card h-100">
                                                        ...
                                                        <div class="card-body px-0 py-3 text-white">
                                                            ...
                                                            <p
                                                                class="card-text text-gray-200 {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}">
                                                                {!! \Illuminate\Support\Str::limit($service->description, 170, '...') !!}</p>
                                                            @if ($vcard->show_service_enquiry_btn == true)
                                                                @if ($service->service_url)
                                                            ...
                                                            <div class="d-flex justify-content-between mt-2 product-info">
                                                                <div class="product-amount">
                                                                    @if ($product->currency_id && $product->price)
                                                                        <span
                                                                            class="text-light fs-18">{{ currencyFormat($product->price, 2, $product->currency->currency_code) }}</span>
                                                                    @elseif($product->price)
                                                                        <span
                                                                            class="text-light fs-18">{{ currencyFormat($product->price, 2, getUserCurrencyIcon($vcard->user->id)) }}</span>
                                                                    @endif
                                                                </div>
                ...
                @if ((isset($managesection) && $managesection['whatsapp_store']) || empty($managesection))
                    @if ($whatsappStore->count())
                        <div class="main-whatsapp-store position-relative">
                            ...
                            <div class="container mt-3 mb-4 mb-16 mt-0">
                                <h4 class="text-center mb-4 text-light product-title">
                                    {{ __('messages.feature.whatsapp_store') }}
                                </h4>

                                <div class="product-section position-relative">
                                    <div class="row g-3 product-card whatsapp-store-slider">
                                            ...
                                            <div class="col-6">
                                                <div class="card w-100 h-100 bg-transparent border-0 text-light">
                                                    ...
                                                    <div class="product-details">
                                                        ...
                                                        <div
                                                            class="d-flex align-items-center justify-content-center mt-2 pb-2">
                                            ...
                                            <div class="col-6">
                                                <div class="card  w-100 h-100 bg-transparent border-0 text-light">
                                                    <div class="d-flex align-items-center gap-3">
                                                        ...
                                                        <div
                                                        class="testimonial-user d-flex justify-content-center flex-column align-center">
                                                        <h5 class="user-name text-center position-relative mb-0">
                ...
                @if ((isset($managesection) && $managesection['blogs']) || empty($managesection))
                    @if (checkFeature('blog') && $vcard->blogs->count())
                        <div class="vcard-six-blog position-relative mt-5">
                            <img src="{{ asset('assets/img/vcard6/bluetesti.png') }}"
                                class="img-fluid position-absolute bluetesti-img" loading="lazy" />
                            <img src="{{ asset('assets/img/vcard6/circle.png') }}"
                                class="img-fluid position-absolute circletesti-img" loading="lazy" />
                                            ...
                                            <div class="card blog-card p-4 border-0 w-100 h-100">
                                                <div class="blog-image">
                                                 ...
                                                 <div class="blog-details mt-4">
                                                    ...
                                                    <a href="{{ $vcardBlogUrl }}"
                                                    class="mt-3 read-more d-flex align-items-center justify-content-end gap-2 text-white">
                        ...
                        <div class="main-businesshour position-relative">
                            ...
                            <div class="container mb-5 mt-0">
                                <div class="main-business position-relative">
                                    ...
                                    <div class="row g-3 pb-3" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                    ...
                    @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                        <div class="container pt-3 mb-10 mt-0">
                            <div class="appointment">
                                ...
                                <button type="button"
                                    class="appointmentAdd appoint-btn rounded mt-4 d-block mx-auto btn btn-lg d-none">{{ __('messages.make_appointments') }}
                                </button>
                            </div>
                        </div>
                ...
                @if ((isset($managesection) && $managesection['payment_link']) || empty($managesection))
                    @if (checkFeature('payment_link') && $vcard->paymentLinks->count())
                        <div class="main-section">
                            <div class="payment-link-section position-relative pt-10 pb-10">
                                <h4 class="text-center mb-0 heading-title">{{ __('messages.vcard.payment_links') }}</h4>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="row">
                                                        ...
                                                        <label for="basic-url"
                                                            class="form-label mb-0">{{ __('messages.user.email') }}
                                                            <span class="text-danger">*</span></label>
                                                        <div class="col-12 mb-3 input-group">
                                                            <span
                                ...
                                <div class="" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                    @if ($contactRequest == 1)
                                        <a href="{{ Auth::check() ? route('add-contact', $vcard->id) : 'javascript:void(0);' }}"
                                            class="add-contact-btn d-flex justify-content-center ms-0 align-items-center rounded px-5 text-decoration-none py-1 justify-content-center
                                            {{ Auth::check() ? 'auth-contact-btn' : 'ask-contact-detail-form' }}"
                                            data-action="{{ Auth::check() ? route('contact-request.store') : 'show-modal' }}"><i
                                ...
                                <div class="modal-dialog news-modal modal-dialog-centered">
                                    <div class="modal-content animate-bottom" id="newsLatter-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <h3 class="modal-desc text-start">
