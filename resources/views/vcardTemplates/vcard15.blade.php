...
<body>
    ...
    <div class="container p-0">
        ...
        @endif
        <div
            class="vcard-fifteen main-content mx-auto w-100 overflow-hidden  @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
            {{-- Pwa support --}}
                    ...
                    <div class="support-banner d-flex align-items-center justify-content-center">
                        ...
                        <div class="">
                            ...
                            <div class="text-center">
                                <a href="{{ $banners->url }}" class="act-now mb-4 text-light" target="_blank"
            ...
            <div class="banner-section position-relative">
                <div class="banner-img @if ($vcard->cover_type == 2) banner-img-15 @endif">
                    @php
                        $coverClass =
                            ...
                            <div class="language pt-3">
                                <ul class="text-decoration-none ps-0">
                                    <li class="dropdown1 dropdown lang-list">
                                        <a class="dropdown-toggle lang-head text-decoration-none"
            ...
            {{-- profile --}}
            <div class="profile-section px-30 pt-30 position-relative">
                <div
                    class="position-absolute top-0 @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') start-0 main-vector-1 @else end-0 @endif">
                    <img src="{{ asset('assets/img/vcard15/main-vector-1.png') }}" loading="lazy" />
                </div>
                <div class="profile-card pt-40 px-30 card d-flex flex-sm-row align-items-center gap-3 position-relative"
                    ...
                    <div class="card-body text-sm-start text-center p-0">
                        <div class="profile-name">
                            <h2 class="font-cormorant vcard-profile-name mb-1">
                            ...
                            <p class="fs-14 mb-0 text-gray-300">{{ ucwords($vcard->occupation) }}</p>
                            <p class="fs-14 mb-0 text-gray-300">{{ ucwords($vcard->job_title) }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            @if (checkFeature('social_links') && getSocialLink($vcard))
                <div class="social-media  d-flex  flex-wrap justify-content-center pt-40 px-30 position-relative">
                    <div class="position-absolute vector-all vector-bg-1">
                        <img src="{{ asset('assets/img/vcard15/vector-bg-1.png') }}" class="w-100"
                            alt="images" />
                    </div>
            ...
            @if (((isset($managesection) && $managesection['contact_list']) || empty($managesection)) && $hasContactData)
                <div class="contact-section pt-50 position-relative">
                    <div class="position-absolute vector-all vector-bg-2 text-end">
                        <img src="{{ asset('assets/img/vcard15/vector-bg-2.png') }}" class="w-100"
                            alt="images" />
                    </div>
                            ...
                            <div class="row row-gap-20px">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="contact-box">
                                            <div class="contact-icon d-flex justify-content-center align-items-center">
                                                <img src="{{ asset('assets/img/vcard15/email.svg') }}" />
                                            </div>
                                            <div class="contact-desc">
                                                <a href="mailto:{{ $vcard->email }}"
                                                    class="text-dark text-center fw-5">{{ $vcard->email }}</a>
                                            </div>
                                        </div>
                                    </div>
                                @endif
                                        ...
                                        <div class="contact-box">
                                            ...
                                            <div class="contact-desc">
                                                <a href="mailto:{{ $vcard->alternative_email }}"
                                                    class="text-dark text-center fw-5">{{ $vcard->alternative_email }}</a>
                                            </div>
                                        </div>
                                    </div>
                                @endif
                                @if ($vcard->phone)
                                    <div class="col-sm-6">
                                        <div class="contact-box">
                                            <div class="contact-icon d-flex justify-content-center align-items-center">
                                                <img src="{{ asset('assets/img/vcard15/phone.svg') }}" />
                                            </div>
                                            <div class="contact-desc">
                                                <a href="tel:+{{ $vcard->region_code }} {{ $vcard->phone }}"
                                                    class="text-dark text-center fw-5"
                                ...
                                @if ($vcard->dob)
                                    <div class="col-sm-6">
                                        <div class="contact-box">
                                            <div class="contact-icon d-flex justify-content-center align-items-center">
                                                <img src="{{ asset('assets/img/vcard15/dob-icon.svg') }}" />
                                            </div>
                                            <div class="contact-desc">
                                                <p class="text-dark text-center fw-5 mb-0">{{ $vcard->dob }}
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                @if ($vcard->location)
                                    <div class="col-sm-6">
                                        <div class="contact-box">
                                            <div class="contact-icon d-flex justify-content-center align-items-center">
                                                <img src="{{ asset('assets/img/vcard15/location.svg') }}" />
                                            </div>
                                            <div class="contact-desc">
                                                <p class="text-dark text-center fw-5 mb-0">{!! ucwords($vcard->location) !!}</p>
                                            </div>
                                        </div>
                                    </div>
                                @endif
            ...
            @if ((isset($managesection) && $managesection['services']) || empty($managesection))
                @if (checkFeature('services') && $vcard->services->count())
                    <div class="our-services-section pt-50 position-relative">
                        <div class="position-absolute vector-all vector-bg-3">
                            <img src="{{ asset('assets/img/vcard15/vector-bg-3.png') }}" class="w-100"
                                alt="images" />
                        </div>
                        <div class="section-heading">
                            <h2>
                                                                    ...
                                                                    @if ($service->service_url)
                                                                        <div class="mt-2 enquiry-btn">
                                                                            <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
                                                                                ...
                                                                                <span
                                                                                    class="fs-14">{{ __('messages.contact_us.enquiry') }}</span>
                                                                            </a>
                                                                        </div>
                                                                    @endif
                                                                @endif
                                                    ...
                                                    <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
                                                        ...
                                                        <div class="service-card card h-100">
                                                            ...
                                                            <div class="card-body text-center">
                                                                ...
                                                                <p
                                                                    class="mb-0 text-gray {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}">
                                                                    {!! \Illuminate\Support\Str::limit($service->description, 170, '...') !!}
                                                                </p>
                                                                @if ($vcard->show_service_enquiry_btn == true)
                                                                    @if ($service->service_url)
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                <div class="qr-code-section position-relative pt-50">
                    <div class="position-absolute vector-all vector-bg-4 text-end">
                        <img src="{{ asset('assets/img/vcard15/vector-bg-4.png') }}" class="w-100"
                            alt="images" />
                    </div>
                    <div class="section-heading">
                    ...
                    <div class="px-30">
                        <div class="qr-code mx-auto px-30 position-relative">
            ...
            @if ((isset($managesection) && $managesection['galleries']) || empty($managesection))
                @if (checkFeature('gallery') && $vcard->gallery->count())
                    <div class="gallery-section pt-50 position-relative">
                        <div class="position-absolute vector-all vector-bg-5">
                            <img src="{{ asset('assets/img/vcard15/vector-bg-5.png') }}" class="w-100"
                                alt="images" />
                        </div>
                        <div class="section-heading">
                            <h2>{{ __('messages.plan.gallery') }}
                            </h2>
                        </div>
                        <div class="px-20">
                                                ...
                                                @elseif($file->type == App\Models\Gallery::TYPE_AUDIO)
                                                    <div class="audio-container">
                                                        <img src="{{ asset('assets/img/music.jpeg') }}"
                                                            alt="Album Cover" class="audio-image mt-2"
                                                            height="173">
            ...
            @if ((isset($managesection) && $managesection['products']) || empty($managesection))
                @if (checkFeature('products') && $vcard->products->count())
                    <div class="product-section pt-50 position-relative">
                        <div class="position-absolute vector-all vector-bg-6 text-end">
                            <img src="{{ asset('assets/img/vcard15/vector-bg-6.png') }}" class="w-100"
                                alt="images" />
                        </div>
                        <div class="section-heading">
                            <h2>{{ __('messages.plan.products') }}
                            </h2>
                        </div>
                        <div class="px-20">
                                                ...
                                                <div class="product-card card">
                                                    ...
                                                    <div class="product-desc card-body">
                                                        <div class="product-title">
                                                            <h3 class="text-dark text-center">{{ $product->name }}
                                                            </h3>
                                                        </div>
                            ...
                            <div class="mt-4 mx-auto d-flex justify-content-center">
                                <a class="view-more-btn fs-6 text-decoration-underline fw-4 py-2 ps-3 pe-4 d-inline-flex justify-content-center align-items-center gap-2 position-relative z-2"
                                    ...
                                    <i class="fa-solid fa-arrow-right-long right-arrow-animation"></i></a>
                            </div>
                        </div>
                    </div>
                @endif
            ...
            @if ((isset($managesection) && $managesection['whatsapp_store']) || empty($managesection))
                @if ($whatsappStore->count())
                    <div class="whatsapp-store-product-section pt-50 px-20 position-relative">
                        <div class="position-absolute vector-all vector-bg-7">
                            <img src="{{ asset('assets/img/vcard15/vector-bg-8.png') }}" class="w-100"
                                alt="images" />
                        </div>
                        <div class="section-heading">
            ...
            @if ((isset($managesection) && $managesection['testimonials']) || empty($managesection))
                @if (checkFeature('testimonials') && $vcard->testimonials->count())
                    <div class="testimonial-section pt-50 position-relative">
                        <div class="position-absolute vector-all vector-bg-7">
                            <img src="{{ asset('assets/img/vcard15/vector-bg-7.png') }}" class="w-100"
                                alt="images" />
                        </div>
                        <div class="section-heading">
                            <h2>
                                    ...
                                    <div>
                                        <div class="testimonial-card p-0"
                                            ...
                                            <div class="card-body text-center position-relative">
                                                <div class="quote-img">
                                                    <img src="{{ asset('assets/img/vcard15/quote-img.svg') }}"
                                                        class="h-100" loading="lazy" />
                                                </div>
                                                <div class="text-center">
                                                    <p
                                                        class="text-gray mb-0 {{ \Illuminate\Support\Str::length($testimonial->description) > 80 ? 'more' : '' }}">
                                            ...
                                            <div
                                                class="d-flex flex-column align-items-center justify-content-center gap-2 profile-desc">
                                                <div class="card-img">
                                                    <img src="{{ $testimonial->image_url }}"
                                                        class="w-100 h-100 object-fit-cover" loading="lazy" />
                                                </div>
                                                <h6 class="name mb-0 text-decoration-underline">
            ...
            @if ((isset($managesection) && $managesection['insta_embed']) || empty($managesection))
                @if (checkFeature('insta_embed') && $vcard->instagramEmbed->count())
                    <div class="insta-feed-section pt-50 position-relative">
                        <div class="position-absolute vector-all vector-bg-8 text-end">
                            <img src="{{ asset('assets/img/vcard15/vector-bg-8.png') }}" class="w-100"
                                alt="images" />
                        </div>
                        <div class="section-heading">
                        ...
                        <div class="px-30">
                            <div id="postContent" class="insta-feed">
                                <div class="row row-gap-20px" loading="lazy">
                                    <!-- "Post" content -->
            ...
            @if ((isset($managesection) && $managesection['blogs']) || empty($managesection))
                @if (checkFeature('blog') && $vcard->blogs->count())
                    <div class="blog-section pt-50 position-relative">
                        <div class="position-absolute vector-all vector-bg-9">
                            <img src="{{ asset('assets/img/vcard15/vector-bg-9.png') }}" class="w-100"
                                alt="images" />
                        </div>
                        <div class="section-heading">
                            <h2>
                                    ...
                                    <div>
                                        <div class="blog-card card">
                                            ...
                                            <div class="card-body text-start">
                                                <h5 class="text-dark blog-head fw-bold"> {{ $blog->title }}</h5>
                                                <div class="text-gray blog-desc mb-0">
                                                    {!! $blog->description !!}
                                                </div>
                                                <div
                                                    class="text-end mt-1  @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') ms-0 @else ms-auto @endif">
                                                    <a href="{{ $vcardBlogUrl }}"
            ...
            @if ((isset($managesection) && $managesection['business_hours']) || empty($managesection))
                @if ($vcard->businessHours->count())
                    ...
                    <div class="business-hour-section pt-50 position-relative">
                        <div class="position-absolute vector-all vector-bg-10 text-end">
                            <img src="{{ asset('assets/img/vcard15/vector-bg-10.png') }}" class="w-100"
                                alt="images" />
                        </div>
                        <div class="section-heading">
                            <h2>
            ...
            @if ((isset($managesection) && $managesection['appointments']) || empty($managesection))
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="appointment-section pt-40 position-relative">
                        <div class="position-absolute vector-all vector-bg-11">
                            <img src="{{ asset('assets/img/vcard15/vector-bg-11.png') }}" class="w-100"
                                alt="images" />
                        </div>
                        <div class="section-heading">
                            <h2>
            ...
            @if ((isset($managesection) && $managesection['iframe']) || empty($managesection))
                @if (checkFeature('iframes') && $vcard->iframes->count())
                    <div class="iframe-section pt-50 position-relative overflow-hidden">
                        <div class="position-absolute vector-all vector-bg-12 text-end">
                            <img src="{{ asset('assets/img/vcard15/vector-bg-12.png') }}" class="w-100"
                                alt="images" />
                        </div>
                        <div class="section-heading">
                            <h2>
                                    ...
                                    <div>
                                        <div class="iframe-card">
                                            <iframe src="{{ $iframe->url }}" frameborder="0"
                                                ...
                                                allowfullscreen width="100%" height="320" class="w-100"
                                                loading="lazy">
                                            </iframe>
                                        </div>
                                    </div>
            ...
            @if ((isset($managesection) && $managesection['payment_link']) || empty($managesection))
                @if (checkFeature('payment_link') && $vcard->paymentLinks->count())
                    <div class="payment-link-section pt-50 position-relative">
                        <div class="position-absolute vector-all vector-bg-2 text-end">
                            <img src="{{ asset('assets/img/vcard15/vector-bg-2.png') }}" class="w-100"
                                alt="images" />
                        </div>
            ...
            @php
                $currentSubs = $vcard
                    ...
                    ->first();
            @endphp
            <div class="contact-us-section pt-50 position-relative">
                <div class="position-absolute vector-all vector-bg-13">
                    <img src="{{ asset('assets/img/vcard15/vector-bg-13.png') }}" class="w-100" alt="images" />
                </div>
                                            ...
                                            <div class="mb-3 mt-2">
                                                <div class="wrapper-file-input">
                                                    <div class="input-box" id="fileInputTrigger">
                                                        ...
                                                        class="text-gray fw-5">{{ __('messages.file_supported') }}</small>
                                                </div>
                                            ...
                                            <div class="col-12 mt-1">
                                                ...
                                                <label class="form-check-label fs-14" for="privacyPolicyCheckbox">
                                                    ...
                                                    <a href="{{ $vcardPrivacyAndTerm }}" target="_blank"
                                                        class="text-decoration-underline link-info text-primary fw-5">{!! __('messages.vcard.term_and_condition') !!}</a>
                                                    <span class="text-dark">&</span>
                                                    <a href="{{ $vcardPrivacyAndTerm }}" target="_blank"
                                                        class="text-decoration-underline link-info text-primary fw-5">{{ __('messages.vcard.privacy_policy') }}</a>
                                                </label>
                                            </div>
                                        @endif
                                        <div class="col-12 text-center mt-4  d-flex justify-content-center">
                                            <button
                                                class="contact-btn btn btn-primary d-flex align-items-center justify-content-center"
                                                type="submit">
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
                <div class="create-vcard-section pt-50 position-relative bg-white">
                    <div class="position-absolute vector-all vector-bg-14 text-end">
                        <img src="{{ asset('assets/img/vcard15/vector-bg-14.png') }}" class="w-100"
                            alt="images" />
                    </div>
                    <div class="section-heading">
                        <h2>
            ...
            @if ($vcard->location_type == 0 && ($vcard->location_url && isset($url[5])))
                <div class="main-section px-30 pt-50 position-relative">
                    <div class="position-absolute vector-all vector-bg-15">
                        <img src="{{ asset('assets/img/vcard15/vector-bg-15.png') }}" class="w-100"
                            alt="images" />
                    </div>
                    <div class="iframe-card-box">
                        <div class="map-location d-flex gap-2 mb-3 align-items-center"
                            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
            ...
            @if ($vcard->location_type == 1 && !empty($vcard->location_embed_tag))
                <div class="main-section px-30 pt-50 position-relative">
                    ...
                    <div class="iframe-card-box">
                        ...
                        <div class="embed-responsive embed-responsive-16by9 overflow-hidden" style="height: 300px;">
            ...
            @endif
            {{-- add contact --}}
            <div class="w-100 d-flex justify-content-center pb-3 sticky-vcard-div">
                    ...
                    <div class="" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        @if ($contactRequest == 1)
                            <a href="{{ Auth::check() ? route('add-contact', $vcard->id) : 'javascript:void(0);' }}"
                                class="btn btn-primary add-contact-btn  d-flex justify-content-center ms-0 text-white align-items-center px-4 gap-2 text-decoration-none py-1  justify-content-center
                        ...
                        @else
                            <a href="{{ route('add-contact', $vcard->id) }}"
                                class="btn btn-primary add-contact-btn  d-flex justify-content-center ms-0 text-white align-items-center px-4 gap-2 text-decoration-none py-1  justify-content-center"><i
                                    class="fas fa-download fa-address-book"></i>
                                ß &nbsp;{{ __('messages.setting.add_contact') }}</a>
                        @endif
                    </div>
            ...
            <div class="btn-section cursor-pointer @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
                <div class="fixed-btn-section">
                    @if (empty($vcard->hide_stickybar))
                        <div
                            class="bars-btn salon-bars-btn @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') vcard-bars-btn-left @endif">
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                                viewBox="0 0 25 25" fill="none">
                                <path
                                    d="M15.413 0.540771H22.4892C23.572 0.540851 24.4597 1.42874 24.4599 2.51147V9.58765C24.4598 10.6777 23.5731 11.5583 22.4892 11.5583H15.413C14.3221 11.5581 13.4424 10.6786 13.4423 9.58765V2.51147C13.4425 1.42774 14.3232 0.540993 15.413 0.540771Z"
                                    stroke="#ffffff" />
                                <path
                                    d="M2.97168 0.500122H8.74609C10.113 0.50023 11.2178 1.61264 11.2178 2.9718V8.74622C11.2177 10.1141 10.114 11.2178 8.74609 11.2179H2.97168C1.61252 11.2179 0.500108 10.1131 0.5 8.74622V2.9718C0.5 1.61366 1.61354 0.500122 2.97168 0.500122Z"
                                    stroke="#ffffff" />
                                <path
                                    d="M2.97168 13.783H8.74609C10.114 13.7831 11.2178 14.8867 11.2178 16.2546V22.0291C11.2177 23.3881 10.1129 24.5006 8.74609 24.5007H2.97168C1.6136 24.5007 0.500109 23.3871 0.5 22.0291V16.2546C0.5 14.8877 1.61245 13.783 2.97168 13.783Z"
                                    stroke="#ffffff" />
                                <path
                                    d="M16.254 13.783H22.0284C23.3875 13.7831 24.5001 14.8877 24.5001 16.2546V22.0291C24.5 23.387 23.3864 24.5006 22.0284 24.5007H16.254C14.8871 24.5007 13.7824 23.3882 13.7823 22.0291V16.2546C13.7823 14.8866 14.8859 13.783 16.254 13.783Z"
                                    stroke="#ffffff" />
                            </svg>
                        </div>
                    @endif
                    <div class="sub-btn d-none">
                        <div class="sub-btn-div @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') sub-btn-div-left @endif">
                            ...
                            @if (empty($vcard->hide_stickybar))
                                <div
                                    class="{{ isset($vcard->whatsapp_share) ? 'vcard15-btn-group' : 'stickyIcon' }}">
                                    <button type="button"
