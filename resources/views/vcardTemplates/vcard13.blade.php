...
<head>
    ...
    <link rel="stylesheet" href="{{ mix('assets/css/vcard13.css') }}">
    {{-- google Font --}}
...
<body>
    <div class="vcard-thirteen-effect position-absolute w-100 h-100"></div>
        ...
        <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
                ...
                @if (isset($banners->title))
                    <div class="support-banner d-flex align-items-center justify-content-center">
                        ...
                        <div class="">
                            ...
                            <p class="text-center text-dark support_text mt-4">{{ $banners->description }} </p>
            ...
            <div class="profile-section pt-40 px-30 mb-40 position-relative">
                <div class="profile-bg">
                    <img src="{{ asset('assets/img/vcard13/profile-bg.png') }}" alt="vector" />
                </div>
                <div class="position-relative">
                    <div class="card-wrapper">
                        @if (getLanguage($vcard->default_language) != 'Arabic' && getLanguage($vcard->default_language) != 'Persian')
                            <div
                                class="card d-flex flex-sm-row align-items-center justify-content-end gap-3 position-relative">

                                <div class="card-img d-flex justify-content-center align-items-center">
                                    <img src="{{ $vcard->profile_url }}" class="img-fluid banner-image"
                                        alt="banner" loading="lazy" />
                                </div>
                                <div class="card-body pb-0 px-0 pt-0">
                                    <div
                                        class="@if ($vcard->cover_type == 2) profile-desc-margin @endif profile-name ">
                                        <h2 class="text-black mb-1 fw-bold fs-28">
                                            {{ ucwords($vcard->first_name . ' ' . $vcard->last_name) }}
                                            @if ($vcard->is_verified)
                                                <i class="verification-icon bi-patch-check-fill"></i>
                                            @endif
                                        </h2>
                                        <p class="fw-5 position-relative company-name mb-0">
                                            {{ ucwords($vcard->company) }}
                                        </p>
                                        <p class="fs-14 text-gray mb-0 fw-5">{{ ucwords($vcard->occupation) }}</p>
                                        <p class="fs-14 text-gray mb-0 fw-5">{{ ucwords($vcard->job_title) }}</p>
                                    </div>
                                </div>
                            </div>
                        @endif
                        @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian')
                            <div class="card d-flex flex-sm-row align-items-sm-end align-items-center gap-3 justify-content-end"
                                dir="rtl">
                                <div class="card-img d-flex justify-content-center align-items-center">
                                    <img src="{{ $vcard->profile_url }}" class="img-fluid banner-image"
                                        alt="banner" loading="lazy" />
                                ...
                                <div class="card-body pb-0 px-0 pt-0">
                                    <div
                                        class="@if ($vcard->cover_type == 2) profile-desc-margin @endif profile-name ">
                                        <h2 class="text-primary mb-2 fs-24">
                                            {{ ucwords($vcard->first_name . ' ' . $vcard->last_name) }}
                                            @if ($vcard->is_verified)
                                                <i class="verification-icon bi-patch-check-fill"></i>
                                            @endif
                                        ...
                                        <p class="fs-16 text-black mb-0 fw-5">{{ ucwords($vcard->occupation) }}</p>
                                        <p class="fs-16 text-black mb-0 fw-5">{{ ucwords($vcard->job_title) }}</p>
                                    </div>
                                </div>
                            </div>
                        @endif
                    </div>
                    <div class="text-center profile-desc pt-40">
                        <div>
                            {!! $vcard->description !!}
                        </div>
                    </div>
            ...
            @if (checkFeature('social_links') && isset($vcard->socialLink) && getSocialLink($vcard))
                <div class="social-media d-flex justify-content-center position-relative mb-40 px-30">
                    <div class="social-icons d-flex flex-wrap justify-content-center w-100 position-relative">
            ...
            @if (checkFeature('custom-links') && $customLink->isNotEmpty())
                <div class="custom-link-section position-relative">
                    <div class="custom-link d-flex flex-wrap justify-content-center w-100 ">
            ...
            @if (((isset($managesection) && $managesection['contact_list']) || empty($managesection)) && $hasContactData)
                <div class="contact-section position-relative section-bg pt-50 px-30">
                    <div class="bg-vector vector-img2">
                        <img src="{{ asset('assets/img/vcard13/vector-img2.png') }}" alt="vector" />
                    </div>
                    <div class="section-heading position-relative text-center pb-40">
                            ...
                            @if ($vcard->email)
                                <div class="col-sm-6">
                                    <div class="contact-box">
                                        ...
                                        <div class="contact-icon-box d-flex align-items-center jusrify-content-center">
                                            <div
                                                class="contact-icon d-flex justify-content-center align-items-center m-auto">
                                                <img src="{{ asset('assets/img/vcard13/email.svg') }}" />
                                            </div>
                                        </div>
                                        <div class="contact-desc mt-2 text-center">
                                            <a href="mailto:{{ $vcard->email }}"
                                                class="text-black">{{ $vcard->email }}</a>
                                        </div>
                                    </div>
                                </div>
                            @endif
                                    ...
                                    <div class="contact-box">
                                        ...
                                        <div class="contact-desc mt-2 text-center">
                                            <a href="mailto:{{ $vcard->alternative_email }}"
                                                class="text-black">{{ $vcard->alternative_email }}</a>
                                        </div>
                                    </div>
                                </div>
                            @endif
                                ...
                                <div class="col-sm-6">
                                    <div class="contact-box">
                                        ...
                                        <div class="contact-icon-box d-flex align-items-center jusrify-content-center">
                                            <div
                                                class="contact-icon d-flex justify-content-center align-items-center m-auto">
                                                <img src="{{ asset('assets/img/vcard13/phone.svg') }}" />
                                            </div>
                                        </div>
                                        <div class="contact-desc mt-2 text-center">
                                            <a href="tel:+{{ $vcard->region_code }}{{ $vcard->phone }}"
                                                class="text-black" dir="ltr">+{{ $vcard->region_code }}
                                                {{ $vcard->phone }}</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="contact-box">
                                        ...
                                        <div class="contact-icon-box d-flex align-items-center jusrify-content-center">
                                            <div
                                                class="contact-icon d-flex justify-content-center align-items-center m-auto">
                                                <img src="{{ asset('assets/img/vcard13/dob-icon.svg') }}" />
                                            </div>
                                        </div>
                                        <div class="contact-desc mt-2 text-center">
                                            <p class="mb-0 text-black">{{ $vcard->dob }}</p>
                                        </div>
                                    </div>
                                </div>
                            @endif
                                ...
                                <div class="col-sm-6">
                                    <div class="contact-box">
                                        ...
                                        <div class="contact-icon-box d-flex align-items-center jusrify-content-center">
                                            <div
                                                class="contact-icon d-flex justify-content-center align-items-center m-auto">
                                                <img src="{{ asset('assets/img/vcard13/location.svg') }}" />
                                            </div>
                                        </div>
                                        <div class="contact-desc mt-2 text-center">
                                            <p class="text-black mb-0">{!! ucwords($vcard->location) !!}</p>
                                        </div>
                                    </div>
                                </div>
                            @endif
                                ...
                                @if ($vcard->email)
                                    <div class="col-sm-6">
                                        <div class="contact-box">
                                            ...
                                            <div
                                                class="contact-icon-box d-flex align-items-center jusrify-content-center">
                                                <div
                                                    class="contact-icon d-flex justify-content-center align-items-center m-auto">
                                                    <img src="{{ asset('assets/img/vcard13/email.svg') }}" />
                                                </div>
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                <div class="qr-code-section position-relative pt-50 px-30">
                    <div class="bg-vector vector-img3 text-end">
                        <img src="{{ asset('assets/img/vcard13/vector-img3.png') }}" alt="vector" />
                    </div>
                    <div class="section-heading position-relative text-center pb-40">
                        <h2 class="text-center mb-0 fw-bold">{{ __('messages.vcard.qr_code') }}</h2>
                    </div>
                    <div class="qr-code mx-auto  position-relative">
                        ...
                        <div class="d-flex flex-sm-row flex-column gap-3 align-items-center"
                            ...
                            <div class="text-sm-start text-center">
                                <h5 class="fw-6">{{ __('messages.vcard.scan_to_contact') }}</h5>
                                <p class="fs-16 text-gray mb-0">{{ __('messages.vcard.qr_section_desc') }}</p>
                            </div>
            ...
            @if ((isset($managesection) && $managesection['services']) || empty($managesection))
                @if (checkFeature('services') && $vcard->services->count())
                    <div class="our-services-section pt-50 position-relative">
                        <div class="bg-vector vector-img4">
                            <img src="{{ asset('assets/img/vcard13/vector-img4.png') }}" alt="vector" />
                        </div>
                        <div class="section-heading position-relative text-center pb-40">
                            <h2 class="text-center fw-bold mb-0">{{ __('messages.vcard.our_service') }}
                            </h2>
                        </div>
                                                    ...
                                                    <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
                                                        ...
                                                        <div
                                                            ...
                                                            <img src="{{ $service->service_icon }}"
                                                                class="web-design" alt="{{ $service->name }}"
                                                                loading="lazy" />
                                                        </div>
                                                    </a>
                                                    <div class="card-body text-center">
                                                        <h3 class="card-title fw-bold text-black">
                                                            {{ ucwords($service->name) }}
                                                        </h3>
                                                        <p
                                                            class="mb-0 text-gray description-text {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}">
                ...
                @endif
            @endif
            <div class="position-relative vector-bg">
                {{-- gallery --}}
                @if ((isset($managesection) && $managesection['galleries']) || empty($managesection))
                    @if (checkFeature('gallery') && $vcard->gallery->count())
                        <div class="vcard-thirteen__gallery gallery-section section-bg pt-30 px-20">
                            <div class="bg-vector vector-img5 text-end">
                                <img src="{{ asset('assets/img/vcard13/vector-img5.png') }}" alt="vector" />
                            </div>
                            <div class="section-heading position-relative text-center pb-40">
                                <h2 class=" text-center fw-bold">{{ __('messages.plan.gallery') }}</h2>
                            </div>

                            <div class="gallery-slider px-sm-4 px-sm-2">
                ...
                @if ((isset($managesection) && $managesection['products']) || empty($managesection))
                    @if (checkFeature('products') && $vcard->products->count())
                        <div class="product-section position-relative pt-50 px-20">
                            <div class="bg-vector vector-img6">
                                <img src="{{ asset('assets/img/vcard13/vector-img6.png') }}" alt="vector" />
                            </div>
                            <div class="section-heading position-relative text-center pb-40 px-30">
                                <h2 class=" mb-0 fw-bold">{{ __('messages.plan.products') }}</h2>
                            </div>
                            <div class="">
                                        ...
                                        <div class="">
                                            <a @if ($product->product_url) href="{{ $product->product_url }}" @endif
                                                ...
                                                <div class="product-card card">
                                                    ...
                                                    <div
                                                        class="product-desc card-body">
                                                        <div class="product-title">
                                                            <h3 class="text-black text-center fw-6">
                                                                {{ $product->name }}</h3>
                                                        </div>
                                                        <div class="d-flex justify-content-between mt-2 product-info">
                                                            <div class="product-amount lh-1 fw-bold">
                                                                @if ($product->currency_id && $product->price)
                                                                    <span
                                                                        class="product-amoun fw-bold text-primary">
                                                                        {{ currencyFormat($product->price, 2, $product->currency->currency_code) }}</span>
                                                                @elseif($product->price)
                                                                    <span
                                                                        class="product-amount fw-5">{{ currencyFormat($product->price, 2, getUserCurrencyIcon($vcard->user->id)) }}</span>
                                                                @endif
                                                            </div>
                                ...
                                <div class="mt-4 mx-auto d-flex justify-content-center">
                                    <a class="view-more-btn fs-6 text-decoration-underline fw-4 py-2 ps-3 pe-4 d-inline-flex justify-content-center align-items-center gap-2 position-relative z-2"
                                        href="{{ $vcardProductUrl }}">{{ __('messages.analytics.view_more') }}
                                        <i
                                            class="fa-solid fa-arrow-right-long right-arrow-animation text-decoration-none"></i></a>
                                </div>
                            </div>
                        </div>
                    @endif
                ...
                @if ((isset($managesection) && $managesection['whatsapp_store']) || empty($managesection))
                    @if ($whatsappStore->count())
                        <div class="whatsapp-store-product-section position-relative pt-50 px-20">
                            <div class="bg-vector vector-img7 text-end">
                                <img src="{{ asset('assets/img/vcard13/vector-img2.png') }}" alt="vector" />
                            </div>
                            <div class="section-heading position-relative text-center pb-40 px-30">
                                    ...
                                    @foreach ($whatsappStore as $product)
                                        <div>
                                            <div class="whatsapp-store-box card">
                                                ...
                                                <div
                                                    class="whatsapp-store-content card-body d-flex flex-column align-items-center">

                                                    <div class="whatsapp-store-name">
                                                        <h3 class="text-black text-center fw-6">
                                                            {{ $product->store_name }}
                                                        </h3>
                                                    </div>
                                                    ...
                                                    <div
                                                        ...
                                                        <a href="{{ route('whatsapp.store.show', $product->url_alias) }}"
                                                            target="_blank" class="btn btn-wp-visit-store d-inline-flex align-items-center justify-content-center w-70 py-1 px-3 fs-14 rounded-pill fw-normal">
                                                            <span class="fs-14">
            ...
            @if ((isset($managesection) && $managesection['testimonials']) || empty($managesection))
                @if (checkFeature('testimonials') && $vcard->testimonials->count())
                    <div class="testimonial-section pt-50 px-20 position-relative">
                        <div class="bg-vector vector-img7 text-end">
                            <img src="{{ asset('assets/img/vcard13/vector-img7.png') }}" alt="vector" />
                        </div>
                        <div class="section-heading position-relative text-center pb-40">
                            <h2 class="text-center mb-0 fw-bold">{{ __('messages.plan.testimonials') }}
                            </h2>
                        </div>
                        ...
                        <div class="testimonial-slider">
                            @foreach ($vcard->testimonials as $testimonial)
                                <div>
                                    <div class="testimonial-card " @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                        <div class="profile-img mb-2">
                                            <img src="{{ $testimonial->image_url }} "
                                                class="img-fluid w-100 h-100 object-fit-cover" loading="lazy" />
                                        </div>
                                        <div class="card-body text-center py-0 px-sm-4 px-3">
                                            <div
                                            ...
                                            <div class="text-center">
                                                <p class="text-primary text-decoration-underline mb-0 fw-6 title-text">
                                                    {!! $testimonial->name !!}
                                                </p>
                                                <p
                                                    class="desc text-gray mb-0 {{ \Illuminate\Support\Str::length($testimonial->description) > 80 ? 'more' : '' }}">
            ...
            @if ((isset($managesection) && $managesection['insta_embed']) || empty($managesection))
                @if (checkFeature('insta_embed') && $vcard->instagramEmbed->count())
                    <div class="position-relative section-bg pt-50 px-30">
                        <div class="bg-vector vector-img8">
                            <img src="{{ asset('assets/img/vcard13/vector-img8.png') }}" alt="vector" />
                        </div>
                        <div class="section-heading position-relative text-center pb-40">
                            <h2 class=" mb-0 fw-bold">{{ __('messages.feature.insta_embed') }}</h2>
                        </div>
                        <nav>
                            <div class="row insta-toggle">
                                <div class="nav nav-tabs px-0 border-0" id="nav-tab" role="tablist">
                                    <button
                                        class="d-flex align-items-center justify-content-center py-2 active postbtn instagram-btn text-dark border-0"
                                    ...
                                    <button
                                        class="d-flex align-items-center justify-content-center py-2 instagram-btn reelsbtn text-dark border-0"
            ...
            @if ((isset($managesection) && $managesection['linkedin_embed']) || empty($managesection))
                @if (checkFeature('linkedin_embed') && $vcard->linkedinEmbed->count())
                    <div class="position-relative section-bg pt-50 px-30">
                        <div class="section-heading position-relative text-center pb-40">
                            <h2 class="mb-0 fw-bold">{{ __('messages.feature.linkedin_embed') }}</h2>
                        </div>

                        <div class="linkedin-feed">
                            <div class="row overflow-hidden mt-2" loading="lazy">
                                <!-- "Post" content -->
            ...
            @if ((isset($managesection) && $managesection['blogs']) || empty($managesection))
                @if (checkFeature('blog') && $vcard->blogs->count())
                    <div
                        class="blog-section position-relative pt-50 pb-50 px-20 @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
                        <div class="bg-vector vector-img9 text-end">
                            <img src="{{ asset('assets/img/vcard13/vector-img9.png') }}" alt="vector" />
                        </div>
                        <div class="section-heading position-relative text-center pb-40">
                            <h2 class=" mb-0 fw-bold">{{ __('messages.feature.blog') }}</h2>
                        </div>
                        <div class="blog-slider">
                            @foreach ($vcard->blogs as $blog)
                                ...
                                ?>
                                <div class="">
                                    <div class="blog-card" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                        <div class="card-img">
                                            <a href="{{ $vcardBlogUrl }}">
                                                <img src="{{ $blog->blog_icon }}" alt="profile"
                                                    class="w-100 h-100 object-fit-cover mx-auto" loading="lazy" />
                                            </a>
                                        </div>
                                        <div class="card-body text-sm-start">
                                            <h2 class="text-black blog-head fw-bold"> {{ $blog->title }}</h2>
                                            <p class="text-gray blog-desc mb-1">
            ...
            @if ((isset($managesection) && $managesection['business_hours']) || empty($managesection))
                @if ($vcard->businessHours->count())
                    ...
                    <div class="business-hour-section pt-50 position-relative">
                        <div class="bg-vector vector-img10">
                            <img src="{{ asset('assets/img/vcard13/vector-img10.png') }}" alt="vector" />
                        </div>
                        <div class="section-heading position-relative text-center pb-40">
                            <h2 class=" mb-0 fw-bold">{{ __('messages.business.business_hours') }}</h2>
                        </div>
                        <div class="px-30">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="business-hour-card d-flex gap-2 align-items-center mb-3">
                                            ...
                                            <div class="d-flex flex-column align-items-start">
                                                <span class="fs-14 text-gray lh-1 fw-5">
                                                    {{ __('messages.business.' . \App\Models\BusinessHour::DAY_OF_WEEK[$key]) }}</span>
                                                <span
                                                    class="fs-16 fw-5">{{ $dayTime ?? __('messages.common.closed') }}</span>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
            ...
            @if ((isset($managesection) && $managesection['appointments']) || empty($managesection))
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="appointment-section section-bg pt-50 px-30 position-relative">
                        <div class="bg-vector vector-img11 text-end">
                            <img src="{{ asset('assets/img/vcard13/vector-img11.png') }}" alt="vector" />
                        </div>
                        <div class="section-heading position-relative text-center pb-40">
                            <h2 class="position-relative text-center fw-bold ">
                                {{ __('messages.make_appointments') }}</h2>
                        </div>
                        <div class="appointment-card p-3">
                            <div class="row d-flex align-items-center justify-content-center    ">
                                <div class="col-12" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                    {{ Form::text('date', null, [
                                        'class' => 'date appointment-input',
                            ...
                            <div class="text-center w-100">
                                <button type="submit"
                                    class="btn vcard-13-btn w-50 w-sm-100 appointmentAdd p-2 d-none">
            ...
            @if ((isset($managesection) && $managesection['iframe']) || empty($managesection))
                @if (checkFeature('iframes') && $vcard->iframes->count())
                    <div class="iframe-section pt-50 px-20 position-relative">
                        <div class="bg-vector vector-img12">
                            <img src="{{ asset('assets/img/vcard13/vector-img12.png') }}" alt="vector" />
                        </div>
                        <div class="section-heading position-relative text-center pb-40">
                            <h2 class=" mb-0 fw-bold">{{ __('messages.vcard.iframe') }}</h2>
                        </div>
                        <div class="iframe-slider">
                            @foreach ($vcard->iframes as $iframe)
                                <div class="">
                                    <div class="iframe-card card">
            ...
            @if ((isset($managesection) && $managesection['payment_link']) || empty($managesection))
                @if (checkFeature('payment_link') && $vcard->paymentLinks->count())
                    <div class="payment-link-section px-20 pt-50 position-relative"
                        ...
                        <div class="section-heading position-relative text-center pb-40">
                            <h2 class=" mb-0 fw-bold">{{ __('messages.vcard.payment_links') }}</h2>
                        </div>
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
                <div class="contact-us-section pt-50 px-30 position-relative">
                    <div class="bg-vector vector-img13 text-end">
                        <img src="{{ asset('assets/img/vcard13/vector-img13.png') }}" alt="vector" />
                    </div>
                    <div class="section-heading position-relative text-center pb-40">
                        <h2 class=" text-center fw-bold mb-0">{{ __('messages.contact_us.inquries') }}
                        </h2>
                    </div>
                    @if (getLanguage($vcard->default_language) != 'Arabic' && getLanguage($vcard->default_language) != 'Persian')
                                            ...
                                            <div class="d-flex gap-2">
                                                ...
                                                <label class="form-check-label fs-14" for="privacyPolicyCheckbox">
                                                    ...
                                                    <a href="{{ $vcardPrivacyAndTerm }}" target="_blank"
                                                        class="text-decoration-none link-info text-decoration-underline text-dark fw-6 ">{!! __('messages.vcard.term_and_condition') !!}</a>
                                                    <span class="text-dark">&</span>
                                                    <a href="{{ $vcardPrivacyAndTerm }}" target="_blank"
                                                        class="text-decoration-none link-info text-decoration-underline text-dark fw-6 ">{{ __('messages.vcard.privacy_policy') }}</a>
                                                </label>
                                            </div>
                                        </div>
                                    @endif
                                    <div class="col-12 text-center mt-4 w-100">
                                        <button class="contact-btn btn vcard-13-btn p-2 w-50 w-sm-100" type="submit">
                        ...
                        <div class="contact-form" dir="rtl">
                            <form id="enquiryForm" enctype="multipart/form-data">
                                ...
                                <div class="row m-sm-0">
                                    ...
                                    @endif
                                    <div class="col-12 text-center mt-4 w-100">
                                        <button class="contact-btn btn vcard-13-btn p-2 w-50 w-sm-100 mb-4"
                                            type="submit">
                                            {{ __('messages.contact_us.send_message') }}
                                        </button>
                                    </div>
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
                <div class="create-vcard-section section-bg pt-50  px-30 position-relative">
                    <div class="bg-vector vector-img14">
                        <img src="{{ asset('assets/img/vcard13/vector-img14.png') }}" alt="vector" />
                    </div>
                    <div class="section-heading position-relative text-center pb-40">
                        <h2 class=" fw-bold mb-0">{{ __('messages.create_vcard') }}</h2>
                    </div>
                    <div>
                ...
                @if ((isset($managesection) && $managesection['map']) || empty($managesection))
                    ...
                    @if ($vcard->location_type == 0 && ($vcard->location_url && isset($url[5])))
                        <div class="map-section">
                            <div class="map-location d-flex gap-2 align-items-center pb-3 pt-1"
                                @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
            ...
            <div class="w-100 d-flex justify-content-center sticky-vcard-div">
                @if ($vcard->enable_contact)
                    <div class="" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        @if ($contactRequest == 1)
                            <a href="{{ Auth::check() ? route('add-contact', $vcard->id) : 'javascript:void(0);' }}"
                                class="vcard13-sticky-btn add-contact-btn  d-flex gap-1 justify-content-center ms-0 text-white align-items-center text-decoration-none  justify-content-center
                        ...
                        @else
                            <a href="{{ route('add-contact', $vcard->id) }}"
                                class="vcard13-sticky-btn add-contact-btn  d-flex gap-1 justify-content-center ms-0 text-white align-items-center rounded px-5 text-decoration-none py-1  justify-content-center"><i
            ...
            <div class="btn-section cursor-pointer @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
                <div class="fixed-btn-section">
                    @if (empty($vcard->hide_stickybar))
                        <div
                            class="bars-btn hospital-bars-btn @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') vcard-bars-btn-left @endif">
                            <img src="{{ asset('assets/img/vcard13/sticky.svg') }}" />
                        </div>
                    @endif
                    <div class="sub-btn d-none">
                        <div class="sub-btn-div @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') sub-btn-div-left @endif">
                                ...
                                <div class="icon-search-container mb-3" data-ic-class="search-trigger">
                                    ...
                                    <div class="share-wp-btn-div">
                                        <a href="javascript:void(0)"
                                            class="vcard13-sticky-btn vcard13-btn-group d-flex justify-content-center align-items-center rounded-0 text-decoration-none py-1 rounded-pill justify-content share-wp-btn">
                            ...
                            @if (empty($vcard->hide_stickybar))
                                <div
                                    class="{{ isset($vcard->whatsapp_share) ? 'vcard13-btn-group' : 'stickyIcon' }}">
                                    <button type="button"
                                    ...
                                    @if (!empty($vcard->enable_download_qr_code))
                                        <a type="button"
                                            class="social-btn hospital-sub-btn d-flex justify-content-center align-items-center  px-2 mb-3 py-2"
                                    ...
                                    {{-- <a type="button"
                                        ...
                                        id="videobtn"><i class="fa-solid fa-video fs-4" style="color: #ffffff;"></i></a>
                                    --}}
                                </div>
                            @endif
                        </div>
            ...
            <div class="d-flex justify-content-evenly py-2">
                    ...
                    @if (checkFeature('advanced')->hide_branding && $vcard->branding == 0)
                        @if ($vcard->made_by)
                            <a @if (!is_null($vcard->made_by_url)) href="{{ $vcard->made_by_url }}" @endif
                                ...
                                <span class="text-primary fw-5 fs-14">{{ __('messages.made_by') }}
                                    {{ $vcard->made_by }}</span>
                            </a>
                        @else
                            <div class="text-center">
                ...
                @if (!empty($vcard->privacy_policy) || !empty($vcard->term_condition))
                    <div>
                        <a class="text-decoration-none text-primary cursor-pointer terms-policies-btn fw-5 fs-14"
                            href="{{ $vcardPrivacyAndTerm }}">{!! __('messages.vcard.term_policy') !!}</a>
                    </div>
                @endif
            </div>
        </div>
    ...
    @if ((isset($managesection) && $managesection['news_latter_popup']) || empty($managesection))
        <div class="modal fade" id="newsLatterModal" tabindex="-1" aria-labelledby="newsLatterModalLabel"
            aria-hidden="true">
            <div class="modal-dialog news-modal modal-dialog-centered px-0 position-relative">
    ...
    <script>
        ...
        /* const fixedBtnSection = document.querySelector(".fixed-btn-section");
        const mainContent = document.querySelector(".main-content");
        let isRTL = document.querySelector(".btn-section")?.classList.contains("rtl");
        let isDragging = false;
        let offsetX = 0;
        let offsetY = 0;
        let currentLeft = 0;
        let currentTop = window.innerHeight / 2 - fixedBtnSection.offsetHeight / 2;
        function getMainContentBounds() {
          return mainContent.getBoundingClientRect();
        }
        function setInitialPosition() {
          const bounds = getMainContentBounds();
          const btnWidth = fixedBtnSection.offsetWidth;
          const btnHeight = fixedBtnSection.offsetHeight;
          currentTop = window.innerHeight / 2 - btnHeight / 2;
          if (isRTL) {
            currentLeft = bounds.left + 30;
          } else {
            currentLeft = bounds.right - btnWidth - 30;
          }
          fixedBtnSection.style.left = `${currentLeft}px`;
          fixedBtnSection.style.top = `${currentTop}px`;
          fixedBtnSection.style.transform = "translateY(-50%)";
        }
        setInitialPosition();
        fixedBtnSection.addEventListener("mousedown", (e) => {
          isDragging = true;
          const rect = fixedBtnSection.getBoundingClientRect();
        ...
        document.addEventListener("mousemove", (e) => {
          ...
          newLeft = Math.max(bounds.left, Math.min(bounds.right - btnWidth, newLeft));
          newTop = Math.max(0, Math.min(window.innerHeight - btnHeight, newTop));
          fixedBtnSection.style.left = `${newLeft}px`;
          fixedBtnSection.style.top = `${newTop}px`;
          fixedBtnSection.style.transform = "none";
          currentLeft = newLeft;
          currentTop = newTop;
        });
        ...
        window.addEventListener("resize", () => {
          ...
          currentTop = Math.max(0, Math.min(window.innerHeight - btnHeight, currentTop));
          fixedBtnSection.style.left = `${currentLeft}px`;
          fixedBtnSection.style.top = `${currentTop}px`;
        }); */
    </script>
