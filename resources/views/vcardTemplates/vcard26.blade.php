...
<head>
    ...
    <link rel="stylesheet" href="{{ mix('assets/css/vcard26.css') }}">
...
<body>
    ...
    <div class="bg-image-animation2">
        ...
        <div class="icon-5 cloud-animate">
            <img src="{{ asset('assets/img/vcard26/cloud1.png') }}" alt="bg-vector" class="position-relative"
                loading="lazy">
        </div>
    ...
    <div class="container p-0">
        ...
        <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
                        ...
                        <div>
                            ...
                            <div class="text-end d-flex">
                                <button id="installPwaBtn"
                                    class="pwa-install-button w-50 mb-1 bg-primary btn text-white">{{ __('messages.pwa.install') }}
                                </button>
                                <button
                    ...
                    <div class="support-banner d-flex align-items-center justify-content-center">
                        ...
                        <div>
                            ...
                            <div class="text-center mt-3">
                                <a href="{{ $banners->url }}" class="act-now text-dark" target="_blank"
            ...
            <div class="banner-section position-relative">
                <div class="banner-img @if ($vcard->cover_type == 2) banner-img-26 @endif">
                    @php
                        $coverClass =
                ...
                <div class="d-flex justify-content-end position-absolute top-0 end-0 pt-3 mx-3 language-btn">
                    @if ($vcard->language_enable == \App\Models\Vcard::LANGUAGE_ENABLE)
                        <div class="language">
                            <ul class="text-decoration-none ps-0">
                                <li class="dropdown1 dropdown lang-list">
                                    <a class="dropdown-toggle lang-head text-decoration-none text-white"
                                        data-toggle="dropdown" role="button" aria-haspopup="true"
                                        aria-expanded="false">
                                        {{ strtoupper(getLanguageIsoCode($vcard->default_language)) }}
                                    </a>
                                    <ul class="dropdown-menu top-dropdown lang-hover-list top-100 mt-0 p-0">
            ...
            {{-- profile data --}}
            <div class="profile-section pt-40  overflow-hidden">
                <div class="px-30">
                    <div class="profile-bg">
                        <img src="{{ asset('assets/img/vcard26/profile-bg.png') }}" alt="cart-img" loading="lazy"
                            class="w-100 h-100" />
                    </div>
                    {{-- <div class="bg-vector cart-img right-6">
                        <img src="{{ asset('assets/img/vcard26/vector1.svg') }}" alt="cart-img" loading="lazy" />
                    </div> --}}
                    <div class="position-relative">
                        <div
                            class="card d-flex align-items-center justify-content-start gap-sm-5 gap-3 flex-column flex-sm-row bg-transparent    @if ($vcard->cover_type == 2)  @endif">
                            {{-- <div class="profile-vector1 position-absolute end-0 bottom-0 rotate-180">
                                <img src="{{ asset('assets/img/vcard26/profile-vector.svg') }}" alt="profile-vector1" loading="lazy" class=" h-100" />
                            </div> --}}
                            <div class="card-img">
                            ...
                            <div class="card-body p-0 text-center text-sm-start">
                                <h4 class="text-black fw-bold fs-28 mb-0">
                                    {{ ucwords($vcard->first_name . ' ' . $vcard->last_name) }}
                                    @if ($vcard->is_verified)
                                        <i class="verification-icon bi-patch-check-fill text-primary"></i>
                                    @endif
                                </h4>
                                <p class="fs-18 text-primary mb-0 company-name p-0 text-decoration-underline fw-5">
                                    {{ ucwords($vcard->company) }}</p>
                                <p class="fs-14 mb-0 text-gray">{{ ucwords($vcard->occupation) }}</p>
                                <p class="fs-14 mb-0 text-gray">{{ ucwords($vcard->job_title) }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="text-black profile-desc text-center fs-14 pt-40 px-30 position-relative">
                    <div class="bg-vector position-absolute vector-1 text-start">
                        <img src="{{ asset('assets/img/vcard26/vector2.svg') }}" alt="profile-desc"
                            loading="lazy" />
                    </div>
                ...
                @if (checkFeature('social_links') && getSocialLink($vcard))
                    <div class="social-media d-flex justify-content-center flex-wrap pt-40 position-relative px-30">
                        <div class="bg-vector position-absolute vector-3 text-end">
                            <img src="{{ asset('assets/img/vcard26/vector3.svg') }}" alt="profile-desc"
                                loading="lazy" />
                        </div>
                        <div class="social-icons d-flex justify-content-center text-decoration-none flex-wrap">
                            @foreach (getSocialLink($vcard) as $value)
                                <span class="social-back d-flex justify-content-center align-items-center">
                                    <div class="cost-circle position-relative">
                                        {{-- <svg fill="#fe624c" width="50px" height="50px" width="50px" height="50px" viewBox="0 0 56 56" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M 7.5860 42.9414 L 23.8516 52.1758 C 26.6407 53.7695 29.3126 53.7930 32.1485 52.1758 L 48.4141 42.9414 C 50.5938 41.6992 51.7890 40.4336 51.7890 37.0352 L 51.7890 18.8008 C 51.7890 15.4961 50.5703 14.3008 48.5783 13.1523 L 32.2657 3.8711 C 29.3595 2.2070 26.5704 2.2305 23.7344 3.8711 L 7.4219 13.1523 C 5.4297 14.3008 4.2110 15.4961 4.2110 18.8008 L 4.2110 37.0352 C 4.2110 40.4336 5.4063 41.6992 7.5860 42.9414 Z"></path></g></svg> --}}
                                        <span> {!! $value !!}</span>
                                    </div>
                                </span>
                            @endforeach
                ...
                @if (checkFeature('custom-links') && $customLink->isNotEmpty())
                    <div class="custom-link-section">
                        <div class="custom-link d-flex flex-wrap justify-content-center w-100 gap-2 pt-40">
            ...
            @if ((isset($managesection) && $managesection['contact_list']) || empty($managesection))
                @if (
                    ...
                    <div class="contact-section px-30 pt-50 position-relative">
                        <div class="bg-vector position-absolute vector-2">
                            <img src="{{ asset('assets/img/vcard26/vector4.svg') }}" alt="open-box-img" />
                        </div>
                        <div class="section-heading text-center position-relative position-relative">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="contact-box d-flex align-items-center">
                                            <div class="contact-icon d-flex justify-content-center align-items-center">
                                                <div class="top-icon">
                                                    <img src="{{ asset('assets/img/vcard26/mail.svg') }}"
                                                        loading="lazy" class="first-mail" />
                                                </div>
                                            </div>
                                ...
                                @if ($vcard->phone)
                                    <div class="col-sm-6">
                                        <div class="contact-box d-flex align-items-center">
                                            <div class="contact-icon d-flex justify-content-center align-items-center">
                                                <div class="top-icon">
                                                    <img src="{{ asset('assets/img/vcard26/phone.svg') }}"
                                                        loading="lazy" class="first-mail" />
                                                </div>
                                            </div>
                                            <div class="contact-desc">
                                ...
                                @if ($vcard->dob)
                                    <div class="col-sm-6 mb-sm-0 mb-4">
                                        <div class="contact-box d-flex align-items-center">
                                            <div class="contact-icon d-flex justify-content-center align-items-center">
                                                <div class="top-icon">
                                                    <img src="{{ asset('assets/img/vcard26/dob.svg') }}"
                                                        loading="lazy" class="first-mail" />
                                                </div>
                                            </div>
                                            <div class="contact-desc">
                                ...
                                @if ($vcard->location)
                                    <div class="col-sm-6">
                                        <div class="contact-box d-flex align-items-center">
                                            <div class="contact-icon d-flex justify-content-center align-items-center">
                                                <div class="top-icon">
                                                    <img src="{{ asset('assets/img/vcard26/location.svg') }}"
                                                        loading="lazy" class="first-mail" />
                                                </div>
                                            </div>
                                            <div class="contact-desc">
                        ...
                        @endif
                        @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian')
                            <div class="row contact-row" dir="rtl">
                                @if ($vcard->email)
                                    <div class="col-sm-6">
                                        <div class="contact-box d-flex align-items-center">
                                            <div class="contact-icon d-flex justify-content-center align-items-center">
                                ...
                                @if ($vcard->location)
                                    <div class="col-sm-6">
                                        <div class="contact-box d-flex align-items-center">
                                            ...
                                            <div class="contact-desc">
                                                <p class="text-primary mb-0 fw-5">{!! ucwords($vcard->location) !!}</p>
                                            </div>
                                        </div>
                                    </div>
                                @endif
            ...
            @if ((isset($managesection) && $managesection['services']) || empty($managesection))
                @if (checkFeature('services') && $vcard->services->count())
                    <div class="our-services-section pt-50">
                        <div class="bg-vector position-absolute vector-4 text-end">
                            <img src="{{ asset('assets/img/vcard26/vector5.svg') }}" alt="open-box-img" />
                        </div>
                        ...
                        <div class="services">
                            @if ($vcard->services_slider_view)
                                <div class="services-slider-view mb-0 px-20">
                                    @foreach ($vcard->services as $service)
                                        <div>
                                            <div class="service-card h-100 align-items-center position-relative">
                                                ...
                                                <div class="service-slider-content text-center">
                                                    <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
                                                    ...
                                                    <p
                                                        class="card-text description-text mb-0 {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}">
                            ...
                            @else
                                <div class="row row-gap-20px px-30">
                                    @foreach ($vcard->services as $service)
                                        <div class="col-sm-6">
                                            <div
                                                class="service-card d-flex flex-column align-items-center position-relative h-100">
                                                {{-- <div class="service-top"></div> --}}
                                                <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
                                                    class="text-decoration-none img {{ $service->service_url ? 'pe-auto' : 'pe-none' }}"
                                                    target="{{ $service->service_url ? '_blank' : '' }}">
                                                ...
                                                <div class="service-slider-content h-100 text-center">
                ...
                @if (checkFeature('gallery') && $vcard->gallery->count())
                    <div class="gallery-section pt-50 position-relative px-20">
                        <div class="bg-vector position-absolute vector-5">
                            <img src="{{ asset('assets/img/vcard26/vector6.svg') }}" alt="box-img"
                                loading="lazy" />
                        </div>
                        <div class="section-heading text-center position-relative px-30">
                ...
                @if (checkFeature('testimonials') && $vcard->testimonials->count())
                    <div class="testimonial-section pt-50 px-20">
                        <div class="bg-vector position-absolute  vector-6 text-end">
                            <img src="{{ asset('assets/img/vcard26/vector7.svg') }}" alt="box-img"
                                loading="lazy" />
                        </div>
                        <div class="section-heading text-center position-relative">
                                ...
                                <div>
                                    <div class="testimonial-card text-center">
                                        <div class="quote-img left">
                                            <img src="{{ asset('assets/img/vcard26/quote-img-left-26.png') }}"
                                                alt="quote-img" class="ms-auto" loading="lazy" />
                                        </div>
                                        <div class="quote-img right">
                                            <img src="{{ asset('assets/img/vcard26/quote-img-right-26.png') }}"
                                                alt="quote-img" class="ms-auto" loading="lazy" />
                                        </div>
                                        <div class="card-body pt-0 pb-4 px-sm-0 px-0">
                                            <div
                                                class="d-flex align-items-center justify-content-center gap-4 position-relative max-w-fit mx-auto">
                                                <div class="bg-img">
                                                    <img src="{{ asset('assets/img/vcard26/profile-bg-testimonial.png') }}"
                                                        alt="">
                                                </div>
                                                ...
                                                <h3 class="text-primary fs-20 fw-6 mb-1 text-end">
                                        ...
                                        <div class="testimonial-description">
                                            <p
                                                class="desc text-black fs-14 mb-0 {{ \Illuminate\Support\Str::length($testimonial->description) > 80 ? 'more' : '' }}">
            ...
            @if ((isset($managesection) && $managesection['products']) || empty($managesection))
                @if (checkFeature('products') && $vcard->products->count())
                    <div class="product-section pt-50 px-20">
                        <div class="bg-vector position-absolute vector-7">
                            <img src="{{ asset('assets/img/vcard26/vector8.svg') }}" alt="box-img"
                                loading="lazy" />
                        </div>
                        <div class="bg-vector position-absolute vector-8 text-end">
                            <img src="{{ asset('assets/img/vcard26/vector19.svg') }}" alt="box-img"
                                loading="lazy" />
                        </div>
                        <div class="section-heading text-center position-relative">
                                        ...
                                        <div class="product-card card h-100">
                                            <div class="product-img card-img">
                                                <a @if ($product->product_url) href="{{ $product->product_url }}" @endif
                                                    target="_blank" class="text-decoration-none h-100">
                                            ...
                                            <div class="product-desc align-items-center">
                                                <div class="text-center d-flex flex-column gap-2">
                                                    <h3 class="text-black fw-5 mb-0">{{ $product->name }}</h3>
                        ...
                        <div class="text-center view-more mt-4">
                            <a class="fs-6 text-decoration-none d-block btn-primary d-flex align-items-center justify-content-center gap-2"
                                href="{{ $vcardProductUrl }}">{{ __('messages.analytics.view_more') }}
                                <i class="fa-solid fa-arrow-right-long right-arrow-animation text-decoration-none"></i>
                            </a>
                        </div>
                    </div>
                @endif
            ...
            @if ((isset($managesection) && $managesection['whatsapp_store']) || empty($managesection))
                @if ($whatsappStore->count())
                    <div class="whatsapp-store-product-section pt-50 px-20 position-relative">

                        <div class="position-absolute vector-75 whatsapp-store-vector-1 text-start">
                            <img src="{{ asset('assets/img/vcard26/vector14.svg') }}"
                                class="w-100 h-100 object-fit-cover" alt="bg-vector" />
                        </div>

                        <div class="section-heading text-center">
                            <h2 class="right-bg">{{ __('messages.feature.whatsapp_store') }}</h2>
                        </div>

                        <div class="whatsapp-store-slider">
                            @foreach ($whatsappStore as $product)
                                <div>
                                    <div class="whatsapp-store-box card h-100">
                                        ...
                                        <div class="whatsapp-store-content card-body text-center"
                                            ...
                                            <h3 class="whatsapp-store-name text-black fw-5 mb-0">
                                                {{ $product->store_name }}
                                            </h3>

                                            <a href="{{ route('whatsapp.store.show', $product->url_alias) }}"
                                                target="_blank" class="btn btn-wp-visit-store mt-2">
            ...
            @if ((isset($managesection) && $managesection['appointments']) || empty($managesection))
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="appointment-section pt-50 px-30 position-relative">
                        <div class="bg-vector position-absolute vector-9">
                            <img src="{{ asset('assets/img/vcard26/vector9.svg') }}" alt="box-img"
                                loading="lazy" />
                        </div>
                        <div class="section-heading text-center position-relative">
                            ...
                            <div>
                                <div>
                                    ...
                                    <div class="text-center">
                                        <button class="appointmentAdd btn d-none mt-2 btn-primary">
            ...
            @if ((isset($managesection) && $managesection['insta_embed']) || empty($managesection))
                @if (checkFeature('insta_embed') && $vcard->instagramEmbed->count())
                    <div class="pt-50 px-20 position-relative">
                        <div class="bg-vector position-absolute vector-10 text-end">
                            <img src="{{ asset('assets/img/vcard26/vector10.svg') }}" alt="box-img"
                                loading="lazy" />
                        </div>
                        <div class="section-heading text-center position-relative">
            ...
            @if ((isset($managesection) && $managesection['blogs']) || empty($managesection))
                @if (checkFeature('blog') && $vcard->blogs->count())
                    <div class="blog-section pt-50 px-20">
                        <div class="bg-vector position-absolute vector-11">
                            <img src="{{ asset('assets/img/vcard26/vector11.svg') }}" alt="box-img"
                                loading="lazy" />
                        </div>
                        <div class="section-heading text-center position-relative">
                        ...
                        <div class="blog-slider mb-0">
                            @foreach ($vcard->blogs as $blog)
                                ...
                                ?>
                                <div>
                                    <a href="{{ $vcardBlogUrl }}" class="d-block w-100 h-100">
                                        <div class="blog-card card-1"
                                            ...
                                            <div class="blog-content d-flex flex-column justify-content-between">
                                                <div>
                                                    <h3 class="text-primary fw-5 blog-head">
                                                        {{ $blog->title }}
                                                    </h3>
                                                    <p class="text-black blog-desc mb-0">
                                                        {{ Illuminate\Support\Str::words(str_replace('&nbsp;', ' ', strip_tags($blog->description)), 100, '...') }}
                                                    </p>
                                                </div>
                                                <div class=" mt-2 d-flex justify-content-end">
                                                    <a href="{{ $vcardBlogUrl }}"
                                                        class="text d-inline-flex align-items-center justify-content-end gap-2 read-more"
                                                        @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
            ...
            @if ((isset($managesection) && $managesection['business_hours']) || empty($managesection))
                @if ($vcard->businessHours->count())
                    ...
                    <div class="business-hour-section pt-50 px-30 position-relative">
                        <div class="bg-vector position-absolute vector-19">
                            <img src="{{ asset('assets/img/vcard26/vector12.svg') }}" alt="box-img"
                                loading="lazy" />
                        </div>
                        <div class="bg-vector position-absolute vector-12 text-end">
                            <img src="{{ asset('assets/img/vcard26/vector20.svg') }}" alt="box-img"
                                loading="lazy" />
                        </div>
                        <div class="section-heading text-center position-relative">
                            <h2 class="mb-0">{{ __('messages.business.business_hours') }}</h2>
                        </div>
                        <div class="business-hours row justify-content-center"
                            ...
                            @foreach ($businessDaysTime as $key => $dayTime)
                                <div class="col-sm-6">
                                    <div class="business-box">
                                        ...
                                        <div class="d-flex  justify-content-center gap-2 w-100 business-time">
                                            <div class="fs-14 text-black">
                                                {{ __('messages.business.' . \App\Models\BusinessHour::DAY_OF_WEEK[$key]) }}
                                                :</div>
                                            <div class="d-flex align-items-center gap-2 fs-14 justify-content-center">
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                <div class="qr-code-section pt-50 px-40">
                    <div class="bg-vector position-absolute vector-13">
                        <img src="{{ asset('assets/img/vcard26/vector13.svg') }}" alt="percentage-img2"
                            loading="lazy" />
                    </div>
                    <div class="section-heading text-center">
                    ...
                    <div
                        class="qr-code d-flex justify-content-center align-items-center flex-wrap flex-sm-nowrap mb-30 position-relative">
            ...
            @if ((isset($managesection) && $managesection['iframe']) || empty($managesection))
                @if (checkFeature('iframes') && $vcard->iframes->count())
                    <div class="iframe-section pt-50 px-20 position-relative">
                        <div class="bg-vector position-absolute vector-14 text-end">
                            <img src="{{ asset('assets/img/vcard26/vector15.svg') }}" alt="box-img"
                                loading="lazy" />
                        </div>
                        <div class="section-heading text-center position-relative">
                ...
                @if (checkFeature('payment_link') && $vcard->paymentLinks->count())
                    <div class="main-section">
                        <div class="payment-link-section pt-40 px-20">
                            <div class="bg-vector position-absolute text-end">
                                <img src="{{ asset('assets/img/vcard26/vector5.svg') }}" alt="open-box-img" />
                            </div>
                            <div class="section-heading text-center position-relative">
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
                <div class="contact-us-section px-30 pt-50 position-relative">
                    <div class="bg-vector position-absolute vector-15 text-end">
                        <img src="{{ asset('assets/img/vcard26/vector16.svg') }}" alt="box-img" loading="lazy" />
                    </div>
                    <div class="bg-vector position-absolute vector-16">
                        <img src="{{ asset('assets/img/vcard26/vector21.svg') }}" alt="box-img" loading="lazy" />
                    </div>
                    <div class="section-heading text-center position-relative">
                                ...
                                @if (!empty($vcard->privacy_policy) || !empty($vcard->term_condition))
                                    <div class="col-12 mb-2 d-flex">
                                        <input type="checkbox" name="terms_condition"
                                            ...
                                            placeholder>&nbsp;
                                        <label class="form-check-label ms-2 fs-14" for="privacyPolicyCheckbox">
                                            <span class="text-black">{{ __('messages.vcard.agree_to_our') }}</span>
                                            <a href="{{ $vcardPrivacyAndTerm }}" target="_blank"
                                                class="text-decoration-underline text-primary">{!! __('messages.vcard.term_and_condition') !!}</a>
                                            <span class="text-black">&</span>
                                            <a href="{{ $vcardPrivacyAndTerm }}" target="_blank"
                                                class="text-decoration-underline text-primary">{{ __('messages.vcard.privacy_policy') }}</a>
                                        </label>
                                    </div>
                                @endif
                                <div class="text-center pt-3">
                                    <button class="contact-btn send-btn btn-primary btn w-100" type="submit">
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
                <div class="create-vcard-section pt-50 px-30">
                    <div class="bg-vector position-absolute vector-17 text-end end-0 top-0">
                        <img src="{{ asset('assets/img/vcard26/vector17.svg') }}" alt="box-img" loading="lazy" />
                    </div>

                    <div class="card-create pt-30 pb-30 px-30 position-relative">
                        <div class="section-heading text-center position-relative">
                            <h2 class="mb-0 bg-white">{{ __('messages.create_vcard') }}</h2>
                        </div>
                        <div>
                            <div class="vcard-link-card card justify-content-center">
                                <div class="d-flex align-items-center justify-content-center">
                                    <a href="{{ config('app.url') . '/register?referral-code=' . $vcard->user->affiliate_code }}"
                                        target="blank"
                                        class="fw-5 text-primary link-text fs-14 d-flex gap-2 align-items-center justify-content-center">{{ route('register', ['referral-code' => $vcard->user->affiliate_code]) }}
                                        <i class="icon fa-solid fa-arrow-up-right-from-square text-primary"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            @if ((isset($managesection) && $managesection['map']) || empty($managesection))
                @if ($vcard->location_type == 0 && ($vcard->location_url && isset($url[5])))
                    <div class="px-30 pt-50 position-relative">
                        <div class="bg-vector position-absolute vector-18">
                            <img src="{{ asset('assets/img/vcard26/vector18.svg') }}" alt="box-img"
                                loading="lazy" />
                        </div>
                                ...
                                <div class="location-icon d-flex justify-content-center align-items-center">
                                    <div class="position-relative">
                                        ...
                                        <div class="map-location">
                                            <img src="{{ asset('assets/img/vcard26/location-white.svg') }}">
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="text-center d-flex align-items-center justify-content-center"
                        ...
                        @if ($contactRequest == 1)
                            <a href="{{ Auth::check() ? route('add-contact', $vcard->id) : 'javascript:void(0);' }}"
                                class="add-contact-btn rounded-2 {{ Auth::check() ? 'auth-contact-btn' : 'ask-contact-detail-form' }}"
                        ...
                        @else
                            <a href="{{ route('add-contact', $vcard->id) }}" class="add-contact-btn rounded-2"><i
            ...
            @endif
            {{-- made by --}}
            <div class="d-flex justify-content-evenly made-by-section p-2 align-items-center">
            ...
            <div class="btn-section cursor-pointer @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
                <div class="fixed-btn-section">
                    @if (empty($vcard->hide_stickybar))
                        <div
                            class="bars-btn retail-bars-btn  @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') vcard-bars-btn-left @endif">
                    ...
                    <div class="sub-btn d-none">
                        <div class="sub-btn-div @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') sub-btn-div-left @endif">
                                ...
                                <div class="icon-search-container mb-3" data-ic-class="search-trigger">
                                    ...
                                    <div class="share-wp-btn-div">
                                        <a href="javascript:void(0)"
                                            class="vcard26-sticky-btn vcard26-btn-group d-flex justify-content-center align-items-center rounded-0 text-decoration-none py-1 rounded-pill justify-content share-wp-btn">
                            ...
                            @if (empty($vcard->hide_stickybar))
                                <div
                                    class="{{ isset($vcard->whatsapp_share) ? 'vcard26-btn-group' : 'stickyIcon' }}">
                                    <button type="button"
                                        class="social-btn ecommerce-sub-btn mb-3 px-2 py-1 wp-btn vcard26-share"><i
                                            class="fas fa-share-alt fs-4"></i></button>
                                    @if (!empty($vcard->enable_download_qr_code))
                                        <a type="button"
                                            class="social-btn ecommerce-sub-btn d-flex justify-content-center align-items-center  px-2 mb-3 py-2"
                                            id="qr-code-btn" download="qr_code.png"><i
                                                class="fa-solid fa-qrcode fs-4"></i></a>
                                    @endif
                                    {{-- <a type="button"
                                        class="social-btn ecommerce-sub-btn d-flex justify-content-center text-white align-items-center  px-2 mb-3 py-2 d-none"
