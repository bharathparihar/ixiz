...
<head>
    ...
    {{-- css link --}}
    <link rel="stylesheet" href="{{ mix('assets/css/vcard21.css') }}">
    ...
    <div class="container p-0">
        ...
        <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
            ...
            @if (isset($enable_pwa) && $enable_pwa == 1 && !isiOSDevice())
                <div class="pwa-support mt-0" id="pwa-container">
            ...
            @if ((isset($managesection) && $managesection['banner']) || empty($managesection))
                @if (isset($banners->title))
                    <div class="support-banner-section">
                        <div class="card-wrapper">
                            <div class="support-banner d-flex align-items-center justify-content-center">
                                ...
                                <div class="d-flex flex-column">
                                    <h1 class="text-center text-primary support_heading mx-auto">{{ $banners->title }}
                                    </h1>
            ...
            {{-- profile detials --}}
            <div class="profile-section position-relative pt-40 px-30">
                <div class="card-wrapper">
                    <div class="profile-card card overflow-hidden flex-sm-row flex-column align-items-center position-relative gap-4 justify-content-sm-start"
                        @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        <div
                            class="position-absolute bottom-0 main-bg-vcard21 @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') start-0 @else end-0 @endif">
                            <img src="{{ asset('assets/img/vcard21/vcard21-main-bg.png') }}" alt="vector-img"
                                class="w-100 h-100 object-fit-cover" />
                        </div>
                        <div class="card-img d-flex justify-content-center align-items-center position-relative">
                            <img src="{{ $vcard->profile_url }}" class="w-100 h-100 object-fit-cover main-img"
                                loading="lazy" />
                        </div>
                        <div
                            class="card-body p-0 position-relative text-center  @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') text-sm-end @else text-sm-start @endif">
                            <div class="profile-name">
                                <h2 class="text-dark fs-24 mb-0">
                                    {{ ucwords($vcard->first_name . ' ' . $vcard->last_name) }}
                                    @if ($vcard->is_verified)
                                        <i class="verification-icon bi-patch-check-fill"></i>
                                    @endif
                                </h2>
                                <p class="fs-18 text-primary text-decoration-underline mb-0">
                                    {{ ucwords($vcard->company) }}</p>
                                <p class="fs-14 fw-5 text-dark mb-0">{{ ucwords($vcard->occupation) }}</p>
                                <p class="fs-14 fw-5 text-dark mb-0">{{ ucwords($vcard->job_title) }}</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            @if (checkFeature('social_links') && getSocialLink($vcard))
                <div
                    class="social-media pt-40 px-30 d-flex flex-wrap justify-content-sm-start justify-content-center position-relative">
                    <div class="position-absolute vector-1 vector-all">
                        <img src="{{ asset('assets/img/vcard21/vcard21-vector-1.png') }}" alt="vector-img"
                            class="w-100" />
                    </div>
                    <div
                        class="social-icons d-flex justify-content-center text-decoration-none flex-wrap text-primary bg-gray-100 rounded-pill align-items-center w-100">
                        @foreach (getSocialLink($vcard) as $value)
                            <span
                                class="social-back d-flex text-decoration-none  justify-content-center align-items-center text-primary">
                                {!! $value !!}
                            </span>
                        @endforeach
                    </div>
            ...
            @if (checkFeature('custom-links') && $customLink->isNotEmpty())
                <div class="custom-link-section">
                    <div class="custom-link d-flex flex-wrap gap-3 justify-content-center px-30 pt-40 w-100">
            ...
            @if (((isset($managesection) && $managesection['contact_list']) || empty($managesection)) && $hasContactData)
                <div class="contact-section position-relative px-30 pt-50">
                    <div class="position-absolute vector-2 vector-all">
                        <img src="{{ asset('assets/img/vcard21/vcard21-vector-2.png') }}" alt="vector-img"
                            class="w-100" />
                    </div>
                    <div class="section-heading text-center mb-40">
                        <h2 class="text-dark mb-0"># {{ __('messages.contact_us.contact') }}</h2>
                    </div>
                                    ...
                                    <div class="card-wrapper">
                                        <div class="contact-box d-flex align-items-center">
                                            <div class="contact-icon d-flex justify-content-center align-items-center">
                                                <img src="{{ asset('assets/img/vcard21/email.svg') }}" />
                                            </div>
                                            <div class="contact-desc">
                                                <a href="mailto:{{ $vcard->email }}"
                                                    class="text-primary fw-5">{{ $vcard->email }}</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="contact-box d-flex align-items-center">
                                            ...
                                            <div class="contact-desc">
                                                <a href="mailto:{{ $vcard->alternative_email }}"
                                                    class="text-primary fw-5">{{ $vcard->alternative_email }}</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            @if ($vcard->phone)
                                <div class="col-sm-6">
                                    <div class="card-wrapper">
                                        <div class="contact-box d-flex align-items-center">
                                            <div class="contact-icon d-flex justify-content-center align-items-center">
                                                <img src="{{ asset('assets/img/vcard21/phone.svg') }}" />
                                            </div>
                                            <div class="contact-desc">
                            ...
                            @if ($vcard->dob)
                                <div class="col-sm-6">
                                    <div class="card-wrapper">
                                        <div class="contact-box d-flex align-items-center">
                                            <div class="contact-icon d-flex justify-content-center align-items-center">
                                                <img src="{{ asset('assets/img/vcard21/dob.svg') }}" />
                                            </div>
                                            <div class="contact-desc">
                                                <p class="mb-0 text-primary fw-5">
                                                    {{ $vcard->dob }}</p>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            @if ($vcard->location)
                                <div class="col-sm-6">
                                    <div class="card-wrapper">
                                        <div class="contact-box d-flex align-items-center">
                                            <div class="contact-icon d-flex justify-content-center align-items-center">
                                                <img src="{{ asset('assets/img/vcard21/location.svg') }}" />
                                            </div>
                                            <div class="contact-desc">
                ...
                @if (checkFeature('services') && $vcard->services->count())
                    <div class="our-services-section pt-50 position-relative">
                        <div class="position-absolute vector-3 vector-all">
                            <img src="{{ asset('assets/img/vcard21/vcard21-vector-3.png') }}" alt="vector-img"
                                class="w-100" />
                        </div>
                        <div class="section-heading text-center mb-40">
                            <h2 class="text-dark mb-0"># {{ __('messages.vcard.our_service') }}</h2>
                        </div>
                        <div class="services">
                                                    ...
                                                    <div class="service-card h-100">
                                                        ...
                                                        <div class="card-body">
                                                            <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
                                                                ...
                                                                target="{{ $service->service_url ? '_blank' : '' }}">
                                                                <h5
                                                                    class="card-title title-text text-primary text-center">
                                                                    {{ ucwords($service->name) }}</h5>
                                                            </a>
                                                            <p
                                                                class="card-text description-text text-black text-center mb-0 {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}">
                                                ...
                                                <div class="card-wrapper h-100">
                                                    <div class="service-card card h-100 ">
                                                        ...
                                                        <div class="card-body  text-center">
                                                            <h3 class="card-title fw-5 text-primary text-center mb-2">
                                                                {{ ucwords($service->name) }}</h3>
                                                            <p
                                                                class="description-text mb-0 text-black text-center  {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}">
                ...
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="appointment-section pt-50 px-30 position-relative">
                        <div class="position-absolute vector-4 vector-all">
                            <img src="{{ asset('assets/img/vcard21/vcard21-vector-4.png') }}" alt="vector-img"
                                class="w-100" />
                        </div>
                        <div class="section-heading text-center mb-40">
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-12 ">
                                        ...
                                        <div class="text-center d-flex justify-content-center">
                                            <button
                                                class="appointmentAdd btn fw-5 mt-3 btn-gradient d-none">{{ __('messages.make_appointments') }}</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                @if (checkFeature('gallery') && $vcard->gallery->count())
                    <div class="gallery-section pt-50 px-30 position-relative">
                        <div class="position-absolute vector-5 vector-all">
                            <img src="{{ asset('assets/img/vcard21/vcard21-vector-5.png') }}" alt="vector-img"
                                class="w-100" />
                        </div>
                        <div class="section-heading text-center mb-40">
                            <h2 class="text-dark mb-0">
                ...
                @if (checkFeature('testimonials') && $vcard->testimonials->count())
                    <div class="testimonial-section pt-50 px-20 position-relative">
                        <div class="position-absolute vector-6 vector-all">
                            <img src="{{ asset('assets/img/vcard21/vcard21-vector-6.png') }}" alt="vector-img"
                                class="w-100" />
                        </div>
                        <div class="section-heading text-center mb-40">
                            <h2 class="text-dark mb-0">
                                    ...
                                    <div class="testimonial-box">
                                        <div class="testimonial-card">
                                            <div class="quote-img left-img">
                                                <img src="{{ asset('assets/img/vcard21/quote-left.svg') }}"
                                                    loading="lazy" />
                                            </div>
                                            <div class="quote-img right-img">
                                                <img src="{{ asset('assets/img/vcard21/quote-right.svg') }}"
                                                    loading="lazy" />
                                            </div>
                                            <div class="card-body p-0 text-sm-start text-center">
                                                <p
                                                    class="text-black desc text-center {{ \Illuminate\Support\Str::length($testimonial->description) > 80 ? 'more' : '' }}">
                                                    {!! $testimonial->description !!}
                                                </p>
                                                <hr class="bg-primary w-25 mx-auto" />
                                                <div class="d-flex align-items-center justify-content-center">
                                                    <div class="testimonial-profile-img me-3 position-relative">
                                                        <img src="{{ $testimonial->image_url }}"
                                                            class="w-100 h-100 object-fit-cover" loading="lazy">
                                                    </div>
                                                    <div>
                                                        <h5 class="fw-5 text-primary mb-0">
                ...
                @if (checkFeature('products') && $vcard->products->count())
                    <div class="product-section pt-50 px-20 position-relative">
                        <div class="position-absolute vector-7 vector-all">
                            <img src="{{ asset('assets/img/vcard21/vcard21-vector-7.png') }}" alt="vector-img"
                                class="w-100" />
                        </div>
                        <div class="section-heading text-center mb-40">
                            <h2 class="text-dark mb-0">
                                    ...
                                    <div class="card-wrapper">
                                        <div class="product-card card">
                                            ...
                                            <div class=" product-desc card-body text-center">
                                                <h3 class="text-black fw-5 text-center">{{ $product->name }}</h3>
                                                <div class="d-flex justify-content-between mt-2 product-info">
                                                    <div
                                                        class="product-amount text-primary fw-bold">
                        ...
                        <div class="mt-3 text-center view-more">
                            <a class="fs-6 fw-5 text text-decoration-underline btn btn-gradient d-inline-flex justify-content-center align-items-center gap-2"
                                href="{{ $vcardProductUrl }}">{{ __('messages.analytics.view_more') }}
                                <i class="fa-solid fa-arrow-right-long right-arrow-animation"></i></a></a>
                        </div>
                    </div>
                @endif
            @endif
            ...
            @if ((isset($managesection) && $managesection['whatsapp_store']) || empty($managesection))
                @if ($whatsappStore->count())
                    <div class="whatsapp-store-product-section pt-50 px-20 mt-40 position-relative">
                                    ...
                                    <div class="card-wrapper">
                                        <div class="whatsapp-store-box card">
                                            ...
                                            <div class="whatsapp-store-img card-img">
                                                <img src="{{ $product->cover_url }}" alt="store" class="w-100 h-100 object-fit-cover" loading="lazy" />
                                            </div>

                                            <div class="whatsapp-store-content card-body text-center"
                                                @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif >
                                                <h3 class="whatsapp-store-name text-black fw-5 mb-3 text-center">
                                                    {{ $product->store_name }}
                                                </h3>
            ...
            @if ((isset($managesection) && $managesection['insta_embed']) || empty($managesection))
                @if (checkFeature('insta_embed') && $vcard->instagramEmbed->count())
                    <div class="instagram-feed-section pt-50 px-30 position-relative">
                        <div class="position-absolute vector-8 vector-all">
                            <img src="{{ asset('assets/img/vcard21/vcard21-vector-8.png') }}" alt="vector-img"
                                class="w-100" />
                        </div>
                        <div>
                            <div class="section-heading text-center mb-40">
                                <h2 class="text-dark mb-0 d-inline-block">
            ...
            @if ((isset($managesection) && $managesection['linkedin_embed']) || empty($managesection))
                @if (checkFeature('linkedin_embed') && $vcard->linkedinEmbed->count())
                    <div class="linkedin-feed-section pt-50 px-30 position-relative">
                        <div class="pt-2">
                            <div class="section-heading text-center mb-40">
                                <h2 class="text-dark mb-0 d-inline-block">#
                                    ...
                                    @foreach ($vcard->LinkedinEmbed as $LinkedinEmbed)
                                        @if ($LinkedinEmbed->type == 0)
                                            <div class="col-12 col-sm-6">
                                                <div class="linkedin-feed-iframe">
                ...
                @if (checkFeature('blog') && $vcard->blogs->count())
                    <div class="blog-section pt-50 px-20 position-relative">
                        <div class="position-absolute vector-9 vector-all">
                            <img src="{{ asset('assets/img/vcard21/vcard21-vector-9.png') }}" alt="vector-img"
                                class="w-100" />
                        </div>
                        <div class="section-heading text-center mb-40">
                            <h2 class="text-dark mb-0 d-inline-block">
                                ...
                                <div>
                                    <div class="card-wrapper">
                                        <div class="blog-card card"
                                            ...
                                            <div class="card-body">
                                                <h6 class="text-primary blog-head">{{ $blog->title }}
                                                </h6>
                                                <div class="mb-0 text-black blog-desc">
                                                    {!! $blog->description !!}
                                                </div>
                                                <div class="d-flex align-items-center justify-content-end mt-2">
                                                    <a href="{{ $vcardBlogUrl }}"
                                                        class="read-more text-primary d-inline-flex align-items-center justify-content-end gap-2 fs-14"
                                                        tabindex="0">
            ...
            @if ((isset($managesection) && $managesection['business_hours']) || empty($managesection))
                @if ($vcard->businessHours->count())
                    ...
                    <div class="business-hour-section pt-50 px-30 position-relative"
                        @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        <div class="position-absolute vector-10 vector-all">
                            <img src="{{ asset('assets/img/vcard21/vcard21-vector-10.png') }}" alt="vector-img"
                                class="w-100" />
                        </div>
                        <div class="section-heading text-center mb-40">
                            <h2 class="text-dark mb-0">
                                ...
                                @foreach ($businessDaysTime as $key => $dayTime)
                                    <div class="col-md-6">
                                        <div class="business-hour">
                                            <div class="business-box d-flex  align-items-center gap-2">
                                                <div class="business-hour-icon text-gradient">
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                <div class="qr-code-section pt-50 px-30 position-relative">
                    <div class="position-absolute vector-11 vector-all">
                        <img src="{{ asset('assets/img/vcard21/vcard21-vector-11.png') }}" alt="vector-img"
                            class="w-100" />
                    </div>
                    <div class="section-heading text-center mb-40">
                        <h2 class="text-dark mb-0">
                    ...
                    <div class="card-wrapper">
                        <div class="qr-code d-flex flex-sm-row flex-column gap-3 align-items-center"
                            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            <div class="qr-code-img text-center" id="qr-code-twentyone">
                ...
                @if (checkFeature('iframes') && $vcard->iframes->count())
                    <div class="iframe-section pt-50 px-20 position-relative">
                        <div class="position-absolute vector-12 vector-all">
                            <img src="{{ asset('assets/img/vcard21/vcard21-vector-13.png') }}" alt="vector-img"
                                class="w-100" />
                        </div>
                        <div class="section-heading text-center mb-40">
                            <h2 class="text-dark mb-0">
                                        ...
                                        <div class="iframe-card">
                                            <div class="overlay">
                                                <iframe src="{{ $iframe->url }}" frameborder="0"
                                                    ...
                                                    allowfullscreen width="100%" class="mb-0" height="500">
                                                </iframe>
                                            </div>
                                        </div>
                                    </div>
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
                <div class="contact-us-section px-30 pt-50 position-relative">
                    <div class="position-absolute vector-13 vector-all">
                        <img src="{{ asset('assets/img/vcard21/vcard21-vector-12.png') }}" alt="vector-img"
                            class="w-100" />
                    </div>
                    <div class="section-heading text-center mb-40">
                        <h2 class="text-dark mb-0">
                                        ...
                                        <div class="col-12 mb-4 d-flex gap-2">
                                            ...
                                            <label class="form-check-label fs-14" for="privacyPolicyCheckbox">
                                                ...
                                                <a href="{{ $vcardPrivacyAndTerm }}" target="_blank"
                                                    class="text-decoration-none link-info text-primary text-decoration-underline">{!! __('messages.vcard.term_and_condition') !!}</a>
                                                <span class="text-black">&</span>
                                                <a href="{{ $vcardPrivacyAndTerm }}" target="_blank"
                                                    class="text-decoration-none link-info text-primary text-decoration-underline">{{ __('messages.vcard.privacy_policy') }}</a>
                                            </label>
                                        </div>
                                    @endif
                                    <div class="col-12 text-center">
                                        <button class="contact-btn send-btn btn  fw-5 btn-primary" type="submit">
                                        ...
                                        <div class="col-12 mb-4 d-flex gap-2">
                                            ...
                                            <label class="form-check-label fs-14" for="privacyPolicyCheckbox">
                                                <span
                                                    class="text-black">{{ __('messages.vcard.agree_to_our') }}</span>
                                                <a href="{{ $vcardPrivacyAndTerm }}" target="_blank"
                                                    class="text-decoration-none link-info text-primary text-decoration-underline fs-14">{!! __('messages.vcard.term_and_condition') !!}</a>
                                                <span class="text-black">&</span>
                                                <a href="{{ $vcardPrivacyAndTerm }}" target="_blank"
                                                    class="text-decoration-none link-info text-primary text-decoration-underline fs-14">{{ __('messages.vcard.privacy_policy') }}</a>
                                            </label>
                                        </div>
                                    @endif
                                    <div class="col-12 text-center">
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
                <div class="create-vcard-section pt-50 px-30 position-relative">
                    <div class="position-absolute vector-14 vector-all">
                        <img src="{{ asset('assets/img/vcard21/vcard21-vector-14.png') }}" alt="vector-img"
                            class="w-100" />
                    </div>
                        ...
                        <div class="vcard-link-card card">
                            <div class="d-flex justify-content-center align-items-center gap-3"
                                ...
                                <a href="{{ config('app.url') . '/register?referral-code=' . $vcard->user->affiliate_code }}"
                                    target="blank"
                                    class="fw-5 text-primary">{{ route('register', ['referral-code' => $vcard->user->affiliate_code]) }}
                                </a>
                ...
                @if ($vcard->location_type == 0 && ($vcard->location_url && isset($url[5])))
                    <div class="px-30 pt-50 position-relative">
                        <div class="position-absolute vector-15 vector-all">
                            <img src="{{ asset('assets/img/vcard21/vcard21-vector-15.png') }}" alt="vector-img"
                                class="w-100" />
                        </div>
                                    ...
                                    <svg width="18" height="24" viewBox="0 0 18 24" fill="none"
                                        ...
                                        <defs>
                                            <clipPath id="clip0_1990_518">
                                                <rect width="18" height="24" fill="#244d4e"></rect>
                                            </clipPath>
                                        </defs>
                                    </svg>
                                </div>
                    ...
                    <div class="text-center d-flex align-items-center justify-content-center"
                        ...
                        @if ($contactRequest == 1)
                            <a href="{{ Auth::check() ? route('add-contact', $vcard->id) : 'javascript:void(0);' }}"
                                class="add-contact-btn btn btn-gradient
                        ...
                        @else
                            <a href="{{ route('add-contact', $vcard->id) }}"
                                class="add-contact-btn btn btn-gradient"><i
                                    class="fas fa-download fa-address-book"></i>
                                &nbsp;{{ __('messages.setting.add_contact') }}</a>
                        @endif
                        {{-- <button class="add-contact-btn  btn-gradient">Add to Contact</button> --}}
                    </div>
                </div>
            ...
            <div class="btn-section cursor-pointer @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
                <div class="fixed-btn-section">
                    @if (empty($vcard->hide_stickybar))
                        <div
                            class="bars-btn social-media-bars-btn @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') vcard-bars-btn-left @endif">
                            <img src="{{ asset('assets/img/vcard21/sticky.svg') }}" loading="lazy">
                        </div>
                    @endif
                        ...
                        <div class="sub-btn-div @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') sub-btn-div-left @endif">
                            @if ($vcard->whatsapp_share)
                                <div class="icon-search-container mb-3" data-ic-class="search-trigger">
                                    <div class="wp-btn">
                                        <i class="fab text-white  fa-whatsapp fa-2x" id="wpIcon"></i>
                                    </div>
                    ...
                    <div class="modal-body">
                        ...
                        <form action="" method="post" id="newsLatterForm">
                            ...
                            <div class="mb-1 mt-1 d-flex gap-1 justify-content-center align-items-center email-input">
                                <div class="w-100">
                                    <input type="email" class="form-control bg-dark border-0 text-dark"
