...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/oldVcard/vcard36.css') }}">
    ...
    <div class="container p-0">
        ...
        <div class="main-content mx-auto w-100 position-relative overflow-hidden bg-white">
            <div class="banner-section position-relative @if ($vcard->cover_type == 2) banner-yt-section @endif">
                <div class="banner-img @if ($vcard->cover_type == 2) banner-yt-video @endif">
                    <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/banner-img.png') }}"
                        class="w-100 h-100 object-fit-cover" alt="banner" />
                </div>
                <div class="travel-img">
                    <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/text-img.svg') }}" alt="Cinque Terre"
                        class="w-100 h-100 object-fit-cover" alt="banner">
                </div>
                <!-- <h1>TRAVEL</h1> -->
                <div class="overlay">
                ...
                @if ($vcard->cover_type == 2)
                    <div class="youtube-link-36">
                        <iframe
                            src="https://www.youtube.com/embed/{{ YoutubeID($vcard->youtube_link) }}?autoplay=1&mute=0&controls=0&loop=1&playlist={{ YoutubeID($vcard->youtube_link) }}"
                ...
                <div class="bg-vector @if ($vcard->cover_type == 2) d-none @endif"
                    @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                    <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/banner-bg-vector.png') }}"
                        alt="vector" />
                </div>
            </div>
            {{-- Pwa support --}}
            ...
            {{-- language --}}
            <div
                class="d-flex justify-content-end position-absolute top-0  me-3 @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') start-0 end-auto @else end-0 @endif">
                @if ($vcard->language_enable == \App\Models\Vcard::LANGUAGE_ENABLE)
                    <div class="language pt-3 me-2 lang-button">
            ...
            {{-- profile section --}}
            <div class="profile-section px-30 @if ($vcard->cover_type == 2) mt-3 @endif"
                @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                <div class="profile-bg text-end">
                    <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/profile-bg.png') }}" alt="bg-vector" />
                </div>
                <div class="card mb-30 d-flex flex-sm-row align-items-sm-stretch align-items-center border-0">
                    ...
                    <div class="card-body p-0 text-sm-start text-center">
                        <div class="profile-name mb-4 pb-1">
                            <h2 class="text-primary-36 mb-2 fw-5 fs-20">
                                {{ ucwords($vcard->first_name . ' ' . $vcard->last_name) }}
                                @if ($vcard->is_verified)
                                    <i class="verification-icon bi-patch-check-fill"></i>
                                @endif
                            </h2>
                            <p class="text-warning mb-0 fw-5 fs-18">{{ ucwords($vcard->occupation) }}</p>
                            <p class="text-warning mb-0 fw-5 fs-18">{{ ucwords($vcard->job_title) }}</p>
                            <p class="text-warning mb-0 fw-5 fs-18">{{ ucwords($vcard->company) }}</p>
                        </div>
                        {{-- social-media --}}
                        <div class="social-media-section" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            @if (checkFeature('social_links') && getSocialLink($vcard))
                                <div
                                    class="d-flex flex-wrap justify-content-sm-start @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') justify-content-sm-end @endif justify-content-center gap-md-4 gap-3">
                ...
                <div class="text-gray-200" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
            ...
            @if ((isset($managesection) && $managesection['contact_list']) || empty($managesection))
                @if (
                    ...
                    <div class="contact-section pt-60 px-30" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>

                        <div class="contact-bg img-1 text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/contact-bg-1.png') }}"
                                alt="bg-vector" />
                        </div>
                        <div class="contact-bg img-2 text-start">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/contact-bg-2.png') }}"
                                alt="bg-vector" />
                        </div>
                        <div class="contact-bg img-3 text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/contact-bg-3.png') }}"
                                alt="bg-vector" />
                        </div>
                        <div class="section-heading left-heading" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            <h2 class="mb-0">{{ __('messages.dynamic_vcard.contact') }}</h2>
                        </div>
                        <div class="row">
                            <div class="col-sm-6  mb-sm-0 mb-30">
                                <div class="contact-img">
                                    <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/contact-img.png') }}"
                                        alt="contact" class="w-100" />
                                </div>
                            </div>
                            <div class="col-sm-6">
                                @if ($vcard->email)
                                    <div
                                        class="contact-box d-flex flex-sm-row flex-column align-items-center gap-3 mb-20">
                                        <div class="contact-icon d-flex justify-content-center align-items-center">
                                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/email.png') }}" />
                                        </div>
                                ...
                                @if ($vcard->phone)
                                    <div
                                        class="contact-box d-flex flex-sm-row flex-column align-items-center gap-3 mb-20">
                                        <div class="contact-icon d-flex justify-content-center align-items-center">
                                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/phone.png') }}" />
                                        </div>
                                        <div class="contact-desc">
                                ...
                                @if ($vcard->dob)
                                    <div
                                        class="contact-box d-flex flex-sm-row flex-column align-items-center gap-3 mb-20">
                                        <div class="contact-icon d-flex justify-content-center align-items-center">
                                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/dob.png') }}" />
                                        </div>
                                        <div class="contact-desc">
                                ...
                                @if ($vcard->location)
                                    <div class="contact-box d-flex flex-sm-row flex-column align-items-center gap-3">
                                        <div class="contact-icon d-flex justify-content-center align-items-center">
                                            <img
                                                src="{{ asset('assets/img/oldVcardTemplate/vcard36/location.png') }}" />
                                        </div>
                                        <div class="contact-desc">
            ...
            @if ((isset($managesection) && $managesection['galleries']) || empty($managesection))
                @if (checkFeature('gallery') && $vcard->gallery->count())
                    <div class="gallery-section pt-60 px-30">
                        <div class="gallery-bg img-1" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/gallery-bg-1.png') }}"
                                alt="bg-vector" />
                        </div>
                        <div class="gallery-bg img-2">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/gallery-bg-2.png') }}"
                                alt="bg-vector" />
                        </div>
                        <div class="gallery-bg img-3" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/gallery-bg-3.png') }}"
                                alt="bg-vector" />
                        </div>
            ...
            @if ((isset($managesection) && $managesection['services']) || empty($managesection))
                @if (checkFeature('services') && $vcard->services->count())
                    <div class="our-services-section pt-60">
                        <div class="services-bg text-end" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/services-bg.png') }}"
                                alt="bg-vector" />
                        </div>
                                            ...
                                            <div class="service-card d-flex flex-sm-row flex-column gap-2">
                                                ...
                                                <div class="card-body p-0 d-flex flex-column justify-content-between ">
                                                   <div>
                                                    ...
                                                    <p
                                                        class="mb-0 fs-12 text-gray-200 {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}">
                                                    ...
                                                    @if ($vcard->show_service_enquiry_btn == true)
                                                        @if ($service->service_url)
                                                            <div class="text-center mt-2 enquiry-btn">
                                                                <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
                                                                    target="{{ $service->service_url ? '_blank' : '' }}"
                        ...
                        @else
                            <div class="row services-grid-view">
                                <div class="col-12 mb-4" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                    @foreach ($vcard->services as $service)
                                        <div class="service-card card d-flex flex-row align-items-center mb-4">
                                            ...
                                            <div class="card-body p-0 @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') me-3 @endif">
                                                <h3 class="card-title fs-18 text-black mb-1">
                                                    {{ ucwords($service->name) }}
                                                </h3>
                                                <p
                                                ...
                                                @if ($vcard->show_service_enquiry_btn == true)
                                                    @if ($service->service_url)
                                                        <div class="text-end mt-2 enquiry-btn">
                                                            <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
                                                                target="{{ $service->service_url ? '_blank' : '' }}"
                                                                class="btn btn-primary-enquiry @if(!$service->service_url) disabled @endif">
                                                                <span class="fs-14">{{ __('messages.contact_us.enquiry') }}</span>
            ...
            @if ((isset($managesection) && $managesection['appointments']) || empty($managesection))
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="appointment-section pt-30" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        <div class="appointment-bg img-1">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/appointment-bg-1.png') }}"
                                alt="bg-vector" />
                        </div>
                        <div class="appointment-bg img-2 text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/appointment-bg-2.png') }}"
                                alt="bg-vector" />
                        </div>
                        ...
                        <div class="appointment px-30 pt-40 pb-40">
                            ...
                            <div class="position-relative">
                                ...
                                <div class="col-12">
                                    <label class="text-white mb-2" id="hourSection"
                                        style="display: none;">{{ __('messages.hour') }}:</label>
                                    <div class="row">
                                        <div id="slotData" class="row">
                                        </div>
                                    </div>
                                </div>
                                <div class="mt-1 mx-auto text-center all-btn">
                                    <button class="btn btn-warning  appoint-btn appointmentAdd d-none">
            ...
            @if ((isset($managesection) && $managesection['products']) || empty($managesection))
                @if (checkFeature('products') && $vcard->products->count())
                    <div class="product-section pt-60 px-30">
                        <div class="product-bg img-1" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/product-bg-1.png') }}"
                                alt="bg-vector" />
                        </div>
                        <div class="product-bg img-2 text-end" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/product-bg-2.png') }}"
                                alt="bg-vector" />
                        </div>
                        <div class="product-bg img-3 text-end" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/product-bg-3.png') }}"
                                alt="bg-vector" />
                        </div>
                        <div class="section-heading left-heading" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                ...
                                <div>
                                    <div class="product-card card">
                                        <a @if ($product->product_url) href="{{ $product->product_url }}" @endif
                                            ...
                                            <div class="product-desc card-body w-100 d-flex flex-column justify-content-between">
                                                <div>
                                                    ...
                                                    <div>
                                                        <p class="fs-14 text-black mb-0 description">{{ $product->description }}
                                                        </p>
                                                    </div>
                                                </div>
                                                <div class="d-flex justify-content-between mt-2 product-info">
                                                      <div class="amount fs-6 mb-0 fw-5 text-end text-success">
                                                        @if ($product->currency_id && $product->price)
                                                            <p
                                                                class="fs-18 mb-0 fw-5 text-success">{{ currencyFormat($product->price, 2, $product->currency->currency_code) }}</p>
                                                        @elseif($product->price)
                                                            <p
                                                                class="fs-18 mb-0 fw-5 text-success">{{ currencyFormat($product->price, 2, getUserCurrencyIcon($vcard->user->id)) }}</p>
                                                        @endif
                                                    </div>
                        ...
                        <div class="me-5 mt-5 text-center view-more mb-5">
                            <a class="text-success fs-6 text text-decoration-underline ms-5"
            ...
            @if ((isset($managesection) && $managesection['whatsapp_store']) || empty($managesection))
                @if ($whatsappStore->count())
                    <div class="whatsapp-store-product-section px-30 position-relative">

                        <div class="product-bg img-1" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/profile-bg.png') }}"
                                alt="bg-vector" />
                        </div>
                        <div class="product-bg img-2 text-end" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/qr-bg-1.png') }}"
                                alt="bg-vector" />
                        </div>
                        <div class="section-heading left-heading" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            <h2 class="mb-0">{{ __('messages.feature.whatsapp_store') }}</h2>
                        </div>
                                ...
                                <div>
                                    <div class="whatsapp-store-box card">
                                        ...
                                        <div class="whatsapp-store-content card-body text-center"
                                            ...
                                            <h3 class="whatsapp-store-name mb-3 fw-5 text-center">
                                                {{ $product->store_name }}
                                            </h3>
                                            <a href="{{ route('whatsapp.store.show', $product->url_alias) }}"
                                                target="_blank" class="btn btn-wp-visit-store">
                                                <span class="fs-14">{{ __('messages.vcard.visit_store') }}</span>
                                            </a>
                                        </div>
                                    </div>
                                </div>
            ...
            @if ((isset($managesection) && $managesection['testimonials']) || empty($managesection))
                @if (checkFeature('testimonials') && $vcard->testimonials->count())
                    <div class="testimonial-section pt-60 px-30">
                        <div class="testimonial-bg img-1" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/testimonial-bg-1.png') }}"
                                alt="bg-vector" />
                        </div>
                        <div class="testimonial-bg img-2 text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/testimonial-bg-2.png') }}"
                                alt="bg-vector" />
                        </div>
                        <div class="testimonial-bg img-3 text-end"
                            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/testimonial-bg-3.png') }}"
                                alt="bg-vector" />
                        </div>
                        <div class="testimonial-bg img-4" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/testimonial-bg-4.png') }}"
                                alt="bg-vector" />
                        </div>
                        <div class="section-heading right-heading"
                            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                ...
                                <div>
                                    <div class="testimonial-card card">
                                        <div class="quote-img quote-left">
                                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/quote-left.png') }}"
                                                alt="quote" />
                                        </div>
                                        <div class="quote-img quote-right">
                                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/quote-right.png') }}"
                                                alt="quote" />
                                        </div>
                                        <div class="card-body p-0">
                                            <p
                                                class="desc text-gray-200 fs-14 mb-3 text-sm-start text-center {{ \Illuminate\Support\Str::length($testimonial->description) > 80 ? 'more' : '' }}">
                                            ...
                                            <div
                                                ...
                                                <div>
                                                    <h3 class="text-black fs-16 fw-5 mb-0">
            ...
            @if ((isset($managesection) && $managesection['linkedin_embed']) || empty($managesection))
                @if (checkFeature('linkedin_embed') && $vcard->linkedinEmbed->count())
                    <div class="pt-5">
                        <div class="section-heading left-heading" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                            <h2 class="mb-0">{{ __('messages.feature.linkedin_embed') }}</h2>
                        </div>
                ...
                @if (checkFeature('blog') && $vcard->blogs->count())
                    <div class="blog-section pt-60">
                        <div class="blog-bg-vector vector-1">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/blog-bg-1.png') }}"
                                alt="bg-vector" />
                        </div>
                        <div class="blog-bg-vector vector-2 text-end"
                            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/blog-bg-2.png') }}"
                                alt="bg-vector" />
                        </div>
                        <div class="blog-bg img-1">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/blog-bg1.png') }}"
                                alt="bg" class="w-100" />
                        </div>
                        <div class="blog-bg img-2">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/blog-bg2.png') }}"
                                alt="bg" class="w-100" />
                        </div>
                        <div class="blog-heading section-heading left-heading px-30 "
                            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            <h2 class="mb-0 text-white">{{ __('messages.feature.blog') }}</h2>
                        </div>
                        <div
                            class="blog-slider pb-sm-0 pb-60 px-sm-0 px-30 @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') blog-rtl @endif">
                ...
                @if ($vcard->businessHours->count())
                    ...
                    <div class="business-hour-section pt-60 px-30"
                        ...
                        <div class="hour-bg img-1">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/hour-bg-1.png') }}"
                                alt="bg-vector" />
                        </div>
                        <div class="hour-bg img-2">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/hour-bg-2.png') }}"
                                alt="bg-vector" />
                        </div>
                        <div class="business-hour-heading section-heading right-heading"
                            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                <div class="qr-code-section pt-60" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                    <div class="qr-bg img-1">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/qr-bg-1.png') }}" alt="bg-vector" />
                    </div>
                    <div class="qr-bg img-2 text-end">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/qr-bg-2.png') }}" alt="bg-vector" />
                    </div>
                    <div class="section-heading left-heading px-30"
                        @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                    ...
                    <div class="qr-code mx-auto position-relative pt-40 pb-40 px-30">
                        <div class="overlay"></div>
                        <div class="qr-code-img mx-auto position-relative mb-30 d-flex align-items-center justify-content-center"
                            id="qr-code-thirtysix">
            ...
            @if ((isset($managesection) && $managesection['payment_link']) || empty($managesection))
                @if (checkFeature('payment_link') && $vcard->paymentLinks->count())
                    <div class="payment-link-section px-30px position-relative"
                        @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>

                        <div class="position-absolute vector-75 business-vector text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/create-vcard-bg-1.png') }}" alt="images"
                                class="w-100" />
                        </div>
                        <div class="section-heading left-heading px-30" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            <h2 class="mb-0">{{ __('messages.vcard.payment_links') }}</h2>
                        </div>

                        <div class="payment-link-slider px-4">
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
                <div class="contact-us-section pt-60 px-30" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                    <div class="contact-us-bg img-1">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/contact-us-bg-1.png') }}"
                            alt="bg-vector" />
                    </div>
                    <div class="contact-us-bg img-2 text-end">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/contact-us-bg-2.png') }}"
                            alt="bg-vector" />
                    </div>
                    <div class="contact-us-bg img-3">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/contact-us-bg-3.png') }}"
                            alt="bg-vector" />
                    </div>
                    <div class="section-heading right-heading" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        ...
                        <div class="contact-form">
                            <form action="" id="enquiryForm" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="tel"
                                            class="form-control @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') text-end @endif"
                                    ...
                                    <div class="col-12">
                                        <textarea class="form-control mb-0 h-100" placeholder="{{ __('messages.form.type_message') }}" name="message"
                                            rows="3"></textarea>
                                    </div>
                                    ...
                                    @if (!empty($vcard->privacy_policy) || !empty($vcard->term_condition))
                                        <div class="col-12 mb-4 mt-2">
                                            ...
                                            <label class="form-check-label" for="privacyPolicyCheckbox">
                                                <span
                                                    class="text-gray">{{ __('messages.vcard.agree_to_our') }}</span>
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
                <div class="create-vcard-section pt-60 px-30" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                    <div class="create-vcard-bg img-1">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/create-vcard-bg-1.png') }}"
                            alt="bg-vector" />
                    </div>
                    <div class="create-vcard-bg img-2 text-end">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/create-vcard-bg-2.png') }}"
                            alt="bg-vector" />
                    </div>
                    <div class="section-heading left-heading" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                    ...
                    <div class="mb-5">
                        <div class="vcard-link-card card mb-3 mx-sm-3">
                            <div
                                class="d-flex align-items-center justify-content-center @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') me-3 @endif">
            ...
            @if ((isset($managesection) && $managesection['map']) || empty($managesection))
                <div class="container">
                    <div class="d-flex flex-column justify-content-center mt-2 mb-sm-1">
                    ...
                    <div class="text-center d-flex align-items-center justify-content-center"
                        ...
                        @if ($contactRequest == 1)
                            <a href="{{ Auth::check() ? route('add-contact', $vcard->id) : 'javascript:void(0);' }}"
                                class="add-contact-btn btn btn-warning all-btn {{ Auth::check() ? 'auth-contact-btn' : 'ask-contact-detail-form' }}"
                        ...
                        @else
                            <a href="{{ route('add-contact', $vcard->id) }}"
                                class="add-contact-btn btn btn-warning"><i
            ...
            <div class="btn-section cursor-pointer @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
                <div class="fixed-btn-section">
                    <div class="bars-btn travel-bars-btn">
                        {{-- <img src="{{ asset('assets/img/oldVcardTemplate/vcard30/sticky.png') }}" /> --}}
                    ...
                    <div class="sub-btn d-none">
                        <div class="sub-btn-div @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') sub-btn-div-left @endif">
                                ...
                                <div class="icon-search-container mb-3" data-ic-class="search-trigger">
                                    ...
                                    <div class="share-wp-btn-div">
                                        <a href="javascript:void(0)"
                                            class="vcard36-sticky-btn vcard36-btn-group d-flex justify-content-center text-primary align-items-center rounded-0 text-decoration-none py-1 rounded-pill justify-content share-wp-btn">
                            ...
                            @if (empty($vcard->hide_stickybar))
                                <div
                                    class="{{ isset($vcard->whatsapp_share) ? 'vcard36-btn-group' : 'stickyIcon' }}">
                                    <button type="button"
                                        class="vcard36-btn-group vcard36-share vcard36-sticky-btn mb-3"><i
                    ...
                    <div class="modal-content" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        ...
                        <div class="modal-body">
                            ...
                            <a href="https://wa.me/?text={{ $shareUrl }}" target="_blank"
                                ...
                                <div class="row">
                                    <div class="col-2">
                                        <i class="fab fa-whatsapp text-black fa-2x"
            ...
            <div class="vcard-bg position-relative">
                <img src="{{ asset('assets/img/oldVcardTemplate/vcard36/vcard-bg.png') }}" alt="bg"
                    class="w-100" />
                {{-- made by --}}
                <div class="d-flex justify-content-evenly w-100 position-absolute bottom-0">
...
<script>
    ...
    $().ready(function() {
        $(".gallery-slider").slick({
            ...
            nextArrow: '<button class="slide-arrow next-arrow"><i class="fa-solid fa-arrow-right"></button>',
            responsive: [
