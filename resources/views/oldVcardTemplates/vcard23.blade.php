...
<head>
    ...
    {{-- css link --}}
    <link rel="stylesheet" href="{{ mix('assets/css/oldVcard/vcard23.css') }}">
    ...
    <div class="container p-0">
        ...
        <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
            ...
            @if ((isset($managesection) && $managesection['contact_list']) || empty($managesection))
                <div class="contact-section mx-md-3 px-40 mb-5" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                    <div class="row">
                        @if ($vcard->email)
                            <div class="col-sm-6 mb-5 px-lg-4 px-sm-3">
                                <div class="contact-box">
                                    <div class="contact-icon d-flex justify-content-center align-items-center">
                                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard23/email.png') }}"
                                            loading="lazy" />
                                    </div>
                        ...
                        @if ($vcard->phone)
                            <div class="col-sm-6 mb-5 px-lg-4 px-sm-3">
                                <div class="contact-box">
                                    <div class="contact-icon d-flex justify-content-center align-items-center">
                                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard23/phone.png') }}"
                                            loading="lazy" />
                                    </div>
                                    <div class="contact-desc">
                                        <a href="tel:+{{ $vcard->region_code }}{{ $vcard->phone }}"
                                            class="text-secondary fs-14 fw-5"
                        ...
                        @if ($vcard->dob)
                            <div class="col-sm-6 mb-sm-0 mb-5 px-lg-4 px-sm-3">
                                <div class="contact-box">
                                    <div class="contact-icon d-flex justify-content-center align-items-center">
                                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard23/dob.png') }}"
                                            loading="lazy" />
                                    </div>
                                    <div class="contact-desc">
                        ...
                        @if ($vcard->location)
                            <div class="col-sm-6 px-lg-4 px-sm-3">
                                <div class="contact-box">
                                    <div class="contact-icon d-flex justify-content-center align-items-center">
                                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard23/location.png') }}"
                                            loading="lazy" />
                                    </div>
                                    <div class="contact-desc">
                ...
                @if (checkFeature('services') && $vcard->services->count())
                    <div class="our-services-section px-40 pt-60">
                        <div class="services-bg-img text-center">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard23/services-bg-img.png') }}"
                        ...
                        <div class="appointment px-2">
                            ...
                            <div class="">
                                ...
                                <div class="text-center px-sm-4 mx-sm-3 mx-2">
                                    <button type="submit"
                                        class="appointmentAdd btn btn-primary w-100 rounded d-none">
                    ...
                    <div class="gallery-section pt-60 pb-50">
                        ...
                        <div class="position-relative">
                            <div class="gallery-bg-img text-end">
                                <img src="{{ asset('assets/img/oldVcardTemplate/vcard23/gallery-bg.png') }}"
                ...
                @if (checkFeature('testimonials') && $vcard->testimonials->count())
                    <div class="testimonial-section pt-60 px-40 pb-30 mb-4">
                        <div class="testimonial-bg-img">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard23/testimonial-bg.png') }}"
                                loading="lazy" />
                        </div>
                        <div class="section-heading text-center mb-40">
                                    ...
                                    <div class="">
                                        <div class="product-card card">
                                            ...
                                            <div class="product-desc card-body p-3">
                                                <h3 class="text-secondary fs-18 fw-5 mb-1 text-truncate"
                                                    title="{{ $product->name }}">
                                                    {{ $product->name }}
                                                </h3>
                                                <p class="mb-2 text-gray-100 fs-14">
                                                    {{ $product->description }}
                                                </p>
                                ...
                                <div>
                                    <div class="whatsapp-store-box card">
                                        ...
                                        <div class="whatsapp-store-content card-body text-center"
                                            ...
                                            <h3 class="whatsapp-store-name text-gray-200 mb-3 fw-5 text-center fs-18">
                                                {{ $product->store_name }}
                                            </h3>
                ...
                @if (checkFeature('blog') && $vcard->blogs->count())
                    <div class="blog-section mt-2 pb-3 pt-60">
                        <div class="blog-bg text-center">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard23/blog-bg.png') }}"
                                alt="blog-bg" />
                        </div>
                        <div class="section-heading text-center mb-40">
            ...
            @if ((isset($managesection) && $managesection['business_hours']) || empty($managesection))
                @if ($vcard->businessHours->count())
                    ...
                    <div class="business-hour-section mb-3">
                        ...
                        <div class="business-hours bg-white" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            @php
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                <div class="qr-code-section pt-60">
                    <div class="qr-bg-img text-end">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard23/qr-code-bg.png') }}"
                            alt="qr-code-bg" loading="lazy" />
                    </div>
            ...
            @if ((isset($managesection) && $managesection['payment_link']) || empty($managesection))
                @if (checkFeature('payment_link') && $vcard->paymentLinks->count())
                    <div class="payment-link-section px-30 pt-30 pb-30 position-relative"
                        @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
                <div class="pt-40 pb-40 px-40 pt-0">
                    <div class="bg-img">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard23/bg-img.png') }}" loading="lazy" />
                    </div>
                </div>
                ...
                <div class="fixed-btn-section">
                    @if (empty($vcard->hide_stickybar))
                        <div
                            ...
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard23/sticky-btn.png') }}"
                                loading="lazy" />
                        </div>
                    @endif
