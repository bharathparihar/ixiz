...
<head>
    ...
    {{-- css link --}}
    <link rel="stylesheet" href="{{ mix('assets/css/oldVcard/vcard28.css') }}">
    ...
    <div class="container p-0">
        ...
        <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
            ...
            <div class="banner-section position-relative">
                <div class="banner-img @if ($vcard->cover_type == 2) banner-img-28 @endif">
                    @php
                        $coverClass =
                ...
                <div class="mask @if ($vcard->cover_type == 2) d-none @endif">
                    <img src="{{ asset('assets/img/oldVcardTemplate/vcard28/mask.svg') }}"
            ...
            @if (getLanguage($vcard->default_language) != 'Arabic' && getLanguage($vcard->default_language) != 'Persian')
                <div
                    class="profile-section px-30 position-relative @if ($vcard->cover_type == 2) profile-margin @endif">
                    <div class="position-absolute vector-1 vector-all">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard28/services-bg1.png') }}"
                            alt="images" class="w-100" />
                    </div>
                    <div class="position-absolute vector-2 text-end vector-all">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard28/services-bg1.png') }}"
                            alt="images" class="w-100" />
                    </div>
                    <div class="profile-bg img-1">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard28/profile-bg1.png') }}"
                            alt="bg-vector" />
                    </div>
                    <div class="profile-bg img-2 text-end">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard28/profile-bg2.png') }}"
                            alt="bg-vector" />
                    </div>
                    <div
                        class="card d-flex flex-column align-items-center mb-4 @if ($vcard->cover_type == 2) profile-min-height @else @endif">
                        ...
                        <div
                            class="card-body p-0 text-center @if ($vcard->cover_type == 2) profile-desc-margin @endif">
                            <div class="profile-name">
                                ...
                                <p class="fs-16 text-pink mb-0">{{ ucwords($vcard->company) }}</p>
                                <p class="fs-14 text-purple mb-0">{{ ucwords($vcard->occupation) }}</p>
                                <p class="fs-14 text-purple mb-0">{{ ucwords($vcard->job_title) }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="fs-14 text-center text-gray-500 profile-desc mb-30">
                                ...
                                @foreach ($customLink as $value)
                                    @if ($value->show_as_button == 1)
                                        ...
                                        @if ($value->button_type === 'square') border-radius: 0px; @endif"
                                            class="mx-2 d-flex justify-content-center align-items-center text-decoration-none link-text font-primary btn mt-2">
                                            {{ $value->link_name }}
                                        </a>
                                    @else
                                        <a href="{{ $value->link }}"
                ...
                <div class="rtl" dir="rtl">
                    <div class="profile-section px-30 @if ($vcard->cover_type == 2) profile-margin @endif">
                        ...
                        <div
                            class="card d-flex flex-column align-items-center mb-4 @if ($vcard->cover_type == 2) profile-min-height @else @endif">
                            <div
                                class="card-img profile-left @if ($vcard->cover_type == 2) profile-top-margin @endif">
                                <img src="{{ $vcard->profile_url }}" class="w-100 h-100 object-fit-cover" />
                            </div>
                            <div
                                class="card-body p-0 text-center @if ($vcard->cover_type == 2) profile-desc-margin @endif">
            ...
            @if ((isset($managesection) && $managesection['contact_list']) || empty($managesection))
                @if (getLanguage($vcard->default_language) != 'Arabic' && getLanguage($vcard->default_language) != 'Persian')
                    <div class="contact-section pt-60 px-30">
                        ...
                        <div class="row row-gap-20px contact-main-box d-flex">
                            @if ($vcard->email)
                                <div class="col-sm-6 d-flex">
                                    <div class="contact-box d-flex align-items-center w-100">
                                        <div
                                            ...
                                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard28/email.png') }}" />
                                        </div>
                                ...
                                <div class="col-sm-6 d-flex">
                                    <div class="contact-box d-flex align-items-center w-100">
                                        <div
                                            ...
                                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard28/phone.png') }}" />
                                        </div>
                                        <div class="contact-desc">
                                ...
                                <div class="col-sm-6 mb-sm-0 mb-4 d-flex">
                                    <div class="contact-box d-flex align-items-center w-100">
                                        <div
                                            ...
                                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard28/dob.png') }}" />
                                        </div>
                                        <div class="contact-desc">
                                ...
                                <div class="col-sm-6 d-flex">
                                    <div class="contact-box d-flex align-items-center w-100">
                                        <div
                                            ...
                                            <img
                                                src="{{ asset('assets/img/oldVcardTemplate/vcard28/location.png') }}" />
                                        </div>
                                        <div class="contact-desc">
                ...
                @endif
                @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian')
                    <div class="contact-section pt-60 px-30" dir="rtl">
                        <div class="section-heading">
                            <h2>{{ __('messages.contact_us.contact') }}</h2>
                        </div>
                        <div class="row row-gap-20px contact-main-box d-flex">
                                ...
                                <div class="col-sm-6 d-flex">
                                    <div class="contact-box d-flex align-items-center w-100">
                                        <div
                                            class="contact-icon d-flex justify-content-center align-items-center bg-yellow-light">
                                            <img
                                                src="{{ asset('assets/img/oldVcardTemplate/vcard28/phone.png') }}" />
                                        </div>
                                        <div class="contact-desc">
                                            <a href="tel:+{{ $vcard->alternative_region_code }}{{ $vcard->alternative_phone }}"
                                                class="text-black fw-5"
                ...
                @if (checkFeature('services') && $vcard->services->count())
                    <div class="our-services-section pt-60 px-30">
                        ...
                        <div class="services-bg img-2 text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard28/services-bg2.png') }}"
                                alt="bg-img" />
                        </div>
                        <div class="services-bg img-3 text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard28/services-bg3.png') }}"
                                alt="bg-img" />
                        </div>
                        <div class="section-heading">
                        ...
                        <div class="services">
                            ...
                            @else
                                <div class="row pt-30 row-gap-48px">
                                    @foreach ($vcard->services as $service)
                                        <div class="col-sm-6">
                                            <div class="service-card h-100">
                                                <div class="card-img">
                                                ...
                                                <div class="card-body text-center p-0">
                                                    ...
                                                    <p
                                                        class="mb-0 fs-14 text-gray-500 text-center  {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}">
                ...
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="appointment-section pt-60 px-30">
                        <div class="appointment-bg img-1">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard28/appointment-bg1.png') }}"
                                alt="bg-img" />
                        </div>
                        <div class="appointment-bg img-2">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard28/appointment-bg2.png') }}"
                                alt="bg-img" />
                        </div>
                        <div class="appointment-bg img-3 text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard28/appointment-bg3.png') }}"
                                alt="bg-img" />
                        </div>
                        <div class="section-heading">
                        ...
                        <div class="appointment mx-sm-5">
                            ...
                            <div class="text-center">
                                <button type="submit" class="appointmentAdd btn btn-blue rounded-2 d-none">
                ...
                @if (checkFeature('gallery') && $vcard->gallery->count())
                    <div class="gallery-section pt-60 px-30">
                        <div class="gallery-bg text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard28/gallery-bg.png') }}"
                                alt="bg-img" />
                        </div>
                        <div class="section-heading">
                ...
                @if (checkFeature('products') && $vcard->products->count())
                    <div class="product-section pt-60 px-3">
                        <div class="product-bg img-1">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard28/product-bg1.png') }}"
                                alt="bg-img" />
                        </div>
                        <div class="product-bg img-2 text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard28/product-bg2.png') }}"
                                alt="bg-img" />
                        </div>
                            ...
                            @foreach ($vcard->products as $product)
                                <div class="">
                                    <div class="product-card card">
                                        ...
                                        <div class="product-desc card-body p-3 text-start">
                                            ...
                                            <div class="d-flex justify-content-between mt-2 product-info">
                                                <p class="amount fs-20 fw-6 mb-0 text-purple lh-1">
                                                    @if ($product->currency_id && $product->price)
                                                        <span
                                                            class="fs-18 fw-6 text-purple">{{ currencyFormat($product->price, 2, $product->currency->currency_code) }}</span>
                                                    @elseif($product->price)
                                                        <span
                                                            class="fs-18 fw-6 text-purple">{{ currencyFormat($product->price, 2, getUserCurrencyIcon($vcard->user->id)) }}</span>
                                                    @endif
                                                </p>
                        ...
                        <div class="text-center">
                            <div class="d-inline-flex gap-2 align-items-center mt-5 text-center view-more mx-auto">
                                <a class="fs-6 text text-purple""
            ...
            @if ((isset($managesection) && $managesection['whatsapp_store']) || empty($managesection))
                @if ($whatsappStore->count())
                    <div class="whatsapp-store-product-section pt-40 px-3">

                        <div class="product-bg img-1">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard28/create-vcard-bg.png') }}"
                                alt="bg-img" />
                        </div>
                        <div class="product-bg img-2 text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard28/qr-bg3.png') }}"
                                alt="bg-img" />
                        </div>
                                ...
                                <div>
                                    <div class="whatsapp-store-box card h-100">
                                        ...
                                        <div class="whatsapp-store-content card-body text-center"
                                            ...
                                            <h3 class="whatsapp-store-name mb-3 fw-5">
                                                {{ $product->store_name }}
                                            </h3>
                ...
                @if (checkFeature('testimonials') && $vcard->testimonials->count())
                    <div class="testimonial-section pt-60">
                        <div class="testimonial-bg img-1">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard28/testimonial-bg1.png') }}"
                                alt="bg-img" />
                        </div>
                        <div class="testimonial-bg img-2 text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard28/testimonial-bg2.png') }}"
                                alt="bg-img" />
                        </div>
                                    ...
                                    <div class="testimonial-card card">
                                        <div class="d-flex justify-content-between"
                                            ...
                                            <div class="d-flex align-items-center gap-3">
                                                ...
                                                <div class="">
                                                    <h3 class="text-pink fs-18">{{ ucwords($testimonial->name) }}
                                                    </h3>
                                                </div>
                                            </div>
                                            <div class="quote-img">
                                                <img src="{{ asset('assets/img/oldVcardTemplate/vcard28/quote-img.png') }}"
                                                    alt="quote" class="h-100" />
                                            </div>
                                        </div>
                                        <div class="card-body p-0 pt-3">
                                            <p
                                                class="desc text-gray-500 fs-12 mb-0 text-start  {{ \Illuminate\Support\Str::length($testimonial->description) > 80 ? 'more' : '' }}">
                ...
                @if (checkFeature('blog') && $vcard->blogs->count())
                    <div class="blog-section pt-60 px-3">
                        <div class="blog-bg-img text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard28/blog-bg-img.png') }}"
                                alt="bg-vector" />
                        </div>
                ...
                @if ($vcard->businessHours->count())
                    ...
                    <div class="business-hour-section pt-60 px-30">
                        <div class="hour-bg-img">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard28/hour-bg.png') }}"
                                alt="bg-vector" />
                        </div>
                        <div class="section-heading">
                        ...
                        <div class="">
                            <div class="business-hour-card row justify-content-center">
                                ...
                                @foreach ($businessDaysTime as $key => $dayTime)
                                    <div class="col-sm-6">
                                        <div class="business-hour text-center flex-column d-flex align-items-center">
                                            <div class="">
                                                {{ __('messages.business.' . \App\Models\BusinessHour::DAY_OF_WEEK[$key]) }}
                                                :</div>
                                            <div class="d-flex gap-2 align-items-center text-pink">
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                <div class="qr-code-section pt-60 px-30">
                    <div class="qr-bg-img img-1">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard28/qr-bg1.png') }}" alt="bg-vector" />
                    </div>
                    <div class="qr-bg-img img-2 text-end">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard28/qr-bg2.png') }}" alt="bg-vector" />
                    </div>
                    <div class="qr-bg-img img-3 text-end">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard28/qr-bg3.png') }}" alt="bg-vector" />
                    </div>
                    <div class="section-heading">
            ...
            @if ((isset($managesection) && $managesection['iframe']) || empty($managesection))
                @if (checkFeature('iframes') && $vcard->iframes->count())
                    <div class="iframe-section pt-60">
                        <div class="section-heading text-center">
                                        ...
                                        <div class="col-12 mb-4">
                                            ...
                                            <label class="form-check-label" for="privacyPolicyCheckbox">
                                                ...
                                                <a href="{{ $vcardPrivacyAndTerm }}" target="_blank"
                                                    class="text-decoration-none link-info text-pink fs-6">{!! __('messages.vcard.term_and_condition') !!}</a>
                                                <span class="text-dark">&</span>
                                                <a href="{{ $vcardPrivacyAndTerm }}" target="_blank"
                                                    class="text-decoration-none link-info text-pink fs-6">{{ __('messages.vcard.privacy_policy') }}</a>
                                            </label>
                                        </div>
                                    @endif
                                    <div class="col-12 text-center">
                                        <button class="send-btn btn rounded-2 btn-pink contact-btn" type="submit">
                    ...
                    <div class="text-center d-flex align-items-center justify-content-center"
                        ...
                        @if ($contactRequest == 1)
                            <a href="{{ Auth::check() ? route('add-contact', $vcard->id) : 'javascript:void(0);' }}"
                                class="add-contact-btn rounded-2 btn-blue {{ Auth::check() ? 'auth-contact-btn' : 'ask-contact-detail-form' }}"
            ...
            <div class="pet-img-section">
                <img src="{{ asset('assets/img/oldVcardTemplate/vcard28/pet-img.png') }}" class="img-fluid" />
            </div>
            {{-- made by --}}
            ...
            <div class="btn-section cursor-pointer @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
                <div class="fixed-btn-section">
                    @if (empty($userSetting['hide_stickybar']))
                        <div
                            class="bars-btn pet-clinic-bars-btn @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') vcard-bars-btn-left @endif">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard28/sticky.png') }}" />
                        </div>
                    @endif
