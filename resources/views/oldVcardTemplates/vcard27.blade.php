...
<head>
    ...
    {{-- css link --}}
    <link rel="stylesheet" href="{{ mix('assets/css/oldVcard/vcard27.css') }}">
...
<body>
    <div class="container p-0">
        ...
        <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
            ...
            @endif
            <div class="bg-img">
                <img src="{{ asset('assets/img/oldVcardTemplate/vcard27/bg-img.png') }}" alt="bg-img" />
            </div>
            ...
            <div class="profile-section pt-sm-4">
                @if (getLanguage($vcard->default_language) != 'Arabic' && getLanguage($vcard->default_language) != 'Persian')
                    <div class="px-30 position-relative">
                        <div class="profile-bg-img img-1">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard27/services-bg-img1.png') }}"
                                alt="bg-img" loading="lazy" />
                        </div>
                        <div class="profile-bg-img img-2 text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard27/services-bg-img2.png') }}"
                                alt="bg-img" loading="lazy" />
                        </div>
                        <div
                            class="card d-flex flex-sm-row-reverse align-items-sm-start align-items-center mb-30 position-relative">
                ...
                <div class="profile-bg pt-80 pb-60 px-30">
                    <div class="text-light text-center profile-desc">
                        ...
                        <div
                            class="text-light text-sm-start text-center profile-desc @if ($vcard->cover_type == 2) profile-des-margin-top @endif">
                        ...
                        {{-- social icon --}}
                        <div
                            class="social-media pt-30 d-flex flex-wrap justify-content-center">
                            @if (checkFeature('social_links') && getSocialLink($vcard))
                                <div class="social-icons d-flex justify-content-center flex-wrap gap-2">
                ...
                <div class="contact-section pt-30 pb-30 px-30">
                    <div class="bg-img1">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard27/bg-img1.png') }}" alt="bg-img" />
                    </div>
                    <div class="bg-img2">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard27/bg-img2.png') }}" alt="bg-img" />
                    </div>
                    <div class="bg-img3 text-end">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard27/bg-img3.png') }}" alt="bg-img" />
                    </div>
                    {{-- contact section --}}
                    @if ((isset($managesection) && $managesection['contact_list']) || empty($managesection))
                        ...
                        <div class="row align-items-center">
                                    ...
                                    @if ($vcard->email)
                                        <div class="contact-box d-flex align-items-center mb-3">
                                            <div class="contact-icon d-flex justify-content-center align-items-center">
                                                <img src="{{ asset('assets/img/oldVcardTemplate/vcard27/email.png') }}"
                                                    alt="" />
                                            </div>
                                    ...
                                    @if ($vcard->phone)
                                        <div class="contact-box d-flex align-items-center mb-3">
                                            <div
                                                ...
                                                <img src="{{ asset('assets/img/oldVcardTemplate/vcard27/phone.png') }}"
                                                    alt="" />
                                            </div>
                                            <div class="contact-desc">
                                    ...
                                    @if ($vcard->dob)
                                        <div class="contact-box d-flex align-items-center mb-3">
                                            <div
                                                ...
                                                <img src="{{ asset('assets/img/oldVcardTemplate/vcard27/dob.png') }}"
                                                    alt="" />
                                            </div>
                                            <div class="contact-desc">
                                    ...
                                    @if ($vcard->location)
                                        <div class="contact-box d-flex align-items-center">
                                            <div
                                                ...
                                                <img src="{{ asset('assets/img/oldVcardTemplate/vcard27/location.png') }}"
                                                    alt="" />
                                            </div>
                                            <div class="contact-desc">
                            ...
                            <div class="col-sm-5">
                                <div class="pet-img">
                                    <img src="{{ asset('assets/img/oldVcardTemplate/vcard27/contact-img.png') }}"
                                        alt="pet" class="w-100" />
                                </div>
                            </div>
                        </div>
                    ...
                    @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                        <div class="appointment-section pt-30 pb-60 px-30">
                            <div class="appointment-bg img-1">
                                <img src="{{ asset('assets/img/oldVcardTemplate/vcard27/appointment-bg-img1.png') }}"
                                    alt="bg-img" loading="lazy" />
                            </div>
                            <div class="appointment-bg img-2 text-end">
                                <img src="{{ asset('assets/img/oldVcardTemplate/vcard27/appointment-bg-img2.png') }}"
                                    alt="bg-img" loading="lazy" />
                            </div>
                            <div class="section-heading">
                                                ...
                                                <div class="d-flex justify-content-between mt-2 product-info">
                                                     <p class="amount fs-18 mb-0 fw-6 text-gradient">
                                                        @if ($product->currency_id && $product->price)
                                                            <span
                                                                class="fs-18 text-secondary">{{ currencyFormat($product->price, 2, $product->currency->currency_code) }}</span>
                                                        @elseif($product->price)
                                                            <span
                                                                class="fs-18 text-secondary">{{ currencyFormat($product->price, 2, getUserCurrencyIcon($vcard->user->id)) }}</span>
                                                        @endif
                                                    </p>
                ...
                @if ((isset($managesection) && $managesection['whatsapp_store']) || empty($managesection))
                    @if ($whatsappStore->count())
                        <div class="whatsapp-store-product-section px-3 pb-30">
                                ...
                                @foreach ($whatsappStore as $product)
                                    <div>
                                        <div class="whatsapp-store-box card h-100">
                                            ...
                                            <div class="whatsapp-store-content card-body text-center p-3"
                    ...
                    @if (checkFeature('testimonials') && $vcard->testimonials->count())
                        <div class="testimonial-section">
                            <div class="testimonial-bg img-1">
                                <img src="{{ asset('assets/img/oldVcardTemplate/vcard27/testimonial-bg-img1.png') }}"
                                    alt="bg-img" loading="lazy" />
                            </div>
                            <div class="testimonial-bg img-2 text-end">
                                <img src="{{ asset('assets/img/oldVcardTemplate/vcard27/testimonial-bg-img2.png') }}"
                                    alt="bg-img" loading="lazy" />
                            </div>
                    ...
                    @if (checkFeature('blog') && $vcard->blogs->count())
                        <div class="blog-section pt-30 pb-30 px-3 mt-5">
                            <div class="blog-bg-img">
                                <img src="{{ asset('assets/img/oldVcardTemplate/vcard27/blog-bg-img.png') }}"
                                    alt="bg-img" loading="lazy" />
                            </div>
                            <div class="section-heading px-3">
                            ...
                            <div class="">
                                <div class="business-hour-card">
                                    ...
                                    @foreach ($businessDaysTime as $key => $dayTime)
                                        <div class="mb-3">
                                            <div class="business-hour d-flex justify-content-between align-items-center"
                                                @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                ...
                @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                    <div class="qr-code-section pt-30 px-30">
                        <div class="qr-code-bg-img text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard27/qr-code-bg-img.png') }}"
                                alt="bg-img" loading="lazy" />
                        </div>
                        <div class="section-heading">
                ...
                @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
                    <div class="contact-us-section pt-60 px-30 pb-60">
                        <div class="contact-us-bg-img">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard27/contact-us-bg.png') }}"
                                alt="bg-img" loading="lazy" />
                        </div>
                        <div class="contact-bg-img img-1">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard27/contact-bg-img1.png') }}"
                                alt="bg-img" loading="lazy" />
                        </div>
                        <div class="contact-bg-img img-2 text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard27/contact-bg-img2.png') }}"
                                alt="bg-img" loading="lazy" />
                        </div>
                        <div class="section-heading">
                ...
                @if (!empty($userSetting['enable_affiliation']))
                    <div class="create-vcard-section px-30 mb-5">
                        <div class="create-vcard-bg-img text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard27/create-vcard-bg.png') }}"
                                alt="bg-img" loading="lazy" />
                        </div>
                        <div class="section-heading">
                ...
                <div class="btn-section cursor-pointer @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
                    <div class="fixed-btn-section">
                        @if (empty($userSetting['hide_stickybar']))
                            <div
                                class="bars-btn pet-shop-bars-btn @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') vcard-bars-btn-left @endif">
                                <img src="{{ asset('assets/img/oldVcardTemplate/vcard27/sticky.png') }}" />
                            </div>
                        @endif
                    ...
                    <div class="modal-content animate-bottom" id="newsLatter-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form action="" method="post" id="newsLatterForm">
                                ...
                                <div
                                    class="mb-2 mt-4 d-flex gap-1 justify-content-center align-items-center email-input">
                                    <div class="w-100">
                                        <input type="email"
