    ...
    <div class="container p-0">
        ...
        <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
            ...
            <div class=" d-flex gap-4 flex-column px-30">
                <div class="profile-section position-relative  @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
                    <div class="banner-bg text-end">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard32/banner-bg.png') }}" alt="bg-img" />
                    </div>
                ...
                {{-- social-media --}}
                <div class="social-media-section position-relative"
                    ...
                    @if (checkFeature('social_links') && getSocialLink($vcard))
                        <div class="d-flex gap-3 flex-row flex-wrap justify-content-center align-items-center">
                            <div class="position-absolute vector-all vector-1">
                                <img src={{ asset('assets/img/oldVcardTemplate/vcard32/vector-1.png') }}
            ...
            @if ((isset($managesection) && $managesection['contact_list']) || empty($managesection))
                <div class="contact-section pt-40 px-30">
                    @if (getLanguage($vcard->default_language) != 'Arabic' && getLanguage($vcard->default_language) != 'Persian')
                        <div class="row row-gap-20px d-flex">
                            @if ($vcard->email)
                    ...
                    @endif
                    @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian')
                        <div class="row row-gap-20px d-flex" dir="rtl">
                            @if ($vcard->email)
                                <div class="col-sm-6 d-flex">
                                    <div class="contact-box d-flex align-items-center w-100">
                                        <div
            ...
            @if ((isset($managesection) && $managesection['services']) || empty($managesection))
                @if (checkFeature('services') && $vcard->services->count())
                    <div class="our-services-section pt-30 px-30">
                                    ...
                                    @foreach ($vcard->services as $service)
                                        <div class="col-sm-6">
                                            <div class="service-card h-100 px-3">
                                                ...
                                                <div class="card-body p-0 text-start d-flex flex-column justify-content-between w-100">
                                                    <div>
                ...
                @if (checkFeature('gallery') && $vcard->gallery->count())
                    <div class="gallery-section pt-50 pb-50 position-relative">
                        <div class="position-absolute vector-all vector-2 text-end">
                            <img src={{ asset('assets/img/oldVcardTemplate/vcard32/vector-2.png') }} alt="images"
                                class="w-100" />
                        </div>
                        <div class="position-absolute vector-all vector-3">
                            <img src={{ asset('assets/img/oldVcardTemplate/vcard32/vector-3.png') }} alt="images"
                                class="w-100" />
                        </div>
                        <div class="section-heading">
 ...
 @endif
                    ...
                    @if (checkFeature('products') && $vcard->products->count())
                        <div class="product-section pt-50 px-30 pb-5">
                            <div class="product-bg text-end">
                                <img src="{{ asset('assets/img/oldVcardTemplate/vcard32/product-bg.png') }}"
                                    alt="bg" />
                            </div>
                            <div class="position-absolute vector-all vector-4">
                                <img src={{ asset('assets/img/oldVcardTemplate/vcard32/vector-4.png') }}
                                    alt="images" class="w-100" />
                            </div>
                            <div class="section-heading">
                                    ...
                                    <div>
                                        <a @if ($product->product_url) href="{{ $product->product_url }}" @endif
                                            ...
                                            <div class="product-card card">
                                                ...
                                                <div class="product-desc d-flex flex-column justify-content-between">
                                                    <h3 class="text-dark fs-6 mb-1">{{ $product->name }}</h3>
                                                    <div class="d-flex justify-content-between mt-2 product-info">
                                                        <div class="amount fs-6 mb-0 fw-6 text-secondary">
                                                            @if ($product->currency_id && $product->price)
                                                                <span
                                                                    class="fs-18 fw-6 text-secondary">{{ currencyFormat($product->price, 2, $product->currency->currency_code) }}</span>
                                                            @elseif($product->price)
                                                                <span
                                                                    class="fs-18 fw-6 text-secondary">{{ currencyFormat($product->price, 2, getUserCurrencyIcon($vcard->user->id)) }}</span>
                                                            @endif
                                                        </div>
                ...
                @if ((isset($managesection) && $managesection['whatsapp_store']) || empty($managesection))
                    @if ($whatsappStore->count())
                        <div class="whatsapp-store-product-section px-30 pb-5 position-relative">
                            <div class="product-bg text-end">
                                <img src="{{ asset('assets/img/oldVcardTemplate/vcard32/vector-7.png') }}"
                                    alt="bg" />
                            </div>
                            <div class="position-absolute vector-all vector-4">
                                <img src={{ asset('assets/img/oldVcardTemplate/vcard32/vector-2.png') }}
                                    alt="images" class="w-100" />
                            </div>
                            <div class="section-heading">
                                <h2 class="mb-0 main-text">{{ __('messages.vcard.interior') }}</h2>
                                ...
                                @foreach ($whatsappStore as $product)
                                    <div>
                                        <div class="whatsapp-store-box card">
                                            ...
                                            <div class="whatsapp-store-content mt-auto"
                                                @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>

                                                <h3 class="text-dark fs-6 mb-1 whatsapp-store-name">
                                                    {{ $product->store_name }}
                                                </h3>
                    ...
                    @if (checkFeature('testimonials') && $vcard->testimonials->count())
                        <div class="testimonial-section px-30 pb-5">
                            ...
                            <div class="testimonial-bg">
                                <img src="{{ asset('assets/img/oldVcardTemplate/vcard32/testimonial-bg.png') }}"
                                    alt="bg-img" />
                            </div>
                            <div class="quote-img text-end">
                                <img src="{{ asset('assets/img/oldVcardTemplate/vcard32/testimonial-vector-1.svg') }}"
                                    alt="bg-img" />
                            </div>
                ...
                @if ((isset($managesection) && $managesection['linkedin_embed']) || empty($managesection))
                    @if (checkFeature('linkedin_embed') && $vcard->linkedinEmbed->count())
                        <div class="pt-5">
                            <div class="section-heading">
                                <h2 class="mb-0 main-text">{{ __('messages.vcard.linkedinembed') }}</h2>
                                <h4 class="mb-0">{{ __('messages.feature.linkedin_embed') }}</h4>
                            </div>

                            <div class="linkedin-feed px-2">
                                <div class="row overflow-hidden m-0 mt-2" loading="lazy">
                                    <!-- "Post" content -->
                    ...
                    @if (checkFeature('blog') && $vcard->blogs->count())
                        <div class="blog-section pt-50 pb-5 position-relative">
                            <div class="position-absolute vector-all vector-5 text-end">
                                <img src={{ asset('assets/img/oldVcardTemplate/vcard32/vector-5.png') }}
                                    alt="images" class="w-100" />
                            </div>
                            <div class="position-absolute vector-all vector-6">
                                <img src={{ asset('assets/img/oldVcardTemplate/vcard32/vector-6.png') }}
                                    alt="images" class="w-100" />
                            </div>
                            <div class="section-heading">
                    ...
                    @if ($vcard->businessHours->count())
                        ...
                        <div class="business-hour-section position-relative pb-50 px-30 {{ checkFeature('blog') && $vcard->blogs->count() ? 'pt-0' : 'pt-50' }}"
                            ...
                            <div class="business-hour-img text-end">
                                <img src="{{ asset('assets/img/oldVcardTemplate/vcard32/business-hour-bg.png') }}"
                                    alt="bg-img" />
                            </div>
                    ...
                    @if (checkFeature('iframes') && $vcard->iframes->count())
                        <div class="blog-section pt-50 pb-50 position-relative">
                            <div class="position-absolute vector-all vector-9">
                                <img src={{ asset('assets/img/oldVcardTemplate/vcard32/vector-9.png') }}
                                    alt="images" class="w-100" />
                            </div>
                            <div class="section-heading">
                ...
                @if ((isset($managesection) && $managesection['payment_link']) || empty($managesection))
                    @if (checkFeature('payment_link') && $vcard->paymentLinks->count())
                        <div class="payment-link-section px-30px pb-50 position-relative"
                            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>

                            <div class="section-heading">
                                <h2 class="mb-0 main-text">{{ __('messages.vcard.payment_links') }}</h2>
                ...
                @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
                    <div class="contact-us-section pb-40 px-40 position-relative"
                        @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        <div class="position-absolute vector-all vector-8">
                            <img src={{ asset('assets/img/oldVcardTemplate/vcard32/vector-8.png') }} alt="images"
                                class="w-100" />
                        </div>
                        <div class="contact-bg-img text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard32/contact-bg.png') }}"
                                alt="bg-img" />
                        </div>
                        <div class="section-heading">
                                ...
                                <div>
                                    <div class="vcard-link-card card mx-sm-3">
                                        <div class="d-flex align-items-center justify-content-center">
                                            ...
                                            <i
                                                class="icon fa-solid fa-arrow-up-right-from-square ms-2 text-secondary"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="icon-search-container mb-3" data-ic-class="search-trigger">
                                        ...
                                        <div class="share-wp-btn-div">
                                            <a href="javascript:void(0)"
                                                class="vcard32-sticky-btn vcard32-btn-group d-flex justify-content-center text-primary align-items-center rounded-0 text-decoration-none py-1 rounded-pill justify-content share-wp-btn">
