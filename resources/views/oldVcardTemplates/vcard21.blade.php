...
<head>
    ...
    {{-- css link --}}
    <link rel="stylesheet" href="{{ mix('assets/css/oldVcard/vcard21.css') }}">
...
<body>
    <div class="container p-0">
        ...
        @endif
        <div class="main-content mx-auto w-100 overflow-hidden bg-img @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
            {{-- Pwa support --}}
            ...
            <div class="banner-section">
                <div class="heart-img">
                    <img src="{{ asset('assets/img/oldVcardTemplate/vcard21/heart-img.png') }}" loading="lazy" />
                </div>
                <div class="banner-img @if ($vcard->cover_type == 2) banner-img-21 cover-video-21 @endif">
                    @php
                        $coverClass =
            ...
            <div class="profile-section px-40 @if ($vcard->cover_type == 2) profile-margin @endif">
                <div class="card flex-column align-items-end justify-content-sm-start">
                    <div class="w-100">
                        <div
                            class="card-img d-flex justify-content-center align-items-center position-relative ms-auto @if ($vcard->cover_type == 2) profile-margin-top @endif">
                            <div class="position-absolute vector-1 vector-all">
                                <img src="{{ asset('assets/img/oldVcardTemplate/vcard21/vector-1.png') }}"
                                    alt="images" class="w-100" />
                            </div>
                            <div class="position-absolute vector-2 vector-all text-end">
                                <img src="{{ asset('assets/img/oldVcardTemplate/vcard21/vector-2.png') }}"
                                    alt="images" class="w-100" />
                            </div>
                    ...
                    <div
                        class="card-body p-0 text-sm-start text-center @if ($vcard->cover_type == 2) profile-des @endif">
                        <div class="profile-name">
                            <h2 class="text-primary fs-24 mb-0">
                            ...
                            <p class="fs-16 text-gray-100 mb-0">{{ ucwords($vcard->occupation) }}</p>
                            <p class="fs-16 text-gray-100 mb-0">{{ ucwords($vcard->job_title) }}</p>
                        </div>
                    </div>
                </div>
                <div class="desc pt-30">
                    <div class="text-gray-100 fs-14 text-center mb-0">
                        {!! $vcard->description !!}
                    </div>
                </div>
                {{-- social icons --}}
                <div class="social-media pt-30 d-flex flex-wrap justify-content-center position-relative">
                    <div class="cherry-blossom-img position-absolute">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard21/cherry-blossom.png') }}"
                            loading="lazy" />
                    </div>
            ...
            @if ((isset($managesection) && $managesection['contact_list']) || empty($managesection))
                @if (getLanguage($vcard->default_language) != 'Arabic' && getLanguage($vcard->default_language) != 'Persian')
                    <div class="contact-section position-relative px-40 pt-40">
                        <div class="row row-gap-50px d-flex">
                            @if ($vcard->email)
                                <div class="col-sm-6 d-flex">
                                    <div class="contact-box d-flex align-items-center w-100">
                                        <div class="contact-icon d-flex justify-content-center align-items-center">
                                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard21/email.png') }}" />
                                        </div>
                            ...
                            @if ($vcard->phone)
                                <div class="col-sm-6 d-flex">
                                    <div class="contact-box d-flex align-items-center w-100">
                                        <div class="contact-icon d-flex justify-content-center align-items-center">
                                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard21/phone.png') }}" />
                                        </div>
                                        <div class="contact-desc">
                            ...
                            @if ($vcard->dob)
                                <div class="col-sm-6 d-flex">
                                    <div class="contact-box d-flex align-items-center w-100">
                                        <div class="contact-icon d-flex justify-content-center align-items-center">
                                            <img
                                                src="{{ asset('assets/img/oldVcardTemplate/vcard21/dob-icon.png') }}" />
                                        </div>
                                        <div class="contact-desc">
                            ...
                            @if ($vcard->location)
                                <div class="col-sm-6 d-flex">
                                    <div class="contact-box d-flex align-items-center w-100">
                                        <div class="contact-icon d-flex justify-content-center align-items-center">
                                            <img
                                                src="{{ asset('assets/img/oldVcardTemplate/vcard21/location.png') }}" />
                                        </div>
                                        <div class="contact-desc">
                ...
                @if (checkFeature('services') && $vcard->services->count())
                    <div class="our-services-section px-40 pt-60">
                        <div class="blossom-img">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard21/blossom.png') }}"
                                loading="lazy" />
                        </div>
                                    ...
                                    @foreach ($vcard->services as $service)
                                        <div>
                                            <div class="service-card my-1 h-100">
                                                ...
                                                <div class="d-flex flex-column justify-content-between card-body align-items-start">
                                                    <div>
                                                        <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
                                        ...
                                        <div class="col-sm-6 mb-sm-0 mb-40 mt-40">
                                            <div class="service-card card h-100 ">
                                                ...
                                                <div class="card-body p-0 text-center">
                                                    <h3 class="fs-18 fw-5 text-black mb-2">
                                                        {{ ucwords($service->name) }}</h3>
                                                    <p
                                                        class="card-desc mb-0 fs-14 text-gray-100  {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}">
            ...
            @if ((isset($managesection) && $managesection['appointments']) || empty($managesection))
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="appointment-section pt-60 px-30">
                        <div class="position-absolute vector-3 vector-all text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard21/vector-3.png') }}"
                                alt="images" class="w-100" />
                        </div>
                        <div class="position-absolute vector-4 vector-all">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard21/vector-4.png') }}"
                                alt="images" class="w-100" />
                        </div>
                        <div class="appointment-bg-img">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard21/appointment-bg-img.png') }}"
                                loading="lazy" />
                        </div>
                        <div class="section-heading text-center mb-40">
                        ...
                        <div class="appointment">
                            <div class="row justify-content-center">
                                <div class="col-sm-10 px-sm-0 ">
                                    ...
                                    <div class="">
                                        <button
                                            class="appointmentAdd btn fw-5 rounded-2 btn-primary w-100 d-none">{{ __('messages.make_appointments') }}</button>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            @if ((isset($managesection) && $managesection['galleries']) || empty($managesection))
                @if (checkFeature('gallery') && $vcard->gallery->count())
                    <div class="gallery-section pt-60 px-3 position-relative">
                        <div class="position-absolute vector-5 vector-all">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard21/vector-5.png') }}"
                                alt="images" class="w-100" />
                        </div>
                        <div class="position-absolute vector-6 vector-all text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard21/vector-6.png') }}"
                                alt="images" class="w-100" />
                        </div>
                        <div class="gallery-bg-img">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard21/gallery-bg-img.png') }}"
                                loading="lazy" />
                        </div>
                        <div class="section-heading text-center mb-40">
                            <h2 class="text-primary mb-0">
                ...
                @if (checkFeature('testimonials') && $vcard->testimonials->count())
                    <div class="testimonial-section pt-60 px-40">
                        <div class="testimonial-bg-img">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard21/testimonial-bg-img.png') }}"
                                loading="lazy" />
                        </div>
                        <div class="section-heading text-center mb-40">
                            <h2 class="text-primary mb-0">
                                    ...
                                    <div class="testimonial-card">
                                        <div class="card-body p-0 text-sm-start text-center">
                                            ...
                                            <div
                                                ...
                                                <div class="profile-img me-3 position-relative">
                ...
                @if (checkFeature('products') && $vcard->products->count())
                    <div class="product-section bg-gray pt-60 px-4">
                        <div class="product-bg-img">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard21/product-bg-img.png') }}"
                                loading="lazy" />
                        </div>
                        <div class="section-heading text-center mb-40">
                            <h2 class="text-primary mb-0">
                                ...
                                <div class="px-2">
                                    <div class="product-card card">
                                        ...
                                        <div class=" card-body d-flex flex-column justify-content-between w-100">
                                            <div>
                                                <div
                                                    class="product-desc d-flex justify-content-between align-items-center">
            ...
            @if ((isset($managesection) && $managesection['whatsapp_store']) || empty($managesection))
                @if ($whatsappStore->count())
                    <div class="whatsapp-store-product-section pt-40 pb-40 px-4">

                        <div class="position-absolute vector-4 vector-all">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard21/cherry-blossom.png') }}" alt="vector-img"
                                class="w-100" />
                        </div>
                                    ...
                                    <div class="card-wrapper">
                                        <div class="whatsapp-store-box card">
                                            ...
                                            <div class="whatsapp-store-content card-body text-center"
                                                ...
                                                <h3 class="whatsapp-store-name text-black fw-5 mb-3 text-center fs-18">
                                                    {{ $product->store_name }}
                                                </h3>
                ...
                @if (checkFeature('blog') && $vcard->blogs->count())
                    <div class="blog-section pt-30 px-40">
                        <div class="blog-bg-img">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard21/blog-bg-img.png') }}"
                                loading="lazy">
                        </div>
                        <div class="section-heading text-center mb-40">
                            <h2 class="text-primary mb-0 d-inline-block">
                                ...
                                <div class="slide">
                                    <div class="blog-card  card flex-sm-row "
                                        ...
                                        <div class="card-body p-0">
                                            <h6 class="card-title text-black fs-18  blog-head ">{{ $blog->title }}
                                            </h6>
                ...
                @if ($vcard->businessHours->count())
                    ...
                    <div class="business-hour-section pt-40 px-40"
                        ...
                        <div class="hour-bg-img">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard21/hour-bg-img.png') }}"
                                loading="lazy" />
                        </div>
                        <div class="section-heading text-center mb-40">
                            <h2 class="text-primary mb-0">
                            ...
                            <div class="business-hour-card row justify-content-center">
                                ...
                                @foreach ($businessDaysTime as $key => $dayTime)
                                    <div class="col-md-6 mb-3">
                                        <div
                                            class="business-hour d-flex flex-column justify-content-center align-items-center gap-2">
                                            <div class="">
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                <div class="qr-code-section pt-60 px-40 position-relative">
                    <div class="position-absolute vector-7 vector-all text-end">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard21/vector-7.png') }}" alt="images"
                            class="w-100" />
                    </div>
                    <div class="qr-bg-img">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard21/qr-code-bg-img.png') }}"
                            loading="lazy" />
                    </div>
                    <div class="section-heading text-center mb-40">
                        <h2 class="text-primary mb-0">
            ...
            @if ((isset($managesection) && $managesection['payment_link']) || empty($managesection))
                @if (checkFeature('payment_link') && $vcard->paymentLinks->count())
                    <div class="payment-link-section px-30 pb-30 position-relative"
                        @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
                <div class="contact-us-section px-40 pb-3">
                    <div class="contact-us-bg-img">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard21/contact-us-bg-img.png') }}"
                            loading="lazy" />
                    </div>
                    <div class="section-heading text-center mb-40">
                        <h2 class="text-primary mb-0">
                            ...
                            <form action="" id="enquiryForm" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 text-center">
                                        <button class="contact-btn send-btn btn rounded-2 fw-5 btn-primary"
                                            type="submit">
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
                <div class="create-vcard-section pt-30 mb-5 px-40">
                    <div class="create-vcard-bg-img">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard21/create-vcard-bg-img.png') }}"
                            loading="lazy" />
                    </div>
                ...
                <div class="fixed-btn-section">
                    @if (empty($vcard->hide_stickybar))
                        <div
                            ...
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard21/sticky.png') }}" loading="lazy">
                        </div>
                    @endif
