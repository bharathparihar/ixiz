...
<head>
    ...
    <link rel="stylesheet" href="{{ mix('assets/css/oldVcard/vcard19.css') }}">
        ...
        <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
            ...
            <div class="profile-section px-40 @if ($vcard->cover_type == 2) profile-margin @endif">
                <div class="profile-bg-img">
                    <img src="{{ asset('assets/img/oldVcardTemplate/vcard19/profile-bg-img.png') }}"
                        loading="lazy" />
                </div>
                @if (getLanguage($vcard->default_language) != 'Arabic' && getLanguage($vcard->default_language) != 'Persian')
                    <div class="card d-flex flex-sm-row  align-items-center position-relative">
                ...
                @endif
                @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian')
                    <div class="card d-flex flex-sm-row  align-items-center position-relative" dir="rtl">
                        <div class="card-img me-sm-4">
                            <img src="{{ $vcard->profile_url }}" class="w-100 h-100 object-fit-cover"
                                loading="lazy" />
                        </div>
                ...
                <div class="text-gray-100 profile-desc mb-40 fs-14 text-center position-relative">
                    {!! $vcard->description !!}
                </div>
            ...
            @if ((isset($managesection) && $managesection['contact_list']) || empty($managesection))
                        ...
                        <div class="px-3 mx-1">
                            <div class="row d-flex">
                                    ...
                                    <div class="col-sm-6 mb-40 d-flex">
                                        <div class="contact-box w-100">
                                            <div class="contact-icon d-flex justify-content-center align-items-center">
                                                <img src="{{ asset('assets/img/oldVcardTemplate/vcard19/email-icon.png') }}"
                                                    alt="" loading="lazy">
                                            </div>
                                ...
                                @if ($vcard->alternative_email)
                                    <div class="col-sm-6 mb-40 d-flex">
                                        <div class="contact-box w-100">
                                            <div class="contact-icon d-flex justify-content-center align-items-start">
                                                <img src="{{ asset('assets/img/oldVcardTemplate/vcard19/email-icon.png') }}"
                                                    alt="">
                                            </div>
                                            <div class="contact-desc">
                                ...
                                @if ($vcard->phone)
                                    <div class="col-sm-6 mb-40 d-flex">
                                        <div class="contact-box w-100">
                                            <div class="contact-icon d-flex justify-content-center align-items-start">
                                                <img src="{{ asset('assets/img/oldVcardTemplate/vcard19/phone-icon.png') }}"
                                                    alt="">
                                            </div>
                                            <div class="contact-desc">
                                ...
                                @if ($vcard->dob)
                                    <div class="col-sm-6 mb-sm-0 mb-40 d-flex">
                                        <div class="contact-box w-100">
                                            <div class="contact-icon d-flex justify-content-center align-items-start">
                                                <img src="{{ asset('assets/img/oldVcardTemplate/vcard19/dob-icon.png') }}"
                                                    alt="">
                                            </div>
                                            <div class="contact-desc">
                                ...
                                @if ($vcard->location)
                                    <div class="col-sm-6 d-flex">
                                        <div class="contact-box w-100">
                                            <div class="contact-icon d-flex justify-content-center align-items-start">
                                                <img src="{{ asset('assets/img/oldVcardTemplate/vcard19/vector.png') }}"
                                                    alt="">
                                            </div>
                                            <div class="contact-desc">
                ...
                @endif
                @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian')
                    <div class="contact-section pb-40" dir="rtl">
                        <div class="px-3 mx-1">
                            <div class="row d-flex">
                                @if ($vcard->email)
                                    <div class="col-sm-6 mb-40 d-flex">
            ...
            <div class="social-media d-flex justify-content-center">
                <div class="social-bg-img1">
                    <img src="{{ asset('assets/img/oldVcardTemplate/vcard19/social-bg-img1.png') }}"
                        loading="lazy" />
                </div>
                <div class="social-bg-img2">
                    <img src="{{ asset('assets/img/oldVcardTemplate/vcard19/social-bg-img2.png') }}"
                        loading="lazy" />
                </div>
            ...
            @if ((isset($managesection) && $managesection['galleries']) || empty($managesection))
                @if (checkFeature('gallery') && $vcard->gallery->count())
                    <div class="gallery-section pt-30 px-40 pb-3">
                        <div class="gallery-bg-img">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard19/gallery-bg-img.png') }}"
                                loading="lazy" />
                        </div>
                                    ...
                                    <div class="gallery-img">
                                        @if ($file->type == App\Models\Gallery::TYPE_IMAGE)
                                            <a href="{{ $file->gallery_image }}" data-lightbox="gallery-images"><img
                                                    ...
                                                    class="w-100 h-100 d-block" loading="lazy" /></a>
                ...
                @if (checkFeature('products') && $vcard->products->count())
                    <div class="product-section pt-40 px-40">
                        <div class="product-bg-img1">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard19/product-bg-img1.png') }}"
                                loading="lazy" />
                        </div>
                        <div class="product-bg-img2">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard19/product-bg-img2.png') }}"
                                loading="lazy" />
                        </div>
                        ...
                        <div class="">
                                ...
                                @foreach ($vcard->products as $product)
                                    <div class="">
                                        <div class="product-card card">
                                            ...
                                            <div class="product-desc card-body pt-2 d-flex flex-column justify-content-between">
                                                <div>
                                                ...
                                                <div class="d-flex justify-content-between mt-2 product-info">
                                                    <div class="text-center fs-20 fw-5 py-1 overflow-hidden">
                            ...
                            <div class="text-center me-5 mt-4 mb-3">
                                <a class="fs-6 text-decoration-underline mb-0 ms-5 mt-5 view-more"
            ...
            @if ((isset($managesection) && $managesection['whatsapp_store']) || empty($managesection))
                @if ($whatsappStore->count())
                    ...
                    <div class="whatsapp-store-product-section pt-30 px-40">
                        <div class="product-bg-img1">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard19/contact-bg-img.png') }}"
                                loading="lazy" />
                        </div>
                        <div class="product-bg-img2">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard19/testimonial-bg-img.png') }}"
                                loading="lazy" />
                        </div>
                        <div class="section-heading text-center mb-40">
                            <h2 class="text-black mb-2">{{ __('messages.feature.whatsapp_store') }}</h2>
                        </div>
                            ...
                            @foreach ($whatsappStore as $product)
                                <div>
                                    <div class="whatsapp-store-card card">
                                        ...
                                        <div class="whatsapp-store-content card-body text-center pt-2">
            ...
            @if ((isset($managesection) && $managesection['services']) || empty($managesection))
                @if (checkFeature('services') && $vcard->services->count())
                    <div class="our-services-section px-40 pt-30 pb-3">
                        <div class="section-heading text-center mb-40">
                        ...
                        <div class="services">
                            ...
                            @else
                                <div class="row">
                                    @foreach ($vcard->services as $service)
                                        <div class="col-sm-6 mb-sm-0 mb-40 mt-5">
                                            <div class="service-card h-100">
                                                <div
                                                ...
                                                <div class="card-body text-center p-0 pt-2">
                                                    <h3 class="card-title fs-18 text-black">
                ...
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="appointment-section pt-60 px-40">
                        <div class="appointment-bg-img1">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard19/appointment-bg-img1.png') }}"
                                loading="lazy" />
                        </div>
                        <div class="appointment-bg-img2">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard19/appointment-bg-img2.png') }}"
                                loading="lazy" />
                        </div>
                        <div class="section-heading text-center mb-40">
                        ...
                        <div class="appointment px-2">
                                ...
                                <div class="row">
                                    <div class="col-12 px-2">
                                        <div class="position-relative">
                                            ...
                                            <span class="calendar-icon pe-none"><svg width="20" height="20"
                            ...
                            <div class="">
                                <div class="mb-40">
                                    ...
                                    <div class="text-center">
                                        <button type="submit"
                                            class="appointmentAdd btn btn-primary w-100 rounded-2 d-none">
            ...
            @if ((isset($managesection) && $managesection['insta_embed']) || empty($managesection))
                @if (checkFeature('insta_embed') && $vcard->instagramEmbed->count())
                    <div class="mt-5 px-40">
                        <div class="section-heading text-center mb-40">
                            <h2 class="text-black mb-2">{{ __('messages.feature.insta_embed') }}</h2>
                        </div>
                        <nav>
            ...
            @if ((isset($managesection) && $managesection['linkedin_embed']) || empty($managesection))
                @if (checkFeature('linkedin_embed') && $vcard->linkedinEmbed->count())
                    <div class="pt-5 px-40">
                        <div class="section-heading text-center mb-40">
                            <h2 class="text-black mb-2">{{ __('messages.feature.linkedin_embed') }}</h2>
                        </div>
            ...
            @if ((isset($managesection) && $managesection['blogs']) || empty($managesection))
                @if (checkFeature('blog') && $vcard->blogs->count())
                    <div class="blog-section pt-40 px-40 pb-3">
                        <div class="blog-bg-img1">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard19/blog-bg-img1.png') }}"
                                loading="lazy" />
                        </div>
                                ...
                                <div class="">
                                    <div class="blog-card card">
                                        ...
                                        <div class="card-body p-2">
                                            <a href="{{ $vcardBlogUrl }}">
                                                <h2 class="fs-20 pt-2 mb-0 text-primary text-center blog-title">
                                                    {{ $blog->title }}
                                                </h2>
                                            </a>
                                        </div>
            ...
            @if ((isset($managesection) && $managesection['testimonials']) || empty($managesection))
                @if (checkFeature('testimonials') && $vcard->testimonials->count())
                    <div class="testimonial-section pt-40 pb-3 px-40">
                                    ...
                                    <div class="testimonial-card card">
                                        ...
                                        <div class="card-body p-0 pt-3">
                                            <div
                                                ...
                                                <img src="{{ asset('assets/img/oldVcardTemplate/vcard19/quote-left.png') }}"
                                            ...
                                            <div
                                                ...
                                                <img src="{{ asset('assets/img/oldVcardTemplate/vcard19/quote-right.png') }}"
                                                    class="img-fluid h-100 object-fit-cover" loading="lazy" />
                                            </div>
                                            <div class="text-center">
                                                <p
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                <div class="qr-code-section pt-60 px-40">
                    <div class="qr-bg-img">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard19/qr-bg-img.png') }}"
                            loading="lazy" />
                    </div>
                    <div class="section-heading text-center pb-40">
                        <h2 class="text-black mb-2">{{ __('messages.vcard.qr_code') }}</h2>
                    </div>
                    <div class="px-30">
                        <div class="qr-code mx-auto d-flex flex-column align-items-center position-relative">
            ...
            @if ((isset($managesection) && $managesection['business_hours']) || empty($managesection))
                @if ($vcard->businessHours->count())
                    ...
                    @endphp
                    <div class="business-hour-section my-5 px-40">
                        <div class="section-heading text-center mb-40">
                        ...
                        <div class="business-hours mt-3" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            ...
                            @foreach ($businessDaysTime as $key => $dayTime)
                                <div class="business-hour mb-2 overflow-hidden">
                                    <div class="row justify-content-between m-0">
                                        <div class="col-4 py-2 bg-primary">
                                            <span class="text-white d-flex fs-16">
                                                {{ __('messages.business.' . \App\Models\BusinessHour::DAY_OF_WEEK[$key]) }}
                                            </span>
                                        </div>
                                        <div class="col-8 py-2 text-primary fs-16">
                                            <span class="d-flex gap-2 align-items-center"><i
                                                    class="fa-regular fa-clock"></i>{{ $dayTime ?? __('messages.common.closed') }}</span>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
            ...
            @if ((isset($managesection) && $managesection['iframe']) || empty($managesection))
                @if (checkFeature('iframes') && $vcard->iframes->count())
                    <div class="blog-section pt-40 pb-3 mt-5  my-0 p-0">
                        <div class="blog-bg-img1">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard19/blog-bg-img1.png') }}"
                                loading="lazy" />
                        </div>
                        ...
                        <div class="section-heading text-center mb-40">
                            <h2 class="text-black text-center mb-2">{{ __('messages.vcard.iframe') }}</h2>
                        </div>
                        <div class="iframe-slider">
                            @foreach ($vcard->iframes as $iframe)
                                <div class="">
                                    <div class="iframe-card card mx-10" style="max-width: none">
                                        <div class="overlay">
            ...
            @if ((isset($managesection) && $managesection['payment_link']) || empty($managesection))
                @if (checkFeature('payment_link') && $vcard->paymentLinks->count())
                    <div class="payment-link-section px-30 pt-40 position-relative"
                        ...
                        <div class="section-heading text-center mb-40">
                            <h2 class="text-black text-center mb-2">{{ __('messages.vcard.payment_links') }}</h2>
                        </div>
            ...
            <div class="contact-us-section pt-30 px-30">
                ...
                @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
                    ...
                    @if (getLanguage($vcard->default_language) != 'Arabic' && getLanguage($vcard->default_language) != 'Persian')
                        <div class="contact-form mb-5 position-relative">
                    ...
                    @endif
                    @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian')
                        <div class="contact-form mb-5 position-relative" dir="rtl">
                            <form action="" id="enquiryForm" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div id="enquiryError" class="alert alert-danger d-none"></div>
            ...
            <div class="bg-img">
                <img src="{{ asset('assets/img/oldVcardTemplate/vcard19/bg-img.png') }}" loading="lazy" />
            </div>
            {{-- sticky btn --}}
                ...
                <div class="fixed-btn-section">
                    @if (empty($vcard->hide_stickybar))
                        <div
                            ...
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard19/sticky.png') }}"
                                loading="lazy" />
                        </div>
                    @endif
            ...
            @if ((isset($managesection) && $managesection['map']) || empty($managesection))
                @if ($vcard->location_type == 0 && ($vcard->location_url && isset($url[5])))
                    <div class="m-2 mt-0 position-relative">
