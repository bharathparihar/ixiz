...
<head>
    ...
    {{-- css link --}}
    <link rel="stylesheet" href="{{ mix('assets/css/oldVcard/vcard17.css') }}">
        ...
        <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
            ...
            <div class="banner-section position-relative">
                <div class="banner-img">
                    ...
                    <div class="youtube-link-17">
                        <iframe
                            src="https://www.youtube.com/embed/{{ YoutubeID($vcard->youtube_link) }}?autoplay=1&mute=0&loop=1&controls=0&playlist={{ YoutubeID($vcard->youtube_link) }}"
            ...
            <div class="profile-section px-30">
                <div class="profile-bg">
                    <img src="{{ asset('assets/img/oldVcardTemplate/vcard17/profile-bg.png') }}" loading="lazy" />
                </div>
                <div class="profile-bg-vector">
                    <img src="{{ asset('assets/img/oldVcardTemplate/vcard17/profile-bg-vector.png') }}" loading="lazy" />
                </div>
                <div class="tag-img">
                    <img src="{{ asset('assets/img/oldVcardTemplate/vcard17/tag.png') }}" loading="lazy" />
                </div>
                <div class="card align-items-center mb-3 pb-3">
                    ...
                    <div class="card-body pt-30 pb-0 px-0 text-center">
                        <div class="profile-name">
                            <h4 class="text-primary fs-24 mb-0 fw-bold">
                                {{ ucwords($vcard->first_name . ' ' . $vcard->last_name) }}
                                @if ($vcard->is_verified)
                                    <i class="verification-icon bi-patch-check-fill"></i>
                                @endif
                            </h4>
                            <p class="fs-18 text-orange mb-0 fw-5">{{ ucwords($vcard->company) }}</p>
                            <p class="fs-16 text-gray-300 mb-0 fw-5">{{ ucwords($vcard->occupation) }}</p>
                            <p class="fs-16 text-gray-300 mb-0 fw-5">{{ ucwords($vcard->job_title) }}</p>
                        </div>
                    </div>
                </div>
                {{-- social media icon --}}
                <div class="vcard-seventeen__social social-media pt-0 py-3 position-relative mt-0">
                    @if (checkFeature('social_links') && getSocialLink($vcard))
                        <div
                            class="social-media-icons d-flex justify-content-center  flex-wrap">
            ...
            @if ((isset($managesection) && $managesection['contact_list']) || empty($managesection))
                @if (getLanguage($vcard->default_language) != 'Arabic' && getLanguage($vcard->default_language) != 'Persian')
                    <div class="contact-section pt-40 pb-40">
                        <div class="px-30 position-relative">
                            <div class="row">
                                @if ($vcard->email)
                                    <div class="col-sm-6 mb-4">
                                        <div class="contact-wrapper mb-2 bg-pink h-100">
                                        <div class="contact-box h-100">
                                            <div
                                                class="contact-icon d-flex justify-content-center align-items-center bg-pink mb-2">
                                                <img src="{{ asset('assets/img/oldVcardTemplate/vcard17/email.png') }}" class="w-100"/>
                                            </div>
                                            <div class="contact-desc pt-2">
                                ...
                                @if ($vcard->phone)
                                    <div class="col-sm-6 mb-4">
                                        <div class="contact-wrapper mb-2 bg-orange h-100">
                                        <div class="contact-box h-100">
                                            <div
                                                class="contact-icon d-flex justify-content-center align-items-center bg-orange mb-2">
                                                <img src="{{ asset('assets/img/oldVcardTemplate/vcard17/phone.png') }}" class="w-100"/>
                                            </div>
                                            <div class="contact-desc pt-2">
                                                <a href="tel:+{{ $vcard->region_code }}{{ $vcard->phone }}"
                                                    class="text-primary fs-14 fw-5" dir="ltr">+{{ $vcard->region_code }}
                                                    {{ $vcard->phone }}</a>
                                            </div>
                                        </div>
                                        </div>
                                        ...
                                        <div class="contact-box h-100">
                                            ...
                                            <div class="contact-desc pt-2">
                                                <a href="tel:+{{ $vcard->alternative_region_code }}{{ $vcard->alternative_phone }}"
                                                    class="text-primary fs-14 fw-5" dir="ltr">+{{ $vcard->alternative_region_code }}
                                ...
                                @if ($vcard->dob)
                                    <div class="col-sm-6 mb-4">
                                        <div class="contact-wrapper mb-2 bg-blue h-100">
                                        <div class="contact-box h-100">
                                            <div
                                                class="contact-icon d-flex justify-content-center align-items-center bg-blue mb-2">
                                                <img src="{{ asset('assets/img/oldVcardTemplate/vcard17/dob-icon.png') }}" class="w-100"/>
                                            </div>
                                            <div class="contact-desc pt-2">
                                ...
                                @if ($vcard->location)
                                    <div class="col-sm-6 mb-4">
                                        <div class="contact-wrapper mb-2 bg-purple h-100">
                                        <div class="contact-box h-100">
                                            <div
                                                class="contact-icon d-flex justify-content-center align-items-center bg-purple mb-2">
                                                <img src="{{ asset('assets/img/oldVcardTemplate/vcard17/location.png') }}" class="w-100"/>
                                            </div>
                                            <div class="contact-desc pt-2">
                ...
                @endif
                @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian')
                    <div class="contact-section pt-40 pb-40" dir="rtl">
                        <div class="px-30 position-relative">
                            <div class="row">
                                @if ($vcard->email)
                                    <div class="col-sm-6 mb-4">
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                <div class="qr-code-section pt-60">
                    <div class="qr-bg-img">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard17/qr-bg-img.png') }}" loading="lazy" />
                    </div>
                    <div class="code-img">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard17/code.png') }}" loading="lazy" />
                    </div>
                                ...
                                <div class="row d-flex align-items-stretch">
                                    @foreach ($vcard->services as $service)
                                        <div class="col-sm-6 mb-40 d-flex">
                                            <div class="service-card d-flex flex-column align-items-center gap-2 h-100 w-100"
                                                @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                                <div class="card-img d-flex justify-content-center align-items-center me-sm-4 me-3 ms-3 flex-shrink-0">
                                                    <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
                                                ...
                                                <div class="card-body p-0 d-flex flex-column flex-grow-1">
                                                    <h3 class="card-title fs-18 text-primary text-center">
                                                        {{ ucwords($service->name) }}
                                                    </h3>
                                                    <p class="mb-0 text-gray-300 text-center flex-grow-1 {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}">
                ...
                @if (checkFeature('gallery') && $vcard->gallery->count())
                    <div class="gallery-section mt-4 px-sm-0">
                        <div class="phyton-img">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard17/phyton.png') }}" loading="lazy" />
                        </div>
                        <div class="section-heading text-center mb-40">
                                    ...
                                    <div class="slide">
                                        <div class="gallery-img">
                                            @if ($file->type == App\Models\Gallery::TYPE_IMAGE)
                                                <a href="{{ $file->gallery_image }}"
                                                    data-lightbox="gallery-images"><img
                                                        ...
                                                        class="w-100 bg-white rounded-20px" loading="lazy" /></a>
                                            @elseif($file->type == App\Models\Gallery::TYPE_FILE)
                                                <a id="file_url" href="{{ $file->gallery_image }}"
                                                    class="gallery-link gallery-file-link bg-white rounded-20px" target="_blank"
                                                    loading="lazy">
                                            ...
                                            @elseif($file->type == App\Models\Gallery::TYPE_VIDEO)
                                                <div class="d-flex align-items-center video-container bg-white rounded-20px">
                                                    <video width="100%" height="100%" controls>
                                                        <source src="{{ $file->gallery_image }}">
                                                    </video>
                                                </div>
                                            @elseif($file->type == App\Models\Gallery::TYPE_AUDIO)
                                                <div class="audio-container mt-2 bg-white rounded-20px">
                                            ...
                                            @else
                                                <iframe
                                                    ...
                                                    class="w-100 h-100 bg-white rounded-20px">
                                                </iframe>
                                            @endif
                                        </div>
                                    </div>
            ...
            @if ((isset($managesection) && $managesection['products']) || empty($managesection))
                @if (checkFeature('products') && $vcard->products->count())
                    <div class="product-section pt-60">
                        <div class="java-img">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard17/java.png') }}" loading="lazy" />
                        </div>
                        <div class="section-heading text-center mb-40">
                            <h2 class="text-primary fw-bold">{{ __('messages.plan.products') }}</h2>
                        </div>
                        <div class="product-slider pt-2 pb-4">
                            @foreach ($vcardProducts as $product)
                                <div>
                                    <a @if ($product->product_url) href="{{ $product->product_url }}" @endif
                                        target="_blank" class="text-decoration-none fs-6 card-wrapper">
                                        <div class="card product-card">
                                            <div class="card-img">
                                                <img src="{{ $product->product_icon }}"
                                                    class="h-100 w-100 object-fit-contain" loading="lazy" />
                                            </div>
                                            <div class="bg-primary-light card-body w-100 d-flex flex-column justify-content-between">
                                                <div>
                                                ...
                                                <div class="d-flex justify-content-between mt-2 product-info">
                                                    <div class="product-amount text-primary">
            ...
            @if ((isset($managesection) && $managesection['whatsapp_store']) || empty($managesection))
                @if ($whatsappStore->count())
                    <div class="whatsapp-store-product-section">
                        <div class="java-img">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard17/phyton.png') }}" loading="lazy" />
                        </div>
                        <div class="section-heading text-center mb-40">
                            <h2 class="text-primary fw-bold">{{ __('messages.feature.whatsapp_store') }}</h2>
                        </div>

                        <div class="whatsapp-store-slider pt-2 pb-4">
                            @foreach ($whatsappStore as $product)
                                <div>
                                    <div class="card whatsapp-store-box">
                                        ...
                                        <div class="whatsapp-store-content bg-pink-light card-body d-flex flex-column justify-content-center align-items-center"
                                            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>

                                            <h3 class="whatsapp-store-name text-primary fw-5 text-center fs-18">
                                                {{ $product->store_name }}
                                            </h3>
                    ...
                    <div class="testimonial-section pb-5">
                        ...
                        <div class="bg">
                            <div class="testimonial-bg">
                                <img src="{{ asset('assets/img/oldVcardTemplate/vcard17/testimonial-bg.png') }}"
            ...
            @if ((isset($managesection) && $managesection['linkedin_embed']) || empty($managesection))
                @if (checkFeature('linkedin_embed') && $vcard->linkedinEmbed->count())
                    <div class="mzt-5">
                        <div class="section-heading text-center mb-5">
                            <h2 class="text-primary">{{ __('messages.feature.linkedin_embed') }}</h2>
                        </div>
            ...
            @if ((isset($managesection) && $managesection['blogs']) || empty($managesection))
                @if (checkFeature('blog') && $vcard->blogs->count())
                    <div class="blog-section px-3 pt-60 pb-60">
                        <div class="c-language-img">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard17/c++.png') }}" loading="lazy" />
                        </div>
                        <div class="section-heading text-center mb-40">
                                ...
                                <div class="">
                                    ...
                                    <div class="blog-card blog-1 card">
                                        ...
                                        <div class="card-body d-flex flex-column justify-content-end">
                                            <a href="{{ $vcardBlogUrl  }}">
                                                <h6 class="card-title text-pink fw-5 fs-20">{{ $blog->title }}</h6>
                                            </a>
                                        </div>
                                    </div>
                                </div>
            ...
            @if ((isset($managesection) && $managesection['business_hours']) || empty($managesection))
                @if ($vcard->businessHours->count())
                    ...
                    @endphp
                    <div class="business-hour-section pt-2 px-30 mb-3"
                        @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        <div class="section-heading text-center mb-40">
                            ...
                            <div class="business-hour-card mt-40">
                                <div class="row">
                                    ...
                                    @foreach ($businessDaysTime as $key => $dayTime)
                                        <div class="col-sm-6">
                                        <div class="business-hour d-flex flex-column align-items-center gap-2 justify-content-between mb-2">
                                            <span
                                                class="days d-flex gap-2 align-items-center">
                                              <div class="days-icon">
                ...
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="appointment-section pt-60 pb-60 px-30">
                        <div class="appointment-bg">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard17/appointment-bg.png') }}" loading="lazy" />
                        </div>
                        <div class="html-img">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard17/html.png') }}" loading="lazy" />
                        </div>
                        <div class="section-heading text-center mb-40">
                        ...
                        <div class="appointment">
                            <div class="mb-20">
                                <div class="position-relative">
                                    {{ Form::text('date', null, ['class' => 'date form-control bg-white appointment-input', 'placeholder' => __('messages.form.pick_date'), 'id' => 'pickUpDate']) }}
                                    <span class="calendar-icon">
                                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard17/Vector.png') }}" loading="lazy" />
                                    </span>
                                </div>
                            </div>
                            <div class="">
                                ...
                                <div class="text-center">
                                    <button type="submit"
                                        class="appointmentAdd rounded-2 appoint-btn btn btn-primary w-100 d-none">
            ...
            @if ((isset($managesection) && $managesection['iframe']) || empty($managesection))
                @if (checkFeature('iframes') && $vcard->iframes->count())
                    <div class="blog-section px-3  pb-30 mb-3">
                        <div class="c-language-img">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard17/c++.png') }}" loading="lazy" />
                        </div>
                        <div class="section-heading text-center mb-40">
            ...
            @if ((isset($managesection) && $managesection['payment_link']) || empty($managesection))
                @if (checkFeature('payment_link') && $vcard->paymentLinks->count())
                    <div class="payment-link-section px-30 position-relative"
                        @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        <div class="php-tag">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard17/php.png') }}" loading="lazy" />
                        </div>
                        <div class="section-heading text-center mb-40">
                            <h2 class="text-primary">{{ __('messages.vcard.payment_links') }}</h2>
                        </div>
                    ...
                    @if (getLanguage($vcard->default_language) != 'Arabic' && getLanguage($vcard->default_language) != 'Persian')
                        <div class="contact-form">
                            <div class="contact-icon">
                                <img src="{{ asset('assets/img/oldVcardTemplate/vcard17/code.png') }}" />
                            </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <label class="form-check-label fs-14" for="privacyPolicyCheckbox">
                                                ...
                                                <a href="{{ $vcardPrivacyAndTerm }}"
                                                    target="_blank"
                                                    class="text-decoration-none link-info fw-5">{!! __('messages.vcard.term_and_condition') !!}</a>
                                                <span class="text-gray-300">&</span>
                                                <a href="{{ $vcardPrivacyAndTerm }}"
                                                    target="_blank"
                                                    class="text-decoration-none link-info fw-5">{{ __('messages.vcard.privacy_policy') }}</a>
                                            </label>
                                        </div>
                                    @endif
                        ...
                        <div class="vcard-link-card card">
                            <div class="d-flex align-items-center justify-content-center">
                                <a target="_blank"
                                    ...
                                    <i class="icon fa-solid fa-arrow-up-right-from-square ms-3 text-orange"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            @if ((isset($managesection) && $managesection['map']) || empty($managesection))
                @if ($vcard->location_type == 0 && ($vcard->location_url && isset($url[5])))
                    <div class="m-2 mt-0 @if(!$vcard->enable_affiliation) pt-60 @endif">
            ...
            @if ($vcard->enable_contact)
                <div class="add-to-contact-section px-30">
                    <div class="text-center mb-2" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        @if ($contactRequest == 1)
                            <a href="{{ Auth::check() ? route('add-contact', $vcard->id) : 'javascript:void(0);' }}"
                                class="vcard17-sticky-btn add-contact-btn  d-flex justify-content-center align-items-center rounded px-5 text-decoration-none py-1  justify-content-center
                ...
                <div class="fixed-btn-section">
                    @if (empty($vcard->hide_stickybar))
                        <div
                            ...
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard17/sticky.png') }}" loading="lazy" />
                        </div>
                    @endif
                    ...
                    <div class="modal-body">
                        ...
                        <form action="" method="post" id="newsLatterForm">
                            ...
                            <div class="mb-1 mt-1 d-flex gap-1 justify-content-center align-items-center email-input">
                                <div class="w-100">
                                    <input type="email" class="text-white form-control bg-dark border-dark email-input w-100"
