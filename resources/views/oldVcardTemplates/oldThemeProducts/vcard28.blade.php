...
<body>
    <div class="container p-0">
        <div class="vcard-twentyeight bg-light main-content  w-100 mx-auto content-blur allSection collapse show">
                            ...
                            <div class="product-card card mb-10">
                                <div class="product-img card-img">
                                    <a @if ($product->product_url) href="{{ $product->product_url }}" @endif
                                        ...
                                        <div
                                            class=" {{ $product->media->count() < 2 ? 'd-flex justify-content-center' : '' }} product-img-slider-28 overflow-hidden">
                                            @foreach ($product->media as $media)
                                                <div>
                                                    <div
                                                        class="product-img-height h-100 text-center mt-0 pb-2 w-100 mx-auto rounded-2">
