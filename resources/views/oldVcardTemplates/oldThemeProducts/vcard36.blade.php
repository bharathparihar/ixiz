...
<head>
    ...
    <link rel="stylesheet" href="{{ mix('assets/css/oldVcard/vcard36.css') }}">
...
<body>
    <div class="container p-0">
        <div class="vcard-thirtysix main-content bg-light  w-100 mx-auto content-blur allSection collapse show">
            <div class="vcard-one__product py-3 mt-0">
                <div class="row justify-content-between" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                    ...
                    <div class="col-4 mt-6 text-center">
                        <a class="back-btn text-decoration-none  text-black" href="{{ $vcardUrl }}"
                                        ...
                                        <div
                                            ...
                                            @foreach ($product->media as $media)
                                                <img src="{{ $media->getUrl() }}" alt="{{ $product->name }}"
                                                    class="text-center mt-0 pb-2 mt-5 object-fit-contain rounded-2"
