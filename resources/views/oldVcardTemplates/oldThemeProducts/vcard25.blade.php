...
<body>
    <div class="container p-0">
        <div class="vcard-twentyfive main-content  w-100 mx-auto content-blur allSection collapse show">
                    ...
                    @foreach ($vcard->products as $product)
                        <div class="px-2">
                            <div class="product-card card card-margin mb-10">
                                        ...
                                        <div
                                            ...
                                            @foreach ($product->media as $media)
                                                <img src="{{ $media->getUrl() }}" alt="{{ $product->name }}"
                                                    class="text-center mt-0 pb-2 object-fit-contain rounded-2"
                                ...
                                <div class=" card-body">
                                    <h3 class="text-black fs-18 fw-5 mb-0 mb-2">{{ $product->name }}</h3>

                                    <p class="fs-14 text-dark mb-0 pb-2">{{ $product->description }}</p>

                                    <div class="product-amount fw-bold fs-18">
                                        @if ($product->currency_id && $product->price)
                                            <span class="fs-18 fw-6"
                                                product-price-{{ $product->id }}">{{ currencyFormat($product->price, 2, $product->currency->currency_code) }}</span>
                                        @elseif($product->price)
                                            <span class="fs-18 fw-6"
                                                product-price-{{ $product->id }}">{{ currencyFormat($product->price, 2, getUserCurrencyIcon($vcard->user->id)) }}</span>
                                        @endif
                                    </div>
