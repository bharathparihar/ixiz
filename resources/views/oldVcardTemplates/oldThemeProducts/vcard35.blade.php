...
<head>
    ...
    <link rel="stylesheet" href="{{ mix('assets/css/oldVcard/vcard35.css') }}">
    {{-- google font --}}
...
<body>
    <div class="container p-0">
        <div class="vcard-thirtyfive main-content w-100 mx-auto content-blur allSection collapse show">
