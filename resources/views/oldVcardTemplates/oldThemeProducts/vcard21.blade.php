...
<body>
    <div class="container p-0">
        <div class="vcard-twentyone bg-light main-content  w-100 mx-auto content-blur allSection collapse show">
                                            ...
                                            <div>
                                                <div class="product-img-height h-100 text-center mt-5 p-2 w-100 mx-auto">
                                                    <img src="{{ $media->getUrl() }}" alt="{{ $product->name }}"
                                                        class="mt-3 object-fit-contain h-100 w-100" loading="lazy">
                                                </div>
                                            </div>
                                            @endforeach
                                        </div>
