    ...
    <div class="container p-0">
        <div class="vcard-twentynine main-content  w-100 mx-auto content-blur allSection collapse show">
            <div class="vcard-one__product py-3 mt-0">
                <div class="row m-0 justify-content-between" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                    <div class="col-6">
                        <h4 class="product-heading text-white py-5">{{ __('messages.vcard.products') }}</h4>
                    </div>
