            ...
            <div class="vcard-one__product py-3 mt-0">
                <div class="row justify-content-between" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                    ...
                    <div class="col-4 mt-8 text-center">
                        <a class="back-btn text-decoration-none" id="product-back"
                            href="{{ $vcardUrl }}"
                            data-button-style="{{ isset($vcard->dynamic_vcard) && !$vcard->dynamic_vcard->isEmpty() ? $vcard->dynamic_vcard[0]->button_style : 'default' }}"
                                        ...
                                        <div
                                            ...
                                            @foreach ($product->media as $media)
                                                <img src="{{ $media->getUrl() }}" alt="{{ $product->name }}"
                                                    class="text-center mt-0 pb-2 object-fit-contain" height="208px"
                                                    loading="lazy">
                                            @endforeach
                                        </div>
                                    </a>
                                ...
                                <div class="card-body card-padding">
                                    ...
                                    @if (!empty($product->price))
                                        <div class="my-5 text-center">
                                            <button class="buy-product text-decoration-none"
                                                data-button-style="{{ isset($vcard->dynamic_vcard) && !$vcard->dynamic_vcard->isEmpty() ? $vcard->dynamic_vcard[0]->button_style : 'default' }}"
                                            ...
                                            @if ($product->product_url)
                                                <div class="ms-1 my-5">
                                                    <a href="{{ $product->product_url ?? 'javascript:void(0)' }}"
                                                        ...
                                                        class="btn btn-product-enquiry text-decoration-none @if(!$product->product_url) disabled @endif"
                                                        data-button-style="{{ isset($vcard->dynamic_vcard) && !$vcard->dynamic_vcard->isEmpty() ? $vcard->dynamic_vcard[0]->button_style : 'default' }}">
