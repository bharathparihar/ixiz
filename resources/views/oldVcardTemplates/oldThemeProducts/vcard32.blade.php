...
<head>
    ...
    <link rel="stylesheet" href="{{ mix('assets/css/oldVcard/vcard32.css') }}">
...
<body>
    <div class="container p-0">
        <div class="vcard-thirtytwo main-content bg-light  w-100 mx-auto content-blur allSection collapse show">
            <div class="vcard-one__product py-3 mt-0">
                ...
                <div class="product-slider">
                    @foreach ($vcard->products as $product)
                        <div class="px-2">
                            <div class="product-card card card-margin mb-10">
                                    ...
                                    <div class="product-desc d-flex justify-content-between align-items-center"
                                        ...
                                        <div class="product-amount text-primary fw-bold fs-18">
                                            @if ($product->currency_id && $product->price)
                                                <span
                                                    class="fs-18 fw-6 text-gray  product-price-{{ $product->id }}">{{ currencyFormat($product->price, 2, $product->currency->currency_code) }}</span>
                                            @elseif($product->price)
                                                <span
                                                    class="fs-18 fw-6 text-gray   product-price-{{ $product->id }}">{{ currencyFormat($product->price, 2, getUserCurrencyIcon($vcard->user->id)) }}</span>
                                            @endif
                                        </div>
                                    </div>
