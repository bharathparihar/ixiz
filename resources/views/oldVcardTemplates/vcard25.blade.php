...
<head>
    ...
    {{-- css link --}}
    <link rel="stylesheet" href="{{ mix('assets/css/oldVcard/vcard25.css') }}">
        ...
        <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
            ...
            <div class="profile-section px-30 @if ($vcard->cover_type == 2) profile-margin @endif"
                ...
                <div class="profile-bg-img">
                    <img src="{{ asset('assets/img/oldVcardTemplate/vcard25/profile-bg-img.png') }}"
                        loading="lazy" />
                </div>
                                ...
                                <div class="col-sm-6 mb-4 pb-sm-2 px-lg-4 px-sm-3">
                                    <div class="contact-box text-center">
                                        <div
                                            ...
                                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard25/email.png') }}"
                                                loading="lazy" />
                                        </div>
                            ...
                            @if ($vcard->phone)
                                <div class="col-sm-6 mb-4 pb-sm-2 px-lg-4 px-sm-3">
                                    <div class="contact-box text-center">
                                        <div
                                            class="contact-icon d-flex justify-content-center align-items-center mx-auto mb-3">
                                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard25/phone.png') }}"
                                                loading="lazy" />
                                        </div>
                                        <div class="contact-desc">
                            ...
                            @if ($vcard->dob)
                                <div class="col-sm-6 mb-4 pb-sm-2 px-lg-4 px-sm-3">
                                    <div class="contact-box text-center">
                                        <div
                                            class="contact-icon d-flex justify-content-center align-items-center mx-auto mb-3">
                                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard25/dob-icon.png') }}"
                                                loading="lazy" />
                                        </div>
                                        <div class="contact-desc">
                            ...
                            @if ($vcard->location)
                                <div class="col-sm-6 mb-4 pb-sm-2 px-lg-4 px-sm-3">
                                    <div class="contact-box text-center">
                                        <div
                                            class="contact-icon d-flex justify-content-center align-items-center mx-auto mb-3">
                                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard25/location.png') }}"
                                                loading="lazy" />
                                        </div>
                                        <div class="contact-desc">
                ...
                @if (checkFeature('gallery') && $vcard->gallery->count())
                    <div class="gallery-section pt-60 px-30 position-relative mb-5 pb-2">
                        <div class="gallery-bg-img">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard25/gallery-bg.png') }}"
                                alt="gallery-bg" loading="lazy" />
                        </div>
                ...
                @if (checkFeature('services') && $vcard->services->count())
                    <div class="our-services-section pt-60">
                        <div class="services-bg-img">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard25/services-bg.png') }}"
                                alt="services-bg-img" loading="lazy" />
                        </div>
                                        ...
                                        <div class="col-sm-6 mb-sm-4 mb-4">
                                            <div class="service-card h-100">
                                                <div
                                                    ...
                                                    <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
                                                        class="{{ $service->service_url ? 'pe-auto w-100 h-100' : 'pe-none' }}"
                                                        target="{{ $service->service_url ? '_blank' : '' }}">
                ...
                @if (checkFeature('products') && $vcard->products->count())
                    <div class="product-section pt-60 px-30 mb-5">
                        <div class="product-bg-img text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard25/product-bg.png') }}"
                                alt="product-bg-img" loading="lazy" />
                        </div>
                        <div class="section-heading text-center mb-40">
                                ...
                                @foreach ($vcard->products as $product)
                                    <div class="">
                                        <div class="product-card card">
                                            ...
                                            <div class="product-desc align-items-center d-flex justify-content-between flex-column">
                                                <div class="w-100">
            ...
            @if ((isset($managesection) && $managesection['whatsapp_store']) || empty($managesection))
                @if ($whatsappStore->count())
                    <div class="whatsapp-store-product-section px-30 mb-5">

                        <div class="product-bg-img text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard25/create-vcard-img1.png') }}"
                                alt="product-bg-img" loading="lazy" />
                        </div>
                            ...
                            @foreach ($whatsappStore as $product)
                                <div>
                                    <div class="whatsapp-store-box card ">
                                        ...
                                        <div class="whatsapp-store-content align-items-center text-center"
                                            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                            <h3 class="whatsapp-store-name text-secondary mb-3 fw-5">
                                                {{ $product->store_name }}
                                            </h3>
                ...
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="appointment-section pt-60 px-30 mb-5 pb-2">
                        ...
                        <div class="appointment">
                            ...
                            <div class="row">
                                <div class="col-sm-2">
                                    <label class="mt-sm-3 mb-2" id="hourSection"
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <div class="mt-3">
                                        <button class="appointmentAdd  rounded-2 btn btn-primary w-100 d-none">
                ...
                @if (checkFeature('testimonials') && $vcard->testimonials->count())
                    <div class="testimonial-section pt-60 pb-5">
                        <div class="testimonial-vector-img">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard25/testimonial-vector.png') }}"
                            ...
                            @foreach ($vcard->testimonials as $testimonial)
                                <div class="">
                                    <div class="testimonial-card card flex-sm-row"
                                        @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                        <div class="testimonial-profile-img ms-3">
                                        ...
                                        <div class="card-body p-0 text-sm-start text-center">
                                            <div class="">
                                                <div class="quote-img text-center mb-3">
                                                    <img src="{{ asset('assets/img/oldVcardTemplate/vcard25/quote-img.png') }}"
                ...
                @if (checkFeature('blog') && $vcard->blogs->count())
                    <div class="blog-section pt-60 pb-5">
                        <div class="blog-bg-vector1">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard25/blog-bg-vector1.png') }}"
                                alt="blog-bg-vector" loading="lazy" />
                        </div>
                        <div class="blog-bg-vector2">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard25/blog-bg-vector2.png') }}"
                                alt="blog-bg-vector" loading="lazy" />
                        </div>
                        <div class="section-heading text-center mb-40">
                                        ...
                                        <div class="row">
                                            <div class="col-6 d-flex align-items-center">
                                                <div class="blog-vector">
                                                    <img src="{{ asset('assets/img/oldVcardTemplate/vcard25/blog-vector.png') }}"
                ...
                @if ($vcard->businessHours->count())
                    ...
                    <div class="business-hour-section pt-60 px-40 mb-5">
                        <div class="business-hour-bg">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard25/business-hour-bg.png') }}"
                                alt="bg-img" loading="lazy" />
                        </div>
                        <div class="section-heading text-center mb-40">
                        ...
                        <div class="business-hours" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            <div class="business-hour-vector1">
                                <img src="{{ asset('assets/img/oldVcardTemplate/vcard25/business-hour-vector.png') }}"
                ...
                <div class="qr-code-section pt-60 px-40">
                    ...
                    <div class="qr-code mx-auto position-relative">
                        <div class="qr-bg-img text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard25/qr-code-bg.png') }}"
                                alt="qr-bg-img" loading="lazy" />
                        </div>
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
                @if (getLanguage($vcard->default_language) != 'Arabic' && getLanguage($vcard->default_language) != 'Persian')
                    <div class="contact-us-section pt-30 px-30 position-relative">
                        <div class="contact-bg-img">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard25/contact-bg.png') }}"
                                loading="lazy" />
                        </div>
                        <div class="section-heading text-center mb-40">
                            ...
                            <form action="" id="enquiryForm" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            <label
                                                class="mb-1 fs-16 fw-5">{{ __('messages.user.your_message') }}</label>
                ...
                @endif
                @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian')
                    <div class="contact-us-section pt-30 px-30 position-relative" dir="rtl">
                        <div class="contact-bg-img">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard25/contact-bg.png') }}"
                                loading="lazy" />
                        </div>
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
                <div class="create-vcard-section pt-100">
                    <div class="create-vcard-img1">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard25/create-vcard-img1.png') }}"
                            alt="create-vcard-img" loading="lazy" />
                    </div>
                    <div class="create-vcard-img2 text-end">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard25/create-vcard-img2.png') }}"
                            alt="create-vcard-img" loading="lazy" />
                    </div>
                ...
                <div class="fixed-btn-section">
                    @if (empty($vcard->hide_stickybar))
                        <div
                            ...
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard25/sticky.png') }}"
                                loading="lazy" />
                        </div>
                    @endif
                    <div class="sub-btn d-none">
                        <div class="sub-btn-div  @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') sub-btn-div-left @endif">
                            ...
                            @if (empty($vcard->hide_stickybar))
                                <div
                                    class="{{ isset($vcard->whatsapp_share) ? 'vcard25-btn-group' : 'stickyIcon' }}">
                                    <button type="button"
