...
<head>
    ...
    {{-- css link --}}
    <link rel="stylesheet" href="{{ mix('assets/css/oldVcard/vcard24.css') }}">
        ...
        <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
            ...
            <div class="banner-section position-relative">
                <div class="banner-img cover-img">
                    ...
                    <div class="cloud-img @if ($vcard->cover_type == 2) d-none @endif">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/Cloud.png') }}" class="w-100"
                            loading="lazy" />
                    </div>
                </div>
            </div>
            <div class="profile-section pt-60 pb-60 px-30 @if ($vcard->cover_type == 2) mt-5 pt-0 @endif">
                <div class="book-img text-end">
                    <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/book.png') }}" alt="book"
                        loading="lazy" />
                </div>
                <div class="card d-flex flex-sm-row flex-column gap-3 align-items-center"
                    ...
                    <div class="card-body p-0 text-sm-start text-center">
                        <div class="profile-name">
                            ...
                            <p class="fs-16 company-name fw-5 mb-0">{{ ucwords($vcard->company) }} </p>
                            <p class="fs-14 text-pink fw-5 mb-0">{{ ucwords($vcard->occupation) }}</p>
                            <p class="fs-14 text-pink fw-5 mb-0">{{ ucwords($vcard->job_title) }}</p>
                        </div>
                    </div>
                </div>
                <div class="fs-14 text-gray-200 text-center mt-4 mb-3">
                    <p class="fs-14 text-gray-200">{!! $vcard->description !!} </p>
                </div>
                {{-- social icons --}}
            ...
            <div class="custom-link-section">
                @if (checkFeature('custom-links'))
                    <div class="custom-link d-flex flex-wrap justify-content-center mb-5 w-100 ">
            ...
            @if ((isset($managesection) && $managesection['contact_list']) || empty($managesection))
                <div class="contact-section pb-60 px-30 mb-3">
                    <div class="abc-img">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/abc.png') }}" alt="book"
                            loading="lazy" />
                    </div>
                    ...
                    @if (getLanguage($vcard->default_language) != 'Arabic' && getLanguage($vcard->default_language) != 'Persian')
                        <div class="row d-flex">
                            @if ($vcard->email)
                                <div class="col-sm-6 mb-20 d-flex">
                                    <div class="contact-box d-flex align-items-center w-100">
                                        <div class="contact-icon d-flex justify-content-center align-items-center">
                                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/email.png') }}"
                                                loading="lazy" />
                                        </div>
                            ...
                            @if ($vcard->phone)
                                <div class="col-sm-6 mb-20 d-flex">
                                    <div class="contact-box d-flex align-items-center w-100">
                                        <div class="contact-icon d-flex justify-content-center align-items-center">
                                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/phone.png') }}"
                                                loading="lazy" />
                                        </div>
                                        <div class="contact-desc">
                            ...
                            @endif
                            @if ($vcard->dob)
                                <div class="col-sm-6 mb-sm-0 mb-20 d-flex">
                                    <div class="contact-box d-flex align-items-center w-100">
                                        <div class="contact-icon d-flex justify-content-center align-items-center">
                                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/dob.png') }}"
                                                loading="lazy" />
                                        </div>
                                        <div class="contact-desc">
                            ...
                            @if ($vcard->location)
                                <div class="col-sm-6 d-flex">
                                    <div class="contact-box d-flex align-items-center w-100">
                                        <div class="contact-icon d-flex justify-content-center align-items-center">
                                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/location.png') }}"
                                                loading="lazy" />
                                        </div>
                                        <div class="contact-desc">
                ...
                @if (checkFeature('services') && $vcard->services->count())
                    <div class="our-services-section px-30">
                        <div class="pencil-img1">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/pencil-img1.png') }}"
                                alt="book" loading="lazy" />
                        </div>
                        <div class="triangle-img1 text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/triangle-img1.png') }}"
                                alt="book" loading="lazy" />
                        </div>
                        <div class="section-heading text-center">
                                            ...
                                            <div class="service-card h-100 text-start">
                                                <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
                                                    ...
                                                    <img src="{{ $service->service_icon }}"
                                                        class="card-img-top service-new-image object-fit-cover"
            ...
            @if ((isset($managesection) && $managesection['appointments']) || empty($managesection))
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="appointment-section pt-60 px-30">
                        <div class="one-img">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/one.png') }}" alt="book"
                                loading="lazy" />
                        </div>
                        <div class="red-heart-img">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/red-heart.png') }}"
                                alt="book" loading="lazy" />
                        </div>
                        <div class="yellow-star-img text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/yellow-star.png') }}"
                                alt="book" />
                        </div>
                        <div class="two-img text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/two.png') }}" alt="book"
                                loading="lazy" />
                        </div>
                        <div class="three-img">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/three.png') }}" alt="book"
                                loading="lazy" />
                        </div>
                        <div class="section-heading text-center">
                            <h2 class="mb-0">{{ __('messages.make_appointments') }}</h2>
                        </div>
                        <div class="appointment px-sm-4 mx-lg-3 pb-5">
                            <div class="mb-20">
                            ...
                            <div class="">
                                <div class="row mb-3">
                                    <div class="text-center">
                                        <button type="submit" class="appointmentAdd btn btn-pink w-100 d-none">
                ...
                @if (checkFeature('gallery') && $vcard->gallery->count())
                    <div class="gallery-section pt-60 px-30">
                        <div class="earth-img text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/earth.png') }}" alt="earth"
                                loading="lazy" />
                        </div>
                        <div class="star-img text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/star.png') }}" alt="star"
                                loading="lazy" />
                        </div>
                        <div class="section-heading text-center">
                                        ...
                                        @elseif($file->type == App\Models\Gallery::TYPE_AUDIO)
                                            <div class="audio-container mt-2">
                                                <img src="{{ asset('assets/img/music.jpeg') }}" alt="Album Cover"
                                                    class="audio-image" loading="lazy">
            ...
            @if ((isset($managesection) && $managesection['products']) || empty($managesection))
                @if (checkFeature('products') && $vcard->products->count())
                    <div class="product-section pt-60 px-3">
                        <div class="bag-img">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/bag.png') }}" alt="bag"
                                loading="lazy" />
                        </div>
                        <div class="brush-img text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/brush.png') }}" alt="brush"
                                loading="lazy" />
                        </div>
                        <div class="section-heading text-center">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <div class="product-desc card-body p-3">
                                                        <div class="d-flex flex-column">
                                                            <h3
                                                                class="text-black fs-18 fw-5 mb-1 product-name text-truncate">
                                                                {{ $product->name }}
                                                            </h3>
                                                            <div class="d-flex justify-content-between mt-2 product-info">
                                                                <p class="amount fs-18 fw-5 mb-2 text-green">
            ...
            @if ((isset($managesection) && $managesection['whatsapp_store']) || empty($managesection))
                @if ($whatsappStore->count())
                    <div class="whatsapp-store-product-section pt-50 px-3">

                        <div class="bag-img">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/lab-img2.png') }}" alt="bag"
                                loading="lazy" />
                        </div>
                                            ...
                                            <div class="mask">
                                                <div class="content">
                                                    ...
                                                    <div class="whatsapp-store-content card-body text-center"
                                                        ...
                                                        <h3
                                                            class="whatsapp-store-name text-black fs-18 fw-5 mb-2">
                                                            {{ $product->store_name }}
                                                        </h3>
            ...
            @if ((isset($managesection) && $managesection['testimonials']) || empty($managesection))
                @if (checkFeature('testimonials') && $vcard->testimonials->count())
                    <div class="testimonial-section pt-60">
                        <div class="clip-img">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/clip.png') }}" alt="clip"
                                loading="lazy" />
                        </div>
                        <div class="color-plat-img">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/color-plat.png') }}"
                                alt="color-plat" loading="lazy" />
                        </div>
                        <div class="pencil-color-img text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/pencil-color.png') }}"
                                alt="pencil-color" loading="lazy" />
                        </div>
                        ...
                        <div class="testimonial-slider">
                            @foreach ($vcard->testimonials as $testimonial)
                                <div class="">
                                    <div class="testimonial-card card d-flex flex-sm-row-reverse flex-column justify-content-center"
                                        @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                        ...
                                        <div class="card-body p-0 pe-sm-3 text-sm-start text-center ms-3">
                                            <div class="">
                ...
                @if (checkFeature('blog') && $vcard->blogs->count())
                    <div class="blog-section pt-60 px-3">
                        <div class="paper-plane-img">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/paper-plane.png') }}"
                                alt="paper-plane" loading="lazy" />
                        </div>
                        <div class="cloud-vector-img text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/cloud-vector.png') }}"
                                alt="cloud-vector" loading="lazy" />
                        </div>
                                ...
                                <div class="">
                                    <div class="blog-card card">
                                        ...
                                        <div class="card-body p-0">
                                            <h2 class="fs-6 fw-6 text-black blog-head text-center">
                                                {{ $blog->title }}
                                            </h2>
                                        </div>
                                    </div>
                ...
                @if ($vcard->businessHours->count())
                    ...
                    <div class="business-hour-section pt-60 px-30">
                        <div class="rainbow-img">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/rainbow.png') }}" alt="rainbow"
                                loading="lazy" />
                        </div>
                        <div class="triangle-img2 text-end mt-3">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/triangle-img2.png') }}"
                                alt="triangle" loading="lazy" />
                        </div>
                        <div class="section-heading text-center">
                        ...
                        <div class="">
                            <div class="business-hours row justify-content-center row-gap-20px"
                                ...
                                @foreach ($businessDaysTime as $key => $dayTime)
                                    <div class="col-sm-6">
                                        <div
                                            class="d-flex justify-content-center align-items-center business-box flex-column">
                                            <div>
                                                {{ __('messages.business.' . \App\Models\BusinessHour::DAY_OF_WEEK[$key]) . ':' }}
                                            </div>
                                            <div class="d-flex gap-2 align-items-center hour">
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                <div class="qr-code-section pt-60 px-30">
                    <div class="pencil-img2">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/pencil-img2.png') }}" alt="pencil"
                            loading="lazy" />
                    </div>
                    <div class="lab-img1 text-end">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/lab-img1.png') }}" alt="lab-img"
                            loading="lazy" />
                    </div>
                    <div class="lab-img2 text-end">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/lab-img2.png') }}" alt="lab-img"
                            loading="lazy" />
                    </div>
                    <div class="blue-heart-img text-end">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/blue-heart.png') }}"
                            alt="blue-heart" loading="lazy" />
                    </div>
                    <div class="section-heading text-center">
                        <h2 class="mb-0">{{ __('messages.vcard.qr_code') }}</h2>
                    </div>
                    <div class="qr-code-box mb-30">
                        <div class="qr-code d-flex justify-content-center align-items-center flex-wrap"
                            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
            ...
            @if ((isset($managesection) && $managesection['payment_link']) || empty($managesection))
                @if (checkFeature('payment_link') && $vcard->paymentLinks->count())
                    <div class="payment-link-section px-30 pt-30 pb-40 position-relative"
                        @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
                <div class="contact-us-section px-30 pb-1 pt-3 ">
                    <div class="crystal-img">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/crystal.png') }}" alt="crystal"
                            loading="lazy" />
                    </div>
                    <div class="apple-img">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/apple.png') }}" alt="apple"
                            loading="lazy" />
                    </div>
                    <div class="half-round-img text-end">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/half-round.png') }}"
                            alt="half-round" loading="lazy" />
                    </div>
                    <div class="section-heading text-center">
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
                <div class="">
                    <div class="create-vcard-section pt-60">
                        <div class="notes-img">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/notes.png') }}" alt="notes"
                                loading="lazy" />
                        </div>
                        <div class="fusion-img text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/fusion.png') }}" alt="fusion"
                                loading="lazy" />
                        </div>
                        <div class="ball-img text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/ball.png') }}" alt="ball"
                                loading="lazy" />
                        </div>
            ...
            @if ($vcard->enable_contact)
                <div class="bg-img">
                    <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/main-bg.png') }}" class="w-100"
                        loading="lazy" />
                </div>
                    ...
                    <div class="text-center" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        @if ($contactRequest == 1)
                            <a href="{{ Auth::check() ? route('add-contact', $vcard->id) : 'javascript:void(0);' }}"
                                class="btn btn-cyan add-contact-btn rounded {{ Auth::check() ? 'auth-contact-btn' : 'ask-contact-detail-form' }}"
            ...
            <div class="btn-section cursor-pointer @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
                <div class="fixed-btn-section">
                    @if (empty($vcard->hide_stickybar))
                        <div
                            class="bars-btn school-bars-btn @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') vcard-bars-btn-left @endif">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard24/sticky.png') }}"
                                loading="lazy" />
                        </div>
                    @endif
                    <div class="sub-btn d-none">
                        <div class="sub-btn-div @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') sub-btn-div-left @endif">
                            ...
                            @if (empty($vcard->hide_stickybar))
                                <div
                                    class="{{ isset($vcard->whatsapp_share) ? 'vcard24-btn-group' : 'stickyIcon' }}">
                                    <button type="button"
