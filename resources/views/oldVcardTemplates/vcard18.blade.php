...
<head>
    ...
    {{-- css link --}}
    <link rel="stylesheet" href="{{ mix('assets/css/oldVcard/vcard18.css') }}">
    ...
    <div class="container p-0">
        ...
        <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
            <div class="banner-section @if ($vcard->cover_type == 2) vcard-yt-link-18 @endif">
                <div class="banner-img @if ($vcard->cover_type == 2) vcard-banner-18 @endif">
                    @php
                        $coverClass =
                ...
                <img src="{{ asset('assets/img/oldVcardTemplate/vcard18/curve-shape.png') }}" class="curve-img w-100 @if($vcard->cover_type == 2) d-none @endif" loading="lazy" />
            ...
            <div class="profile-section pb-40 px-30 position-relative @if ($vcard->cover_type == 2) profile-margin @endif">
                <div class="position-absolute vector-all vector-1">
                    <img src="{{ asset('assets/img/oldVcardTemplate/vcard18/bag.png') }}" loading="lazy" class="w-100" />
                </div>
                <div class="position-absolute vector-all vector-2 text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard18/time.png') }}" loading="lazy" class="w-100" />
                </div>
                <div class="position-absolute vector-all vector-3 text-end">
                    <img src="{{ asset('assets/img/oldVcardTemplate/vcard18/appointment-bg.png') }}" loading="lazy" class="w-100" />
                </div>
                <div class="card flex-sm-row-reverse align-items-center pt-sm-0 pt-4">
                    ...
                    <div class="card-body text-start pt-sm-4 px-0 @if ($vcard->cover_type == 2) profile-detail @else pt-sm-5 @endif">
            ...
            <div class="desc px-30 pb-20 text-center fs-14">
                ...
                @if (getLanguage($vcard->default_language) != 'Arabic' && getLanguage($vcard->default_language) != 'Persian')
                    <div class="contact-section position-relative px-40 pt-40">
                        <div class="contact-bg">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard18/earth.png') }}" loading="lazy" />
                        </div>
                        ...
                        <div class="position-relative">
                            <div class="row d-flex">
                                @if ($vcard->email)
                                    <div class="col-md-6 mt-40 d-flex">
                                        <div class="contact-box d-flex align-items-center w-100">
                                            <div class="contact-icon d-flex justify-content-center align-items-center">
                                                <img src="{{ asset('assets/img/oldVcardTemplate/vcard18/email-icons.png') }}" />
                                            </div>
                                ...
                                @if ($vcard->phone)
                                    <div class="col-md-6  mt-40 d-flex">
                                        <div class="contact-box d-flex align-items-center w-100">
                                            <div class="contact-icon d-flex justify-content-center align-items-center">
                                                <img src="{{ asset('assets/img/oldVcardTemplate/vcard18/phone-icons.png') }}" />
                                            </div>
                                            <div class="contact-desc">
                                ...
                                @if ($vcard->dob)
                                    <div class="col-md-6 mt-40 d-flex">
                                        <div class="contact-box d-flex align-items-center w-100">
                                            <div class="contact-icon d-flex justify-content-center align-items-center">
                                                <img src="{{ asset('assets/img/oldVcardTemplate/vcard18/dob-icons.png') }}" />
                                            </div>
                                            <div class="contact-desc">
                                ...
                                @if ($vcard->location)
                                    <div class="col-md-6 mt-40 d-flex">
                                        <div class="contact-box d-flex align-items-center w-100">
                                            <div class="contact-icon d-flex justify-content-center align-items-center">
                                                <img src="{{ asset('assets/img/oldVcardTemplate/vcard18/location.png') }}" />
                                            </div>
                                            <div class="contact-desc">
            ...
            <div class="our-services-section px-40 pt-60">
                <div class="amount-bg">
                    <img src="{{ asset('assets/img/oldVcardTemplate/vcard18/amount.png') }}" loading="lazy" />
                </div>
                <div class="bag-bg">
                    <img src="{{ asset('assets/img/oldVcardTemplate/vcard18/bag.png') }}" loading="lazy" />
                </div>
                <div class="dollar-bg">
                    <img src="{{ asset('assets/img/oldVcardTemplate/vcard18/dollar.png') }}" loading="lazy" />
                </div>
                ...
                @if (checkFeature('products') && $vcard->products->count())
                    <div class="product-section bg-gray pt-40 px-40 pb-5">
                        <div class="product-bg">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard18/product-bg.png') }}" loading="lazy" />
                        </div>
                            ...
                            @foreach ($vcard->products as $product)
                                <div class="">
                                    ...
                                    <div class="product-desc card-body d-flex flex-column justify-content-between">
                                        <div>
                                            <h3 class="product-title text-black fw-5">
                                                {{ $product->name }}</h3>
                                        ...
                                        <div class="d-flex justify-content-between mt-2 product-info">
                                            <div class="overflow-hidden">
                                                @if ($product->currency_id && $product->price)
                                                    <span
                                                        class="product-amount text-primary fw-5 fs-6">{{ currencyFormat($product->price, 2, $product->currency->currency_code) }}</span>
                                                @elseif($product->price)
                                                    <span
                                                        class="product-amount text-primary fw-5 fs-6">{{ currencyFormat($product->price, 2, getUserCurrencyIcon($vcard->user->id)) }}</span>
                                                @endif
                                            </div>
                        ...
                        <div class="text-center mt-3">
                            <a class="fs-5 text-decoration-underline text-primary mb-0"
            ...
            @if ((isset($managesection) && $managesection['whatsapp_store']) || empty($managesection))
                @if ($whatsappStore->count())
                    <div class="whatsapp-store-product-section bg-gray px-40">
                        <div class="product-bg">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard18/product-bg.png') }}" loading="lazy" />
                        </div>
                        <div class="section-heading text-start overflow-hidden mb-40">
                        ...
                        <div class="whatsapp-store-slider">
                            @foreach ($whatsappStore as $product)
                                <div>
                                    ...
                                    <div class="whatsapp-store-content card-body d-flex flex-column justify-content-between"
                                        @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                        <div>
                                            <h3 class="whatsapp-store-name text-black fw-5">
                                                {{ $product->store_name }}
                                            </h3>
                                        </div>
                                        ...
                                        <div class="card-body text-center p-0">
                                            ...
                                            <div class="d-flex">
                                                <div class="quote-img quote-left-img">
                                                    <img src="{{ asset('assets/img/oldVcardTemplate/vcard18/quote-left-img.png') }}"
                                                        loading="lazy" />
                                                </div>
                                                <p
                                                ...
                                                <div class="quote-img quote-right-img align-self-end">
                                                    <img src="{{ asset('assets/img/oldVcardTemplate/vcard18/quote-right-img.png') }}"
                                                        loading="lazy" />
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="px-3">
                                    <div class="blog-card d-flex flex-sm-row flex-column">
                                        ...
                                        <div class="card-body text-sm-start text-center bg-white">
                                            <a href="{{ $vcardBlogUrl  }}">
                                                <h2 class="p-1 text-center fs-6 fw-5 text-black blog-head text-black">
                                                    {{ $blog->title }}
                                                </h2>
                                            </a>
                                        </div>
            ...
            @if ((isset($managesection) && $managesection['business_hours']) || empty($managesection))
                @if ($vcard->businessHours->count())
                    ...
                    <div class="business-hour-section pt-30 px-40 pb-3">
                        <div class="time-bg-1">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard18/time.png') }}" loading="lazy" />
                        </div>
                        <div class="time-bg-2">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard18/time.png') }}" loading="lazy" />
                        </div>
                        ...
                        <div class="business-hours mt-3 business-time d-flex flex-column" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            @php
            ...
            @if ((isset($managesection) && $managesection['appointments']) || empty($managesection))
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="appointment-section pt-60 pt-60 px-30 mb-40 pb-4">
                        <div class="appointment-bg">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard18/appointment-bg.png') }}" loading="lazy" />
                        </div>
                        ...
                        <div class="appointment">
                                ...
                                <div class="col-sm-10 mx-auto">
                                    <div class="position-relative">
                                        ...
                                        <span class="calendar-icon">
                                            <img src=" {{ asset('assets/img/oldVcardTemplate/vcard18/calendar.png') }}"
                                                loading="lazy" />
                                        </span>
                                    </div>
                                </div>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-sm-10 mt-3">
                                    <button type="submit" class=" appointmentAdd btn btn-primary w-100 rounded-2 d-none">
            ...
            @php
                $currentSubs = $vcard
                    ...
                    ->first();
            @endphp
            <div class="contact-us-section px-30 mb-2">
                                ...
                                <div class="row">
                                        ...
                                        <div class="mb-3">
                                            <div class="input-group mb-3">
                                                <span class="input-group-text">
                                                    <img src=" {{ asset('assets/img/oldVcardTemplate/vcard18/icon-1.png') }}" />
                                                </span>
                                    ...
                                    <div class="col-sm-6 ps-sm-2">
                                        <div class="mb-3">
                                            <div class="input-group mb-3">
                                                <span class="input-group-text">
                                                    <img src=" {{ asset('assets/img/oldVcardTemplate/vcard18/icon-2.png') }}" />
                                                </span>
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            <div class="input-group mb-3">
                                                <span class="input-group-text">
                                                    <img src=" {{ asset('assets/img/oldVcardTemplate/vcard18/icon-3.png') }}" />
                                                </span>
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
                <div class="create-vcard-section pt-30 pb-10 mb-40 px-30">
                ...
                <div class="fixed-btn-section">
                    @if (empty($vcard->hide_stickybar))
                        <div
                            ...
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard18/sticky.png') }}" loading="lazy" />
                        </div>
                    @endif
            ...
            <div class="bg-img">
                <img src="{{ asset('assets/img/oldVcardTemplate/vcard18/bg-img.png') }}" loading="lazy" />
            </div>
            {{-- map --}}
