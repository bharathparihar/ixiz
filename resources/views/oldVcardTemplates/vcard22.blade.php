...
<head>
    ...
    <style>
        :root {
            --primary-color: {{ $dynamicVcard->primary_color ?? '#6777ef' }};
            --green-100: {{ $dynamicVcard->back_color ?? '#224754' }};
            --green: {{ $dynamicVcard->back_seconds_color ?? '#0f2f3a' }};
            --black: {{ $dynamicVcard->button_text_color ?? '#2d2624' }};
            --gray-100: {{ $dynamicVcard->text_description_color ?? '#9facb0' }};
            --white: {{ $dynamicVcard->text_label_color ?? '#ffffff' }};
    ...
    {{-- css link --}}
    <link rel="stylesheet" href="{{ mix('assets/css/oldVcard/vcard22.css') }}">
...
<body>
    <div class="container p-0 vcard22-main">
        ...
        <div class="main-content mx-auto w-100 overflow-hidden bg-green @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
                ...
                <div class="banner-img">
                    ...
                    @elseif($vcard->cover_type == 1)
                        @if (strpos($vcard->cover_url, '.mp4') !== false ||
                            ...
                            <video
                                class="cover-video {{ $coverClass }}" loop autoplay muted playsinline
                            alt="background
            ...
            <div class="profile-section mb-5 px-30 @if ($vcard->cover_type == 2) profile-margin @endif">
                <div
                    class="card d-flex flex-sm-row-reverse justify-content-sm-end align-items-sm-end align-items-center mb-30">
                    <div class="card-img">
                    ...
                    <div class="card-body text-sm-start text-center profile-details px-0">
                        <div class="profile-name @if ($vcard->cover_type == 2) name-margin @endif">
                                            ...
                                            <div class="service-card h-100">
                                                <div
                                                    ...
                                                    <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
                                                        class="text-decoration-none img {{ $service->service_url ? 'pe-auto' : 'pe-none' }}"
                                                        target="{{ $service->service_url ? '_blank' : '' }}">
                                                        <img src="{{ $service->service_icon }}" class="w-100 h-100"
                                                            loading="lazy" />
                                                    </a>
                                                </div>
                                                <div class="card-body text-center p-0 d-flex flex-column align-items-center justify-content-between">
                                            <div>
                ...
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="appointment-section mb-5 pb-3 px-30">
                        ...
                        <div class="appointment">
                            ...
                            <div class="">
                                <label class="appoint-hour fs-18 mb-10 text-start" id="hourSection"
                            ...
                            @foreach ($vcard->products as $product)
                                <div class="">
                                    <div class="product-card card">
                                        ...
                                        <div class="product-desc card-body p-3 d-flex flex-column justify-content-between">
                                            <div class="mb-2">
                                                <h3 class="product-head fs-18 fw-5 mb-0 flex-grow-1 text-break"
                                                    style="min-width: 0;">{{ $product->name }}</h3>
                                                    <p class="fs-14 text-gray-100 mb-0">
                                                {{ $product->description }}
                                            </p>
                                            </div>
                                            <div class="d-flex justify-content-between mt-2 product-info">
                                                  <div class="amount fs-18 mb-0 text-primary">
            ...
            @if ((isset($managesection) && $managesection['whatsapp_store']) || empty($managesection))
                @if ($whatsappStore->count())
                    <div class="whatsapp-store-product-section px-3 mb-5 pb-3">

                        <div class="section-heading px-3">
                            <h2 class="mb-5 product-heading">{{ __('messages.feature.whatsapp_store') }}</h2>
                        </div>
                                ...
                                <div>
                                    <div class="whatsapp-store-box card">
                                        ...
                                        <div class="whatsapp-store-content card-body text-center p-3"
                                            ...
                                            <h3 class="whatsapp-store-name text-white mb-3 fw-5 text-center fs-18">
                                                {{ $product->store_name }}
                                            </h3>
                                            ...
                                            <div class="">
                                                ...
                                                <div class="d-flex justify-content-between align-items-end"
                                                    ...
                                                    <div
                                                        ...
                                                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard22/quote-img.png') }}"
            ...
            @if ((isset($managesection) && $managesection['linkedin_embed']) || empty($managesection))
                @if (checkFeature('linkedin_embed') && $vcard->linkedinEmbed->count())
                    <div class="pt-5">
                        <div class="section-heading text-start px-3 ms-3">
                            <h2 class="mb-5 insta-head">{{ __('messages.feature.linkedin_embed') }}</h2>
                        </div>
            ...
            @if ((isset($managesection) && $managesection['payment_link']) || empty($managesection))
                @if (checkFeature('payment_link') && $vcard->paymentLinks->count())
                    <div class="payment-link-section px-30 pb-30 position-relative"
                        ...
                        <div class="section-heading text-start">
                            <h2 class="blog-head">{{ __('messages.vcard.payment_links') }}</h2>
                        </div>
                                    ...
                                    @if (isset($inquiry) && $inquiry == 1)
                                        <div class="mb-3 mt-3">
                                            <div class="wrapper-file-input">
                                                <div class="input-box" id="fileInputTrigger">
                                                    <h4> <i
                                                            class="fa-solid fa-upload ms-2 mt-1"></i>{{ __('messages.choose_file') }}
                                                    </h4> <input type="file" id="attachment" name="attachment" accept=".jpg, .jpeg, .png"
                                                        hidden multiple />
                                                </div> <small>{{ __('messages.file_supported') }}</small>
                                            </div>
                    ...
                    <div class="text-center" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        @if ($contactRequest == 1)
                            <a href="{{ Auth::check() ? route('add-contact', $vcard->id) : 'javascript:void(0);' }}"
                                id="dynamic-btn"
                                data-button-style="{{ isset($dynamicVcard) ? $dynamicVcard->button_style : 'default' }}"
                                class="rounded-2 btn {{ Auth::check() ? 'auth-contact-btn' : 'ask-contact-detail-form' }}"
