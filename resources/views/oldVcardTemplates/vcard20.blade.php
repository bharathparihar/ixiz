...
<head>
    ...
    {{-- css link --}}
    <link rel="stylesheet" href="{{ mix('assets/css/oldVcard/vcard20.css') }}">
...
<body>
    <div class="container p-0">
        ...
        @endif
        <div
            class="main-content mx-auto w-100 overflow-hidden bg-gray-300 @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
            {{-- Pwa support --}}
            ...
            <div class="profile-section pb-30 px-30">
                <div class="card flex-sm-row align-items-center gap-4" dir="rtl">
                    ...
                    <div class="card-body pt-sm-0 px-0 text-sm-start text-center">
                        <div class="profile-name">
                            ...
                            <p class="fs-16 text-white fw-5 mb-0">{{ ucwords($vcard->occupation) }}</p>
                            <p class="fs-16 text-white fw-5 mb-0">{{ ucwords($vcard->job_title) }}</p>
            ...
            <div class="desc px-30 text-light">
                <div class="text-light fs-14 fw-5 text-center mb-0">
                    {!! $vcard->description !!}
                </div>
            </div>
            <div class="contact-section position-relative px-30 pt-30 pb-5">
                <div class="contact-bg-img">
                    <img src="{{ asset('assets/img/oldVcardTemplate/vcard20/contact-bg-img.png') }}"
                        loading="lazy" />
                </div>
                {{-- contact --}}
                                ...
                                @if ($vcard->phone)
                                    <div class="col-sm-6 mb-30 d-flex">
                                        <div class="contact-box w-100">
                                            <div class="contact-icon d-flex justify-content-center align-items-center">
                                                <img
                                                    src="{{ asset('assets/img/oldVcardTemplate/vcard20/phone.png') }}" />
                                            </div>
                                            <div class="contact-desc">
                                ...
                                @if ($vcard->dob)
                                    <div class="col-sm-6 mb-30 d-flex">
                                        <div class="contact-box w-100">
                                            <div class="contact-icon d-flex justify-content-center align-items-center">
                                                <img
                                                    src="{{ asset('assets/img/oldVcardTemplate/vcard20/dob-icon.png') }}" />
                                            </div>
                                            <div class="contact-desc">
                                ...
                                @if ($vcard->location)
                                    <div class="col-sm-6 mb-30 d-flex">
                                        <div class="contact-box w-100">
                                            <div class="contact-icon d-flex justify-content-center align-items-center">
                                                <img
                                                    src="{{ asset('assets/img/oldVcardTemplate/vcard20/location.png') }}" />
                                            </div>
                                            <div class="contact-desc">
            ...
            @if ((isset($managesection) && $managesection['galleries']) || empty($managesection))
                @if (checkFeature('gallery') && $vcard->gallery->count())
                    <div class="gallery-section pt-2 px-30 pb-5">
                        <div class="gallery-bg-img">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard20/gallery-bg-img.png') }}"
                                loading="lazy" />
                        </div>
            ...
            @if ((isset($managesection) && $managesection['services']) || empty($managesection))
                @if (checkFeature('services') && $vcard->services->count())
                    <div class="our-services-section px-30 py-3">
                        <div class="services-bg-img">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard20/services-bg-img.png') }}"
                                loading="lazy" />
                        </div>
                                        ...
                                        <div class="col-sm-6 mb-40 mt-15">
                                            <div class="service-card card h-100">
                                                ...
                                                <div class="card-body p-0 text-center">
                                                    <h3 class="fs-18  text-white mb-2">{{ ucwords($service->name) }}
                                                    </h3>
                                                    <p
                ...
                @if (checkFeature('testimonials') && $vcard->testimonials->count())
                    <div class="testimonial-section pb-5 mb-4">
                        <div class="testimonial-bg-img">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard20/testimonial-bg-img.png') }}"
                                loading="lazy" />
                        </div>
                ...
                @if (checkFeature('products') && $vcard->products->count())
                    <div class="product-section bg-gray pt-40 px-4">
                        <div class="product-bg-img">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard20/product-bg-img.png') }}"
                                loading="lazy" />
                        </div>
            ...
            @if ((isset($managesection) && $managesection['whatsapp_store']) || empty($managesection))
                @if ($whatsappStore->count())
                    ...
                    <div class="whatsapp-store-product-section px-4 pb-40 position-relative">

                        <div class="product-bg-img">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard20/contact-us-bg-img.png') }}"
                                loading="lazy" />
                        </div>
                                ...
                                <div>
                                    <div class="whatsapp-store-box card h-100">
                                        ...
                                        <div class="whatsapp-store-content card-body text-center"
                                            ...
                                            <h3 class="text-white whatsapp-store-name card-title fs-18 mb-3">{{ $product->store_name }}</h3>
            ...
            @if ((isset($managesection) && $managesection['appointments']) || empty($managesection))
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="appointment-section pt-40 px-30 pb-5 mb-2">
                        <div class="appointment-bg-img">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard20/appointment-bg-img.png') }}"
                                loading="lazy" />
                        </div>
                            ...
                            <div class="mb-20">
                                <div class="position-relative date-input">
                                    ...
                                    <span class="calendar-icon">
                                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard20/Vector.png') }}"
                                            loading="lazy" />
                                    </span>
                                    </span>
                                </div>
                ...
                @if (checkFeature('linkedin_embed') && $vcard->linkedinEmbed->count())
                    <div class="pt-5">
                        ...
                        <div class="linkedin-feed">
                            <div class="row overflow-hidden m-0 mt-2 row-gap-20 pb-4" loading="lazy">
                                <!-- "Post" content -->
            ...
            @if ((isset($managesection) && $managesection['blogs']) || empty($managesection))
                @if (checkFeature('blog') && $vcard->blogs->count())
                    <div class="blog-section pt-30 pb-5 px-30">
                        <div class="section-heading text-center mx-30 mb-40 overflow-hidden">
                            <h2 class=" text-white mb-1 d-inline-block">
            ...
            @if ((isset($managesection) && $managesection['business_hours']) || empty($managesection))
                @if ($vcard->businessHours->count())
                    ...
                    @endphp
                    <div class="business-hour-section pt-40 px-30 pb-5">
                        <div class="hour-bg-img">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard20/hour-bg-img.png') }}"
                                loading="lazy" />
                        </div>
                        <div class="section-heading text-center mb-40 overflow-hidden">
                            <h2 class=" text-white mb-1 d-inline-block">
                        ...
                        @if (getLanguage($vcard->default_language) != 'Arabic' && getLanguage($vcard->default_language) != 'Persian')
                            <div>
                                ...
                                @foreach ($businessDaysTime as $key => $dayTime)
                                    <div
                                        class="business-hours mb-3 d-flex align-items-center justify-content-between justify-content-center">
                                        <span
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                <div class="qr-code-section pt-60 px-30">
                    <div class="qr-code-bg-img">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard20/qr-code-bg-img.png') }}"
                            loading="lazy" />
                    </div>
                    <div class="section-heading text-center mb-40 overflow-hidden">
                        <h2 class=" text-white mb-1 d-inline-block">
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
                <div class="create-vcard-section mb-5 px-30">
            ...
            @if ($vcard->enable_contact)
                <div class="add-to-contact-section z-index-9">
                    <div class="text-center mt-2" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        @if ($contactRequest == 1)
                ...
                <div class="fixed-btn-section">
                    @if (empty($vcard->hide_stickybar))
                        <div
                            ...
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard20/sticky.png') }}"
                                loading="lazy" />
                        </div>
                    @endif
