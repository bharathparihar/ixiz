...
<head>
    ...
    {{-- css link --}}
    <link rel="stylesheet" href="{{ mix('assets/css/oldVcard/vcard31.css') }}">
    ...
    <div class="container p-0">
        ...
        <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
            ...
            <div class="banner-section position-relative">
                <div class="banner-img @if ($vcard->cover_type == 2) banner-img-31 @endif">
                    @php
                        $coverClass =
            ...
            {{-- profile section --}}
            <div class="profile-section px-30 mb-1 @if ($vcard->cover_type == 2) profile-margin @endif"
                ...
                <div class="profile-bg-img text-sm-start text-end">
                    <img src="{{ asset('assets/img/oldVcardTemplate/vcard31/profile-bg-img.png') }}" loading="lazy"
                        alt="profile-bg" />
                </div>
                <div class="card d-flex flex-sm-row">
                    ...
                    <div class="card-body bg-light">
                        <div class="profile-name">
                            ...
                            <p class="text-primary mb-0">{{ ucwords($vcard->occupation) }}</p>
                            <p class="text-primary mb-0">{{ ucwords($vcard->job_title) }}</p>
                            <p class="text-primary mb-0">{{ ucwords($vcard->company) }}</p>
                            ...
                            @if (checkFeature('social_links') && getSocialLink($vcard))
                                <div
                                    ...
                                    @foreach (getSocialLink($vcard) as $value)
                                        <span
                                            class="social-back d-flex text-decoration-none bg-gray-100 justify-content-center align-items-center m-sm-2 m-1 text-primary">
                                            {!! $value !!}
                                        </span>
                                    @endforeach
                                </div>
                            ...
                            @if ($vcard->email)
                                <div class="col-sm-6 mb-4 pb-sm-2">
                                    <div class="contact-box d-flex align-items-center">
                                        <div
                                            class="contact-icon d-flex justify-content-center align-items-center me-3">
                                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard31/email.png') }}" />
                                        </div>
                            ...
                            @if ($vcard->phone)
                                <div class="col-sm-6 mb-4 pb-sm-2">
                                    <div class="contact-box d-flex align-items-center">
                                        <div
                                            class="contact-icon d-flex justify-content-center align-items-center me-3">
                                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard31/phone.png') }}" />
                                        </div>
                                        <div class="contact-desc">
                            ...
                            @if ($vcard->dob)
                                <div class="col-sm-6 mb-sm-0 mb-4">
                                    <div class="contact-box d-flex align-items-center">
                                        <div
                                            class="contact-icon d-flex justify-content-center align-items-center me-3">
                                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard31/dob.png') }}" />
                                        </div>
                                        <div class="contact-desc">
                                            <p class="mb-0 text-secondary fs-6 fw-5">{{ $vcard->dob }}</p>
                                        </div>
                                    </div>
                                </div>
                            @endif
                                ...
                                <div class="col-sm-6">
                                    <div class="contact-box d-flex align-items-center">
                                        <div
                                            class="contact-icon d-flex justify-content-center align-items-center me-3">
                                            <img
                                                src="{{ asset('assets/img/oldVcardTemplate/vcard31/location.png') }}" />
                                        </div>
                                        <div class="contact-desc">
                                            <p class="text-secondary mb-0 fs-6 fw-5">{!! ucwords($vcard->location) !!}</p>
                                        </div>
                                    </div>
                                </div>
                            @endif
                ...
                @if (checkFeature('services') && $vcard->services->count())
                    <div class="our-services-section pt-60 px-30">
                        <div class="services-bg-img">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard31/services-bg.png') }}"
                                alt="services-bg" />
                        </div>
                        <div class="section-heading">
                                ...
                                <div class="row  services-slider-view">
                                    @foreach ($vcard->services as $service)
                                        <div class="col-sm-6 mb-sm-0 mb-40 mt-4">
                                            <div class="service-card h-100 text-start d-flex flex-column justify-content-between">
                                                <div>
                                            ...
                                            <div class="service-card h-100 text-start d-flex flex-column justify-content-between">
                                                <div>
                                                    <div class="mb-2">
                                                        ...
                                                        <h4 class="card-title fs-6 text-secondary mb-0 text-break mt-2">
                                                            {{ ucwords($service->name) }}
                                                        </h4>
                                                    </div>
                                                    <div class="card-body p-0">
                ...
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="appointment-section pt-60 px-30">
                        <div class="appointment-bg-img text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard31/make-appointment-bg.png') }}"
                                alt="appointment-bg" />
                        </div>
                        <div class="section-heading">
                        ...
                        <div class="appointment">
                            <div class="row justify-content-center">
                                <div class="col-12">
                                    <div class="mb-20">
                                        <label
                                            class="text-secondary fs-6 fw-5 mb-1 text-start">{{ __('messages.date') }}
                                            :</label>
                                    ...
                                    <label class="text-secondary fs-6 fw-5 mb-1 text-start" id="hourSection"
                                    ...
                                    <div class="mt-2 text-center">
                                        <button class="appointmentAdd btn btn-primary w-100 rounded-2 d-none">
            ...
            @if ((isset($managesection) && $managesection['galleries']) || empty($managesection))
                @if (checkFeature('gallery') && $vcard->gallery->count())
                    <div class="gallery-section pt-30">
                ...
                @if (checkFeature('products') && $vcard->products->count())
                    <div class="product-section pt-60 px-4">
                        <div class="product-bg-img text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard31/product-bg.png') }}"
                                alt="product-bg" />
                        </div>
                        <div class="section-heading px-1">
                                    ...
                                    <div class="">
                                        <div class="product-card card justify-content-end">
                                            ...
                                            <a @if ($product->product_url) href="{{ $product->product_url }}" @endif
                                                ...
                                                <div class="product-desc align-items-center desc-div d-flex flex-column justify-content-between">
                                                    <div class="w-100">
                                                        <div
                                                            class="d-flex justify-content-between align-items-center mb-1">
                                                            <h3 class="text-secondary fs-6 fw-5 mb-0 product-name">
                                                                {{ $product->name }}</h3>
                                                        </div>
                                                    ...
                                                    <div class="d-flex justify-content-between mt-2 product-info w-100">
                                                        <h4 class="text-center text-primary mb-0 fs-6 product-amount">
            ...
            @if ((isset($managesection) && $managesection['whatsapp_store']) || empty($managesection))
                @if ($whatsappStore->count())
                    <div class="whatsapp-store-product-section position-relative pt-60 px-4 pb-60">

                        <div class="product-bg-img text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard31/create-vcard-bg.png') }}"
                                alt="product-bg" />
                        </div>
                                ...
                                @foreach ($whatsappStore as $product)
                                    <div>
                                        <div class="whatsapp-store-box card justify-content-end">
                                            ...
                                            {{-- Image (matches Product structure) --}}
                                            <div class="card-img whatsapp-store-img">
                                                <img src="{{ $product->cover_url }}"
                                                    class="w-100 h-100 object-fit-contain" loading="lazy"
                                                    alt="store">
                                            </div>

                                            {{-- Description (same layout as Product) --}}
                                            <div class="whatsapp-store-content align-items-center desc-div text-center"
                                                @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>

                                                <div class="d-flex justify-content-center align-items-center mb-3">
                                                    <h3 class="text-secondary fw-5 mb-0 whatsapp-store-name fs-6">
                                                        {{ $product->store_name }}
                                                    </h3>
                                                </div>
            ...
            @if ((isset($managesection) && $managesection['testimonials']) || empty($managesection))
                @if (checkFeature('testimonials') && $vcard->testimonials->count())
                    <div class="testimonial-section pt-30 pb-60">
                        <div class="testimonial-bg-img text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard31/testimonial-bg.png') }}"
                                alt="testimonial-bg" />
                        </div>
                        <div class="section-heading px-30">
                                    ...
                                    <div class="testimonial-card card">
                                        ...
                                        <div class="card-body p-0 pt-5">
                                            <div class="text-center">
                                                <h3 class="text-primary fs-20">{{ ucwords($testimonial->name) }}</h3>
                                                <div class="quote-img text-center mb-3">
                                                    <img src="{{ asset('assets/img/oldVcardTemplate/vcard31/quote-img.png') }}"
                                                        class="mx-auto" />
                                                </div>
                                                <p
                ...
                @if (checkFeature('blog') && $vcard->blogs->count())
                    <div class="blog-section pt-60 px-3">
                        <div class="blog-bg-img text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard31/blog-bg.png') }}"
                                alt="blog-bg" />
                        </div>
                                ...
                                <div class="">
                                    <div class="blog-card">
                                        ...
                                        <div class="blog-desc text-start">
                                            <h3 class="text-primary fs-6 fw-5 mb-1 blog-head">
                                                {{ $blog->title }}
                                            </h3>
            ...
            @if ((isset($managesection) && $managesection['business_hours']) || empty($managesection))
                @if ($vcard->businessHours->count())
                    ...
                    @endphp
                    <div class="business-hour-section pt-60 mb-3">
                        <div class="hour-bg-img">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard31/hour-bg.png') }}"
                                alt="hour-bg" />
                        </div>
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                <div class="qr-code-section pt-60 px-30">
                    <div class="qr-bg-img text-end">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard31/qr-bg-img.png') }}"
                            alt="qr-bg" />
                    </div>
                    <div class="section-heading">
            ...
            @if ((isset($managesection) && $managesection['iframe']) || empty($managesection))
                @if (checkFeature('iframes') && $vcard->iframes->count())
                    <div class="blog-section pt-40 pb-40 mb-3">
                        <div class="section-heading ms-4">
            ...
            @if ((isset($managesection) && $managesection['payment_link']) || empty($managesection))
                @if (checkFeature('payment_link') && $vcard->paymentLinks->count())
                    <div class="payment-link-section px-4 position-relative"
                        @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
                <div class="create-vcard-section">
                    ...
                    <div class="add-to-contact-bg-img">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard31/add-to-contact-bg.png') }}"
                            alt="add-to-contact-bg" />
                    </div>
                    <div class="pt-60 pb-60">
                        <div class="section-heading mb-40 px-30">
                            <h2 class="mb-0">{{ __('messages.create_vcard') }}</h2>
                        </div>
                        <div class="pb-30 mb-5">
                    ...
                    <div class="text-center d-flex align-items-center justify-content-center"
                        ...
                        @if ($contactRequest == 1)
                            <a href="{{ Auth::check() ? route('add-contact', $vcard->id) : 'javascript:void(0);' }}"
                                class="add-contact-btn rounded-2 btn-primary gap-2 d-flex justify-content-center align-items-center {{ Auth::check() ? 'auth-contact-btn' : 'ask-contact-detail-form' }}"
                ...
                <div class="fixed-btn-section">
                    @if (empty($vcard->hide_stickybar))
                        <div
                            ...
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard31/sticky.png') }}" />
                        </div>
                    @endif
                    ...
                    <div class="modal-body">
                        ...
                        <form action="" method="post" id="newsLatterForm">
                            ...
                            <div class="mb-1 mt-4 d-flex gap-1 justify-content-center align-items-center email-input">
                                <div class="w-100">
                                    <input type="email"
                                        class="form-control bg-dark border-0 text-lightemail-input w-100"
