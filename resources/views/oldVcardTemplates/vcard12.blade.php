...
<head>
    ...
    <link rel="stylesheet" href="{{ mix('assets/css/oldVcard/vcard12.css') }}">
...
<body class="bg-primary-100">
    <div>
        ...
        @endif
        <div
            class="main-content mx-auto w-100 overflow-hidden bg-gray-200 @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
            {{-- Pwa support --}}
            ...
            {{-- profile --}}
            <div
                class="profile-section pb-3 px-30 position-relative @if ($vcard->cover_type == 2) profile-margin @endif">
                <div class="position-absolute vector-bg-1 vector-bg">
                    <img src="{{ asset('assets/img/oldVcardTemplate/vcard12/vector-gym-1.png') }}" alt="images" />
                </div>
                <div class="position-absolute vector-bg-2 vector-bg text-end">
                    <img src="{{ asset('assets/img/oldVcardTemplate/vcard12/vector-gym-2.png') }}" alt="images" />
                </div>
                @if (getLanguage($vcard->default_language) != 'Arabic' && getLanguage($vcard->default_language) != 'Persian')
                    <div class="card flex-column">
                        <div class="card-img d-flex justify-content-center align-items-center mx-auto">
                            <img src="{{ $vcard->profile_url }}" class="w-100 h-100" loading="lazy" />
                        </div>
                        <div class="card-body px-0">
                            <div class="position-relative text-center">
                                ...
                                <p class="fs-14 text-primary mb-2 profile-name">{{ ucwords($vcard->company) }}</p>
                                <p class="fs-16 text-white mb-0"><span class="profile-designation pt-2 fw-light">
                                        {{ ucwords($vcard->occupation) }}</span></p>
                                <p class="fs-14 text-white mb-0">{{ ucwords($vcard->job_title) }}</p>
                    ...
                    <div class="card flex-column">
                        ...
                        <div class="card-body px-0">
                            <div class="position-relative text-center">
                                ...
                                <p class="fs-14 text-primary mb-3 profile-name">{{ ucwords($vcard->company) }}</p>
                                <p class="fs-16 text-white mb-0"><span class="profile-designation pt-2 fw-light">
                                        {{ ucwords($vcard->occupation) }}</span></p>
                                <p class="fs-14 text-white mb-0">{{ ucwords($vcard->job_title) }}</p>
            ...
            <div class="text-gray-100 desc text-center px-30 pt-sm-3 pb-40">
                <p class="text-gray-100 text-center mb-0">
                    <span class="mt-4 profile-description fs-6"> {!! $vcard->description !!}</span>
                </p>
            </div>
            <div class="social-media d-flex text-light justify-content-center px-30">
            ...
            {{-- custom link section --}}
            <div class="custom-link-section mb-4">
            ...
            @if ((isset($managesection) && $managesection['contact_list']) || empty($managesection))
                <div class="contact-section position-relative px-30 ">
                    ...
                    <div class="chest-expander-img" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard12/chest-expander.png') }}"
                            alt="chest-expander" />
                    </div>
                    <div class="dumbbell-img" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard12/dumbbell.png') }}" alt="dumbbell" />
                    </div>
                    @if (getLanguage($vcard->default_language) != 'Arabic' && getLanguage($vcard->default_language) != 'Persian')
                            ...
                            <div class="row">
                                <div class="col-sm-6 mb-40">
                                    <div class="contact-box">
                                        <div
                                            class="contact-icon ms-0 me-4 mx-sm-auto d-flex justify-content-center align-items-center">
                                            <img
                                                src="{{ asset('assets/img/oldVcardTemplate/vcard12/email-icon.png') }}" />
                                        </div>
                                    ...
                                    <div class="col-sm-6 mb-40">
                                        <div class="contact-box">
                                            <div
                                                class="contact-icon ms-0 me-4 mx-sm-auto d-flex justify-content-center align-items-center">
                                                <img
                                                    src="{{ asset('assets/img/oldVcardTemplate/vcard12/phone.png') }}" />
                                            </div>
                                            <div class="contact-desc text-center">
                                    ...
                                    <div class="col-sm-6 mb-40">
                                        <div class="contact-box">
                                            <div
                                                class="contact-icon ms-0 me-4 mx-sm-auto d-flex justify-content-center align-items-center">
                                                <img
                                                    src="{{ asset('assets/img/oldVcardTemplate/vcard12/bod-icon.png') }}" />
                                            </div>
                                            <div class="contact-desc text-center">
                                    ...
                                    <div class="col-sm-6 mb-40">
                                        <div class="contact-box">
                                            <div
                                                class="contact-icon ms-0 me-4 mx-sm-auto d-flex justify-content-center align-items-center">
                                                <img
                                                    src="{{ asset('assets/img/oldVcardTemplate/vcard12/location-icon.png') }}" />
                                            </div>
                                            <div class="contact-desc text-center">
                    ...
                    @endif
                    @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian')
                        <div class="pt-3 mt-3 position-relative" dir="rtl">
                            <div class="row">
                                <div class="col-sm-6 mb-40">
                                    <div class="contact-box">
                                        <div
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                <div class="qr-code-section pb-40 px-30" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                    <div class="section-heading text-center overflow-hidden">
                        <h2 class="text-white mb-0 d-inline-block">
                                            ...
                                            <div class="service-card card h-100">
                                                <div class="card-img mb-4">
                                                    <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
                                                        ...
                                                        target="{{ $service->service_url ? '_blank' : '' }}">
                                                        <img src="{{ $service->service_icon }}"
                                                            alt="physical-fitness" class="img-fluid h-100"
                                                            loading="lazy" />
                                                    </a>
                                                </div>
            ...
            @if ((isset($managesection) && $managesection['galleries']) || empty($managesection))
                @if (checkFeature('gallery') && $vcard->gallery->count())
                    <div class="gallery-section mb-4 pb-2">
                                ...
                                @if ($file->type == App\Models\Gallery::TYPE_IMAGE)
                                    <div class="">
                                        <a href="{{ $file->gallery_image }}" data-lightbox="gallery-images"
                                            class="gallery-img"><img src="{{ $file->gallery_image }}"
            ...
            @if ((isset($managesection) && $managesection['products']) || empty($managesection))
                @if (checkFeature('products') && $vcard->products->count())
                    <div class="product-section bg-gray pb-40 px-30">
            ...
            @if ((isset($managesection) && $managesection['whatsapp_store']) || empty($managesection))
                @if ($whatsappStore->count())
                    <div class="whatsapp-store-product-section px-30 pb-40">
                        <div class="section-heading text-center overflow-hidden mx-3">
                            <h2 class="text-white mb-0 d-inline-block">
                        ...
                        <div class="whatsapp-store-slider pt-3 mt-3">
                                ...
                                <div>
                                    <div class="whatsapp-store-box card">
                                        ...
                                        <div class="whatsapp-store-content card-body text-center"
                                            ...
                                            <h3 class="whatsapp-store-name mb-3 fw-5 text-white text-center fs-18">
                                                {{ $product->store_name }}
                                            </h3>
            ...
            @if ((isset($managesection) && $managesection['testimonials']) || empty($managesection))
                @if (checkFeature('testimonials') && $vcard->testimonials->count())
                    <div class="testimonial-section pb-4" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        ...
                        <div class=" bg-black position-relative">
                            <div class="quote-img">
                                <img src="{{ asset('assets/img/oldVcardTemplate/vcard12/quote-img.png') }}"
                                    class="h-100" loading="lazy" />
                            </div>
                            <div class="bg-img">
                                <img src="{{ asset('assets/img/oldVcardTemplate/vcard12/testimonial-bg.png') }}"
                                    loading="lazy" />
                            </div>
                                                ...
                                                <div class="d-flex align-items-center justify-content-sm-start justify-content-center"
                                                    ...
                                                    <div class="profile-img me-3">
                                                        <img src="{{ $testimonial->image_url }}"
                                                            class="w-100 h-100 object-fit-cover ms-2" loading="lazy">
                                                    </div>
                                                    <div class="">
                        ...
                        <nav>
                            <div class="row insta-toggle">
                                <div class="nav nav-tabs px-0 border-0 d-flex justify-content-around" id="nav-tab"
                                    role="tablist">
                                    <button
                                        class="d-flex align-items-center justify-content-center py-2 active postbtn instagram-btn border-0"
                                    ...
                                    <button
                                        class="d-flex align-items-center justify-content-center py-2 instagram-btn reelsbtn border-0"
            ...
            @if ((isset($managesection) && $managesection['blogs']) || empty($managesection))
                @if (checkFeature('blog') && $vcard->blogs->count())
                    <div class="blog-section mt-4 pb-4">
                            ...
                            <div class="row justify-content-center">
                                ...
                                @foreach ($businessDaysTime as $key => $dayTime)
                                    <div class="col-12 col-sm-9 mx-auto">
                                        <div
                                            class="mb-10 p-1 d-flex align-items-center justify-content-between business-card overflow-hidden">
                                            <div class="fs-14 p-2 w-50 text-center">
                                                {{ __('messages.business.' . \App\Models\BusinessHour::DAY_OF_WEEK[$key]) . ':' }}
                                            </div>
                                            <div class="fs-14 p-2 w-50 text-center text-white">{!! $dayTime ?? '<span class="text-primary">' . __('messages.common.closed') . '</span>' !!}
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
            ...
            @if ((isset($managesection) && $managesection['appointments']) || empty($managesection))
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="appointment-section pt-3 pb-4 mt-3 mb-5 px-30">
                        <div class="section-heading text-center overflow-hidden">
                            <h2 class="text-white mb-0 d-inline-block">
                        ...
                        <div class="appointment mt-3 pt-3">
                            <div class="row">
                                <div class="col-8 mx-auto mb-20">
                                    <div class="position-relative">
                                        {{ Form::text('date', null, ['class' => 'form-control date appointment-input text-start', 'placeholder' => __('messages.form.pick_date'), 'id' => 'pickUpDate']) }}
                                        <span class="calendar-icon">
                                            <img
                                                src="{{ asset('assets/img/oldVcardTemplate/vcard12/calendar 1.png') }}" />
                                        </span>
                                    </div>
                                </div>
                                <div class="col-12">
                                ...
                                <div class="text-center">
                                    <button type="submit"
                                        class="btn btn-primary w-53 appointmentAdd rounded-2 d-none">
                                        {{ __('messages.make_appointments') }}
                                    </button>
                                </div>
                            </div>
            ...
            @if ((isset($managesection) && $managesection['payment_link']) || empty($managesection))
                @if (checkFeature('payment_link') && $vcard->paymentLinks->count())
                    <div class="payment-link-section px-30 pt-40 pb-40 position-relative"
                        @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
                <div class="contact-us-section mt-1">
                    <div class="section-heading text-center overflow-hidden px-30 mb-4">
                        <h2 class="text-white mb-0 d-inline-block">
                            {{ __('messages.contact_us.inquries') }}
                        </h2>
                    </div>
                    <div class="contact-after-img">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard12/contact-after-img.png') }}">
                    </div>
                    @if (getLanguage($vcard->default_language) != 'Arabic' && getLanguage($vcard->default_language) != 'Persian')
                        <div class="contact-form py-4 mt-2 position-relative px-30">
                            <form action="" id="enquiryForm" enctype="multipart/form-data">
                                ...
                                <div class="row row-gap-20">
                                    ...
                                    <div class="col-sm-12 mb-3">
                                        <div class="mb-0">
                                            <label class="text-white mb-1">{{ __('messages.user.your_message') }}
                                    ...
                                    <div class="col-12 text-center mt-4">
                                        <button class="contact-btn btn btn-primary rounded-2" type="submit">
                    ...
                    @endif
                    @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian')
                        <div class="contact-form py-4 mt-2 position-relative px-30" dir="rtl">
                            <form action="" id="enquiryForm" enctype="multipart/form-data">
                                @csrf
                                <div id="enquiryError" class="alert alert-danger d-none"></div>
                                <div class="row row-gap-20">
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
                {{-- create vcard --}}
                <div class="create-vcard-section px-30 pb-30 pt-30"
                    @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                    <div class="section-heading text-center overflow-hidden">
                        <h2 class="text-white mb-0 d-inline-block">
                    ...
                    <div @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        @if ($contactRequest == 1)
                            <a href="{{ Auth::check() ? route('add-contact', $vcard->id) : 'javascript:void(0);' }}"
                                class="add-contact-btn rounded-2 btn-primary gap-2 d-flex justify-content-center align-items-center
            ...
            <div class="btn-section cursor-pointer @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
                <div class="fixed-btn-section ">
                    @if (empty($vcard->hide_stickybar))
                        <div class="@if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') vcard-bars-btn-left @endif">
                            <div class="bars-btn gym-bars-btn ">
                                <img src="{{ asset('assets/img/oldVcardTemplate/vcard12/sticky.png') }}" />
                            </div>
                        </div>
                    @endif
                    <div class="sub-btn d-none">
                        <div class="sub-btn-div @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') sub-btn-div-left @endif">
                            ...
                            @if (empty($vcard->hide_stickybar))
                                <div
                                    class="{{ isset($vcard->whatsapp_share) ? 'vcard12-btn-group' : 'stickyIcon' }}">
                                    <button type="button"
