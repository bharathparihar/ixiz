...
<head>
    ...
    <link rel="stylesheet" href="{{ mix('assets/css/oldVcard/vcard13.css') }}">
    {{-- google Font --}}
...
<body>
    <div class="container p-0">
        ...
        <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
            ...
            {{-- profile --}}
            <div class="profile-section px-30 mb-40  @if ($vcard->cover_type == 2) profile-margin @endif">
                @if (getLanguage($vcard->default_language) != 'Arabic' && getLanguage($vcard->default_language) != 'Persian')
                    <div
                        class="card d-flex flex-sm-row align-items-sm-start align-items-center justify-content-end gap-3 position-relative">
                        <div class="position-absolute text-end vector-all vector-2">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard13/doctor-vector-2.png') }}"
                                alt="vector-images" class="w-75" />
                        </div>
                        ...
                        <div class="card-body pb-0 px-0 pt-0 position-relative">
                            <div class="@if ($vcard->cover_type == 2) profile-desc-margin @endif profile-name pt-sm-2 pe-sm-5">
                                ...
                                <p class="fs-16 fw-5 position-relative company-name mb-2">
                ...
                @endif
                @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian')
                    <div class="card d-flex flex-sm-row align-items-sm-end align-items-center justify-content-end"
                        dir="rtl">
                        <div class="card-img d-flex justify-content-center align-items-center position-relative">
                            <img src="{{ $vcard->profile_url }}" class="img-fluid banner-image" alt="banner"
                                loading="lazy" />
                ...
                @endif
                <div class="text-primary text-center profile-desc my-4">
                    <p class="mb-0">
                        {!! $vcard->description !!}
                    </p>
                </div>
            ...
            @if (checkFeature('social_links') && isset($vcard->socialLink) && getSocialLink($vcard))
                <div class="social-media d-flex justify-content-center position-relative mb-40 px-30">
                    <div class="position-absolute text-end vector-1 position-absolute">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard13/doctor-vector-1.png') }}"
                            alt="vector-images" class="w-50" />
                    </div>
                    <div class="position-absolute vector-all vector-4 position-absolute">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard13/doctor-vector-4.png') }}"
                            alt="vector-images" class="w-75" />
                    </div>
            ...
            <div class="custom-link-section position-relative">
                @if (checkFeature('custom-links'))
                    <div class="custom-link d-flex flex-wrap justify-content-center pb-4 w-100 ">
                ...
                @if (getLanguage($vcard->default_language) != 'Arabic' && getLanguage($vcard->default_language) != 'Persian')
                    <div class="contact-section">
                        <div class="section-heading position-relative text-center pb-40">
                            <h2 class="text-primary text-center mb-0 fw-bold">contact</h2>
                        </div>
                        <div class="px-3 mx-1">
                            <div class="row row-gap-16px d-flex">
                                @if ($vcard->email)
                                    <div class="col-sm-6 d-flex">
                                        <div
                                            class="contact-box d-flex align-items-center justify-content-center w-100">
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <img
                                                        src="{{ asset('assets/img//oldVcardTemplate/vcard13/email.png') }}" />
                                                </div>
                                            </div>
                                            <div class="contact-desc mt-2">
                                                <a href="mailto:{{ $vcard->email }}"
                                                    class="text-primary text-break">{{ $vcard->email }}</a>
                                            </div>
                                        </div>
                                    </div>
                                @endif
                                        ...
                                        <div
                                            ...
                                            <div class="contact-desc mt-2">
                                                <a href="mailto:{{ $vcard->alternative_email }}"
                                                    class="text-primary text-break">{{ $vcard->alternative_email }}</a>
                                            </div>
                                        </div>
                                    </div>
                                @endif
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <div
                                                    class="contact-icon d-flex justify-content-center align-items-center m-auto">
                                                    <img
                                                        src="{{ asset('assets/img/oldVcardTemplate/vcard13/phone.png') }}" />
                                                </div>
                                            </div>
                                            <div class="contact-desc mt-2">
                                                <a href="tel:+{{ $vcard->region_code }}{{ $vcard->phone }}"
                                                    class="text-primary" dir="ltr">+{{ $vcard->region_code }}
                                                    {{ $vcard->phone }}</a>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <div
                                                    class="contact-icon d-flex justify-content-center align-items-center m-auto">
                                                    <img
                                                        src="{{ asset('assets/img/oldVcardTemplate/vcard13/dob-icon.png') }}" />
                                                </div>
                                            </div>
                                            <div class="contact-desc mt-2">
                                                <p class="mb-0 text-primary">{{ $vcard->dob }}</p>
                                            </div>
                                        </div>
                                    </div>
                                @endif
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <div
                                                    class="contact-icon d-flex justify-content-center align-items-center m-auto">
                                                    <img
                                                        src="{{ asset('assets/img/oldVcardTemplate/vcard13/location.png') }}" />
                                                </div>
                                            </div>
                                            <div class="contact-desc mt-2">
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                <div class="qr-code-section mt-4 position-relative">
                    <div class="position-absolute text-end vector-all vector-5">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard13/doctor-vector-5.png') }}"
                            alt="vector-images" class="w-100" />
                    </div>
                    <div class="position-absolute vector-all vector-6">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard13/doctor-vector-9.png') }}"
                            alt="vector-images" class="w-100" />
                    </div>
                    <div class="section-heading position-relative text-center pb-40">
            ...
            @if ((isset($managesection) && $managesection['services']) || empty($managesection))
                @if (checkFeature('services') && $vcard->services->count())
                    <div class="our-services-section px-30 mt-5">
                        <div class="section-heading position-relative text-center pb-sm-3">
                            <h2 class="text-primary text-center fw-bold mb-3">{{ __('messages.vcard.our_service') }}
                            </h2>
                        </div>
                                        ...
                                        <div class="col-sm-6 mb-40">
                                            <div class="service-card h-100">
                                                ...
                                                <div class="card-body text-center p-0 mt-4">
                                                    <h3 class="card-title fs-18 text-white">
                                                        {{ ucwords($service->name) }}
                                                    </h3>
                                                    <p
                                                        class="mb-0 fs-14 fw-light text-white {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}">
            ...
            <div class="position-relative vector-bg">
                ...
                @if ((isset($managesection) && $managesection['galleries']) || empty($managesection))
                    @if (checkFeature('gallery') && $vcard->gallery->count())
                        <div class="vcard-thirteen__gallery gallery-section mt-2 px-sm-0 mb-5 pb-1">
                            <div class="section-heading position-relative text-center mb-3 pb-3">
                                <h2 class="text-primary text-center fw-bold">{{ __('messages.plan.gallery') }}</h2>
                            </div>
                ...
                @if ((isset($managesection) && $managesection['products']) || empty($managesection))
                    @if (checkFeature('products') && $vcard->products->count())
                        <div class="product-section pt-40 mb-5">
                            <div class="section-heading position-relative text-center pb-3  px-30">
                                    ...
                                    <div class="">
                                        <a @if ($product->product_url) href="{{ $product->product_url }}" @endif
                                            ...
                                            <div class="product-card">
                                                    ...
                                                    <div class="product-desc card-body w-100">
                                                    <div class="product-title">
                                                            <h3 class="text-black fs-18 fw-5 product-name">{{ $product->name }}
                                                            </h3>
                                                        </div>
                                                  <div class="d-flex gap-2 flex-sm-row flex-column justify-content-between product-info">
                                                            <div class="product-amount fs-18 text-primary text-center fw-5 mt-2">
                                                                @if ($product->currency_id && $product->price)
                                                                    <span
                                                                        class="product-amount fs-18 text-primary text-center fw-5">{{ currencyFormat($product->price, 2, $product->currency->currency_code) }}</span>
                                                                @elseif($product->price)
                                                                    <span
                                                                        class="product-amount fs-18 text-primary text-center fw-5">{{ currencyFormat($product->price, 2, getUserCurrencyIcon($vcard->user->id)) }}</span>
                                                                @endif
                                                            </div>
                                                            @if ($vcard->show_product_enquiry_btn == true)
                                                                @if ($product->product_url)
                                                                    <div class="text-center ms-auto enquiry-btn">
                            ...
                            <div class="text-center mb-3 me-3 ms-4">
                ...
                @if ((isset($managesection) && $managesection['whatsapp_store']) || empty($managesection))
                    @if ($whatsappStore->count())
                        <div class="whatsapp-store-product-section position-relative px-20 pb-30">
                            <div class="position-absolute vector-all vector-8">
                                <img src="{{ asset('assets/img/oldVcardTemplate/vcard13/doctor-vector-7.png') }}"
                                    alt="vector-images" class="w-100" />
                            </div>
                            <div class="section-heading position-relative text-center mb-3 pb-3 px-4 mt-5">
                                <h2 class="text-primary mb-0 fw-bold">{{ __('messages.feature.whatsapp_store') }}</h2>
                            </div>
                            <div>
                                    ...
                                    @foreach ($whatsappStore as $product)
                                        <div>
                                            <div class="whatsapp-store-box card">
                                                ...
                                                <div
                                                    class="whatsapp-store-content card-body d-flex flex-column justify-content-between">

                                                    <div class="whatsapp-store-name">
                                                        <h3 class="text-black text-center fs-18">
                                                            {{ $product->store_name }}
                                                        </h3>
                                                    </div>
            ...
            @if ((isset($managesection) && $managesection['testimonials']) || empty($managesection))
                @if (checkFeature('testimonials') && $vcard->testimonials->count())
                    <div class="testimonial-section pt-20 pb-4 mb-2">
                        <div class="section-heading position-relative text-center mb-3 pb-3">
                            <h2 class="text-primary text-center mb-0 fw-bold">{{ __('messages.plan.testimonials') }}
                            </h2>
                        </div>
                        ...
                        <div class="testimonial-slider">
                            @foreach ($vcard->testimonials as $testimonial)
                                <div class="px-sm-4 px-3">
                                    <div class="testimonial-card d-sm-flex justify-content-sm-start justify-content-center align-items-center"
                                        ...
                                        <div class="card-body p-0">
                                            <div
                                                ...
                                                <img src="{{ asset('assets/img/oldVcardTemplate/vcard13/quote-left.png') }}"
                                                    class="img-fluid h-100 object-fit-cover" loading="lazy" />
                                            </div>
                                            <div
                                                class="quote-right-img quote-img d-flex justify-content-center align-items-center">
                                                <img src="{{ asset('assets/img/oldVcardTemplate/vcard13/quote-right.png') }}"
                                                    class="img-fluid h-100 object-fit-cover" loading="lazy" />
                                            </div>
            ...
            @if ((isset($managesection) && $managesection['insta_embed']) || empty($managesection))
                @if (checkFeature('insta_embed') && $vcard->instagramEmbed->count())
                    <div class="my-5 position-relative">
                        ...
                        <div class="section-heading position-relative text-center mb-3 pb-3 px-4">
                            <h2 class="text-primary mb-0 fw-bold">{{ __('messages.feature.insta_embed') }}</h2>
                        </div>
                        <nav>
            ...
            @if ((isset($managesection) && $managesection['blogs']) || empty($managesection))
                @if (checkFeature('blog') && $vcard->blogs->count())
                    <div
                        class="blog-section position-relative pb-40 mb-4  @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
                        <div class="position-absolute vector-all vector-8">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard13/doctor-vector-8.png') }}"
                                alt="vector-images" class="w-100" />
                        </div>
                        <div class="section-heading position-relative text-center mb-3 pb-3 px-4 mt-5">
                            ...
                            @foreach ($vcard->blogs as $blog)
                                ...
                                <div class="">
                                    <div class="blog-card mb-sm-0 mb-5 d-flex flex-sm-row-reverse flex-column-reverse"
                                        ...
                                        <div class="card-body text-sm-start text-center p-0 pe-sm-4 ms-3">
                                            <h2 class="fs-20 text-primary blog-head"> {{ $blog->title }}</h2>
            ...
            @if ((isset($managesection) && $managesection['business_hours']) || empty($managesection))
                @if ($vcard->businessHours->count())
                    ...
                    @endphp
                    <div class="bussiness-hour-section pt-40 pb-40 position-relative">
                        <div class="position-absolute vector-all vector-9 text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard13/doctor-vector-6.png') }}"
                                alt="vector-images" class="w-100" />
                        </div>
                        ...
                        <div class="px-30">
                            <div class="bussiness-hour-card d-flex flex-column"
                                @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                @php
                                ...
                                @foreach ($businessDaysTime as $key => $dayTime)
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8 d-flex gap-3 align-items-center justify-content-center">
            ...
            @if ((isset($managesection) && $managesection['appointments']) || empty($managesection))
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="appointment-section py-3 px-sm-4 px-3 mt-2 position-relative mt-0">
                        <div class="position-absolute vector-all vector-10">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard13/doctor-vector-7.png') }}"
                                alt="vector-images" class="w-100" />
                        </div>
                        <div class="section-heading position-relative text-center mb-3 pb-3">
                            <h2 class="position-relative text-center fw-bold text-primary">
            ...
            @if ((isset($managesection) && $managesection['iframe']) || empty($managesection))
                @if (checkFeature('iframes') && $vcard->iframes->count())
                    <div class="product-section pt-40 pb-5">
                        <div class="section-heading position-relative text-center pb-3  px-30">
                            <h2 class="text-primary mb-0 fw-bold">{{ __('messages.vcard.iframe') }}</h2>
                        </div>
                        <div class="">
            ...
            @if ((isset($managesection) && $managesection['payment_link']) || empty($managesection))
                @if (checkFeature('payment_link') && $vcard->paymentLinks->count())
                    <div class="payment-link-section px-30 pb-5 position-relative"
                        @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        ...
                        <div class="section-heading position-relative text-center pb-3">
                            <h2 class="position-relative text-center fw-bold text-primary">
                                {{ __('messages.vcard.payment_links') }}</h2>
                        </div>
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
                <div class="contact-us-section pt-30 px-sm-4 px-3 mb-4 mx-3 mx-sm-4 position-relative">
                    <div class="position-absolute vector-all vector-11 text-end">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard13/doctor-vector-10.png') }}"
                            alt="vector-images" class="w-50" />
                    </div>
                    <div class="section-heading position-relative text-center mb-3 pb-3">
                        <h2 class="text-primary text-center fw-bold mb-0">{{ __('messages.contact_us.inquries') }}
                        </h2>
                    </div>
                    @if (getLanguage($vcard->default_language) != 'Arabic' && getLanguage($vcard->default_language) != 'Persian')
                                        ...
                                        <div class="my-3">
                                            <div class="wrapper-file-input">
                                                <div class="input-box form-control" id="fileInputTrigger">
                                                    ...
                                                    </h4> <input type="file" id="attachment" name="attachment" accept=".jpg, .jpeg, .png"
                                                        hidden multiple />
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
                <div class="create-vcard-section pt-40 px-30 position-relative">
                    <div class="position-absolute vector-all vector-12">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard13/doctor-vector-3.png') }}"
                            alt="vector-images" class="w-100" />
                    </div>
                    <div class="section-heading position-relative text-center mb-3 pb-3">
            ...
            {{-- add to contact --}}
            <div class="w-100 d-flex justify-content-center sticky-vcard-div mb-5">
                    ...
                    <div class="" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        @if ($contactRequest == 1)
                            <a href="{{ Auth::check() ? route('add-contact', $vcard->id) : 'javascript:void(0);' }}"
                                class="vcard13-sticky-btn add-contact-btn  d-flex justify-content-center ms-0 text-white align-items-center rounded px-5 text-decoration-none py-1  justify-content-center
                ...
                <div class="fixed-btn-section">
                    @if (empty($vcard->hide_stickybar))
                        <div
                            ...
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard13/sticky.png') }}" />
                        </div>
                    @endif
