...
<head>
    ...
    {{-- css link --}}
    <link rel="stylesheet" href="{{ mix('assets/css/oldVcard/vcard15.css') }}">
    ...
    <div class="container p-0">
        ...
        <div
            ...
            <div class="banner-section position-relative">
                ...
                <svg class="curve-shape @if ($vcard->cover_type == 2) d-none @endif" version="1.1"
            ...
            <div class="bg-primary">
                <div class="profile-section px-30 profile-border position-relative">
                    <div class="position-absolute vector-6 text-end">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard15/vector-6.png') }}" alt="images"
                            class="w-50" />
                    </div>
                    <div class="position-absolute vector-7">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard15/vector-7.png') }}" alt="images"
                            class="w-50" />
                    </div>
                    <div class="position-absolute vector-8">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard15/vector-8.png') }}" alt="images"
                            class="w-25" />
                    </div>
                    <div class="card text-start @if ($vcard->cover_type == 2) profile-margin @endif">
                        <div class="card-img d-flex justify-content-center align-items-center">
                            <img src="{{ $vcard->profile_url }}" class="img-fluid" loading="lazy" />
                        </div>
                        <div class="card-body text-start px-0 pb-0">
                            <div class="profile-name text-center">
                                <h2 class="font-cormorant vcard-profile-name mt-2">
                                    {{ ucwords($vcard->first_name . ' ' . $vcard->last_name) }}
                                    @if ($vcard->is_verified)
                                        <i class="verification-icon bi-patch-check-fill"></i>
                                    @endif
                                </h2>
                                <p class="fs-16 text-white mb-0">{{ ucwords($vcard->company) }}</p>
                                <p class="fs-14 mb-0">{{ ucwords($vcard->occupation) }}</p>
                                <p class="fs-14 mb-20">{{ ucwords($vcard->job_title) }}</p>
                                <div class="fs-14 text-center">
                                    <p class="text-primary-light mb-0 text-center fs-14">
                                        {!! $vcard->description !!}
                                    </p>
                                </div>
                            </div>
            ...
            @if ((isset($managesection) && $managesection['contact_list']) || empty($managesection))
                <div class="contact-section bg-primary position-relative">
                    <div class="section-heading text-center border-top-0">
                                    ...
                                    <div class="col-sm-6 mb-40 d-flex">
                                        <div class="contact-box d-flex align-items-center w-100">
                                            <div class="contact-icon d-flex justify-content-center align-items-center">
                                                <img
                                                    src="{{ asset('assets/img/oldVcardTemplate/vcard15/email.png') }}" />
                                            </div>
                                ...
                                @if ($vcard->phone)
                                    <div class="col-sm-6 mb-40">
                                        <div class="contact-box d-flex align-items-center">
                                            <div class="contact-icon d-flex justify-content-center align-items-center">
                                                <img
                                                    src="{{ asset('assets/img/oldVcardTemplate/vcard15/phone.png') }}" />
                                            </div>
                                            <div class="contact-desc">
                                ...
                                @if ($vcard->dob)
                                    <div class="col-sm-6 mb-40 d-flex">
                                        <div class="contact-box d-flex align-items-center w-100">
                                            <div class="contact-icon d-flex justify-content-center align-items-center">
                                                <img
                                                    src="{{ asset('assets/img/oldVcardTemplate/vcard15/dob-icon.png') }}" />
                                            </div>
                                            <div class="contact-desc">
                                ...
                                @if ($vcard->location)
                                    <div class="col-sm-6 mb-40 d-flex">
                                        <div class="contact-box d-flex align-items-center w-100">
                                            <div class="contact-icon d-flex justify-content-center align-items-center">
                                                <img
                                                    src="{{ asset('assets/img/oldVcardTemplate/vcard15/location.png') }}" />
                                            </div>
                                            <div class="contact-desc">
            ...
            @if ((isset($managesection) && $managesection['services']) || empty($managesection))
                @if (checkFeature('services') && $vcard->services->count())
                    <div class="our-services-section bg-gray pt-3 pb-40 position-relative">
                        <div class="position-absolute vector-all vector-4 text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard15/vector-4.png') }}" alt="images"
                                class="w-100" />
                        </div>
                        <div
                            class="section-primary position-relative d-flex justify-content-center align-items-center">
                            <h2 class="font-cormorant text-primary text-center mb-0 d-inline-block">
                                {{ __('messages.vcard.our_service') }}
                            </h2>
                        </div>
                        <div class="services pt-3 mt-3 px-30">
                                        ...
                                        <div class="col-sm-6 mb-sm-0 mb-40 p-3">
                                            <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
                                                ...
                                                <div class="service-card card h-100">
                                                    ...
                                                    <div class="card-body p-0 text-center d-flex flex-column justify-content-between align-items-center">
                                                    <div>
                                                        <h3 class="card-title fs-18 text-primary">
                                                            {{ ucwords($service->name) }}
                                                        </h3>
                                                        <p
                                                            class="mb-0 fs-14 text-primary-light {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}">
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                <div class="qr-code-section pt-50 pb-40 position-relative">
                    <div class="position-absolute vector-10">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard15/vector-10.png') }}" alt="images"
                            class="w-25" />
                    </div>
            ...
            @if ((isset($managesection) && $managesection['galleries']) || empty($managesection))
                @if (checkFeature('gallery') && $vcard->gallery->count())
                    <div class="gallery-section pt-50 pb-40 position-relative">
                        <div class="position-absolute vector-all vector-5">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard15/vector-5.png') }}"
                                alt="images" class="w-100" />
                        </div>
                        <div
                            class="section-primary position-relative d-flex justify-content-center align-items-center mb-2">
                            <h2 class="font-cormorant text-primary text-center d-inline-block bg-white mb-0">
                                            ...
                                            @elseif($file->type == App\Models\Gallery::TYPE_AUDIO)
                                                <div class="audio-container">
                                                    <img src="{{ asset('assets/img/music.jpeg') }}"
                                                        alt="Album Cover" class="audio-image mt-2" height="173">
            ...
            @if ((isset($managesection) && $managesection['products']) || empty($managesection))
                @if (checkFeature('products') && $vcard->products->count())
                    <div class="product-section bg-gray pt-30 pb-30">
                        <div
                            class="section-primary position-relative d-flex justify-content-center align-items-center">
                            <h2 class="font-cormorant text-primary text-center mb-0 d-inline-block">
                        ...
                        <div class="px-30">
                                        ...
                                        <a @if ($product->product_url) href="{{ $product->product_url }}" @endif
                                            ...
                                            <div class="product-card card">
                                                ...
                                                <div class="product-desc card-body">
                                                    ...
                                                    <p class="fs-14 text-primary-light mb-0 product-description">
                                                        {{ $product->description }}
                                                    </p>
                                                    <div class="d-flex justify-content-between mt-2 product-info">
                                                        <div class="product-amount">
                                                            @if ($product->currency_id && $product->price)
                                                                <span
                                                                    class="text-white">{{ currencyFormat($product->price, 2, $product->currency->currency_code) }}</span>
                                                            @elseif($product->price)
                                                                <span
                                                                    class="text-white">{{ currencyFormat($product->price, 2, getUserCurrencyIcon($vcard->user->id)) }}</span>
                                                            @endif
                                                        </div>
                            ...
                            <div class="text-center pt-2">
                                <a class="fs-6 text-decoration-underline text-primary"
            ...
            @if ((isset($managesection) && $managesection['whatsapp_store']) || empty($managesection))
                @if ($whatsappStore->count())
                    <div class="whatsapp-store-product-section pt-30 pb-30">
                        <div
                            class="section-primary position-relative d-flex align-items-center justify-content-center">
                            <h2 class="font-cormorant text-primary text-center mb-0 d-inline-block bg-white">
                                            ...
                                            <div class="whatsapp-store-box card">
                                                ...
                                                <div class="whatsapp-store-content card-body">
                                                    <div class="whatsapp-store-name">
                                                        <h3 class="text-dark text-center fs-18">
                                                            {{ $product->store_name }}
                                                        </h3>
                                                    </div>
                                    ...
                                    <div class="">
                                        <div class="testimonial-card d-flex flex-sm-row flex-column align-items-center"
                                            ...
                                            <div class="card-body text-start p-0">
                                                <div class="quote-img">
                                                    <img src="{{ asset('assets/img/oldVcardTemplate/vcard15/quote-img.png') }}"
            ...
            @if ((isset($managesection) && $managesection['insta_embed']) || empty($managesection))
                @if (checkFeature('insta_embed') && $vcard->instagramEmbed->count())
                    <div class="blog-section pt-40 bg-gray-200">
                        <div
                            class="text-center mb-40 section-primary position-relative d-flex align-items-center justify-content-center">
                            <h2 class="font-cormorant text-primary text-center mb-0 d-inline-block bg-white">
            ...
            @if ((isset($managesection) && $managesection['blogs']) || empty($managesection))
                @if (checkFeature('blog') && $vcard->blogs->count())
                    <div class="blog-section pt-50 pb-30 position-relative">
                        <div class="position-absolute vector-all vector-3">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard15/vector-3.png') }}"
                                alt="images" class="w-100" />
                        </div>
                        <div
                            class="section-primary position-relative d-flex align-items-center justify-content-center">
                                    ...
                                    <div class="">
                                        <a href="{{ $vcardBlogUrl }}">
                                            <div class="blog-card card">
                                                ...
                                                <div class="card-body h-auto" style="min-height:auto!important">
                                                    <h6 class="card-title text-primary fw-2 text-center min-h-38px">
                                                        {{ $blog->title }}</h6>
                                                </div>
                                            </div>
                                        </a>
            ...
            @if ((isset($managesection) && $managesection['business_hours']) || empty($managesection))
                @if ($vcard->businessHours->count())
                    ...
                    @endphp
                    <div class="bussiness-hour-section pt-50 pb-60 position-relative">
                        <div class="position-absolute vector-all vector-2 text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard15/vector-2.png') }}"
                                alt="images" class="w-100" />
                        </div>
                        <div
                            class="section-primary position-relative d-flex align-items-center justify-content-center mb-30px">
                            <h2 class="font-cormorant text-primary text-center d-inline-block mb-0">
                                {{ __('messages.business.business_hours') }}
                            </h2>
                        </div>
                        <div class="px-30">
                            <div class="bussiness-hour-card row justify-content-center"
                                @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                @php
                                ...
                                @foreach ($businessDaysTime as $key => $dayTime)
                                    <div class="col-sm-6">
                                        <div
                                            class="mb-10 d-flex align-items-center justify-content-center business-box">
                                            <div class="fs-16 fw-medium">
                                                {{ __('messages.business.' . \App\Models\BusinessHour::DAY_OF_WEEK[$key]) . ':' }}
                                            </div>
                                            <div class="text-primary fs-14 time d-flex gap-2 align-items-center">
                                                <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"
                                                    width="16" height="16">
                                                    <defs>
                                                        <linearGradient id="clockGradient" x1="0%"
                                                            y1="0%" x2="100%" y2="0%">
                                                            <stop offset="0%" stop-color="#d68328" />
                                                            <stop offset="50%" stop-color="#ffc994" />
                                                            <stop offset="100%" stop-color="#d68328" />
                                                        </linearGradient>
                                                    </defs>
                                                    <path fill="url(#clockGradient)"
            ...
            @if ((isset($managesection) && $managesection['appointments']) || empty($managesection))
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="appointment-section bg-primary pt-50 pb-60 position-relative">
                        <div class="position-absolute vector-all vector-9 text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard15/vector-9.png') }}"
                                alt="images" class="w-50" />
                        </div>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-sm-10">
                                    <div class="row">
                                        ...
                                        <div
                                            class="col-12 text-center pt-2  d-flex justify-content-center position-relative">
                                            <button type="submit"
                                                class="btn btn-gradient appointmentAdd rounded-2 d-flex align-items-center justify-content-center d-none">
                                                {{ __('messages.make_appointments') }}
                                            </button>
                                        </div>
                                    </div>
            ...
            @if ((isset($managesection) && $managesection['iframe']) || empty($managesection))
                @if (checkFeature('iframes') && $vcard->iframes->count())
                    <div class="gallery-section pt-50 pb-4">
                        <div
                            class="position-relative d-flex section-primary justify-content-center align-items-center mb-2">
                            <h2 class="font-cormorant text-primary text-center mb-0 d-inline-block bg-white">
                                    ...
                                    <div class="slide">
                                        <div class="iframe-card">
                                            <iframe src="{{ $iframe->url }}" frameborder="0"
                                                ...
                                                allowfullscreen width="100%" height="300" class="w-100"
                                                loading="lazy">
                                            </iframe>
                                        </div>
                                    </div>
            ...
            @if ((isset($managesection) && $managesection['payment_link']) || empty($managesection))
                @if (checkFeature('payment_link') && $vcard->paymentLinks->count())
                    <div class="payment-link-section pt-50 pb-60 position-relative"
                        @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
            ...
            @php
                $currentSubs = $vcard
                    ...
                    ->first();
            @endphp
            <div class="contact-us-section pt-20 pb-60 px-30">
                @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
                    <div
                        class="section-primary position-relative mb-30px d-flex align-items-center justify-content-center">
                        <h2 class="font-cormorant text-primary text-center mb-0 d-inline-block bg-white">
                            ...
                            <form action="" id="enquiryForm" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 text-center mt-4  d-flex justify-content-center">
                                        <button
                                            class="contact-btn btn btn-gradient rounded-2 d-flex align-items-center justify-content-center"
                                            type="submit">
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
                <div class="create-vcard-section pt-50 pb-40 mb-5 position-relative">
                    <div class="position-absolute vector-all vector-1">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard15/vector-1.png') }}" alt="images"
                            class="w-100" />
                    </div>
                    <div
                        class="section-primary d-flex justify-content-center align-items-center position-relative mb-30px">
                        <h2 class="font-cormorant text-primary text-center mb-0 d-inline-block">
                    ...
                    <div class="" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        @if ($contactRequest == 1)
                            <a href="{{ Auth::check() ? route('add-contact', $vcard->id) : 'javascript:void(0);' }}"
                                class="btn btn-gradient add-contact-btn  d-flex justify-content-center ms-0 text-white align-items-center rounded px-5 text-decoration-none py-1  justify-content-center
                ...
                <div class="fixed-btn-section">
                    @if (empty($vcard->hide_stickybar))
                        <div
                            ...
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard15/sticky.png') }}" />
                        </div>
                    @endif
