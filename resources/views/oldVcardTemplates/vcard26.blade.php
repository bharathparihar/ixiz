...
<head>
    ...
    <link rel="stylesheet" href="{{ mix('assets/css/oldVcard/vcard26.css') }}">
    ...
    <div class="container p-0">
        ...
        <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
            ...
            <div class="profile-section px-30">
                <div class="cart-img">
                    <img src="{{ asset('assets/img/oldVcardTemplate/vcard26/cart.png') }}" alt="cart-img"
                        loading="lazy" />
                </div>
                <div class="percentage-img text-end">
                    <img src="{{ asset('assets/img/oldVcardTemplate/vcard26/percentage.png') }}" alt="percentage-img"
                        loading="lazy" />
                </div>
                <div
                    class="card d-flex align-items-center justify-content-center mb-3 @if ($vcard->cover_type == 2) profile-margin @endif">
                    <div class="card-img">
                    ...
                    <div class="card-body text-center">
                        <div class="profile-name">
                            ...
                            <p class="fs-16 text-white mb-0 company-name">{{ ucwords($vcard->company) }}</p>
                            <p class="fs-14 text-gray-100 mb-0">{{ ucwords($vcard->occupation) }}</p>
                            <p class="fs-14 text-gray-100 mb-0">{{ ucwords($vcard->job_title) }}</p>
                        </div>
                    </div>
                </div>
                <div class="text-light profile-desc text-center fs-14 mb-5">
            ...
            @if ((isset($managesection) && $managesection['contact_list']) || empty($managesection))
                <div class="contact-section px-30 mt-4">
                    <div class="open-box-img text-end">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard26/open-box.png') }}" alt="open-box-img"
                            loading="lazy" />
                    </div>
                            ...
                            @if ($vcard->email)
                                <div class="col-sm-6 d-flex">
                                    <div class="contact-box d-flex align-items-center w-100">
                                        <div
                                            class="contact-icon d-flex justify-content-center align-items-center me-2">
                                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard26/email.png') }}"
                                                loading="lazy" />
                                        </div>
                            ...
                            @if ($vcard->phone)
                                <div class="col-sm-6 d-flex">
                                    <div class="contact-box d-flex align-items-center w-100">
                                        <div
                                            class="contact-icon d-flex justify-content-center align-items-center me-2">
                                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard26/phone.png') }}"
                                                loading="lazy" />
                                        </div>
                                        <div class="contact-desc">
                            ...
                            @if ($vcard->dob)
                                <div class="col-sm-6 d-flex">
                                    <div class="contact-box d-flex align-items-center w-100">
                                        <div
                                            class="contact-icon d-flex justify-content-center align-items-center me-2">
                                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard26/dob.png') }}"
                                                loading="lazy" />
                                        </div>
                                        <div class="contact-desc">
                            ...
                            @if ($vcard->location)
                                <div class="col-sm-6 d-flex">
                                    <div class="contact-box d-flex align-items-center w-100">
                                        <div
                                            class="contact-icon d-flex justify-content-center align-items-center me-2">
                                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard26/location.png') }}"
                                                loading="lazy" />
                                        </div>
                                        <div class="contact-desc">
                                    ...
                                    @foreach ($vcard->services as $service)
                                        <div class="col-12">
                                            <div class="service-card h-100 align-items-center"
                                                ...
                                                <div
                                                    class="card-img d-flex justify-content-center align-items-center ms-3">
                                                    <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
            ...
            @if ((isset($managesection) && $managesection['galleries']) || empty($managesection))
                @if (checkFeature('gallery') && $vcard->gallery->count())
                    <div class="gallery-section pt-60 position-relative mb-4 pb-1">
                        <div class="box-img">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard26/box.png') }}" alt="box-img"
                                loading="lazy" />
                        </div>
                                ...
                                <div class="">
                                    <div class="testimonial-card card flex-sm-row">
                                        ...
                                        <div class="quote-img left">
                                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard26/quote-img-left.png') }}"
                                                alt="quote-img" class="mx-auto" loading="lazy" />
                                        </div>
                                        <div class="quote-img right">
                                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard26/quote-img-right.png') }}"
                                                alt="quote-img" class="mx-auto" loading="lazy" />
                                        </div>
                                    </div>
                                </div>
            ...
            @if ((isset($managesection) && $managesection['products']) || empty($managesection))
                @if (checkFeature('products') && $vcard->products->count())
                    <div class="product-section pt-30 px-30 mb-5 pb-3">
                        <div class="cards-img">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard26/cards.png') }}" alt="cards-img"
                                loading="lazy" />
                        </div>
                        <div class="section-heading text-center mb-40">
            ...
            @if ((isset($managesection) && $managesection['whatsapp_store']) || empty($managesection))
                @if ($whatsappStore->count())
                    <div class="whatsapp-store-product-section px-30 mb-5 pb-3">

                        <div class="cards-img">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard26/bag.png') }}" alt="cards-img"
                                loading="lazy" />
                        </div>
                                ...
                                <div>
                                    <div class="whatsapp-store-box card h-100">
                                        ...
                                        <div class="whatsapp-store-content card-body text-center"
                                            ...
                                            <h3 class="whatsapp-store-name text-white fw-5 mb-3">
                                                {{ $product->store_name }}
                                            </h3>
            ...
            @if ((isset($managesection) && $managesection['appointments']) || empty($managesection))
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="appointment-section px-10 pb-5 position-relative">
                        <div class="position-absolute vector-all vector-2">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard26/vector-1.png') }}"
                                alt="images" class="w-100" />
                        </div>
                        <div class="position-absolute vector-all vector-3">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard26/home.png') }}" alt="home-img"
                                loading="lazy" />
                        </div>
                        <div class="section-heading text-center">
                ...
                @if (checkFeature('blog') && $vcard->blogs->count())
                    <div class="blog-section pt-60 pb-4">
                        <div class="shoes-img text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard26/shoes.png') }}" alt="shoes-img"
                                loading="lazy" />
                        </div>
                        <div class="section-heading text-center mb-40">
            ...
            @if ((isset($managesection) && $managesection['business_hours']) || empty($managesection))
                @if ($vcard->businessHours->count())
                    ...
                    @endphp
                    <div class="business-hour-section pt-60 px-40 position-relative">
                        ...
                        <div class="business-hours row justify-content-center"
                            ...
                            @foreach ($businessDaysTime as $key => $dayTime)
                                <div class="col-sm-6">
                                    <div class="d-flex justify-content-between flex-column business-box">
                                        <div class="fs-14 text-primary">
                                        ...
                                        <div class="d-flex align-items-center gap-2 fs-14 justify-content-center">
                                            ...
                                            <div class="text-white">{{ $dayTime ?? __('messages.common.closed') }}
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                <div class="qr-code-section pt-60 px-40">
                    <div class="percentage-img2">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard26/percrentage-2.png') }}"
                            alt="percentage-img2" loading="lazy" />
                    </div>
                    <div class="bag-img text-end">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard26/bag.png') }}" alt="bag-img"
                            loading="lazy" />
                    </div>
            ...
            @if ((isset($managesection) && $managesection['payment_link']) || empty($managesection))
                @if (checkFeature('payment_link') && $vcard->paymentLinks->count())
                    <div class="payment-link-section px-30 pb-40 position-relative"
                        @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
                <div class="contact-us-section px-30 position-relative">
                    <div class="add-to-bag-img text-end">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard26/add-to-bag.png') }}"
                            alt="add-to-bag-img" loading="lazy" />
                    </div>
                    <div class="section-heading text-center mb-40">
                        ...
                        <div class="contact-form">
                            <form action="" id="enquiryForm" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        <div class="wrapper-file-input">
                                            <div class="input-box" id="fileInputTrigger">
                                                ...
                                                </h4> <input type="file" id="attachment" name="attachment" hidden accept=".jpg, .jpeg, .png"
                                                    multiple />
                                ...
                                <div class="text-center pt-3">
                                    <button class="contact-btn send-btn btn rounded-2 btn-secondary w-100"
                                        type="submit">
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
                <div class="create-vcard-section">
                    <div class="delivery-van-img">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard26/delivery-van.png') }}"
                            alt="delivery-van-img" loading="lazy" />
                    </div>
                            ...
                            <div class="vcard-link-card card">
                                <div class="d-flex align-items-center justify-content-center">
                                    <a href="{{ config('app.url') . '/register?referral-code=' . $vcard->user->affiliate_code }}"
                                        target="blank"
                                        class="fw-5 text-light link-text fs-14">{{ route('register', ['referral-code' => $vcard->user->affiliate_code]) }}
                    ...
                    <div class="text-center d-flex align-items-center justify-content-center"
                        ...
                        @if ($contactRequest == 1)
                            <a href="{{ Auth::check() ? route('add-contact', $vcard->id) : 'javascript:void(0);' }}"
                                class="add-contact-btn rounded-2 btn-secondary {{ Auth::check() ? 'auth-contact-btn' : 'ask-contact-detail-form' }}"
                ...
                <div class="fixed-btn-section">
                    @if (empty($vcard->hide_stickybar))
                        <div
                            ...
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard26/sticky.png') }}"
                                loading="lazy" />
                        </div>
                    @endif
