...
<head>
    ...
    <link rel="stylesheet" href="{{ mix('assets/css/oldVcard/vcard14.css') }}" />
        ...
        <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
            ...
            <div class="profile-section px-30 @if ($vcard->cover_type == 2) profile-margin @endif">
                @if (getLanguage($vcard->default_language) != 'Arabic' && getLanguage($vcard->default_language) != 'Persian')
                    <div class="">
                        <div class="card flex-sm-row align-items-center mb-4 p-3">
                            <div class="card-img me-sm-3">
                                <img src="{{ $vcard->profile_url }}" class="rounded-circle h-100 w-100 profileImage"
                                    loading="lazy" />
                            </div>
                            <div class="card-body text-sm-start text-center p-0">
                                <div class="profile-name">
                                    <h2 class="text-white mb-2 fs-24">
                ...
                @endif
                @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian')
                    <div class="card flex-sm-row align-items-center mb-4 p-3" dir="rtl">
                        <div class="card-img ms-sm-3">
                            <img src="{{ $vcard->profile_url }}" class="rounded-circle h-100 w-100 profileImage"
                                loading="lazy" />
                        </div>
                        <div class="card-body text-sm-start text-center p-0">
                ...
                @endif
                <div class="text-light fs-14 text-center">
            ...
            <div class="social-media d-flex justify-content-end">
                ...
                <div class="social-media-icon flex-1 d-flex justify-content-center ">
                    @if (checkFeature('social_links') && getSocialLink($vcard))
                        <div class="social-icons d-flex justify-content-center pt-4 flex-wrap w-100 px-30">
            ...
            @if ((isset($managesection) && $managesection['contact_list']) || empty($managesection))
                <div class="contact-section pt-40 pb-4 position-relative">
                    <div class="position-absolute vector-all vector-3 text-end">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard14/banner-vector-3.png') }}"
                    ...
                    @if (getLanguage($vcard->default_language) != 'Arabic' && getLanguage($vcard->default_language) != 'Persian')
                        <div class="px-30 pt-3 mt-3 position-relative">
                            <div class="row d-flex">
                                @if ($vcard->email)
                                    <div class="col-sm-6 mb-40 d-flex">
                                        <div class="contact-box d-flex align-items-center w-100">
                                            <div class="contact-icon d-flex justify-content-center align-items-center">
                                                <img
                                                    src="{{ asset('assets/img/oldVcardTemplate/vcard14/email.png') }}" />
                                            </div>
                                ...
                                @if ($vcard->phone)
                                    <div class="col-sm-6 mb-40 d-flex">
                                        <div class="contact-box d-flex align-items-center w-100">
                                            <div class="contact-icon d-flex justify-content-center align-items-center">
                                                <img
                                                    src="{{ asset('assets/img/oldVcardTemplate/vcard14/phone.png') }}" />
                                            </div>
                                            <div class="contact-desc">
                                                <a href="tel:+{{ $vcard->region_code }} {{ $vcard->phone }}"
                                                    class="text-white" dir="ltr">+{{ $vcard->region_code }}
                                                    {{ $vcard->phone }}</a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                @endif
                                @if ($vcard->dob)
                                    <div class="col-sm-6 mb-sm-0 mb-40 d-flex">
                                        <div class="contact-box d-flex align-items-center w-100">
                                            <div class="contact-icon d-flex justify-content-center align-items-center">
                                                <img
                                                    src="{{ asset('assets/img/oldVcardTemplate/vcard14/dob-icons.png') }}" />
                                            </div>
                                            <div class="contact-desc">
                                ...
                                @if ($vcard->location)
                                    <div class="col-sm-6 d-flex">
                                        <div class="contact-box d-flex align-items-center w-100">
                                            <div class="contact-icon d-flex justify-content-center align-items-center">
                                                <img
                                                    src="{{ asset('assets/img/oldVcardTemplate/vcard14/location-icons.png') }}" />
                                            </div>
                                            <div class="contact-desc">
                    ...
                    @endif
                    @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian')
                        <div class="px-30 pt-3 mt-3" dir="rtl">
                            <div class="row d-flex">
                                @if ($vcard->email)
                                    <div class="col-sm-6 mb-40 d-flex">
                                        <div class="contact-box d-flex align-items-center w-100">
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                <div class="qr-code-section pt-60 position-relative">
                    <div class="position-absolute vector-2 vector-all">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard14/vector-qr-code-1.png') }}"
                            alt="images" class="w-100" />
                    </div>
                    <div class="pb-3 section-heading-right">
                        <h2 class="text-white mb-0 pb-3">{{ __('messages.vcard.qr_code') }}</h2>
                    </div>
                    <div class="px-30">
                        <div class="qr-code d-flex justify-content-center position-relative">
                            <div class="qr-profile-img">
                                <img src="{{ $vcard->profile_url }}" loading="lazy" />
                            </div>
            ...
            @if ((isset($managesection) && $managesection['services']) || empty($managesection))
                @if (checkFeature('services') && $vcard->services->count())
                    <div class="our-services-section mt-5 position-relative">
                        <div class="position-absolute vector-all vector-4">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard14/service-vector-4.png') }}"
                                alt="images" class="w-100" />
                        </div>
                        <div class="section-heading-left">
                            <h2 class="text-white mb-3">{{ __('messages.vcard.our_service') }}</h2>
                        </div>
                        <div class="services py-4 px-30">
            ...
            @if ((isset($managesection) && $managesection['galleries']) || empty($managesection))
                @if (checkFeature('gallery') && $vcard->gallery->count())
                    <div class="gallery-section pb-40">
                        <div class="pb-3 section-heading-right">
                            <h2 class="text-white mb-0 pb-3">{{ __('messages.plan.gallery') }}</h2>
                        </div>
                        <div class="px-30">
            ...
            @if ((isset($managesection) && $managesection['products']) || empty($managesection))
                @if (checkFeature('products') && $vcard->products->count())
                    <div class="product-section">
                        <div class="section-heading-left mb-3">
                                    ...
                                    <a @if ($product->product_url) href="{{ $product->product_url }}" @endif
                                        ...
                                        <div class="">
                                            <div class="product-card card">
                                                ...
                                                <div class="product-desc card-body d-flex flex-column justify-content-between">
                                                  <div>
                                                    <h3 class="product-title text-white">
                                                        {{ $product->name }}
                                                    </h3>

                                                    <p class="fs-14 text-gray-100 mb-0 product-description">
                                                        {{ $product->description }}
                                                    </p>
                                                    </div>
            ...
            @if ((isset($managesection) && $managesection['testimonials']) || empty($managesection))
                @if (checkFeature('testimonials') && $vcard->testimonials->count())
                    <div class="testimonial-section pt-20 pb-40 position-relative">
                        <div class="position-absolute vector-all vector-5 text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard14/testimonail-vector-5.png') }}"
                                alt="images" class="w-100" />
                        </div>
                        <div class="section-heading-right">
                            <h2 class="text-white">{{ __('messages.plan.testimonials') }}</h2>
                        </div>
                        <div class="px-30">
                                    ...
                                    <div class="">
                                        <div class="testimonial-card position-relative">
                                            <div
                                                ...
                                                <img src="{{ asset('assets/img/oldVcardTemplate/vcard14/quote-left.png') }}"
                                                    class="img-fluid" loading="lazy" />
                                            </div>
                                            <div
                                                class="quote-right-img quote-img d-flex justify-content-center align-items-center">
                                                <img src="{{ asset('assets/img/oldVcardTemplate/vcard14/quote-right.png') }}"
                                                    class="img-fluid" loading="lazy" />
                                            </div>
                                            <div class="card-body p-0">
            ...
            @if ((isset($managesection) && $managesection['appointments']) || empty($managesection))
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="appointment-section pb-4 mb-2 position-relative">
                        <div class="position-absolute vector-all vector-1">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard14/vector-1.png') }}"
                                alt="images" class="w-100" />
                        </div>
                        <div class="section-heading-left">
                            ...
                            <div class="row mb-3 pb-2">
                                <div class="col-sm-10 mx-auto">
                                    <div class="position-relative">
                                        {{ Form::text('date', null, ['class' => 'date appointment-input text-start', 'placeholder' => __('messages.form.pick_date'), 'id' => 'pickUpDate']) }}
                            ...
                            <div class="row">
                                <div class="col-sm-10 mx-auto">
                                    ...
                                    <div class="col-12 mt-3 d-flex justify-content-center">
                                        <button type="submit"
                                            class="btn btn-gradient w-100  appointmentAdd rounded-2 d-flex align-items-center justify-content-center d-none">
                ...
                @if (checkFeature('insta_embed') && $vcard->instagramEmbed->count())
                    <div class="mt-5">
                        <div class="insta-feed">
                            <div class="section-heading-right my-3">
                        ...
                        <nav>
                            <div class="row insta-toggle">
                                <div class="nav nav-tabs border-0 px-0" id="nav-tab" role="tablist">
                                    ...
                                    <button
                                        class="d-flex align-items-center justify-content-center py-2 instagram-btn reelsbtn  border-0 text-light"
            ...
            @if ((isset($managesection) && $managesection['linkedin_embed']) || empty($managesection))
                @if (checkFeature('linkedin_embed') && $vcard->linkedinEmbed->count())
                    <div class="pt-5">
                        <div class="section-heading-left my-3">
                            <h2 class="text-white mb-0">{{ __('messages.feature.linkedin_embed') }}
                            </h2>
                        </div>
            ...
            @if ((isset($managesection) && $managesection['blogs']) || empty($managesection))
                @if (checkFeature('blog') && $vcard->blogs->count())
                    <div class="blog-section mt-5 pb-2">
                        <div class="section-heading-right pb-4 mb-3">
                            <h2 class="text-white mb-0">{{ __('messages.feature.blog') }}</h2>
                        </div>
                        <div class="center-slider pt-sm-0 pt-3 mt-5">
                    ...
                    <div class="bussiness-hour-section mt-5">
                        ...
                        <div class="px-30 position-relative">
                            <div class="position-absolute vector-all vector-7">
                                <img src="{{ asset('assets/img/oldVcardTemplate/vcard14/business-vector-7.png') }}"
                                    alt="images" class="w-100" />
                            </div>
                            <div class="position-absolute vector-all vector-6">
                                <img src="{{ asset('assets/img/oldVcardTemplate/vcard14//businness-vector-6.png') }}"
                                    alt="images" class="w-100" />
                            </div>
                            <div class="bussiness-hour-card" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                @php
                                ...
                                @foreach ($businessDaysTime as $key => $dayTime)
                                    <div
                                        class="mb-10 d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap gap-2">
                                        <div class="me-2 w-25">
                                            {{ __('messages.business.' . \App\Models\BusinessHour::DAY_OF_WEEK[$key]) }}
                                        </div>
                                        <div class="d-flex gap-3 align-items-center w-75 justify-content-end">
            ...
            @if ((isset($managesection) && $managesection['iframe']) || empty($managesection))
                @if (checkFeature('iframes') && $vcard->iframes->count())
                    <div class="my-5">
                        <div class="section-heading-right mb-2">
                            <h2 class="text-white">
            ...
            @if ((isset($managesection) && $managesection['payment_link']) || empty($managesection))
                @if (checkFeature('payment_link') && $vcard->paymentLinks->count())
                    <div class="payment-link-section position-relative"
                        @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>

                        <div class="section-heading-left my-3">
                            <h2 class="text-white mb-0">{{ __('messages.vcard.payment_links') }}
                            </h2>
                        </div>

                        <div class="payment-link-slider px-30">
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
                <div class="contact-us-section mt-5">
                    <div class="section-heading-left">
                        <h2 class="text-white mb-3 pb-3">{{ __('messages.contact_us.inquries') }}</h2>
                    </div>
                    <div class="px-30">
                        @if (getLanguage($vcard->default_language) != 'Arabic' && getLanguage($vcard->default_language) != 'Persian')
                            <div class="contact-form mb-4 p-3">
                                <form action="" id="enquiryForm" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 d-flex justify-content-center mt-4">
                                            <button
                                                class="contact-btn btn btn-gradient rounded-2 d-flex align-items-center"
                                                type="submit">
                                ...
                                <form action="" id="enquiryForm" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 d-flex justify-content-center mt-4 pb-2">
                                            <button
                                                class="contact-btn btn btn-gradient rounded-2 d-flex align-items-center mb-4"
                                                type="submit">
                                                {{ __('messages.contact_us.send_message') }}
                                            </button>
                                        </div>
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
                <div class="create-vcard-section mb-5 position-relative">
                    <div class="section-heading-right mb-3 pb-3">
            ...
            {{-- add contact --}}
            <div class="w-100 d-flex justify-content-center sticky-vcard-div pb-3 mb-5">
                    ...
                    <div class="" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        @if ($contactRequest == 1)
                            <a href="{{ Auth::check() ? route('add-contact', $vcard->id) : 'javascript:void(0);' }}"
                                class="btn btn-gradient add-contact-btn d-flex justify-content-center ms-0 align-items-center rounded px-5 text-decoration-none p-2  py-1 justify-content-center
                ...
                <div class="fixed-btn-section">
                    @if (empty($vcard->hide_stickybar))
                        <div
                            ...
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard14/sticky.png') }}"
                                loading="lazy" />
                        </div>
                    @endif
