...
<head>
    ...
    {{-- css link --}}
    <link rel="stylesheet" href="{{ mix('assets/css/oldVcard/vcard30.css') }}">
        ...
        <div class="main-content mx-auto w-100 overflow-hidden bg-green @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
            ...
            <div class="profile-section px-40 @if ($vcard->cover_type == 2) profile-margin @endif ">
                <div class="profile-bg img-2 text-end">
                    <img src="{{ asset('assets/img/oldVcardTemplate/vcard30/profile-bg2.png') }}" alt="bg" />
                </div>
                ...
                @endif
                {{-- description --}}
                <div class="text-gray-100 fs-14 text-center">
            ...
            <div class="contact-section pt-60 px-40">
                <div class="contact-bg img-1 text-end">
                    <img src="{{ asset('assets/img/oldVcardTemplate/vcard30/contact-bg1.png') }}" alt="bg" />
                </div>
                <div class="contact-bg img-2 text-end">
                    <img src="{{ asset('assets/img/oldVcardTemplate/vcard30/contact-bg2.png') }}" alt="bg" />
                </div>
                <div class="section-heading text-start">
                    <h2 class="mb-0">{{ __('messages.contact_us.contact') }}</h2>
                </div>
                <div class="row row-gap-20px d-flex" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                    @if ($vcard->email)
                        <div class="col-sm-6 d-flex">
                            <div class="contact-box d-flex flex-sm-column flex-row align-items-center gap-2 w-100">
                                <div class="contact-icon d-flex justify-content-center align-items-center">
                                    <img src="{{ asset('assets/img/oldVcardTemplate/vcard30/email.png') }}" />
                                </div>
                    ...
                    @if ($vcard->phone)
                        <div class="col-sm-6 d-flex">
                            <div class="contact-box d-flex flex-sm-column flex-row align-items-center gap-2 w-100">
                                <div class="contact-icon d-flex justify-content-center align-items-center">
                                    <img src="{{ asset('assets/img/oldVcardTemplate/vcard30/phone.png') }}" />
                                </div>
                                <div class="contact-desc">
                    ...
                    @if ($vcard->dob)
                        <div class="col-sm-6 d-flex">
                            <div class="contact-box d-flex flex-sm-column flex-row align-items-center gap-2 w-100">
                                <div class="contact-icon d-flex justify-content-center align-items-center">
                                    <img src="{{ asset('assets/img/oldVcardTemplate/vcard30/dob.png') }}" />
                                </div>
                                <div class="contact-desc">
                                    <p class="mb-0 text-primary fw-5"> {{ $vcard->dob }}</p>
                                </div>
                            </div>
                        </div>
                    @endif
                    @if ($vcard->location)
                        <div class="col-sm-6 d-flex">
                            <div class="contact-box d-flex flex-sm-column flex-row align-items-center gap-2 w-100">
                                <div class="contact-icon d-flex justify-content-center align-items-center">
                                    <img src="{{ asset('assets/img/oldVcardTemplate/vcard30/location.png') }}" />
                                </div>
                                <div class="contact-desc">
                                    <p class="mb-0 text-primary fw-5">{!! ucwords($vcard->location) !!}</p>
                                </div>
                            </div>
                        </div>
                    @endif
                ...
                @if (checkFeature('gallery') && $vcard->gallery->count())
                    <div class="gallery-section pt-60">
                        <div class="gallery-bg text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard30/gallery-bg.png') }}"
                                alt="bg" />
                        </div>
                        <div class="section-heading text-start px-40">
                ...
                @if (checkFeature('services') && $vcard->services->count())
                    <div class="our-services-section pt-60 px-40">
                        <div class="services-bg img-1">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard30/service-bg1.png') }}"
                                alt="bg" />
                        </div>
                        <div class="services-bg img-2 text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard30/service-bg2.png') }}"
                                alt="bg" />
                        </div>
                        <div class="section-heading text-start">
                ...
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="appointment-section pt-60 px-40">
                        <div class="appointment-bg text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard30/appointment-bg.png') }}"
                                alt="bg" />
                        </div>
                            ...
                            <div class="appointment">
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-sm-10">
                                        ...
                                        <div class="mt-3">
                                            <button class="btn btn-primary w-100 appointmentAdd rounded-2 d-none">
                ...
                @if (checkFeature('products') && $vcard->products->count())
                    <div class="product-section pt-60 px-40">
                        <div class="product-bg img-1">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard30/product-bg1.png') }}"
                                alt="bg" />
                        </div>
                        <div class="product-bg img-2 text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard30/product-bg2.png') }}"
                                alt="bg" />
                        </div>
                        <div class="section-heading text-start">
                        ...
                        <div class="product-slider">
                            @foreach ($vcard->products as $product)
                                <div class="">
                                    <div class="card-wrapper">
                                        <div class="product-card card justify-content-between align-items-center gap-4"
                                            ...
                                            <div class="product-desc card-body p-0">
                                                <div class="d-flex flex-column gap-2">
                                                    <div>
                                                        <p class="fs-14 text-gray-200 mb-1">{{ $product->name }}</p>
                                                    </div>
                        ...
                        <div class="text-center">
                            <div
                                class="mt-3 text-center btn-primary view-more mb-5 d-inline-flex justify-content-center align-items-center gap-2 mx-auto">
                                <a class="fs-6 text-primary text"
                                    href="{{ $vcardProductUrl }}">{{ __('messages.analytics.view_more') }}</a>
                                <i class="fa-solid fa-arrow-right rightarrow-animation text-white"></i>
                            </div>
                        </div>
                    </div>
                @endif
            ...
            @if ((isset($managesection) && $managesection['whatsapp_store']) || empty($managesection))
                @if ($whatsappStore->count())
                    <div class="whatsapp-store-product-section px-40 pb-40">
                        <div class="product-bg img-1">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard30/hour-bg1.png') }}"
                                alt="bg" />
                        </div>

                        <div class="product-bg img-2 text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard30/product-img2.png') }}"
                                alt="bg" />
                        </div>
                        ...
                        <div class="whatsapp-store-slider">
                            @foreach ($whatsappStore as $product)
                                <div>
                                    <div class="card-wrapper">
                                        <div class="whatsapp-store-box card flex-row justify-content-between align-items-center gap-4"
                                            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                            ...
                                            <div class="whatsapp-store-content card-body p-0">
                                                <div class="text-center d-flex flex-column gap-2">
                                                    <div>
                                                        <p class="fs-18 text-gray-200 mb-0 whatsapp-store-name">
                                                            {{ $product->store_name }}
                                                        </p>
                                                    </div>
                ...
                @if (checkFeature('testimonials') && $vcard->testimonials->count())
                    <div class="testimonial-section pt-sm-3 pt-60">
                        <div class="testimonial-bg img-1">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard30/testimonial-bg1.png') }}"
                                alt="bg" />
                        </div>
                        <div class="testimonial-bg img-2 text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard30/testimonial-bg2.png') }}"
                                alt="bg" />
                        </div>
                        <div class="section-heading text-start px-40">
                ...
                @if ($vcard->businessHours->count())
                    ...
                    <div class="business-hour-section pt-60 px-40">
                        ...
                        <div class="hour-bg img-2 text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard30/hour-bg2.png') }}"
                                alt="bg" />
                        </div>
                        <div class="section-heading text-start">
                        ...
                        <div
                            class="business-hour-card row justify-content-center"@if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                            @php
            ...
            @if ((isset($managesection) && $managesection['linkedin_embed']) || empty($managesection))
                @if (checkFeature('linkedin_embed') && $vcard->linkedinEmbed->count())
                    <div class="pt-5">
                        <div class="section-heading text-start px-40">
                            <h2 class="mb-0 mt-3">{{ __('messages.feature.linkedin_embed') }}</h2>
                        </div>
                ...
                @if (checkFeature('blog') && $vcard->blogs->count())
                    <div class="blog-section pt-60 px-40">
                        <div class="blog-bg img-1">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard30/blog-bg1.png') }}"
                                alt="bg" />
                        </div>
                        <div class="blog-bg img-2 text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard30/blog-bg2.png') }}"
                                alt="bg" />
                        </div>
                        <div class="section-heading text-start">
                        ...
                        <div class="blog-slider">
                            @foreach ($vcard->blogs as $blog)
                                ...
                                ?>
                                <div>
                                    <div class="blog-card d-flex flex-column align-items-center gap-3"
                                        @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                        <div class="card-img">
                                            <a href="{{ $vcardBlogUrl }}">
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                <div class="qr-code-section px-40">
                    <div class="qr-bg img-1">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard30/qr-bg2.png') }}" alt="bg" />
                    </div>
            ...
            @if ((isset($managesection) && $managesection['payment_link']) || empty($managesection))
                @if (checkFeature('payment_link') && $vcard->paymentLinks->count())
                    <div class="payment-link-section px-40 position-relative"
                        @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
                <div class="contact-us-section pt-30  px-40 pb-30">
                    <div class="contact-us-bg img-1 text-end">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard30/contact-us-bg1.png') }}"
                            alt="bg" />
                    </div>
                    <div class="contact-us-bg img-2">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard30/contact-us-bg2.png') }}"
                            alt="bg" />
                    </div>
                    <div class="contact-us-bg img-3 text-end">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard30/contact-us-bg3.png') }}"
                            alt="bg" />
                    </div>
                    <div class="section-heading text-start">
                                    ...
                                    @if (!empty($vcard->privacy_policy) || !empty($vcard->term_condition))
                                        <div class="col-12 mb-4">
                                            ...
                                            <label class="form-check-label" for="privacyPolicyCheckbox">
                                                <span
                                                    class="text-light">{{ __('messages.vcard.agree_to_our') }}</span>
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
                <div class="create-vcard-section pt-60 pb-3 px-40">
                    <div class="create-vcard-bg text-end">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard30/create-vcard-bg.png') }}"
                            alt="bg" />
                    </div>
                    <div class="section-heading text-start">
            ...
            {{-- end sticky buttons --}}
            <div class="vcard-bg">
                <img src="{{ asset('assets/img/oldVcardTemplate/vcard30/vcard-bg.png') }}" alt="bg" />
            </div>
        </div>
    </div>
    {{-- newslatter modal --}}
