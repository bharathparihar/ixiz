...
<body>
    <div class="container p-0">
        ...
        @endif
        <div
            class="main-section mx-auto w-100 overflow-hidden position-relative @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
            {{-- Pwa support --}}
            ...
            <!-- Profile Section -->
            <div class="profile-section mt-2 position-relative" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                <div class="px-30px">
                    <div class="rotate-circle">
                        <div
                            ...
                            <div class="rotate-text position-absolute">
                                <img src="{{ asset('assets/img/oldVcardTemplate/vcard34/black-text.png') }}"
                                    alt="images" class="h-100 w-100 object-fit-cover" />
                            </div>
                        </div>
                    </div>
                    <div class="profile-desc">
                        <h1 class="fs-28 fw-semibold lh-base text-primary mb-0 text-center text-sm-start">
                        ...
                        <p
                            class="fs-18 lh-base text-primary mb-0 photo-title text-uppercase text-center text-sm-start text-decoration-underline">
                            {{ ucwords($vcard->company) }}</p>
                        <p
                            class="fs-14 fw-light lh-base text-primary mb-0 photo-title text-uppercase text-center text-sm-start">
                    ...
                    <div class="fs-14 text-primary pt-40 text-center">
                        {!! $vcard->description !!}
                    </div>
                </div>
                {{-- social-media --}}
                <div class="social pt-4 px-30px position-relative">
                    <div class="social-bg">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard34/social-bg.png') }}" alt="images"
                            class="img-fluid" />
                    </div>
                    <div class="row @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif">
                            ...
                            @foreach (getSocialLinkIcon($vcard) as $key => $social)
                                <div class="col-sm-6 mb-3">
                                    <a href="{{ $social['url'] }}" target="_blank"
                                        ...
                                        <div
                                            class="social-item d-flex align-items-center text-white rounded-pill px-2 py-2 w-100">
                                            <div
                                                class="social-icon me-3 bg-white-100 rounded-circle d-flex justify-content-center align-items-center">
                                                {!! $social['icon'] !!}
                                            </div>
            ...
            <div class="custom-link-section">
                @if (checkFeature('custom-links'))
                    <div class="custom-link d-flex flex-wrap justify-content-center pt-3 pb-30 w-100">
            ...
            @if ((isset($managesection) && $managesection['contact_list']) || empty($managesection))
                @if (
                    ...
                    <div class="personal-section position-relative pt-40 px-30px overflow-hidden">
                        <div class="personal-bg">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard34/personal-bg.png') }}"
                                alt="images" class="img-fluid" />
                        </div>
                        @if (getLanguage($vcard->default_language) != 'Arabic' && getLanguage($vcard->default_language) != 'Persian')
                            <div class="personal-detalis position-relative py-2">
                                <div class="row d-flex">
                                    @if ($vcard->email)
                                        <div class="col-sm-6 mb-36 d-flex">
                                            <div class="details-item w-100 d-flex">
                                                <div
                                                    class="text-center position-relative z-2 w-100 d-flex flex-column justify-content-center">
                                                    <div
                                                        class="details-icon bg-primary rounded-circle d-flex justify-content-center align-items-center mx-auto">
                                                    ...
                                                    <a href="mailto:{{ $vcard->email }}"
                                                        class="fs-14 fw-5 lh-base text-primary mb-0 text-break">
                                                        {{ $vcard->email }}
                                                    </a>
                                                </div>
                                            </div>
                                            ...
                                            <div class="details-item w-100 d-flex">
                                                <div
                                                    ...
                                                    <a href="tel:+{{ $vcard->region_code }}{{ $vcard->phone }}"
                                                        class="fs-14 fw-5 lh-base text-primary mb-0">
                                        ...
                                        <div class="col-sm-6 mb-36 d-flex">
                                            <div class="details-item w-100 d-flex">
                                                <div
                                                    ...
                                                    <p class="fs-14 fw-5 lh-base text-primary mb-0">
                                                        {{ $vcard->dob }}
                                                    </p>
                                                </div>
                                            </div>
            ...
            @if ((isset($managesection) && $managesection['galleries']) || empty($managesection))
                @if (checkFeature('gallery') && $vcard->gallery->count())
                    <div class="gallery-section pt-40 pb-1 position-relative">
                        <div class="gallery-bg position-absolute end-0 text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard34/gallery-bg.png') }}"
                                alt="images" class="img-fluid" />
                        </div>
                        <div>
            ...
            @if ((isset($managesection) && $managesection['services']) || empty($managesection))
                @if (checkFeature('services') && $vcard->services->count())
                    <div class="our-section pt-40 pb-40 px-30px mb-40px position-relative"
                        @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        <div class="services-bg">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard34/services-bg.png') }}"
                                alt="images" />
                        </div>
                        <p class="section-heading fs-24 lh-base fw-semibold mx-auto mb-40px">
                        ...
                        @else
                            <div class="row services-card row-gap-3 d-flex">
                                @foreach ($vcard->services as $service)
                                    <div class="col-sm-6 d-flex">
                                        <div class="our-card1 d-flex flex-column w-100">
                                            <div
                                                class="position-relative z-2 text-center flex-grow-1 d-flex flex-column">
                                                <div class="our-img1 mb-20px mx-auto">
                                                    <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
                                                        class="{{ $service->service_url ? 'pe-auto' : 'pe-none' }}"
                                                        target="{{ $service->service_url ? '_blank' : '' }}">
                                                ...
                                                <p
                                                    class="fs-14 lh-sm text-gray-100 mb-0 flex-grow-1 {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}">
                                                    {!! \Illuminate\Support\Str::limit($service->description, 170, '...') !!}
                                                </p>
                                                @if ($vcard->show_service_enquiry_btn == true)
                                                    @if ($service->service_url)
            ...
            @if ((isset($managesection) && $managesection['appointments']) || empty($managesection))
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="appointment-section px-30px overflow-hidden pt-40 pb-40px">
                        <p class="section-heading fs-24 lh-base fw-semibold mx-auto mb-40px text-white-100">
                        ...
                        <div class="book-select">
                                    ...
                                    <div class="position-relative">
                                        {{ Form::text('date', null, [
                                            'class' =>
                                                ...
                                                (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian'
                                                    ? 'text-end'
                                                    : 'text-start'),
                            ...
                            <div class="d-flex justify-content-center">
                                <button type="submit"
                                    class="appointmentAdd btn btn-white text-primary fw-semibold fs-16 lh-base time-btn w-100 d-none">
                                    {{ __('messages.make_appointments') }}
                                </button>
                            </div>
                        </div>
            ...
            @if ((isset($managesection) && $managesection['products']) || empty($managesection))
                @if (checkFeature('products') && $vcard->products->count())
                    <div class="products-section pt-40 pb-40">
                        <div class="test-left position-absolute top-0">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard34/testleft.png') }}"
                                alt="images" class="img-fluid" />
                        </div>
                        <p class="section-heading fs-24 lh-base fw-semibold mx-auto mb-40px">
                                    ...
                                    <a @if ($product->product_url) href="{{ $product->product_url }}" @endif
                                        ...
                                        <div class="product mx-auto">
                                            ...
                                            <div class="product-content p-3">
                                                <h2 class="fs-16 lh-base text-primary mb-2">
                                                    {{ $product->name }}
                                                </h2>
                        ...
                        <div class="mx-auto d-flex">
                            <div class="mt-4 pt-2 text-center view-more mx-auto">
                                <a class="fs-6 text-white text-decoration-underline fw-4 py-2 ps-3 pe-4 d-inline-flex justify-content-center align-items-center gap-2 position-relative z-2"
            ...
            @if ((isset($managesection) && $managesection['whatsapp_store']) || empty($managesection))
                @if ($whatsappStore->count())
                    <div class="whatsapp-store-product-section px-20 position-relative">

                        <div class="position-absolute vector-75 whatsapp-store-vector-1 text-start img">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard34/iframe-bg.png') }}"
                            ...
                            @foreach ($whatsappStore as $product)
                                <div>
                                    <div class="whatsapp-store-box">
                                        ...
                                        <div class="whatsapp-store-content p-3"
                                            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>

                                            <h2 class="mb-1 whatsapp-store-name text-center">
                                                {{ $product->store_name }}
                                            </h2>
            ...
            @if ((isset($managesection) && $managesection['testimonials']) || empty($managesection))
                @if (checkFeature('testimonials') && $vcard->testimonials->count())
                    <div class="testimonial-section pt-40 pb-2 px-30px position-relative overflow-hidden">
                        <div class="testimonial-bg">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard34/testimonial-bg.png') }}"
                                alt="images" />
                        </div>
                        <p class="section-heading fs-24 lh-base fw-semibold mx-auto mb-40px">
            ...
            @if ((isset($managesection) && $managesection['insta_embed']) || empty($managesection))
                @if (checkFeature('insta_embed') && $vcard->instagramEmbed->count())
                    <div class="pt-40 mb-3 position-relative">
                        <div class="lens-img rounded-circle mx-auto mx-sm-0 mt-40px mb-40px">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard34/lens.png') }}" alt="images" />
                        </div>
                        <p class="section-heading fs-24 lh-base fw-semibold mx-auto mb-40px">
            ...
            @if ((isset($managesection) && $managesection['blogs']) || empty($managesection))
                @if (checkFeature('blog') && $vcard->blogs->count())
                    <div class="blog-section position-relative pt-40">
                        <div class="test-right position-absolute end-0 text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard34/testright.png') }}"
                                alt="images" class="img-fluid" />
                        </div>
                        <p class="section-heading fs-24 lh-base fw-semibold mx-auto mb-40px">
            ...
            @if ((isset($managesection) && $managesection['business_hours']) || empty($managesection))
                @if ($vcard->businessHours->count())
                    ...
                    @endphp
                    <div class="business-hour position-relative pb-30 {{ checkFeature('blog') && $vcard->blogs->count() ? 'pt-0' : 'pt-40' }}"
                        @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        <div class="business-right">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard34/business.png') }}"
                                alt="images" class="img-fluid" />
                        </div>
                            ...
                            <div class="time-table w-100">
                                @foreach ($businessDaysTime as $key => $dayTime)
                                    ...
                                    <div class="time-table-hour">
                                        <div
                                            class="d-flex justify-content-between align-items-center  gap-2 time-detail position-relative z-2">
                                            <p
                                                class="fs-14 fw-medium lh-base mb-0 days d-flex align-items-center gap-2">
                                                <span class="time-icon">
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                        fill="none" stroke="#060606" stroke-width="2"
                                            ...
                                            <p class="fs-14 fw-medium lh-base mb-0">
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                <div class="qr-section pt-40 pb-40">
                    <div class="qr-code-bg">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard34/qr-code-bg.png') }}" alt="images"
                            class="img-fluid" />
                    </div>
                    <div class="qr-code d-flex justify-content-center align-items-center position-relative">
                        <p class="section-heading fs-24 lh-base fw-semibold mx-auto mb-40px text-white-100 ">
                    ...
                    <div class="container">
                        <div
                            class="qr-code-wrapper d-flex justify-content-center align-items-center m-0 flex-column flex-sm-row gap-4 @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') qr-box @endif">
                            <div class="mb-sm-0 mb-4 position-relative z-2">
            ...
            @if ((isset($managesection) && $managesection['iframe']) || empty($managesection))
                @if (checkFeature('iframes') && $vcard->iframes->count())
                    <div class="iframe-section pt-40">
                        <div class="iframe-bg text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard34/iframe-bg.png') }}"
                                alt="images" />
                        </div>
                        <p class="section-heading fs-24 lh-base fw-semibold mx-auto mb-40px">
            ...
            @if ((isset($managesection) && $managesection['payment_link']) || empty($managesection))
                @if (checkFeature('payment_link') && $vcard->paymentLinks->count())
                    <div class="payment-link-section pt-40 position-relative"
                        @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
                <div class="contact-section px-30px pt-40 pb-40" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                    <div class="contact-bg">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard34/contact-bg.png') }}"
                            alt="images" />
                    </div>
                    <p class="section-heading fs-24 lh-base fw-semibold mx-auto mb-40px">
                    ...
                    <div class="contact-form">
                        <form action="" id="enquiryForm" enctype="multipart/form-data">
                            ...
                            <div class="mb-20px">
                                <div class="form-control-wrapper">
                                    <input type="tel" class="form-control fs-16 lh-base"
                            ...
                            <div class="mb-20px">
                                <div class="form-control-wrapper">
                                    <textarea rows="3" placeholder="{{ __('messages.form.type_message') }}" name="message" rows="4"
                                        class="w-100 border-top-0 border-start-0 border-end-0"></textarea>
                                </div>
                            </div>
                            @if (isset($inquiry) && $inquiry == 1)
                                <div class="mb-3 mt-3">
                                    <div class="wrapper-file-input">
                                        ...
                                        <small>{{ __('messages.file_supported') }}</small>
                                    </div>
                                ...
                                <div class="col-12 mb-4">
                                    ...
                                    <label class="form-check-label fs-14" for="privacyPolicyCheckbox">
                                        ...
                                        <a href="{{ $vcardPrivacyAndTerm }}" target="_blank"
                                            class="text-decoration-none link-info fs-14 text-primary text-decoration-underline fw-6">{!! __('messages.vcard.term_and_condition') !!}</a>
                                        <span class="text-dark">&</span>
                                        <a href="{{ $vcardPrivacyAndTerm }}" target="_blank"
                                            class="text-decoration-none link-info fs-14 text-primary text-decoration-underline fw-6">{{ __('messages.vcard.privacy_policy') }}</a>
                                    </label>
                                </div>
                            @endif
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
                <div class="v-card-section">
                    <div class="v-bg-img position-relative pt-40 mb-60px pb-40px">
                        <p
                            class="section-heading fs-24 lh-base fw-semibold mx-auto mb-40px text-white-100 position-relative z-2">
...
<script>
    ...
    let isRtl = {{ checkLanguageSession($vcard->url_alias) == 'ar' ? 'true' : 'false' }};
