...
<head>
    ...
    {{-- css link --}}
    <link rel="stylesheet" href="{{ mix('assets/css/oldVcard/vcard29.css') }}">
        ...
        <div class="main-content mx-auto w-100 overflow-hidden bg-green @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
            ...
            <div class="contact-section pt-60 px-40">
                <div class="contact-bg img-1">
                    <img src="{{ asset('assets/img/oldVcardTemplate/vcard29/contact-bg1.png') }}" alt="bg" />
                </div>
                <div class="contact-bg img-2 text-end">
                    <img src="{{ asset('assets/img/oldVcardTemplate/vcard29/contact-bg2.png') }}" alt="bg" />
                </div>
                <div class="section-heading">
                    <div class="heading-img">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard29/contact-heading.png') }}"
                            class="w-100" alt="img" />
                    </div>
                    ...
                    <div class="row">
                            ...
                            <div class="col-sm-6 mb-40">
                                <div class="contact-box d-flex align-items-center">
                                    <div class="contact-icon d-flex justify-content-center align-items-center">
                                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard29/email.png') }}" />
                                    </div>
                        ...
                        @if ($vcard->phone)
                            <div class="col-sm-6 mb-40">
                                <div class="contact-box d-flex align-items-center">
                                    <div class="contact-icon d-flex justify-content-center align-items-center">
                                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard29/phone.png') }}" />
                                    </div>
                                    <div class="contact-desc">
                        ...
                        @if ($vcard->dob)
                            <div class="col-sm-6 mb-40">
                                <div class="contact-box d-flex align-items-center">
                                    <div class="contact-icon d-flex justify-content-center align-items-center">
                                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard29/dob.png') }}" />
                                    </div>
                                    <div class="contact-desc">
                        ...
                        @if ($vcard->location)
                            <div class="col-sm-6 mb-40">
                                <div class="contact-box d-flex align-items-center">
                                    <div class="contact-icon d-flex justify-content-center align-items-center">
                                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard29/location.png') }}" />
                                    </div>
                                    <div class="contact-desc">
                ...
                @if (checkFeature('services') && $vcard->services->count())
                    <div class="our-services-section pt-60 pb-40 px-40">
                        <div class="services-bg img-1">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard29/services-bg1.png') }}"
                                alt="bg" />
                        </div>
                        <div class="services-bg img-2 text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard29/services-bg2.png') }}"
                                alt="bg" />
                        </div>
                        <div class="section-heading">
                            <div class="heading-img">
                                <img src="{{ asset('assets/img/oldVcardTemplate/vcard29/services-heading.png') }}"
                                    class="w-100" alt="img" />
                            </div>
                ...
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="appointment-section pt-40 pb-40 px-40">
                        <div class="appointment">
                            <div class="section-heading">
                                <div class="heading-img">
                                    <img src="{{ asset('assets/img/oldVcardTemplate/vcard29/appointment-heading.png') }}"
                                        class="w-100" alt="img" />
                                </div>
                            ...
                            <div>
                                ...
                                <div class="text-center">
                                    <button type="submit"
                                        class="appoint-btn appointmentAdd btn btn-primary w-100 rounded-2 d-none">
                ...
                @if (checkFeature('gallery') && $vcard->gallery->count())
                    <div class="gallery-section pt-60">
                        <div class="gallery-bg img-1">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard29/gallery-bg1.png') }}"
                                alt="bg" />
                        </div>
                        <div class="gallery-bg img-2 text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard29/gallery-bg2.png') }}"
                                alt="bg" />
                        </div>
                        <div class="section-heading px-40">
                            <div class="heading-img">
                                <img src="{{ asset('assets/img/oldVcardTemplate/vcard29/gallery-heading.png') }}"
                                    class="w-100" alt="img" />
                            </div>
                ...
                @if (checkFeature('products') && $vcard->products->count())
                    <div class="product-section pt-60 mb-10 pb-60 px-30">
                        <div class="product-bg img-1">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard29/product-bg1.png') }}"
                                alt="bg" />
                        </div>
                        <div class="product-bg img-2 text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard29/product-bg2.png') }}"
                                alt="bg" />
                        </div>
                        <div class="section-heading px-3">
                            <div class="heading-img">
                                <img src="{{ asset('assets/img/oldVcardTemplate/vcard29/product-heading.png') }}"
                                    class="w-100" alt="img" />
                            </div>
            ...
            @if ((isset($managesection) && $managesection['whatsapp_store']) || empty($managesection))
                @if ($whatsappStore->count())
                    <div class="main-section">
                        <div class="whatsapp-store-product-section pb-60 px-30">
                            <div class="product-bg img-1">
                                <img src="{{ asset('assets/img/oldVcardTemplate/vcard29/contact-bg2.png') }}"
                                    alt="bg" />
                            </div>
                            <div class="product-bg img-2 text-end">
                                <img src="{{ asset('assets/img/oldVcardTemplate/vcard29/services-bg2.png') }}"
                            ...
                            <div class="section-heading px-3">
                                <div class="heading-img">
                                    <img src="{{ asset('assets/img/oldVcardTemplate/vcard29/hour-heading.png') }}"
                                        class="w-100" alt="img" />
                                </div>
                                ...
                                @foreach ($whatsappStore as $product)
                                    <div>
                                        <div class="whatsapp-store-box card">
                                            ...
                                            <div class="whatsapp-store-content card-body p-3"
                                                @if (getLanguage($vcard->default_language) == 'Arabic' ||
                                                    getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>

                                                <div>
                                                    <h3 class="text-center mb-3 whatsapp-store-name text-white">
                                                        {{ $product->store_name }}
                                                    </h3>
                ...
                @if (checkFeature('testimonials') && $vcard->testimonials->count())
                    <div class="testimonial-section pb-60 px-40">
                        <div class="testimonial-bg img-1">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard29/testimonial-bg1.png') }}"
                                alt="bg" />
                        </div>
                        <div class="section-heading px-3">
                            <div class="heading-img">
                                <img src="{{ asset('assets/img/oldVcardTemplate/vcard29/testimonial-heading.png') }}"
                                    class="w-100" alt="img" />
                            </div>
            ...
            @if ((isset($managesection) && $managesection['insta_embed']) || empty($managesection))
                @if (checkFeature('insta_embed') && $vcard->instagramEmbed->count())
                    <div class="">
                        <div class="section-heading px-40">
                            <div class="heading-img">
                                <img src="{{ asset('assets/img/oldVcardTemplate/vcard29/blog-heading.png') }}"
                                    class="w-100" alt="img" />
                            </div>
                ...
                @if (checkFeature('blog') && $vcard->blogs->count())
                    <div class="blog-section pt-60">
                        <div class="blog-bg img-1">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard29/blog-bg1.png') }}"
                                alt="bg" />
                        </div>
                        <div class="blog-bg img-2 text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard29/blog-bg2.png') }}"
                                alt="bg" />
                        </div>
                        <div class="section-heading px-40">
                            <div class="heading-img">
                ...
                @if ($vcard->businessHours->count())
                    ...
                    <div class="business-hour-section pt-60 pb-40 px-40">
                        <div class="hour-bg img-1">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard29/hour-bg1.png') }}"
                                alt="bg" />
                        </div>
                        <div class="hour-bg img-2 text-end">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard29/hour-bg2.png') }}"
                                alt="bg" />
                        </div>
                        <div class="section-heading">
                            <div class="heading-img">
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                <div class="qr-code-section pt-40 pb-40 px-40">
                    <div class="qr-bg img-1">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard29/qr-bg1.png') }}" alt="bg" />
                    </div>
                    <div class="section-heading">
                        <div class="heading-img">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard29/qr-heading.png') }}"
                                class="w-100" alt="img" />
                        </div>
                        <h2 class="mb-0">{{ __('messages.vcard.qr_code') }}</h2>
                    </div>
                    <div class="qr-code gap-3 mb-20" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
            ...
            @if ((isset($managesection) && $managesection['payment_link']) || empty($managesection))
                @if (checkFeature('payment_link') && $vcard->paymentLinks->count())
                    <div class="payment-link-section pt-60 px-40 position-relative"
                        @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
                <div class="contact-us-section pt-60 pb-40 px-40">
                    <div class="contact-us-bg img-1 text-end">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard29/contact-us-bg1.png') }}"
                            alt="bg" />
                    </div>
                    <div class="section-heading">
                        <div class="heading-img">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard29/contact-us-heading.png') }}"
                                class="w-100" alt="img" />
                        </div>
                                    ...
                                    @if (!empty($vcard->privacy_policy) || !empty($vcard->term_condition))
                                        <div class="col-12 mb-4">
                                            ...
                                            <label class="form-check-label" for="privacyPolicyCheckbox">
                                                <span
                                                    class="text-primary">{{ __('messages.vcard.agree_to_our') }}</span>
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
                <div class="create-vcard-section pt-40 pb-60 px-40">
                    <div class="create-vcard-bg img-1">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard29/create-vcard-bg1.png') }}"
                            alt="bg" />
                    </div>
                    <div class="create-vcard-bg img-2 text-end">
                        <img src="{{ asset('assets/img/oldVcardTemplate/vcard29/create-vcard-bg2.png') }}"
                            alt="bg" />
                    </div>
                    ...
                    <div class="content">
                        <div class="section-heading">
                            <div class="heading-img">
                                <img src="{{ asset('assets/img/oldVcardTemplate/vcard29/create-vcard-heading.png') }}"
                                    class="w-100" alt="img" />
                            </div>
                ...
                <div class="fixed-btn-section">
                    @if (empty($vcard->hide_stickybar))
                        <div
                            ...
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard29/sticky.png') }}" loading="lazy">
                        </div>
                    @endif
