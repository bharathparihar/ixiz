...
<head>
    ...
    <link rel="stylesheet" href="{{ mix('assets/css/oldVcard/vcard16.css') }}">
...
<body>
    <div class="container p-0">
        ...
        <div class="main-content mx-auto w-100 overflow-hidden  @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') rtl @endif">
            ...
            <div class="profile-section pb-40 px-30  bg-primary">
                <div class="row justify-content-end">
                    <div class="col-12">
                        <div class="card flex-sm-row @if ($vcard->cover_type == 2) profile-margin @endif">
                            <div class="card-img d-flex justify-content-center align-items-center">
                                <img src="{{ $vcard->profile_url }}"
                                    class="rounded-circle h-100 w-100 object-fit-cover" loading="lazy" />
                            </div>
                            <div class="card-body text-sm-start text-center">
                                <div class="profile-name">
                                    <h2 class=" text-primary fs-24 fw-bold mb-1 font-hedvig">
                                        {{ ucwords($vcard->first_name . ' ' . $vcard->last_name) }}
                                        @if ($vcard->is_verified)
                                            <i class="verification-icon bi-patch-check-fill"></i>
                                        @endif
                                    </h2>
                                    <p class="fs-16 text-primary fw-5 text-decoration-underline">{{ ucwords($vcard->company) }}</p>
                                    <p class="fs-14 text-primary mb-0">{{ ucwords($vcard->occupation) }}</p>
                                    <p class="fs-14 text-primary mb-0">{{ ucwords($vcard->job_title) }}</p>
                                </div>
                ...
                <div class="social-media mt-0 pt-0 mb-40 d-flex justify-content-center">
                    <div class="bg-vector-1">
                                <img src={{ asset('assets/img/oldVcardTemplate/vcard16/bg-vector-1.png') }} alt="bg-vector"/>
                                </div>
                                <div class="bg-vector-2">
                                <img src={{ asset('assets/img/oldVcardTemplate/vcard16/bg-vector-2.png') }} alt="bg-vector"/>
                                </div>
                    @if (checkFeature('social_links') && getSocialLink($vcard))
                        <div class="social-icons d-flex justify-content-center pt-3 pt-sm-0 flex-wrap w-100">
                ...
                <div class="desc text-gray-100 text-center">
                    <p class=" mb-0">
                        {!! $vcard->description !!}
                    </p>
                </div>
            ...
            @if ((isset($managesection) && $managesection['contact_list']) || empty($managesection))
                <div class="contact-section pt-40 pb-30">
                    <div class="section-heading text-center mb-40">
                        <h2 class="text-primary text-center mb-2">{{ __('messages.contact_us.contact') }}</h2>
                    </div>
                    <div class="px-30">
                            @if (getLanguage($vcard->default_language) != 'Arabic' && getLanguage($vcard->default_language) != 'Persian')
                                <div class="row mb-sm-0 mb-4 d-flex">
                                    <div class="col-sm-6 d-flex">
                                        {{-- email --}}
                                        @if ($vcard->email)
                                            <div class="contact-box mb-10 w-100">
                                                <div
                                                    class="contact-icon d-flex justify-content-center align-items-center">
                                                    <img src="{{ asset('assets/img/oldVcardTemplate/vcard16/email.png') }}" />
                                                </div>
                                    ...
                                    @if ($vcard->phone)
                                        <div class="col-sm-6">
                                            <div class="contact-box mb-10">
                                                <div
                                                    class="contact-icon d-flex justify-content-center align-items-center">
                                                    <img src="{{ asset('assets/img/oldVcardTemplate/vcard16/phone.png') }}" />
                                                </div>
                                                <div class="contact-desc">
                                                    <a href="tel:+ {{ $vcard->region_code }}
                                            {{ $vcard->phone }}"
                                                        class="text-primary fw-6 mb-0 fs-14"
                                    ...
                                    @if ($vcard->dob)
                                        <div class="col-sm-6 d-flex">
                                            <div class="contact-box mb-10 w-100">
                                                <div
                                                    class="contact-icon d-flex justify-content-center align-items-center">
                                                    <img src="{{ asset('assets/img/oldVcardTemplate/vcard16/dob-icon.png') }}" />
                                                </div>
                                                <div class="contact-desc">
                                    ...
                                    @if ($vcard->location)
                                        <div class="col-sm-6 d-flex">
                                            <div class="contact-box mb-10 w-100">
                                                <div
                                                    class="contact-icon d-flex justify-content-center align-items-center">
                                                    <img src="{{ asset('assets/img/oldVcardTemplate/vcard16/location.png') }}" />
                                                </div>
                                                <div class="contact-desc">
                            ...
                            @endif
                            @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian')
                                <div class="row mb-sm-0 mb-4 d-flex" dir="rtl">
                                    <div class="col-sm-6 d-flex">
                                        {{-- email --}}
                                        @if ($vcard->email)
                                            <div class="contact-box mb-10 w-100">
            ...
            @if ((isset($managesection) && $managesection['appointments']) || empty($managesection))
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="appointment-section pt-50  pb-50 bg-primary">
                        <div class="section-heading text-center mb-40">
                        <h2 class="text-white text-center mb-2">{{ __('messages.make_appointments') }}</h2>
                    </div>
                                ...
                                <div class="col-12 mb-20">
                                    <div class="position-relative">
                                        ...
                                        <span class="calendar-icon">
                                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard16/Vector.png') }}" />
                                        </span>
                                    </div>
                                </div>
                                <div class="col-12">
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                <div class="qr-code-section pt-40 pb-50 position-relative">
                    <div class="section-heading text-center mb-40">
                        <h2 class="text-primary text-center mb-2">{{ __('messages.vcard.qr_code') }}</h2>
                    </div>
                    <div class="px-30">
            ...
            @if ((isset($managesection) && $managesection['services']) || empty($managesection))
                @if (checkFeature('services') && $vcard->services->count())
                    <div class="our-services-section pb-30">
                        <div class="section-heading text-center mb-40">
                            <h2 class="text-primary text-center mb-2">{{ __('messages.vcard.our_service') }}</h2>
                        </div>
                        <div class="services-bg">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard16/services-bg.png') }}" alt=""
                                class="" loading="lazy">
                        </div>
                                        ...
                                        <div class="col-sm-6 mb-40">
                                            <div class="service-card card h-100 align-items-center">
                                                ...
                                                <div class="card-body text-center p-0">
                                                    <h3 class="card-title fs-18 fw-4 text-primary">
                                                        {{ $service->name }}</h3>
                                                    <p
                                                        class="mb-0 text-gray-300 {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}">
            ...
            @if ((isset($managesection) && $managesection['galleries']) || empty($managesection))
                @if (checkFeature('gallery') && $vcard->gallery->count())
                    <div class="gallery-section px-30 bg-primary position-relative pt-60 pb-60">
                        <div class="gallery-bg text-end position-absolute">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard16/gallery-bg.png') }}" class="h-100"
                                loading="lazy">
                        </div>
                        <div>
                            <div class="section-heading text-center mb-40">
                                    <h2 class="text-white text-center mb-2">{{ __('messages.plan.gallery') }}</h2>
                               </div>
            ...
            @if ((isset($managesection) && $managesection['products']) || empty($managesection))
                @if (checkFeature('products') && $vcard->products->count())
                    <div class="product-section pt-40 pb-20">
                        <div class="section-heading text-center mb-40">
                                    <h2 class="text-primary text-center mb-2">{{ __('messages.plan.products') }}</h2>
                               </div>
                        ...
                        <div class="text-center p-2">
                            <a class="fs-6 text-decoration-underline p-2 text-dark"
            ...
            @if ((isset($managesection) && $managesection['whatsapp_store']) || empty($managesection))
                @if ($whatsappStore->count())
                    <div class="whatsapp-store-product-section pt-40 pb-20">
                        ...
                        <div class="mb-4">
                            <div class="whatsapp-store-slider px-4">
                                        ...
                                        <div class="whatsapp-store-box card">
                                            ...
                                            <div class="whatsapp-store-content card-body d-flex align-items-center flex-column gap-2"
                                                ...
                                                <div class="whatsapp-store-name">
                                                    <h3 class="text-primary fs-18 text-center">
                                                        {{ $product->store_name }}
                                                    </h3>
                                                </div>
            ...
            @if ((isset($managesection) && $managesection['testimonials']) || empty($managesection))
                @if (checkFeature('testimonials') && $vcard->testimonials->count())
                    <div class="testimonial-section pt-40 pb-50 bg-primary position-relative">
                        <div class="section-heading text-center mb-40">
                            <h2 class="text-white text-center mb-2">{{ __('messages.plan.testimonials') }}</h2>
                        </div>
                                ...
                                <div class="">
                                    <div class="testimonial-card">
                                        ...
                                        <div class="card-body p-0  text-center">
                                            <p
                                                class="text-gray-300 mb-3 fs-14 {{ \Illuminate\Support\Str::length($testimonial->description) > 80 ? 'more' : '' }}">
                                                {!! $testimonial->description !!}
                                            </p>
                                            <h6 class="card-title fs-18  mb-0 text-primary">
                        ...
                        <div class="testimonial-bg-img">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard16/testimonial-bg-img.png') }}" loading="lazy" />
                        </div>
            ...
            @if ((isset($managesection) && $managesection['insta_embed']) || empty($managesection))
                @if (checkFeature('insta_embed') && $vcard->instagramEmbed->count())
                    <div class="insta-section pt-5 position-relative">
                        <div class="section-heading text-center mb-40">
                            <h2 class="text-primary text-center mb-2">{{ __('messages.feature.insta_embed') }}</h2>
                        </div>
                        <nav>
            ...
            @if ((isset($managesection) && $managesection['linkedin_embed']) || empty($managesection))
                @if (checkFeature('linkedin_embed') && $vcard->linkedinEmbed->count())
                    <div class="pt-5">
                        <div class="section-heading text-center mb-40">
                            <h2 class="text-primary text-center mb-2">{{ __('messages.feature.linkedin_embed') }}</h2>
                        </div>
            ...
            @if ((isset($managesection) && $managesection['blogs']) || empty($managesection))
                @if (checkFeature('blog') && $vcard->blogs->count())
                    <div class="blog-section mt-4 pb-50">
                        <div class="section-heading text-center mb-40">
                            <h2 class="text-primary text-center mb-2">{{ __('messages.feature.blog') }}</h2>
                        </div>
                        <div class="blog-slider px-4">
                            @foreach ($vcard->blogs as $blog)
                                ...
                                ?>s
                                <div class="">
                                    <div class="blog-card card gap-3 align-items-center "
                                        @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                        <div class="card-img">
                                            <a href="{{ $vcardBlogUrl  }}">
                        ...
                        <div class="blog-bg">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard16/blog-bg-img.png') }}" loading="lazy">
                        </div>
                    </div>
                @endif
            @endif
                        ...
                        <div class="px-30">
                            <div class="bussiness-hour-card" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                ...
                                @foreach ($businessDaysTime as $key => $dayTime)
                                    <div class="mb-10 d-flex gap-2 align-items-center justify-content-between">
                                        <span
                                            class="days fs-16"><i class="fa-solid fa-calendar-week text-primary me-1"></i> {{ __('messages.business.' . \App\Models\BusinessHour::DAY_OF_WEEK[$key]) }}</span>
                                        <span class="fs-16 hours"> {{ $dayTime ?? __('messages.common.closed') }}</span>
                                    </div>
                                @endforeach
                            </div>
                        </div>
                        <div class="business-hour-bg">
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard16/hour-bg-img.png') }}">
                        </div>
                    </div>
                @endif
            @endif
            ...
            @if ((isset($managesection) && $managesection['iframe']) || empty($managesection))
                @if (checkFeature('iframes') && $vcard->iframes->count())
                    <div class="iframe-section pt-20 pb-20 mt-4 position-relative">
                        <div class="section-heading text-center mb-40">
                            <h2 class="text-primary text-center mb-2">{{ __('messages.vcard.iframe') }}</h2>
                        </div>
                        <div class="iframe-slider  mt-3">
            ...
            @if ((isset($managesection) && $managesection['payment_link']) || empty($managesection))
                @if (checkFeature('payment_link') && $vcard->paymentLinks->count())
                    <div class="payment-link-section px-30 pt-50 position-relative"
                        @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>

                        <div class="section-heading text-center mb-40">
                            <h2 class="text-primary text-center mb-2">{{ __('messages.vcard.payment_links') }}</h2>
                        </div>
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
                <div class="contact-us-section pb-50 pt-50 px-30">
                    <div class="section-heading text-center mb-40">
                            <h2 class="text-primary text-center mb-2">{{ __('messages.contact_us.inquries') }}</h2>
                        </div>
                    @if (getLanguage($vcard->default_language) != 'Arabic' && getLanguage($vcard->default_language) != 'Persian')
                        <div class="contact-form position-relative">
                            <form action="" id="enquiryForm" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            <textarea class="form-control h-100" rows="4" name="message" placeholder="{{ __('messages.form.type_message') }}"
                                                rows="4"></textarea>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-12  mt-2">
                                            ...
                                            <label class="form-check-label fs-14" for="privacyPolicyCheckbox">
                                                ...
                                                <a href="{{ $vcardPrivacyAndTerm }}"
                                                    target="_blank"
                                                    class="text-decoration-underline fw-5 link-info">{!! __('messages.vcard.term_and_condition') !!}</a>
                                                <span class="text-dark">&</span>
                                                <a href="{{ $vcardPrivacyAndTerm }}"
                                                    target="_blank"
                                                    class="text-decoration-underline fw-5 link-info">{{ __('messages.vcard.privacy_policy') }}</a>
                                            </label>
                                        </div>
                                    @endif
                        ...
                        <div class="contact-form position-relative" dir="rtl">
                            <form action="" id="enquiryForm" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    @endif
                                    @if (!empty($vcard->privacy_policy) || !empty($vcard->term_condition))
                                        <div class="col-12 mx-3 px-3 mt-2">
                                            <input type="checkbox" name="terms_condition"
                                                class="form-check-input terms-condition" id="termConditionCheckbox"
                                                placeholder>&nbsp;
            ...
            @if ($vcard->enable_contact)
                <div class="add-to-contact-section py-3 px-30 text-center">
                    <div class="d-inline-block" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        @if ($contactRequest == 1)
                            <a href="{{ Auth::check() ? route('add-contact', $vcard->id) : 'javascript:void(0);' }}"
                                class="vcard16-sticky-btn add-contact-btn sticky-vcard16-div d-flex justify-content-center ms-0 align-items-center rounded px-5 text-decoration-none py-1 justify-content-center
                ...
                <div class="fixed-btn-section">
                    @if (empty($vcard->hide_stickybar))
                        <div
                            ...
                            <img src="{{ asset('assets/img/oldVcardTemplate/vcard16/sticky.png') }}" loading="lazy" />
                        </div>
                    @endif
